...
""" #+begin_org
* ~[Summary]~ :: A =CS-Lib= for incorporating qmail in systemd.
#+end_org """
...
** This File: /bisos/git/auth/bxRepos/bisos-pip/qmail/py3/bisos/qmail/qmailDaemonSysd.py
...
####+BEGIN: b:py3:class/decl :className "ConfigFile_sysdQmailUnused" :superClass "configFile.ConfigFile" :comment "" :classType "basic"
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  Cls-basic  [[elisp:(outline-show-subtree+toggle)][||]] /ConfigFile_sysdQmailUnused/  superClass=configFile.ConfigFile  [[elisp:(org-cycle)][| ]]
#+end_org """
class ConfigFile_sysdQmailUnused(configFile.ConfigFile):
####+END:
    """ #+begin_org
...
*** [[elisp:(org-cycle)][| DocStr| ]]  Return path NOTYET
        #+end_org """
        serviceFilePath = sysdUnitQmail.serviceFilePath()
...
####+END
        ...
        """ #+begin_org
*** [[elisp:(org-cycle)][| DocStr| ]]  Returns string. See provenence and history below:
...
#sysdConfigQmail = ConfigFile_sysdQmail("NOTYET")
sysdUnitNotQmail = bifSystemd.SysUnit("notqmail")
...
** [[elisp:(org-cycle)][| *DocStr | ] Examples of Service Access Instance Commands.
    ...
    # configFile.examples_csu(concreteConfigFile='sysdConfigQmail', sectionTitle="default")

    bifSystemd.examples_csuSysUnit(userUnitInstanceName='sysdUnitNotQmail', sectionTitle="default")

    cs.examples.menuChapter('*Qmail Daemon Full Update*')

    cmndName = "qmailDaemonFullUpdate" ;  cmndArgs = ""
    cps=cpsInit(); menuItem(verbosity='none') ; menuItem(verbosity='full')

    cmndName = "sysdCmndQmail" ;  cmndArgs = ""
    cps=cpsInit(); menuItem(verbosity='none') ; menuItem(verbosity='full')


####+BEGIN: b:py3:cs:cmnd/classHead :cmndName "qmailDaemonFullUpdate" :extent "verify" :parsMand "" :parsOpt "" :argsMin 0 :argsMax 0 :pyInv ""
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  CmndSvc-   [[elisp:(outline-show-subtree+toggle)][||]] <<qmailDaemonFullUpdate>>  =verify= ro=cli   [[elisp:(org-cycle)][| ]]
#+end_org """
class qmailDaemonFullUpdate(cs.Cmnd):
    cmndParamsMandatory = [ ]
    cmndParamsOptional = [ ]
...
** [[elisp:(org-cycle)][| *CmndDesc:* | ]] Return a dict of parName:parValue as results
        ...
        # sysdConfigQmail.configFileUpdate()

        # path = sysdConfigQmail.configFilePath()
        ...
        sysdUnitNotQmail.reload()  # to have systemd aware of the unit files

        sysdUnitNotQmail.start()
