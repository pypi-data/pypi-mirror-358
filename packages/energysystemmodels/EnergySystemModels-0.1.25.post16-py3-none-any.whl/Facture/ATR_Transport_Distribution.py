...
class ATR_calculation:
    ...
    def calculate(self):
        ...
        if self.contrat.type_tarif_acheminement in ["T1", "T2", "T3"]:
            ...
            self.euro_an_ATRD_souscript_capa_CJA = round(CJN_MWh_j * 1000 * tarif_capacite, 2)
            ...
            self.euro_an_ATRD_souscript_capa_CJA = round(CJN_MWh_j * tarif_capacite * self.nb_jour, 2)
        ...
        if self.contrat.CAR_MWh is not None and self.contrat.CAR_MWh > 0 and self.contrat.CJN_MWh_j is None:
            ...
            self.CJN = self.contrat.CJN_MWh_j if self.contrat.CJN_MWh_j is not None else 0.0
        ...
        self.euro_an_ATRT_TCS = self.CJN * self.TCS
        self.euro_an_ATRT_TCR = self.CJN * (self.TCR * self.NTR)
        self.euro_an_ATRT_TCL = self.CJN * self.TCL
        ...
        self.euro_CTA = self.euro_an_CTA * self.nb_jour / 365.0
    ...
    # def plot_detail(self, title="Détail des Composantes Gaz (ATRD/ATRT)", figsize=(16, 6)):
    #     """Affiche un graphique en cascade des composantes ATRD et ATRT."""
    #     fig, axs = plt.subplots(1, 3, figsize=figsize)

    #     # === Distribution (ATRD) ===
    #     atrd_labels = ['Fixe', 'Souscription capacité', 'Variable']
    #     atrd_values = [
    #         self.euro_ATRD_fixe_hors_capacite,
    #         self.euro_ATRD_souscript_capa_CJA,
    #         self.euro_ATRD_variable
    #     ]
    #     axs[0].bar(atrd_labels, atrd_values, color='#4CAF50')
    #     axs[0].set_title("Distribution (ATRD)")
    #     axs[0].set_ylabel("€")
    #     axs[0].set_xticklabels(atrd_labels, rotation=30, ha='right')

    #     # === Transport (ATRT) ===
    #     atrt_labels = ['Réseau principal', 'Régional', 'Capacité livraison', 'Stockage']
    #     atrt_values = [
    #         self.euro_ATRT_TCS,
    #         self.euro_ATRT_TCR,
    #         self.euro_ATRT_TCL,
    #         self.euro_ATRT_compensation_stockage
    #     ]
    #     axs[1].bar(atrt_labels, atrt_values, color='#2196F3')
    #     axs[1].set_title("Transport (ATRT)")
    #     axs[1].set_ylabel("€")
    #     axs[1].set_xticklabels(atrt_labels, rotation=30, ha='right')
    ...
    #         self.euro_TICGN
    #     ]
    #     axs[2].bar(taxes_labels, taxes_values, color='#FFC107')
    #     axs[2].set_title("Taxes et Contributions")
    #     axs[2].set_ylabel("€")
    #     axs[2].set_xticklabels(taxes_labels, rotation=30, ha='right')
