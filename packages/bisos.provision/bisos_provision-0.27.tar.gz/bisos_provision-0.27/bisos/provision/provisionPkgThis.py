...
** This File: /bisos/git/bxRepos/bisos-pip/provision/py3/bisos/provision/provisionPkgThis.py
...
#+end_org """
import typing
csInfo: typing.Dict[str, typing.Any] = { 'moduleName': ['provisionPkgThis'], }
csInfo['version'] = '202502115208'
csInfo['status']  = 'inUse'
csInfo['panel'] = 'provisionPkgThis-Panel.org'
...
####+BEGIN: bx:cs:python:cmnd:subSection :title "This Package Bases" :context "func-1"
