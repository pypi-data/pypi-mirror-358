...
from lovekit.rath import LovekitRath, current_lovekit_rath
from koil import unkoil, unkoil_gen
from rath.turms.funcs import TOperation
from .errors import NoLovekitFoundError
...
async def aexecute(
    ...
    rath = rath or current_lovekit_rath.get()
    if not rath:
        raise NoLovekitFoundError(
