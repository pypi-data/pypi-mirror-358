    ...
    class venv_mangt:
        ...
        def requirements(self):
            ...
            with open(f'{name}', 'w') as f:
                for line in lines:
                    if any(imp in line.lower() for imp in imports_lower):
                        f.write(line)
            ...
            print(f"{self.visuals.bold}{self.visuals.YL} Libraries installed: {[f'\n {lib}' for lib in add_list]} {self.visuals.RESET}")
