...
# TODO: This looks strange when I open the IK task in the OpenSim GUI.
#   It looks like everything has a weight of 0.
#   But maybe that is just what happens when you load the weights from a file...?
