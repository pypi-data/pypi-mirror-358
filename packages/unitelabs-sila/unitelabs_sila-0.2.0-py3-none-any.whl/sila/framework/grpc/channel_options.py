...
ChannelOptions = typing.TypedDict(
    "ChannelOptions",
    {
        ...
        "grpc.socket_mutator": typing.Annotated[
            typing.Any, typing.Doc("""The grpc_socket_mutator instance that set the socket options. A pointer.""")
        ],
        "grpc.socket_factory": typing.Annotated[
            typing.Any, typing.Doc("""The grpc_socket_factory instance to create and bind sockets. A pointer.""")
        ],
        ...
        "grpc.experimental.stats_plugins": typing.Annotated[
            typing.Any, typing.Doc("""Configure per-channel or per-server stats plugins.""")
        ],
