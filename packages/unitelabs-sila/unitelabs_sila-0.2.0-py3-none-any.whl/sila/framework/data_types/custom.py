...
class Custom(DataType[T]):
    ...
    data_type: typing.ClassVar[type[typing.Union[BasicType, "Structure", "Constrained"]]] = Any
    feature: typing.ClassVar[typing.Optional["Feature"]] = None

    value: typing.Union[BasicType, "Structure", "Constrained"] = dataclasses.field(default_factory=Any)
    ...
    def fully_qualified_identifier(cls) -> DataTypeIdentifier:
        ...
        if cls.feature is None:
            msg = (
                f"Unable to access fully qualified identifier of unregistered {cls.__name__} "
    ...
    def create(
        ...
        display_name: str,
        description: str = "",
        data_type: type[typing.Union[BasicType, "Structure", "Constrained"]] = Any,
