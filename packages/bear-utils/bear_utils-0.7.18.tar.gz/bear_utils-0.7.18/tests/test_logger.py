...
from src.bear_utils.extras import fmt_header
from src.bear_utils.logging import VERBOSE, BufferLogger, ConsoleLogger, FileLogger
...
class TestLoggerFactory:
    ...
    @staticmethod
    def create_console_logger(**kwargs):
...
class TestFileLogging:
    ...
    def test_file_logging(self):
        ...
        assert not "This is a verbose message" in log_content
