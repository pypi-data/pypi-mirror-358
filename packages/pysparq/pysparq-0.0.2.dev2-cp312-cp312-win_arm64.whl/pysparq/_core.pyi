...
class GetMid_UInt_UInt(SelfAdjointOperator):
    ...
    def condition_variable_nonzeros(self) -> list[int]:
        ...
class GetOutput:
    def __call__(self, arg0: SparseState) -> tuple:
        ...
    def __init__(self, main_reg: str, anc_UA: str, anc_4: str, anc_3: str, anc_2: str, anc_1: str) -> None:
        ...
...
class Push(BaseOperator):
    ...
    def __init__(self, reg_id: int, garbage: str) -> None:
        ...
class QDADebugger:
    def __init__(self, matrix_A: DenseMatrix_float64, vector_b: DenseVector_float64, s: float, kappa: float, p: float) -> None:
        ...
    def get_matrix_Af(self) -> DenseMatrix_float64:
        ...
    def get_mid_eigenstate(self) -> list[float]:
        ...
    def get_vector_0b(self) -> DenseVector_float64:
        ...
    def get_vector_1b(self) -> DenseVector_float64:
        ...
...
def qda_classical2quantum(A: numpy.ndarray[tuple[M, N], numpy.dtype[numpy.float64]], b: numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.float64]]) -> tuple[numpy.ndarray[tuple[M, N], numpy.dtype[numpy.float64]], numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.float64]], typing.Callable[[numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.float64]]], numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.float64]]]]:
    ...
def qda_solve(A: numpy.ndarray[tuple[M, N], numpy.dtype[numpy.float64]], b: numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.float64]], kappa: float | None = None, p: float = 1.3, step_rate: float = 0.01) -> numpy.ndarray[numpy.complex128[M, 1]]:
    ...
