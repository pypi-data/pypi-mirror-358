...
class MaskGenerator:
    ...
    def generate_geojson(
        ...
        # --- MERGE LOGIC ---
        # Add this import at the top of mask_generator.py with the other imports:
# from shapely.strtree import STRtree

# Replace the existing merge logic section (around lines 135-150) with this updated version:
