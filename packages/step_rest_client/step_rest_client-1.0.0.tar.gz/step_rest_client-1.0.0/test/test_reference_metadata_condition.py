...
class TestReferenceMetadataCondition(unittest.TestCase):
    """ReferenceMetadataCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReferenceMetadataCondition:
        """Test ReferenceMetadataCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReferenceMetadataCondition`
        """
        model = ReferenceMetadataCondition()
        if include_optional:
            return ReferenceMetadataCondition(
                condition_type = 'and',
                conditions = [
    ...
    def testReferenceMetadataCondition(self):
        """Test ReferenceMetadataCondition"""
