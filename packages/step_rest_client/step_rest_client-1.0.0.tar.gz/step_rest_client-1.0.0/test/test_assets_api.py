...
class TestAssetsApi(unittest.TestCase):
    ...
    def test_assets_id_approval_status_get(self) -> None:
        """Test case for assets_id_approval_status_get

        Returns the approval status of the asset with the specified ID / key value
        """
        pass

    def test_assets_id_approve_delete_post(self) -> None:
        """Test case for assets_id_approve_delete_post

        Approve deletes the asset with the specified ID
        """
        pass

    def test_assets_id_approve_post(self) -> None:
        """Test case for assets_id_approve_post

        Approves the asset with the specified ID / key value
        """
        pass

    def test_assets_id_content_get(self) -> None:
        """Test case for assets_id_content_get

        Returns asset content for the asset with the specified ID / key value
        """
        pass

    def test_assets_id_content_put(self) -> None:
        """Test case for assets_id_content_put

        Replaces asset content
        """
        pass

    def test_assets_id_delete(self) -> None:
    ...
    def test_assets_id_get(self) -> None:
    ...
    def test_assets_id_incoming_references_reference_type_id_get(self) -> None:
        """Test case for assets_id_incoming_references_reference_type_id_get

        Returns stream of incoming references of the specified type
        """
        pass

    def test_assets_id_patch(self) -> None:
        """Test case for assets_id_patch

        Partially updates an asset
        """
        pass

    def test_assets_id_purge_post(self) -> None:
        """Test case for assets_id_purge_post

        Purges the asset with the specified ID from recycle bin
        """
        pass

    def test_assets_id_put(self) -> None:
    ...
    def test_assets_id_references_reference_type_id_get(self) -> None:
        """Test case for assets_id_references_reference_type_id_get

        Returns reference(s) of the specified type
        """
        pass

    def test_assets_id_references_reference_type_id_target_id_delete(self) -> None:
        """Test case for assets_id_references_reference_type_id_target_id_delete

        Deletes the reference
        """
        pass

    def test_assets_id_references_reference_type_id_target_id_get(self) -> None:
        """Test case for assets_id_references_reference_type_id_target_id_get

        Returns a specific reference
        """
        pass

    def test_assets_id_references_reference_type_id_target_id_put(self) -> None:
        """Test case for assets_id_references_reference_type_id_target_id_put

        Replaces a reference
        """
        pass

    def test_assets_id_references_reference_type_id_target_id_values_attribute_id_delete(self) -> None:
        """Test case for assets_id_references_reference_type_id_target_id_values_attribute_id_delete

        Deletes the value for a reference metadata attribute
        """
        pass

    def test_assets_id_references_reference_type_id_target_id_values_attribute_id_get(self) -> None:
        """Test case for assets_id_references_reference_type_id_target_id_values_attribute_id_get

        Returns the value for a reference metadata attribute
        """
        pass

    def test_assets_id_references_reference_type_id_target_id_values_attribute_id_put(self) -> None:
        """Test case for assets_id_references_reference_type_id_target_id_values_attribute_id_put

        Replaces the value for a reference metadata attribute
        """
        pass

    def test_assets_id_values_attribute_id_delete(self) -> None:
        """Test case for assets_id_values_attribute_id_delete

        Deletes the value for an asset attribute
        """
        pass

    def test_assets_id_values_attribute_id_get(self) -> None:
        """Test case for assets_id_values_attribute_id_get

        Returns the value for an asset attribute
        """
        pass

    def test_assets_id_values_attribute_id_put(self) -> None:
        """Test case for assets_id_values_attribute_id_put

        Replaces the value for an asset attribute
        """
        pass

    def test_assets_post(self) -> None:
    ...
    def test_assets_search_post(self) -> None:
        """Test case for assets_search_post
