...
class TestTextValueCondition(unittest.TestCase):
    """TextValueCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TextValueCondition:
        """Test TextValueCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TextValueCondition`
        """
        model = TextValueCondition()
        if include_optional:
            return TextValueCondition(
                condition_type = 'and',
                attribute = '',
                operator = 'like',
                query_string = '',
    ...
    def testTextValueCondition(self):
        """Test TextValueCondition"""
