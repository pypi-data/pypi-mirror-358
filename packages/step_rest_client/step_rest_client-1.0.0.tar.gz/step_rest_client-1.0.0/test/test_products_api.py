...
class TestProductsApi(unittest.TestCase):
    ...
    def test_products_id_approval_status_get(self) -> None:
        """Test case for products_id_approval_status_get

        Returns the approval status of the product with the specified ID / key value
        """
        pass

    def test_products_id_approve_delete_post(self) -> None:
        """Test case for products_id_approve_delete_post

        Approve deletes the product with the specified ID
        """
        pass

    def test_products_id_approve_post(self) -> None:
        """Test case for products_id_approve_post

        Approves the product with the specified ID / key value
        """
        pass

    def test_products_id_children_get(self) -> None:
        """Test case for products_id_children_get

        Returns a streamed array of IDs for product children
        """
        pass

    def test_products_id_data_containers_data_container_type_id_get(self) -> None:
        """Test case for products_id_data_containers_data_container_type_id_get
    ...
    def test_products_id_incoming_references_reference_type_id_get(self) -> None:
        """Test case for products_id_incoming_references_reference_type_id_get

        Returns stream of incoming references of the specified type
        """
        pass

    def test_products_id_patch(self) -> None:
    ...
    def test_products_id_purge_post(self) -> None:
        """Test case for products_id_purge_post
    ...
    def test_products_id_references_reference_type_id_get(self) -> None:
        """Test case for products_id_references_reference_type_id_get

        Returns reference(s) of the specified type
        """
        pass

    def test_products_id_references_reference_type_id_target_id_delete(self) -> None:
        """Test case for products_id_references_reference_type_id_target_id_delete

        Deletes the reference
        """
        pass

    def test_products_id_references_reference_type_id_target_id_get(self) -> None:
        """Test case for products_id_references_reference_type_id_target_id_get

        Returns a specific reference
        """
        pass

    def test_products_id_references_reference_type_id_target_id_put(self) -> None:
        """Test case for products_id_references_reference_type_id_target_id_put

        Replaces a reference
        """
        pass

    def test_products_id_references_reference_type_id_target_id_values_attribute_id_delete(self) -> None:
        """Test case for products_id_references_reference_type_id_target_id_values_attribute_id_delete

        Deletes the value for a reference metadata attribute
        """
        pass

    def test_products_id_references_reference_type_id_target_id_values_attribute_id_get(self) -> None:
        """Test case for products_id_references_reference_type_id_target_id_values_attribute_id_get

        Returns the value for a reference metadata attribute
        """
        pass

    def test_products_id_references_reference_type_id_target_id_values_attribute_id_put(self) -> None:
        """Test case for products_id_references_reference_type_id_target_id_values_attribute_id_put

        Replaces the value for a reference metadata attribute
        """
        pass

    def test_products_id_values_attribute_id_delete(self) -> None:
        """Test case for products_id_values_attribute_id_delete

        Deletes the value for a product attribute
        """
        pass

    def test_products_id_values_attribute_id_get(self) -> None:
        """Test case for products_id_values_attribute_id_get

        Returns the value for a product attribute
        """
        pass

    def test_products_id_values_attribute_id_put(self) -> None:
        """Test case for products_id_values_attribute_id_put
    ...
    def test_products_search_post(self) -> None:
        """Test case for products_search_post
