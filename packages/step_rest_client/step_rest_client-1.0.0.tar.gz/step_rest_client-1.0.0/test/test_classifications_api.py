...
class TestClassificationsApi(unittest.TestCase):
    ...
    def test_classifications_id_approval_status_get(self) -> None:
        """Test case for classifications_id_approval_status_get

        Returns the approval status of the classification with the specified ID / key value
        """
        pass

    def test_classifications_id_approve_delete_post(self) -> None:
        """Test case for classifications_id_approve_delete_post

        Approves deletes the classification with the specified ID
        """
        pass

    def test_classifications_id_approve_post(self) -> None:
        """Test case for classifications_id_approve_post

        Approves the classification with the specified ID / key value
        """
        pass

    def test_classifications_id_assets_get(self) -> None:
        """Test case for classifications_id_assets_get

        Returns a streamed array of IDs for assets linked to the classification
        """
        pass

    def test_classifications_id_children_get(self) -> None:
        """Test case for classifications_id_children_get

        Returns a streamed array of IDs for classification children
        """
        pass

    def test_classifications_id_delete(self) -> None:
    ...
    def test_classifications_id_get(self) -> None:
    ...
    def test_classifications_id_incoming_references_reference_type_id_get(self) -> None:
        """Test case for classifications_id_incoming_references_reference_type_id_get

        Returns stream of incoming references of the specified type
        """
        pass

    def test_classifications_id_patch(self) -> None:
        """Test case for classifications_id_patch

        Partially updates a classification
        """
        pass

    def test_classifications_id_purge_post(self) -> None:
        """Test case for classifications_id_purge_post

        Purges the classification with the specified ID from recycle bin
        """
        pass

    def test_classifications_id_put(self) -> None:
    ...
    def test_classifications_id_references_reference_type_id_get(self) -> None:
        """Test case for classifications_id_references_reference_type_id_get

        Returns reference(s) of the specified type
        """
        pass

    def test_classifications_id_references_reference_type_id_target_id_delete(self) -> None:
        """Test case for classifications_id_references_reference_type_id_target_id_delete

        Deletes the reference
        """
        pass

    def test_classifications_id_references_reference_type_id_target_id_get(self) -> None:
        """Test case for classifications_id_references_reference_type_id_target_id_get

        Returns a specific reference
        """
        pass

    def test_classifications_id_references_reference_type_id_target_id_put(self) -> None:
        """Test case for classifications_id_references_reference_type_id_target_id_put

        Replaces a reference
        """
        pass

    def test_classifications_id_references_reference_type_id_target_id_values_attribute_id_delete(self) -> None:
        """Test case for classifications_id_references_reference_type_id_target_id_values_attribute_id_delete

        Deletes the value for a reference metadata attribute
        """
        pass

    def test_classifications_id_references_reference_type_id_target_id_values_attribute_id_get(self) -> None:
        """Test case for classifications_id_references_reference_type_id_target_id_values_attribute_id_get

        Returns the value for a reference metadata attribute
        """
        pass

    def test_classifications_id_references_reference_type_id_target_id_values_attribute_id_put(self) -> None:
        """Test case for classifications_id_references_reference_type_id_target_id_values_attribute_id_put

        Replaces the value for a reference metadata attribute
        """
        pass

    def test_classifications_id_values_attribute_id_delete(self) -> None:
        """Test case for classifications_id_values_attribute_id_delete

        Deletes the value for a classification attribute
        """
        pass

    def test_classifications_id_values_attribute_id_get(self) -> None:
        """Test case for classifications_id_values_attribute_id_get

        Returns the value for a classification attribute
        """
        pass

    def test_classifications_id_values_attribute_id_put(self) -> None:
        """Test case for classifications_id_values_attribute_id_put

        Replaces the value for a classification attribute
        """
        pass

    def test_classifications_post(self) -> None:
    ...
    def test_classifications_search_post(self) -> None:
        """Test case for classifications_search_post
