...
class TestReferenceTypesApi(unittest.TestCase):
    """ReferenceTypesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ReferenceTypesApi()

    def tearDown(self) -> None:
        pass

    def test_reference_types_id_get(self) -> None:
        """Test case for reference_types_id_get
