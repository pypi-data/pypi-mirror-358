...
class TestInboundIntegrationEndpoint(unittest.TestCase):
    """InboundIntegrationEndpoint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InboundIntegrationEndpoint:
        """Test InboundIntegrationEndpoint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InboundIntegrationEndpoint`
        """
        model = InboundIntegrationEndpoint()
        if include_optional:
            return InboundIntegrationEndpoint(
                id = '',
                name = ''
            )
        else:
    ...
    def testInboundIntegrationEndpoint(self):
        """Test InboundIntegrationEndpoint"""
