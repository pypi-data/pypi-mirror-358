...
class TestGatewayIntegrationEndpoint(unittest.TestCase):
    """GatewayIntegrationEndpoint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GatewayIntegrationEndpoint:
        """Test GatewayIntegrationEndpoint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GatewayIntegrationEndpoint`
        """
        model = GatewayIntegrationEndpoint()
        if include_optional:
            return GatewayIntegrationEndpoint(
                id = '',
                name = ''
            )
        else:
    ...
    def testGatewayIntegrationEndpoint(self):
        """Test GatewayIntegrationEndpoint"""
