...
class TestWorkflowTaskQuery(unittest.TestCase):
    """WorkflowTaskQuery unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowTaskQuery:
        """Test WorkflowTaskQuery
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowTaskQuery`
        """
        model = WorkflowTaskQuery()
        if include_optional:
    ...
    def testWorkflowTaskQuery(self):
        """Test WorkflowTaskQuery"""
