...
class TestTriggerWorkflowEvent(unittest.TestCase):
    """TriggerWorkflowEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TriggerWorkflowEvent:
        """Test TriggerWorkflowEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TriggerWorkflowEvent`
        """
        model = TriggerWorkflowEvent()
        if include_optional:
            return TriggerWorkflowEvent(
                event = step_rest_client.models.workflow_event.WorkflowEvent(
                    id = '', 
                    anonymous = True, ),
                message = ''
            )
    ...
    def testTriggerWorkflowEvent(self):
        """Test TriggerWorkflowEvent"""
