...
class TestNameCondition(unittest.TestCase):
    """NameCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NameCondition:
        """Test NameCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NameCondition`
        """
        model = NameCondition()
        if include_optional:
