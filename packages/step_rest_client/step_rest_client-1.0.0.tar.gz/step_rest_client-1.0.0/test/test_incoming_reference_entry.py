...
class TestIncomingReferenceEntry(unittest.TestCase):
    """IncomingReferenceEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncomingReferenceEntry:
        """Test IncomingReferenceEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncomingReferenceEntry`
        """
        model = IncomingReferenceEntry()
        if include_optional:
            return IncomingReferenceEntry(
                source = '',
                source_type = 'product',
                values = {
    ...
    def testIncomingReferenceEntry(self):
        """Test IncomingReferenceEntry"""
