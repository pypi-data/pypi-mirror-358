...
class TestMatchAndMergeRecordOut(unittest.TestCase):
    """MatchAndMergeRecordOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchAndMergeRecordOut:
        """Test MatchAndMergeRecordOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchAndMergeRecordOut`
        """
        model = MatchAndMergeRecordOut()
        if include_optional:
            return MatchAndMergeRecordOut(
                correlation_id = '',
                status = '',
    ...
    def testMatchAndMergeRecordOut(self):
        """Test MatchAndMergeRecordOut"""
