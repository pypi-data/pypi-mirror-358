...
class TestAttributeLink(unittest.TestCase):
    """AttributeLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttributeLink:
        """Test AttributeLink
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttributeLink`
        """
        model = AttributeLink()
        if include_optional:
