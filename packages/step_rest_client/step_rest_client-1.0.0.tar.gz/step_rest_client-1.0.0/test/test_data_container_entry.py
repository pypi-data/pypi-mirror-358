...
class TestDataContainerEntry(unittest.TestCase):
    """DataContainerEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataContainerEntry:
        """Test DataContainerEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataContainerEntry`
        """
        model = DataContainerEntry()
        if include_optional:
            return DataContainerEntry(
                values = {
    ...
    def testDataContainerEntry(self):
        """Test DataContainerEntry"""
