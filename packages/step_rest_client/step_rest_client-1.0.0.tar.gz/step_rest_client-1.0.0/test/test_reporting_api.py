...
class TestReportingApi(unittest.TestCase):
    ...
    def test_reports_historic_changes_report_id_clean_up_post(self) -> None:
        """Test case for reports_historic_changes_report_id_clean_up_post

        Deletes configuration objects specific to a report.
        """
        pass

    def test_reports_historic_changes_report_id_post(self) -> None:
        """Test case for reports_historic_changes_report_id_post
