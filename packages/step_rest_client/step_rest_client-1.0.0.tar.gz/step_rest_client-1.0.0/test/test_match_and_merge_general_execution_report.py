...
class TestMatchAndMergeGeneralExecutionReport(unittest.TestCase):
    """MatchAndMergeGeneralExecutionReport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchAndMergeGeneralExecutionReport:
        """Test MatchAndMergeGeneralExecutionReport
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchAndMergeGeneralExecutionReport`
        """
        model = MatchAndMergeGeneralExecutionReport()
        if include_optional:
            return MatchAndMergeGeneralExecutionReport(
                http_status = 56,
                http_reason = '',
                message = ''
            )
    ...
    def testMatchAndMergeGeneralExecutionReport(self):
        """Test MatchAndMergeGeneralExecutionReport"""
