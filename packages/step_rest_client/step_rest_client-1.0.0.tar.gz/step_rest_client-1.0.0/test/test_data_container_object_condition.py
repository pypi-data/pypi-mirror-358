...
class TestDataContainerObjectCondition(unittest.TestCase):
    """DataContainerObjectCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataContainerObjectCondition:
        """Test DataContainerObjectCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataContainerObjectCondition`
        """
        model = DataContainerObjectCondition()
        if include_optional:
            return DataContainerObjectCondition(
                condition_type = 'and',
                conditions = [
                    step_rest_client.models.condition.Condition(
                        condition_type = 'and', )
                    ],
                attribute = '',
                operator = 'eq',
                query_string = '',
                match_inherited_values = True,
                ignore_case = True,
                query_value = 1.337,
                unit = '',
                value_id = ''
    ...
    def testDataContainerObjectCondition(self):
        """Test DataContainerObjectCondition"""
