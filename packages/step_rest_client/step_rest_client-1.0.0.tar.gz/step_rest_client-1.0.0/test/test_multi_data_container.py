...
class TestMultiDataContainer(unittest.TestCase):
    """MultiDataContainer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultiDataContainer:
        """Test MultiDataContainer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultiDataContainer`
        """
        model = MultiDataContainer()
        if include_optional:
            return MultiDataContainer(
                data_containers = [
                    step_rest_client.models.data_container_entry.DataContainerEntry(
                        values = {
    ...
    def testMultiDataContainer(self):
        """Test MultiDataContainer"""
