...
class TestFindSimilarBusinessRuleResult(unittest.TestCase):
    """FindSimilarBusinessRuleResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FindSimilarBusinessRuleResult:
        """Test FindSimilarBusinessRuleResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FindSimilarBusinessRuleResult`
        """
        model = FindSimilarBusinessRuleResult()
        if include_optional:
            return FindSimilarBusinessRuleResult(
    ...
    def testFindSimilarBusinessRuleResult(self):
        """Test FindSimilarBusinessRuleResult"""
