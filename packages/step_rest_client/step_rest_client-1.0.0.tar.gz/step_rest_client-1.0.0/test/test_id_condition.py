...
class TestIdCondition(unittest.TestCase):
    """IdCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IdCondition:
        """Test IdCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IdCondition`
        """
        model = IdCondition()
        if include_optional:
            return IdCondition(
