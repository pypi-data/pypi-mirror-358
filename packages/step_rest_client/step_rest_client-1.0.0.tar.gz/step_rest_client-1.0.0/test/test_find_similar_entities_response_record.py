...
class TestFindSimilarEntitiesResponseRecord(unittest.TestCase):
    """FindSimilarEntitiesResponseRecord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FindSimilarEntitiesResponseRecord:
        """Test FindSimilarEntitiesResponseRecord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FindSimilarEntitiesResponseRecord`
        """
        model = FindSimilarEntitiesResponseRecord()
        if include_optional:
            return FindSimilarEntitiesResponseRecord(
                rank = 56,
    ...
    def testFindSimilarEntitiesResponseRecord(self):
        """Test FindSimilarEntitiesResponseRecord"""
