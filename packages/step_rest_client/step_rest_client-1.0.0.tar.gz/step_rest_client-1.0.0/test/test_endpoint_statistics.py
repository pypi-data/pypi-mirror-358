...
class TestEndpointStatistics(unittest.TestCase):
    """EndpointStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointStatistics:
        """Test EndpointStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointStatistics`
        """
        model = EndpointStatistics()
        if include_optional:
            return EndpointStatistics(
                enabled_on = '',
                last_run = '',
                next_run = '',
                number_of_created_worker_processes = 56,
                avg_worker_process_processing_time_in_seconds = 56,
                max_worker_process_processing_time_in_seconds = 56
            )
        else:
            return EndpointStatistics(
        )
    ...
    def testEndpointStatistics(self):
        """Test EndpointStatistics"""
