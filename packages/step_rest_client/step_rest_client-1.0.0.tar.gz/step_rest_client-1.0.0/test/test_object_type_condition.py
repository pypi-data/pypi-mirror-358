...
class TestObjectTypeCondition(unittest.TestCase):
    """ObjectTypeCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObjectTypeCondition:
        """Test ObjectTypeCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ObjectTypeCondition`
        """
        model = ObjectTypeCondition()
        if include_optional:
    ...
    def testObjectTypeCondition(self):
        """Test ObjectTypeCondition"""
