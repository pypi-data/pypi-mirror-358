...
class TestExecutionReportEntry(unittest.TestCase):
    """ExecutionReportEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExecutionReportEntry:
        """Test ExecutionReportEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExecutionReportEntry`
        """
        model = ExecutionReportEntry()
        if include_optional:
            return ExecutionReportEntry(
                entry_type = 'info',
                entry_text = ''
            )
        else:
    ...
    def testExecutionReportEntry(self):
        """Test ExecutionReportEntry"""
