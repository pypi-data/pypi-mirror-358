...
class TestEventProcessorsApi(unittest.TestCase):
    """EventProcessorsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = EventProcessorsApi()

    def tearDown(self) -> None:
        pass

    def test_event_processors_get(self) -> None:
        """Test case for event_processors_get

        Returns basic event processor representations
        """
        pass

    def test_event_processors_id_disable_post(self) -> None:
        """Test case for event_processors_id_disable_post

        Disables the specified event processor
        """
        pass

    def test_event_processors_id_enable_post(self) -> None:
        """Test case for event_processors_id_enable_post

        Enables the specified event processor
        """
        pass

    def test_event_processors_id_execution_report_get(self) -> None:
        """Test case for event_processors_id_execution_report_get

        Returns the execution report for the specified event processor
        """
        pass

    def test_event_processors_id_invoke_post(self) -> None:
        """Test case for event_processors_id_invoke_post

        Invokes the specified event processor
        """
        pass

    def test_event_processors_id_queue_disable_post(self) -> None:
        """Test case for event_processors_id_queue_disable_post

        Disables the event queue associated with the event processor
        """
        pass

    def test_event_processors_id_queue_enable_post(self) -> None:
        """Test case for event_processors_id_queue_enable_post

        Enables the event queue associated with the event processor
        """
        pass

    def test_event_processors_id_queue_number_of_unread_events_get(self) -> None:
        """Test case for event_processors_id_queue_number_of_unread_events_get

        Returns the number of unread events for the associated event queue
        """
        pass

    def test_event_processors_id_queue_status_get(self) -> None:
        """Test case for event_processors_id_queue_status_get

        Returns the status of the event queue associated with the event processor
        """
        pass

    def test_event_processors_id_statistics_get(self) -> None:
        """Test case for event_processors_id_statistics_get

        Returns statistics for the specified event processor
        """
        pass

    def test_event_processors_id_status_get(self) -> None:
        """Test case for event_processors_id_status_get

        Returns the status of the specified event processor
        """
        pass
