...
class TestMatchAndMergeExecutionReport(unittest.TestCase):
    """MatchAndMergeExecutionReport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchAndMergeExecutionReport:
        """Test MatchAndMergeExecutionReport
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchAndMergeExecutionReport`
        """
        model = MatchAndMergeExecutionReport()
        if include_optional:
            return MatchAndMergeExecutionReport(
                operation = 'NEW',
                error_message = '',
    ...
    def testMatchAndMergeExecutionReport(self):
        """Test MatchAndMergeExecutionReport"""
