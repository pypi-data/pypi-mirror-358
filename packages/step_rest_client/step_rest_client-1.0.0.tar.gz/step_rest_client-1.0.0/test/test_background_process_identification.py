...
class TestBackgroundProcessIdentification(unittest.TestCase):
    """BackgroundProcessIdentification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BackgroundProcessIdentification:
        """Test BackgroundProcessIdentification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BackgroundProcessIdentification`
        """
        model = BackgroundProcessIdentification()
        if include_optional:
            return BackgroundProcessIdentification(
                id = ''
            )
        else:
            return BackgroundProcessIdentification(
    ...
    def testBackgroundProcessIdentification(self):
        """Test BackgroundProcessIdentification"""
