...
class TestEventQueueStatus(unittest.TestCase):
    """EventQueueStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventQueueStatus:
        """Test EventQueueStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventQueueStatus`
        """
        model = EventQueueStatus()
        if include_optional:
