...
class TestListOfValues(unittest.TestCase):
    """ListOfValues unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListOfValues:
        """Test ListOfValues
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListOfValues`
        """
        model = ListOfValues()
        if include_optional:
            return ListOfValues(
