...
class TestListsOfValuesApi(unittest.TestCase):
    """ListsOfValuesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ListsOfValuesApi()

    def tearDown(self) -> None:
        pass

    def test_list_of_values_id_get(self) -> None:
        """Test case for list_of_values_id_get

        Returns the list of values with the specified ID
        """
        pass

    def test_list_of_values_id_value_entries_get(self) -> None:
        """Test case for list_of_values_id_value_entries_get
