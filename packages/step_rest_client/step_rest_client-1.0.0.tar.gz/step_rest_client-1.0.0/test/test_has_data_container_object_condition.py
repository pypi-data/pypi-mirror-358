...
class TestHasDataContainerObjectCondition(unittest.TestCase):
    """HasDataContainerObjectCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HasDataContainerObjectCondition:
        """Test HasDataContainerObjectCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HasDataContainerObjectCondition`
        """
        model = HasDataContainerObjectCondition()
        if include_optional:
            return HasDataContainerObjectCondition(
                condition_type = 'and',
                data_container_type = '',
                match_inherited_data_container_objects = True,
                condition = step_rest_client.models.data_container_object_condition.DataContainerObjectCondition()
            )
        else:
            return HasDataContainerObjectCondition(
                condition_type = 'and',
    ...
    def testHasDataContainerObjectCondition(self):
        """Test HasDataContainerObjectCondition"""
