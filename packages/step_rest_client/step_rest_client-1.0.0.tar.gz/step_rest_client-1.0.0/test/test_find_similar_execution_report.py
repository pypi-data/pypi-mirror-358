...
class TestFindSimilarExecutionReport(unittest.TestCase):
    """FindSimilarExecutionReport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FindSimilarExecutionReport:
        """Test FindSimilarExecutionReport
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FindSimilarExecutionReport`
        """
        model = FindSimilarExecutionReport()
        if include_optional:
            return FindSimilarExecutionReport(
                http_status = 56,
                http_reason = '',
                message = '',
    ...
    def testFindSimilarExecutionReport(self):
        """Test FindSimilarExecutionReport"""
