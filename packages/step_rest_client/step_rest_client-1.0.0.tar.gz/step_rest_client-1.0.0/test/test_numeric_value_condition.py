...
class TestNumericValueCondition(unittest.TestCase):
    """NumericValueCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NumericValueCondition:
        """Test NumericValueCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NumericValueCondition`
        """
        model = NumericValueCondition()
        if include_optional:
            return NumericValueCondition(
                condition_type = 'and',
                attribute = '',
                operator = 'eq',
                query_value = 1.337,
    ...
    def testNumericValueCondition(self):
        """Test NumericValueCondition"""
