...
class TestListOfValuesEntry(unittest.TestCase):
    """ListOfValuesEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListOfValuesEntry:
        """Test ListOfValuesEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListOfValuesEntry`
        """
        model = ListOfValuesEntry()
        if include_optional:
            return ListOfValuesEntry(
                value = '',
                value_id = '',
                unit = ''
            )
    ...
    def testListOfValuesEntry(self):
        """Test ListOfValuesEntry"""
