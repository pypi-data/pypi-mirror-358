...
class TestOutboundIntegrationEndpoint(unittest.TestCase):
    """OutboundIntegrationEndpoint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutboundIntegrationEndpoint:
        """Test OutboundIntegrationEndpoint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutboundIntegrationEndpoint`
        """
        model = OutboundIntegrationEndpoint()
        if include_optional:
            return OutboundIntegrationEndpoint(
                id = '',
                name = ''
            )
        else:
    ...
    def testOutboundIntegrationEndpoint(self):
        """Test OutboundIntegrationEndpoint"""
