...
class TestGatewayIntegrationEndpointsApi(unittest.TestCase):
    """GatewayIntegrationEndpointsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = GatewayIntegrationEndpointsApi()

    def tearDown(self) -> None:
        pass

    def test_gateway_integration_endpoints_get(self) -> None:
        """Test case for gateway_integration_endpoints_get

        Returns basic gateway integration endpoint representations
        """
        pass

    def test_gateway_integration_endpoints_id_disable_post(self) -> None:
        """Test case for gateway_integration_endpoints_id_disable_post

        Disables the gateway integration endpoint
        """
        pass

    def test_gateway_integration_endpoints_id_enable_post(self) -> None:
        """Test case for gateway_integration_endpoints_id_enable_post

        Enables the gateway integration endpoint
        """
        pass

    def test_gateway_integration_endpoints_id_status_get(self) -> None:
        """Test case for gateway_integration_endpoints_id_status_get
