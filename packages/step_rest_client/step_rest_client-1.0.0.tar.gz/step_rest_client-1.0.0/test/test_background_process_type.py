...
class TestBackgroundProcessType(unittest.TestCase):
    """BackgroundProcessType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BackgroundProcessType:
        """Test BackgroundProcessType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BackgroundProcessType`
        """
        model = BackgroundProcessType()
        if include_optional:
    ...
    def testBackgroundProcessType(self):
        """Test BackgroundProcessType"""
