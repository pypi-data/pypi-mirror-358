...
class TestDataTypeGroupsApi(unittest.TestCase):
    """DataTypeGroupsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = DataTypeGroupsApi()

    def tearDown(self) -> None:
        pass

    def test_data_type_groups_id_get(self) -> None:
        """Test case for data_type_groups_id_get
