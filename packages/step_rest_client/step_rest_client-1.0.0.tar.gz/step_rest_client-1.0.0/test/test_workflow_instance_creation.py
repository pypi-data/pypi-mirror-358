...
class TestWorkflowInstanceCreation(unittest.TestCase):
    """WorkflowInstanceCreation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowInstanceCreation:
        """Test WorkflowInstanceCreation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowInstanceCreation`
        """
        model = WorkflowInstanceCreation()
        if include_optional:
            return WorkflowInstanceCreation(
                node = step_rest_client.models.workflow_node.WorkflowNode(
                    id = '', 
                    type = 'product', ),
                message = ''
            )
    ...
    def testWorkflowInstanceCreation(self):
        """Test WorkflowInstanceCreation"""
