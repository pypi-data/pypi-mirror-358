...
class TestHasReferenceToCondition(unittest.TestCase):
    """HasReferenceToCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HasReferenceToCondition:
        """Test HasReferenceToCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HasReferenceToCondition`
        """
        model = HasReferenceToCondition()
        if include_optional:
            return HasReferenceToCondition(
                condition_type = 'and',
                reference_type = '',
                target = '',
                match_inherited_references = True,
                metadata_condition = step_rest_client.models.reference_metadata_condition.ReferenceMetadataCondition()
            )
        else:
            return HasReferenceToCondition(
                condition_type = 'and',
    ...
    def testHasReferenceToCondition(self):
        """Test HasReferenceToCondition"""
