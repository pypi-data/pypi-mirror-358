...
class TestDataTypeGroup(unittest.TestCase):
    """DataTypeGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataTypeGroup:
        """Test DataTypeGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataTypeGroup`
        """
        model = DataTypeGroup()
        if include_optional:
