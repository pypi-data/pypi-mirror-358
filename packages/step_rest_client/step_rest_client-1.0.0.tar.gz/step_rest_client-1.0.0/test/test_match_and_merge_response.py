...
class TestMatchAndMergeResponse(unittest.TestCase):
    """MatchAndMergeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchAndMergeResponse:
        """Test MatchAndMergeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchAndMergeResponse`
        """
        model = MatchAndMergeResponse()
        if include_optional:
            return MatchAndMergeResponse(
                match_and_merge_general_execution_report = step_rest_client.models.match_and_merge_general_execution_report.MatchAndMergeGeneralExecutionReport(
                    http_status = 56, 
                    http_reason = '', 
                    message = '', ),
                match_and_merge_responses = [
                    step_rest_client.models.match_and_merge_record_out.MatchAndMergeRecordOut(
                        correlation_id = '', 
                        status = '', 
                        potential_duplicates = [
                            step_rest_client.models.match_and_merge_potential_duplicate.MatchAndMergePotentialDuplicate(
                                rank = '', 
                                entity = step_rest_client.models.entity.Entity(
                                    id = '', 
                                    name = '', 
                                    object_type = '', 
                                    parent = '', 
                                    values = {
                                        'key' : step_rest_client.models.value.Value()
                                        }, 
                                    references = {
                                        'key' : step_rest_client.models.reference.Reference()
                                        }, 
                                    data_containers = {
                                        'key' : step_rest_client.models.data_container.DataContainer()
                                        }, ), )
                            ], 
                        match_and_merge_execution_report = step_rest_client.models.match_and_merge_execution_report.MatchAndMergeExecutionReport(
                            operation = 'NEW', 
                            error_message = '', 
                            rejected_by_business_condition = [
                                step_rest_client.models.rejected_by_business_condition.RejectedByBusinessCondition(
                                    rejected_by_business_condition_id = '', 
                                    rejected_by_business_condition_reason = '', )
                                ], 
                            rejected_by_potential_duplicates = True, ), 
                        entity = step_rest_client.models.entity.Entity(
                            id = '', 
                            name = '', 
                            object_type = '', 
    ...
    def testMatchAndMergeResponse(self):
        """Test MatchAndMergeResponse"""
