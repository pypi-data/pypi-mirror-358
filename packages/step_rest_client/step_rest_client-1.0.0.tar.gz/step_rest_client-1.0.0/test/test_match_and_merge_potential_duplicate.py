...
class TestMatchAndMergePotentialDuplicate(unittest.TestCase):
    """MatchAndMergePotentialDuplicate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchAndMergePotentialDuplicate:
        """Test MatchAndMergePotentialDuplicate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchAndMergePotentialDuplicate`
        """
        model = MatchAndMergePotentialDuplicate()
        if include_optional:
            return MatchAndMergePotentialDuplicate(
                rank = '',
    ...
    def testMatchAndMergePotentialDuplicate(self):
        """Test MatchAndMergePotentialDuplicate"""
