...
class TestDataContainerType(unittest.TestCase):
    """DataContainerType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataContainerType:
        """Test DataContainerType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataContainerType`
        """
        model = DataContainerType()
        if include_optional:
    ...
    def testDataContainerType(self):
        """Test DataContainerType"""
