...
class TestMultiReference(unittest.TestCase):
    """MultiReference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MultiReference:
        """Test MultiReference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultiReference`
        """
        model = MultiReference()
        if include_optional:
            return MultiReference(
                references = [
                    step_rest_client.models.reference_entry.ReferenceEntry(
                        context_local = True, 
                        inherited = True, 
                        target = '', 
                        target_type = 'product', 
                        ...
                        entity = {
                            'key' : step_rest_client.models.entity.Entity(
                                id = '', 
                                name = '', 
                                object_type = '', 
                                parent = '', 
