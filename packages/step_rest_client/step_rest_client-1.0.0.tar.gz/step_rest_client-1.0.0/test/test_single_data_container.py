...
class TestSingleDataContainer(unittest.TestCase):
    """SingleDataContainer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SingleDataContainer:
        """Test SingleDataContainer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SingleDataContainer`
        """
        model = SingleDataContainer()
        if include_optional:
            return SingleDataContainer(
                data_container = step_rest_client.models.data_container_entry.DataContainerEntry(
                    values = {
    ...
    def testSingleDataContainer(self):
        """Test SingleDataContainer"""
