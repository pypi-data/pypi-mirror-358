...
class TestLovValueCondition(unittest.TestCase):
    """LovValueCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LovValueCondition:
        """Test LovValueCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LovValueCondition`
        """
        model = LovValueCondition()
        if include_optional:
            return LovValueCondition(
                condition_type = 'and',
                attribute = '',
                value_id = '',
    ...
    def testLovValueCondition(self):
        """Test LovValueCondition"""
