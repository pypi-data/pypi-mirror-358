...
class TestMatchAndMergeRecordIn(unittest.TestCase):
    """MatchAndMergeRecordIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatchAndMergeRecordIn:
        """Test MatchAndMergeRecordIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchAndMergeRecordIn`
        """
        model = MatchAndMergeRecordIn()
        if include_optional:
            return MatchAndMergeRecordIn(
                correlation_id = '',
    ...
    def testMatchAndMergeRecordIn(self):
        """Test MatchAndMergeRecordIn"""
