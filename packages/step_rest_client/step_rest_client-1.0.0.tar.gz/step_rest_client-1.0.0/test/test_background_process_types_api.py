...
class TestBackgroundProcessTypesApi(unittest.TestCase):
    """BackgroundProcessTypesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = BackgroundProcessTypesApi()

    def tearDown(self) -> None:
        pass

    def test_background_process_types_get(self) -> None:
        """Test case for background_process_types_get

        Returns the available background process types
        """
        pass

    def test_background_process_types_type_id_processes_get(self) -> None:
        """Test case for background_process_types_type_id_processes_get
