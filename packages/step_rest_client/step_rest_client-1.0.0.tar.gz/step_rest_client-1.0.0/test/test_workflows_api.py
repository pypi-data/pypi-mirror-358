...
class TestWorkflowsApi(unittest.TestCase):
    ...
    def test_workflows_id_get(self) -> None:
    ...
    def test_workflows_id_instances_instance_id_delete(self) -> None:
        """Test case for workflows_id_instances_instance_id_delete

        Deletes the workflow instance with the specified ID
        """
        pass

    def test_workflows_id_instances_post(self) -> None:
        """Test case for workflows_id_instances_post
