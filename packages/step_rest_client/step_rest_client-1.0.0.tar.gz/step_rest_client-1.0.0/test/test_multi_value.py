...
class TestMultiValue(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MultiValue:
        """Test MultiValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultiValue`
        """
        model = MultiValue()
        if include_optional:
            return MultiValue(
                ...
                inherited = True,
                values = [
                    step_rest_client.models.value_entry.ValueEntry(
                        value = '', 
                        value_id = '', 
                        unit = '', )
                    ]
