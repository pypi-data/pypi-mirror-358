...
class TestBackgroundProcessesApi(unittest.TestCase):
    """BackgroundProcessesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = BackgroundProcessesApi()

    def tearDown(self) -> None:
        pass

    def test_background_processes_id_attachments_attachment_id_content_get(self) -> None:
        """Test case for background_processes_id_attachments_attachment_id_content_get

        Returns the background process attachment content
        """
        pass

    def test_background_processes_id_attachments_attachment_id_get(self) -> None:
        """Test case for background_processes_id_attachments_attachment_id_get

        Returns attachment metadata for a specific attachment
        """
        pass

    def test_background_processes_id_attachments_get(self) -> None:
        """Test case for background_processes_id_attachments_get

        Returns information about available background process attachments
        """
        pass

    def test_background_processes_id_execution_report_get(self) -> None:
        """Test case for background_processes_id_execution_report_get

        Returns a streamed array of execution report entries (ExecutionReportEntry)
        """
        pass

    def test_background_processes_id_get(self) -> None:
        """Test case for background_processes_id_get
