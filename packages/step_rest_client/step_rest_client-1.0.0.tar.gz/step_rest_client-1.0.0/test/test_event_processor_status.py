...
class TestEventProcessorStatus(unittest.TestCase):
    """EventProcessorStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventProcessorStatus:
        """Test EventProcessorStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventProcessorStatus`
        """
        model = EventProcessorStatus()
        if include_optional:
            return EventProcessorStatus(
                status = 'enabled'
            )
        else:
            return EventProcessorStatus(
    ...
    def testEventProcessorStatus(self):
        """Test EventProcessorStatus"""
