...
class TestFindSimilarEntitiesResponse(unittest.TestCase):
    """FindSimilarEntitiesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FindSimilarEntitiesResponse:
        """Test FindSimilarEntitiesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FindSimilarEntitiesResponse`
        """
        model = FindSimilarEntitiesResponse()
        if include_optional:
            return FindSimilarEntitiesResponse(
                find_similar_execution_report = step_rest_client.models.find_similar_execution_report.FindSimilarExecutionReport(
                    http_status = 56, 
                    http_reason = '', 
                    message = '', 
                    rejected_by_business_rule_id = '', 
                    business_rule_rejections = [
                        step_rest_client.models.find_similar_business_rule_result.FindSimilarBusinessRuleResult(
                            business_condition_id = '', 
                            business_condition_message = '', 
                            data_issues_report = [
                                ''
                                ], )
                        ], ),
                find_similar_responses = [
                    step_rest_client.models.find_similar_entities_response_record.FindSimilarEntitiesResponseRecord(
                        rank = 56, 
    ...
    def testFindSimilarEntitiesResponse(self):
        """Test FindSimilarEntitiesResponse"""
