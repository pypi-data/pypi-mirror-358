...
class TestRejectedByBusinessCondition(unittest.TestCase):
    """RejectedByBusinessCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RejectedByBusinessCondition:
        """Test RejectedByBusinessCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RejectedByBusinessCondition`
        """
        model = RejectedByBusinessCondition()
        if include_optional:
            return RejectedByBusinessCondition(
    ...
    def testRejectedByBusinessCondition(self):
        """Test RejectedByBusinessCondition"""
