...
class TestEntitiesApi(unittest.TestCase):
    ...
    def test_entities_find_similar_post(self) -> None:
        """Test case for entities_find_similar_post

        Performs a find similar operation for entities
        """
        pass

    def test_entities_id_approval_status_get(self) -> None:
        """Test case for entities_id_approval_status_get

        Returns the approval status of the entity with the specified ID / key value
        """
        pass

    def test_entities_id_approve_delete_post(self) -> None:
        """Test case for entities_id_approve_delete_post

        Approve deletes the entity with the specified ID
        """
        pass

    def test_entities_id_approve_post(self) -> None:
        """Test case for entities_id_approve_post

        Approves the entity with the specified ID / key value
        """
        pass

    def test_entities_id_children_get(self) -> None:
        """Test case for entities_id_children_get

        Returns a streamed array of IDs for entity children
        """
        pass

    def test_entities_id_data_containers_data_container_type_id_get(self) -> None:
        """Test case for entities_id_data_containers_data_container_type_id_get

        Returns data container(s) of the specified type
        """
        pass

    def test_entities_id_delete(self) -> None:
        """Test case for entities_id_delete

        Deletes the entity with the specified ID
        """
        pass

    def test_entities_id_get(self) -> None:
    ...
    def test_entities_id_incoming_references_reference_type_id_get(self) -> None:
        """Test case for entities_id_incoming_references_reference_type_id_get

        Returns stream of incoming references of the specified type
        """
        pass

    def test_entities_id_patch(self) -> None:
        """Test case for entities_id_patch

        Partially updates an entity
        """
        pass

    def test_entities_id_purge_post(self) -> None:
        """Test case for entities_id_purge_post

        Purges the entity with the specified ID from recycle bin
        """
        pass

    def test_entities_id_put(self) -> None:
        """Test case for entities_id_put

        Creates or replaces entity with known ID
        """
        pass

    def test_entities_id_references_reference_type_id_get(self) -> None:
        """Test case for entities_id_references_reference_type_id_get

        Returns reference(s) of the specified type
        """
        pass

    def test_entities_id_references_reference_type_id_target_id_delete(self) -> None:
        """Test case for entities_id_references_reference_type_id_target_id_delete

        Deletes the reference
        """
        pass

    def test_entities_id_references_reference_type_id_target_id_get(self) -> None:
        """Test case for entities_id_references_reference_type_id_target_id_get

        Returns a specific reference
        """
        pass

    def test_entities_id_references_reference_type_id_target_id_put(self) -> None:
        """Test case for entities_id_references_reference_type_id_target_id_put

        Replaces a reference
        """
        pass

    def test_entities_id_references_reference_type_id_target_id_values_attribute_id_delete(self) -> None:
        """Test case for entities_id_references_reference_type_id_target_id_values_attribute_id_delete

        Deletes the value for a reference metadata attribute
        """
        pass

    def test_entities_id_references_reference_type_id_target_id_values_attribute_id_get(self) -> None:
        """Test case for entities_id_references_reference_type_id_target_id_values_attribute_id_get

        Returns the value for a reference metadata attribute
        """
        pass

    def test_entities_id_references_reference_type_id_target_id_values_attribute_id_put(self) -> None:
        """Test case for entities_id_references_reference_type_id_target_id_values_attribute_id_put

        Replaces the value for a reference metadata attribute
        """
        pass

    def test_entities_id_values_attribute_id_delete(self) -> None:
        """Test case for entities_id_values_attribute_id_delete

        Deletes the value for an entity attribute
        """
        pass

    def test_entities_id_values_attribute_id_get(self) -> None:
        """Test case for entities_id_values_attribute_id_get

        Returns the value for an entity attribute
        """
        pass

    def test_entities_id_values_attribute_id_put(self) -> None:
        """Test case for entities_id_values_attribute_id_put

        Replaces the value for an entity attribute
        """
        pass

    def test_entities_match_and_merge_post(self) -> None:
        """Test case for entities_match_and_merge_post
    ...
    def test_entities_search_post(self) -> None:
        """Test case for entities_search_post
