...
class TestFindSimilarEntitiesRequest(unittest.TestCase):
    """FindSimilarEntitiesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FindSimilarEntitiesRequest:
        """Test FindSimilarEntitiesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FindSimilarEntitiesRequest`
        """
        model = FindSimilarEntitiesRequest()
        if include_optional:
            return FindSimilarEntitiesRequest(
                max_results = 56,
    ...
    def testFindSimilarEntitiesRequest(self):
        """Test FindSimilarEntitiesRequest"""
