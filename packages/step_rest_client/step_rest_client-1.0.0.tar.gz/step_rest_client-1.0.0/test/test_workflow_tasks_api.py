...
class TestWorkflowTasksApi(unittest.TestCase):
    ...
    def test_workflow_tasks_id_claim_post(self) -> None:
        """Test case for workflow_tasks_id_claim_post

        Claims a specific workflow tasks
        """
        pass

    def test_workflow_tasks_id_events_get(self) -> None:
        """Test case for workflow_tasks_id_events_get

        Returns the available events for a task
        """
        pass

    def test_workflow_tasks_id_get(self) -> None:
        """Test case for workflow_tasks_id_get

        Returns the workflow task with the specified ID
        """
        pass

    def test_workflow_tasks_id_release_post(self) -> None:
        """Test case for workflow_tasks_id_release_post

        Releases a task
        """
        pass

    def test_workflow_tasks_id_trigger_event_post(self) -> None:
        """Test case for workflow_tasks_id_trigger_event_post

        Triggers an event for a task
        """
        pass

    def test_workflow_tasks_search_post(self) -> None:
        """Test case for workflow_tasks_search_post
