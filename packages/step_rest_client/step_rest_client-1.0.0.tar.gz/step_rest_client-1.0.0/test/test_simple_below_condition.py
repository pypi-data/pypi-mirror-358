...
class TestSimpleBelowCondition(unittest.TestCase):
    """SimpleBelowCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimpleBelowCondition:
        """Test SimpleBelowCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimpleBelowCondition`
        """
        model = SimpleBelowCondition()
        if include_optional:
            return SimpleBelowCondition(
                condition_type = 'and',
                top_node_id = '',
    ...
    def testSimpleBelowCondition(self):
        """Test SimpleBelowCondition"""
