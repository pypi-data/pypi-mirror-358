...
class TestBackgroundProcessAttachmentMetadata(unittest.TestCase):
    """BackgroundProcessAttachmentMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BackgroundProcessAttachmentMetadata:
        """Test BackgroundProcessAttachmentMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BackgroundProcessAttachmentMetadata`
        """
        model = BackgroundProcessAttachmentMetadata()
        if include_optional:
            return BackgroundProcessAttachmentMetadata(
                id = '',
                name = '',
                mime_type = '',
    ...
    def testBackgroundProcessAttachmentMetadata(self):
        """Test BackgroundProcessAttachmentMetadata"""
