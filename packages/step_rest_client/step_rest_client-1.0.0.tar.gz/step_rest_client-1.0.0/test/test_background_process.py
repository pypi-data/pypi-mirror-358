...
class TestBackgroundProcess(unittest.TestCase):
    """BackgroundProcess unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BackgroundProcess:
        """Test BackgroundProcess
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BackgroundProcess`
        """
    ...
    def testBackgroundProcess(self):
        """Test BackgroundProcess"""
