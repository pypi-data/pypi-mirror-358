...
class TestObjectTypesApi(unittest.TestCase):
    """ObjectTypesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ObjectTypesApi()

    def tearDown(self) -> None:
        pass

    def test_object_types_id_get(self) -> None:
        """Test case for object_types_id_get
