...
class TestEventProcessorStatistics(unittest.TestCase):
    """EventProcessorStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventProcessorStatistics:
        """Test EventProcessorStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventProcessorStatistics`
        """
        model = EventProcessorStatistics()
        if include_optional:
            return EventProcessorStatistics(
                enabled_on = '',
                last_run = '',
                next_run = ''
            )
    ...
    def testEventProcessorStatistics(self):
        """Test EventProcessorStatistics"""
