...
class FindSimilarExecutionReport(BaseModel):
    """
    Object holding additional information about the result of the find similar operation
    """ # noqa: E501
    http_status: Optional[StrictInt] = Field(default=None, description="The HTTP status code", alias="httpStatus")
    http_reason: Optional[StrictStr] = Field(default=None, description="The name of the HTTP status code", alias="httpReason")
    message: Optional[StrictStr] = Field(default=None, description="Extended error information that can be shown to users.")
    rejected_by_business_rule_id: Optional[StrictStr] = Field(default=None, description="ID of first failing or rejecting business rule", alias="rejectedByBusinessRuleID")
    business_rule_rejections: Optional[List[FindSimilarBusinessRuleResult]] = Field(default=None, description="Detailed information from all rejecting business rules", alias="businessRuleRejections")
    __properties: ClassVar[List[str]] = ["httpStatus", "httpReason", "message", "rejectedByBusinessRuleID", "businessRuleRejections"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FindSimilarExecutionReport from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in business_rule_rejections (list)
        _items = []
        if self.business_rule_rejections:
            for _item_business_rule_rejections in self.business_rule_rejections:
                if _item_business_rule_rejections:
                    _items.append(_item_business_rule_rejections.to_dict())
            _dict['businessRuleRejections'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FindSimilarExecutionReport from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "httpReason": obj.get("httpReason"),
            "message": obj.get("message"),
            "rejectedByBusinessRuleID": obj.get("rejectedByBusinessRuleID"),
            "businessRuleRejections": [FindSimilarBusinessRuleResult.from_dict(_item) for _item in obj["businessRuleRejections"]] if obj.get("businessRuleRejections") is not None else None
        })
        return _obj
