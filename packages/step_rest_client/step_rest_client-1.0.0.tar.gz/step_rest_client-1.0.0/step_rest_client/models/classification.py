...
class Classification(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the classification object")
    name: Optional[StrictStr] = Field(default=None, description="Classification name")
    object_type: Optional[StrictStr] = Field(default=None, description="Object type ID", alias="objectType")
    parent: Optional[StrictStr] = Field(default=None, description="Parent classification ID")
    values: Optional[Dict[str, Value]] = Field(default=None, description="Classification values. Keys are attribute IDs and values either a SingleValue or a MultiValue depending on whether the attribute is multivalued.")
    references: Optional[Dict[str, Reference]] = Field(default=None, description="References / links from the classification. Keys are reference / link type IDs and values either a SingleReference or a MultiReference depending on whether the reference type is multivalued.")
    attribute_links: Optional[List[AttributeLink]] = Field(default=None, description="Attribute links from the classification", alias="attributeLinks")
    __properties: ClassVar[List[str]] = ["id", "name", "objectType", "parent", "values", "references", "attributeLinks"]
