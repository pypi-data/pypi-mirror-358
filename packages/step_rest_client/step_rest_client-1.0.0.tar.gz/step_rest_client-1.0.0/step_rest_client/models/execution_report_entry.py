...
class ExecutionReportEntry(BaseModel):
    """
    A single execution report entry/row
    """ # noqa: E501
    entry_type: Optional[StrictStr] = Field(default=None, description="The type of entry. Either 'info', 'warning' or 'error'.", alias="entryType")
    entry_text: Optional[StrictStr] = Field(default=None, description="The entry text/message", alias="entryText")
    __properties: ClassVar[List[str]] = ["entryType", "entryText"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExecutionReportEntry from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExecutionReportEntry from a dict"""
        if obj is None:
            return None
