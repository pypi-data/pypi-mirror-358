...
class MatchAndMergeGeneralExecutionReport(BaseModel):
    """
    Object holding additional information about the result of the match and merge operation
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["httpStatus", "httpReason", "message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MatchAndMergeGeneralExecutionReport from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MatchAndMergeGeneralExecutionReport from a dict"""
        if obj is None:
            return None
