...
class Entity(BaseModel):
    ...
    An entity object
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the entity object")
    ...
    parent: Optional[StrictStr] = Field(default=None, description="Parent entity ID")
    values: Optional[Dict[str, Value]] = Field(default=None, description="Entity values. Keys are attribute IDs and values either a SingleValue or a MultiValue depending on whether the attribute is multivalued.")
    references: Optional[Dict[str, Reference]] = Field(default=None, description="References from the entity. Keys are reference type IDs and values either a SingleReference or a MultiReference depending on whether the reference type is multivalued.")
    data_containers: Optional[Dict[str, DataContainer]] = Field(default=None, description="Entity data containers. Keys are data container type IDs and values either a SingleDataContainer or a MultiDataContainer depending on whether the data container type is multivalued.", alias="dataContainers")
    __properties: ClassVar[List[str]] = ["id", "name", "objectType", "parent", "values", "references", "dataContainers"]
