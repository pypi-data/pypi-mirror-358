...
class MatchAndMergeRecordIn(BaseModel):
    """
    A Match an Merge Entity with correlation ID
    """ # noqa: E501
    correlation_id: Optional[StrictStr] = Field(default=None, description="Correlation ID of the Match and Merge entity object", alias="correlationID")
    entity: Optional[Entity] = None
    __properties: ClassVar[List[str]] = ["correlationID", "entity"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MatchAndMergeRecordIn from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MatchAndMergeRecordIn from a dict"""
        if obj is None:
            return None
