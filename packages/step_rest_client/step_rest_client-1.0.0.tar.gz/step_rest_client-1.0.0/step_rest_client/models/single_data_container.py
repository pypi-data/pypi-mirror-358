...
class SingleDataContainer(BaseModel):
    """
    A data container for a single-valued data container type
    """ # noqa: E501
    data_container: Optional[DataContainerEntry] = Field(default=None, alias="dataContainer")
    ...
    __properties: ClassVar[List[str]] = ["dataContainer", "inherited"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SingleDataContainer from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of data_container
        if self.data_container:
            _dict['dataContainer'] = self.data_container.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SingleDataContainer from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "dataContainer": DataContainerEntry.from_dict(obj["dataContainer"]) if obj.get("dataContainer") is not None else None,
...
SingleDataContainer.model_rebuild(raise_errors=False)
