...
class GatewayIntegrationEndpoint(BaseModel):
    """
    Gateway integration endpoint representation
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the gateway integration endpoint")
    name: Optional[StrictStr] = Field(default=None, description="Name of the gateway integration endpoint")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GatewayIntegrationEndpoint from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GatewayIntegrationEndpoint from a dict"""
        if obj is None:
            return None
