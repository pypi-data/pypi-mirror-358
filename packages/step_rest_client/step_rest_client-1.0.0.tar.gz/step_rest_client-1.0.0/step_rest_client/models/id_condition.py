...
class IdCondition(BaseModel):
    """
    Node ID query condition
    """ # noqa: E501
    condition_type: StrictStr = Field(description="The condition type. Must have the value \"id\" for this type of condition.", alias="conditionType")
    ...
    __properties: ClassVar[List[str]] = ["conditionType", "operator", "queryString"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IdCondition from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IdCondition from a dict"""
        if obj is None:
            return None
