...
class WorkflowEvent(BaseModel):
    ...
    A workflow event
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The event ID. Must/will be populated if 'anonymous' is 'false'.")
    anonymous: Optional[StrictBool] = Field(default=None, description="Indicates whether the event is anonymous. If 'false', an 'id' must/will be present. If 'true', a provided 'id' will be ignored.")
    __properties: ClassVar[List[str]] = ["id", "anonymous"]
