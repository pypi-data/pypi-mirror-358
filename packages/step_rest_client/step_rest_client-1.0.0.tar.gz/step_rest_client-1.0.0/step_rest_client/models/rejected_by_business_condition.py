...
class RejectedByBusinessCondition(BaseModel):
    """
    Records rejected by business conditions
    """ # noqa: E501
    rejected_by_business_condition_id: Optional[StrictStr] = Field(default=None, description="ID of business condition that rejected the Record", alias="rejectedByBusinessConditionID")
    rejected_by_business_condition_reason: Optional[StrictStr] = Field(default=None, description="Message from the business condition that rejected the record", alias="rejectedByBusinessConditionReason")
    __properties: ClassVar[List[str]] = ["rejectedByBusinessConditionID", "rejectedByBusinessConditionReason"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RejectedByBusinessCondition from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RejectedByBusinessCondition from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "rejectedByBusinessConditionID": obj.get("rejectedByBusinessConditionID"),
            "rejectedByBusinessConditionReason": obj.get("rejectedByBusinessConditionReason")
        })
        return _obj
