...
class FindSimilarBusinessRuleResult(BaseModel):
    """
    Object holding additional information about business rule that rejects the incoming entity as source for find similar
    """ # noqa: E501
    business_condition_id: Optional[StrictStr] = Field(default=None, description="ID of rejecting business condition", alias="businessConditionID")
    business_condition_message: Optional[StrictStr] = Field(default=None, description="Message from rejecting business rule", alias="businessConditionMessage")
    data_issues_report: Optional[List[StrictStr]] = Field(default=None, description="Optional detailed messages about data issues", alias="dataIssuesReport")
    __properties: ClassVar[List[str]] = ["businessConditionID", "businessConditionMessage", "dataIssuesReport"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FindSimilarBusinessRuleResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FindSimilarBusinessRuleResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "businessConditionID": obj.get("businessConditionID"),
            "businessConditionMessage": obj.get("businessConditionMessage"),
            "dataIssuesReport": obj.get("dataIssuesReport")
        })
        return _obj
