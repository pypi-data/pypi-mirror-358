...
class StatusFlag(BaseModel):
    """
    A workflow task status flag
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The status flag ID")
    name: Optional[StrictStr] = Field(default=None, description="The status flag name")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StatusFlag from a dict"""
        if obj is None:
            return None
