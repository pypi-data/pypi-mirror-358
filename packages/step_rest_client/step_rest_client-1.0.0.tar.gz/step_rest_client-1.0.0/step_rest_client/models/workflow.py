...
class Workflow(BaseModel):
    """
    Basic representation of a workflow
    """ # noqa: E501
    ...
    valid_object_types: Optional[List[StrictStr]] = Field(default=None, description="IDs of the object types for which this workflow is valid", alias="validObjectTypes")
    __properties: ClassVar[List[str]] = ["id", "name", "validObjectTypes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "validObjectTypes": obj.get("validObjectTypes")
        })
        return _obj
