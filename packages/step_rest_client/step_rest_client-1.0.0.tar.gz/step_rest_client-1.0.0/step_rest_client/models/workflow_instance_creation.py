...
class WorkflowInstanceCreation(BaseModel):
    """
    Message body used for starting a workflow / creating an instance
    """ # noqa: E501
    node: Optional[WorkflowNode] = None
    message: Optional[StrictStr] = Field(default=None, description="The message to submit while starting the workflow")
    __properties: ClassVar[List[str]] = ["node", "message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkflowInstanceCreation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkflowInstanceCreation from a dict"""
        if obj is None:
            return None
