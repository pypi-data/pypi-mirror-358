...
class UnitsApi:
    ...
    def units_id_get(
        self,
        id: Annotated[StrictStr, Field(description="ID of the unit for which to retrieve data")],
        ...
        Operation for retrieving information about a specific unit object

        :param id: ID of the unit for which to retrieve data (required)
        :type id: str
        ...
        _param = self._units_id_get_serialize(
            id=id,
            context=context,
            workspace=workspace,
    ...
    @validate_call
    def units_id_get_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the unit for which to retrieve data")],
        context: Annotated[StrictStr, Field(description="ID of the context in which to perform the operation")],
        workspace: Annotated[Optional[StrictStr], Field(description="ID of the workspace in which to perform the operation. Defaults to \"Main\".")] = None,
    ...
    @validate_call
    def units_id_get_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the unit for which to retrieve data")],
        context: Annotated[StrictStr, Field(description="ID of the context in which to perform the operation")],
        workspace: Annotated[Optional[StrictStr], Field(description="ID of the workspace in which to perform the operation. Defaults to \"Main\".")] = None,
