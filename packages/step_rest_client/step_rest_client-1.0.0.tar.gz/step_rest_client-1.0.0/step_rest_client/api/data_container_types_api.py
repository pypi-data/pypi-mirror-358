...
class DataContainerTypesApi:
    ...
    @validate_call
    def data_container_types_id_get(
        self,
        id: Annotated[StrictStr, Field(description="ID of the data container type")],
        ...
        """Returns the data container type with the specified ID

        Operation for retrieving information about a specific data container type object

        :param id: ID of the data container type (required)
        :type id: str
        ...
        _param = self._data_container_types_id_get_serialize(
            id=id,
            context=context,
            workspace=workspace,
    ...
    @validate_call
    def data_container_types_id_get_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the data container type")],
        context: Annotated[StrictStr, Field(description="ID of the context in which to perform the operation")],
        workspace: Annotated[Optional[StrictStr], Field(description="ID of the workspace in which to perform the operation. Defaults to \"Main\".")] = None,
    ...
    @validate_call
    def data_container_types_id_get_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the data container type")],
        context: Annotated[StrictStr, Field(description="ID of the context in which to perform the operation")],
        workspace: Annotated[Optional[StrictStr], Field(description="ID of the workspace in which to perform the operation. Defaults to \"Main\".")] = None,
    ...
    def _data_container_types_id_get_serialize(
        self,
        id,
        context,
        workspace,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/data-container-types/{id}',
