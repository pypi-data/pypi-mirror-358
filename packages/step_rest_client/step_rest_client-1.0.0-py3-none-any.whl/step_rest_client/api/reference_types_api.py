...
class ReferenceTypesApi:
    ...
    @validate_call
    def reference_types_id_get(
        self,
        id: Annotated[StrictStr, Field(description="ID of the reference type for which to retrieve data")],
        ...
        """Returns the reference type with the specified ID

        Operation for retrieving information about a specific reference type object. Notice that this resource covers both \"cross reference types\" and \"classification product link types\".

        :param id: ID of the reference type for which to retrieve data (required)
        :type id: str
        ...
        _param = self._reference_types_id_get_serialize(
            id=id,
            context=context,
            workspace=workspace,
    ...
    @validate_call
    def reference_types_id_get_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the reference type for which to retrieve data")],
        context: Annotated[StrictStr, Field(description="ID of the context in which to perform the operation")],
        workspace: Annotated[Optional[StrictStr], Field(description="ID of the workspace in which to perform the operation. Defaults to \"Main\".")] = None,
    ...
    @validate_call
    def reference_types_id_get_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the reference type for which to retrieve data")],
        context: Annotated[StrictStr, Field(description="ID of the context in which to perform the operation")],
        workspace: Annotated[Optional[StrictStr], Field(description="ID of the workspace in which to perform the operation. Defaults to \"Main\".")] = None,
    ...
    def _reference_types_id_get_serialize(
        self,
        id,
        context,
        workspace,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/reference-types/{id}',
