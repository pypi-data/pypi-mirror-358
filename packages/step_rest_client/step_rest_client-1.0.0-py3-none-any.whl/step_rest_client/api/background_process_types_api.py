...
class BackgroundProcessTypesApi:
    ...
    @validate_call
    def background_process_types_get(
        self,
    ...
    ) -> List[BackgroundProcessType]:
        """Returns the available background process types

        Operation for retrieving an array of simple background process type representations for all background process types
        ...
        _param = self._background_process_types_get_serialize(
            context=context,
            workspace=workspace,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[BackgroundProcessType]",
            '400': "Error",
        }
    ...
    @validate_call
    def background_process_types_get_with_http_info(
        self,
        context: Annotated[StrictStr, Field(description="ID of the context in which to perform the operation")],
        workspace: Annotated[Optional[StrictStr], Field(description="ID of the workspace in which to perform the operation. Defaults to \"Main\".")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[BackgroundProcessType]]:
        """Returns the available background process types
    ...
    @validate_call
    def background_process_types_get_without_preload_content(
        self,
        context: Annotated[StrictStr, Field(description="ID of the context in which to perform the operation")],
        workspace: Annotated[Optional[StrictStr], Field(description="ID of the workspace in which to perform the operation. Defaults to \"Main\".")] = None,
        _request_timeout: Union[
    ...
    def _background_process_types_get_serialize(
        self,
        context,
        workspace,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/background-process-types',
    ...
    @validate_call
    def background_process_types_type_id_processes_get(
        self,
        type_id: Annotated[StrictStr, Field(description="Background process type ID")],
        context: Annotated[StrictStr, Field(description="ID of the context in which to perform the operation")],
        workspace: Annotated[Optional[StrictStr], Field(description="ID of the workspace in which to perform the operation. Defaults to \"Main\".")] = None,
        ...
        """Returns background process IDs for the specified background process type

        Operation for retrieving background process IDs for a specific background process type. Can be filtered on process status.

        :param type_id: Background process type ID (required)
        :type type_id: str
        :param context: ID of the context in which to perform the operation (required)
        :type context: str
        :param workspace: ID of the workspace in which to perform the operation. Defaults to \"Main\".
        ...
        _param = self._background_process_types_type_id_processes_get_serialize(
            type_id=type_id,
            context=context,
            workspace=workspace,
            status=status,
    ...
    @validate_call
    def background_process_types_type_id_processes_get_with_http_info(
        self,
        type_id: Annotated[StrictStr, Field(description="Background process type ID")],
        context: Annotated[StrictStr, Field(description="ID of the context in which to perform the operation")],
        workspace: Annotated[Optional[StrictStr], Field(description="ID of the workspace in which to perform the operation. Defaults to \"Main\".")] = None,
    ...
    @validate_call
    def background_process_types_type_id_processes_get_without_preload_content(
        self,
        type_id: Annotated[StrictStr, Field(description="Background process type ID")],
        context: Annotated[StrictStr, Field(description="ID of the context in which to perform the operation")],
        workspace: Annotated[Optional[StrictStr], Field(description="ID of the workspace in which to perform the operation. Defaults to \"Main\".")] = None,
    ...
    def _background_process_types_type_id_processes_get_serialize(
        self,
        type_id,
        context,
        workspace,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/background-process-types/{typeId}/processes',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
