...
class FindSimilarEntitiesResponseRecord(BaseModel):
    """
    Object holding an entity and its rank score with the entity in the request
    """ # noqa: E501
    rank: Optional[StrictInt] = Field(default=None, description="Rank score against entity in the request as calculated by the Matching Algorithm.")
    entity: Optional[Entity] = None
    __properties: ClassVar[List[str]] = ["rank", "entity"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FindSimilarEntitiesResponseRecord from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FindSimilarEntitiesResponseRecord from a dict"""
        if obj is None:
            return None
