...
class BackgroundProcessAttachmentMetadata(BaseModel):
    """
    Background process attachment metadata
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the background process attachment")
    name: Optional[StrictStr] = Field(default=None, description="Name of the background process attachment")
    mime_type: Optional[StrictStr] = Field(default=None, description="Mime type of the background process attachment", alias="mimeType")
    original_attachment_id: Optional[StrictStr] = Field(default=None, description="Original ID of the background process attachment. Please remember that this ID does not have to be unique - same ID can be used by multiple attachments if the attachment holds multiple files", alias="originalAttachmentId")
    description: Optional[StrictStr] = Field(default=None, description="Description of the background process attachment")
    __properties: ClassVar[List[str]] = ["id", "name", "mimeType", "originalAttachmentId", "description"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BackgroundProcessAttachmentMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BackgroundProcessAttachmentMetadata from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "originalAttachmentId": obj.get("originalAttachmentId"),
