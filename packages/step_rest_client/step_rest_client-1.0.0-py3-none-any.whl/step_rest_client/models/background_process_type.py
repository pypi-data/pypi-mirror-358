...
class BackgroundProcessType(BaseModel):
    """
    Background process type
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the background process type")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BackgroundProcessType from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BackgroundProcessType from a dict"""
        if obj is None:
            return None
