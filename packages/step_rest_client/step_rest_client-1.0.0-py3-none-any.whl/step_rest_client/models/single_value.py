...
class SingleValue(BaseModel):
    """
    A value for a single-valued attribute
    """ # noqa: E501
    calculated: Optional[StrictBool] = Field(default=None, description="Indicates whether the value is calculated. Should not be supplied for value updates. If supplied with the value \"true\", the update of the specific value will be skipped.")
    context_local: Optional[StrictBool] = Field(default=None, description="Indicates whether the value is set locally or inherited from a dimension point / a combination dimension points different from the ones used for current context. Should not be supplied for value updates. If supplied with the value \"false\", the update of the specific value will be skipped.", alias="contextLocal")
    inherited: Optional[StrictBool] = Field(default=None, description="Indicates whether the value is inherited from parent node.")
    value: Optional[ValueEntry] = None
    __properties: ClassVar[List[str]] = ["calculated", "contextLocal", "inherited", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": ValueEntry.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
