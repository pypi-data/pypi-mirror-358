...
class ReferenceType(BaseModel):
    """
    A reference type object. Can represent both \"cross reference types\" and \"classification product link types\".
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the reference type object")
    name: Optional[StrictStr] = Field(default=None, description="Reference type name")
    product_classification_link_type: Optional[StrictBool] = Field(default=None, description="Boolean indication of whether the type is a \"classification product link type\" as opposed to a \"cross reference type\"", alias="productClassificationLinkType")
    multivalued: Optional[StrictBool] = Field(default=None, description="Boolean indication of whether multiple references / links from a single source are allowed. Notice that a \"classification product link type\" always will be multivalued when seen from the classification side.")
    valid_source_object_types: Optional[List[StrictStr]] = Field(default=None, description="IDs of the valid source object types", alias="validSourceObjectTypes")
    valid_target_object_types: Optional[List[StrictStr]] = Field(default=None, description="IDs of the valid target object types", alias="validTargetObjectTypes")
    values: Optional[Dict[str, Value]] = Field(default=None, description="Reference type metadata values. Keys are attribute IDs and values either a SingleValue or a MultiValue depending on whether the attribute is multivalued.")
    __properties: ClassVar[List[str]] = ["id", "name", "productClassificationLinkType", "multivalued", "validSourceObjectTypes", "validTargetObjectTypes", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "productClassificationLinkType": obj.get("productClassificationLinkType"),
            "multivalued": obj.get("multivalued"),
            "validSourceObjectTypes": obj.get("validSourceObjectTypes"),
            "validTargetObjectTypes": obj.get("validTargetObjectTypes"),
            "values": dict(
