...
class QueryResult(BaseModel):
    """
    A query result. The \"type\" and \"id\" combined uniquely identifies an object in STEP.
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="The result supertype")
    id: Optional[StrictStr] = Field(default=None, description="The result id")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['asset', 'classification', 'entity', 'product']):
            raise ValueError("must be one of enum values ('asset', 'classification', 'entity', 'product')")
        return value
