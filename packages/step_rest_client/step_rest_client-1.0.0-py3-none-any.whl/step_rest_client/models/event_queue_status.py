...
class EventQueueStatus(BaseModel):
    """
    Status of an event queue. I.e. whether it is enabled (listening) or not.
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Is the queue enabled (listening) or not")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EventQueueStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EventQueueStatus from a dict"""
        if obj is None:
            return None
