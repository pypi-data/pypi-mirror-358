...
class BackgroundProcess(BaseModel):
    ...
    created: Optional[StrictStr] = Field(default=None, description="Time that the process was created in yyyy-mm-ddThh:mm:ss&#177hh:mm format")
    started: Optional[StrictStr] = Field(default=None, description="Time that the process was started in yyyy-mm-ddThh:mm:ss&#177hh:mm format. 'null' if the process has not yet started.")
    ended: Optional[StrictStr] = Field(default=None, description="Time that the process ended in yyyy-mm-ddThh:mm:ss&#177hh:mm format. 'null' if the process is still active.")
