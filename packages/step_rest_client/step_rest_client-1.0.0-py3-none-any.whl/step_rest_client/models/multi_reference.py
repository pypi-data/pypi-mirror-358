...
class MultiReference(BaseModel):
    """
    References for a multivalued reference type. Covers both \"cross references\" and \"classification product links\".
    """ # noqa: E501
    references: Optional[List[ReferenceEntry]] = Field(default=None, description="Multiple references of specific reference type")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MultiReference from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MultiReference from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "references": [ReferenceEntry.from_dict(_item) for _item in obj["references"]] if obj.get("references") is not None else None
        })
        return _obj

from step_rest_client.models.reference_entry import ReferenceEntry
# TODO: Rewrite to not use raise_errors
MultiReference.model_rebuild(raise_errors=False)
