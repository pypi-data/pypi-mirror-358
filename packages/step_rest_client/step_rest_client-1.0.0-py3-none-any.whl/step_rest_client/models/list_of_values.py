...
class ListOfValues(BaseModel):
    """
    A list of values object. Notice that the representation does not include value entires. These must be obtained via a separate resource.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the list of values object")
    name: Optional[StrictStr] = Field(default=None, description="List of values name")
    extendable: Optional[StrictBool] = Field(default=None, description="Boolean indication of whether it is possible to add values to the list of values via data objects")
    uses_value_ids: Optional[StrictBool] = Field(default=None, description="Boolean indication of whether the list of values uses value IDs", alias="usesValueIds")
    values: Optional[Dict[str, Value]] = Field(default=None, description="List of values metadata values. Keys are attribute IDs and values either a SingleValue or a MultiValue depending on whether the attribute is multivalued.")
    __properties: ClassVar[List[str]] = ["id", "name", "extendable", "usesValueIds", "values"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListOfValues from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListOfValues from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "usesValueIds": obj.get("usesValueIds"),
            "values": dict(
