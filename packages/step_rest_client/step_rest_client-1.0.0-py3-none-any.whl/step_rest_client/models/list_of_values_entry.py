...
class ListOfValuesEntry(BaseModel):
    """
    A value entry for a list of values
    """ # noqa: E501
    value: Optional[StrictStr] = Field(default=None, description="The \"value\" part of the value")
    value_id: Optional[StrictStr] = Field(default=None, description="The value ID (for lists of values that use value IDs)", alias="valueId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListOfValuesEntry from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListOfValuesEntry from a dict"""
        if obj is None:
            return None
