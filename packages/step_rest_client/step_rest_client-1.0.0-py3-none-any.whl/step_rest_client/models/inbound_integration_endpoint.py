...
class InboundIntegrationEndpoint(BaseModel):
    """
    Inbound integration endpoint representation
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the inbound integration endpoint")
    name: Optional[StrictStr] = Field(default=None, description="Name of the inbound integration endpoint")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InboundIntegrationEndpoint from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InboundIntegrationEndpoint from a dict"""
        if obj is None:
            return None
