...
class ValueEntry(BaseModel):
    """
    An atomic value. A value will consist of either a \"value\" alone, a \"valueId\" alone, a \"value\" and a \"unit\" or a \"value\", a \"valueId\" and a \"unit\". For writes, \"valueId\" takes precedence over \"value\" (and implicitly \"unit\") that will be ignored if \"valueId\" is supplied.
    """ # noqa: E501
    value: Optional[StrictStr] = Field(default=None, description="The \"value\" part of the value")
    value_id: Optional[StrictStr] = Field(default=None, description="Value ID to be used with list of values based attributes for which the list of values uses value IDs", alias="valueId")
    unit: Optional[StrictStr] = Field(default=None, description="Unit ID")
    __properties: ClassVar[List[str]] = ["value", "valueId", "unit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ValueEntry from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ValueEntry from a dict"""
        if obj is None:
            return None
