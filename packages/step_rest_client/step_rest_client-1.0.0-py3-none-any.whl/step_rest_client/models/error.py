...
class Error(BaseModel):
    ...
    message: Optional[StrictStr] = Field(default=None, description="Extended error information. Notice that error messages may change without warning and that programming logic should not rely upon the content of the message.")
    http_reason: Optional[StrictStr] = Field(default=None, description="The name of the HTTP status code", alias="httpReason")
    __properties: ClassVar[List[str]] = ["httpStatus", "message", "httpReason"]
