...
class EventProcessorStatus(BaseModel):
    """
    Status for event processor
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Status for event processor")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EventProcessorStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EventProcessorStatus from a dict"""
        if obj is None:
            return None
