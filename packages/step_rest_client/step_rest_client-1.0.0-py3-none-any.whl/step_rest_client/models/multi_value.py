...
class MultiValue(BaseModel):
    """
    A value for a multivalued attribute
    """ # noqa: E501
    ...
    values: Optional[List[ValueEntry]] = Field(default=None, description="Multiple values entries for multivalued attribute")
    __properties: ClassVar[List[str]] = ["contextLocal", "inherited", "values"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MultiValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MultiValue from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "values": [ValueEntry.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
