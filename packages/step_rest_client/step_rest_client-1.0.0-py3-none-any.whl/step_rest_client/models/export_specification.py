...
class ExportSpecification(BaseModel):
    """
    Object holding optional data for starting an export process
    """ # noqa: E501
    step_urls: Optional[List[StrictStr]] = Field(default=None, description="STEP URLs for the nodes to be used as the roots for the export. If 'stepUrls' is 'null' or an empty array is supplied, root nodes from the export configuration will be used.", alias="stepUrls")
    process_description: Optional[StrictStr] = Field(default=None, description="Desired process description. If not supplied, an auto generated description will be used.", alias="processDescription")
    __properties: ClassVar[List[str]] = ["stepUrls", "processDescription"]
