...
class MatchAndMergePotentialDuplicate(BaseModel):
    """
    A potential duplicate in a Match and Merge request
    """ # noqa: E501
    rank: Optional[StrictStr] = Field(default=None, description="Rank score")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MatchAndMergePotentialDuplicate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MatchAndMergePotentialDuplicate from a dict"""
        if obj is None:
            return None
