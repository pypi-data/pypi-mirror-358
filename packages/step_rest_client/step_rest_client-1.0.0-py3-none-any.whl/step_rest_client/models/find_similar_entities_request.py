...
class FindSimilarEntitiesRequest(BaseModel):
    """
    Object holding the data for a Find Similar operation for entities
    """ # noqa: E501
    max_results: Optional[StrictInt] = Field(default=10, description="Optional specification for maximum number of similar entities to return. Defaults to 10 and can not exceed 1000.", alias="maxResults")
    entity: Optional[Entity] = None
    __properties: ClassVar[List[str]] = ["maxResults", "entity"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FindSimilarEntitiesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FindSimilarEntitiesRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "maxResults": obj.get("maxResults") if obj.get("maxResults") is not None else 10,
