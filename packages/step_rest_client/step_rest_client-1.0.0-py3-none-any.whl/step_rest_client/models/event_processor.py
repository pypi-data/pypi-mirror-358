...
class EventProcessor(BaseModel):
    """
    Event processor representation
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the event processor")
    name: Optional[StrictStr] = Field(default=None, description="Name of the event processor")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EventProcessor from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EventProcessor from a dict"""
        if obj is None:
            return None
