...
class EndpointStatistics(BaseModel):
    ...
    """ # noqa: E501
    enabled_on: Optional[StrictStr] = Field(default=None, description="Time that the endpoint was enabled in yyyy-mm-ddThh:mm:ss&#177hh:mm format. Will be null for disabled endpoints.", alias="enabledOn")
    last_run: Optional[StrictStr] = Field(default=None, description="Time for last run (invocation) in yyyy-mm-ddThh:mm:ss&#177hh:mm format. Will be null if the endpoint has never run.", alias="lastRun")
