...
class BackgroundProcessIdentification(BaseModel):
    """
    Object wrapping a background process ID
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the background process")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BackgroundProcessIdentification from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BackgroundProcessIdentification from a dict"""
        if obj is None:
            return None
