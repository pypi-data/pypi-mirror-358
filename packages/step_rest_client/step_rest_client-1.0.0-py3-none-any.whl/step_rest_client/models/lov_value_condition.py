...
class LovValueCondition(BaseModel):
    """
    LOV value query condition. This type of value condition can be used for LOV validated attributes for which the LOV uses value IDs.
    """ # noqa: E501
    condition_type: StrictStr = Field(description="The condition type. Must have the value \"lovvalue\" for this type of condition.", alias="conditionType")
    attribute: StrictStr = Field(description="Id of the attribute for which to match the value")
    value_id: StrictStr = Field(description="The value ID", alias="valueId")
    ...
    __properties: ClassVar[List[str]] = ["conditionType", "attribute", "valueId", "matchInheritedValues"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LovValueCondition from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LovValueCondition from a dict"""
        if obj is None:
            return None
