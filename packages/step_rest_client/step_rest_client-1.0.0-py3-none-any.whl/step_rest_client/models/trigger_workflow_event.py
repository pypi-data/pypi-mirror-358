...
class TriggerWorkflowEvent(BaseModel):
    """
    Message body used for triggering a workflow event
    """ # noqa: E501
    event: Optional[WorkflowEvent] = None
    message: Optional[StrictStr] = Field(default=None, description="The message to submit while triggering the event")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TriggerWorkflowEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TriggerWorkflowEvent from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "event": WorkflowEvent.from_dict(obj["event"]) if obj.get("event") is not None else None,
