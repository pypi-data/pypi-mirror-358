...
class SingleReference(BaseModel):
    """
    A reference for a single-valued reference type. Covers both \"cross references\" and \"classification product links\".
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reference": ReferenceEntry.from_dict(obj["reference"]) if obj.get("reference") is not None else None
        })
        return _obj

from step_rest_client.models.reference_entry import ReferenceEntry
# TODO: Rewrite to not use raise_errors
SingleReference.model_rebuild(raise_errors=False)
