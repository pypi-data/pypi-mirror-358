"""
    ...
    Classes/Functions:
      - Functions:
        - _get_go_parser_path() -> Path (line 27)
        - _parse_with_go_ast(source_code: str) -> Tuple[List[ClassInfo], List[SignatureInfo]] (line 62)
        - parse_go_file(lines: List[str]) -> tuple[List[ClassInfo], List[SignatureInfo]] (line 120)
        - _parse_with_regex(lines: List[str]) -> Tuple[List[ClassInfo], List[SignatureInfo]] (line 145)
