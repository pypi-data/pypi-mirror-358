"""
    ...
    Classes/Functions:
      - Functions:
        - _format_arg(arg: ast.arg) -> str (line 22)
        - _format_signature(node: Union[ast.FunctionDef, ast.AsyncFunctionDef]) -> str (line 30)
        - parse_python_file(lines: List[str]) -> Tuple[List[ClassInfo], List[SignatureInfo]] (line 97)
        - _parse_class_node(node: ast.ClassDef) -> ClassInfo (line 138)
