...
VERSION = "0.0.1.3"  # la version doit être supérieure à la précédente sinon la publication sera refusée
...
ENTRY_POINTS = {
    "orange.widgets": (
        "Image Analysis Intelligent Tools = orangecontrib.AAIT.widgets",
    )
}
# /!\ les noms de fichier 'orangecontrib.hkh_bot.widgets' doivent correspondre à l'arborescence
