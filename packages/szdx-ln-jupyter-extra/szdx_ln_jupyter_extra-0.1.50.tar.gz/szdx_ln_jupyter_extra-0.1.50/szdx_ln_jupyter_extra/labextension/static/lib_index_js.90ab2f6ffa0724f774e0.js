...
async function activate(app, palette, restorer, statusBar, router, settingRegistry) {
    var _a;
    console.log('Activating szdx-szdx-ln-jupyter-extra extension...');
    ...
    if (router) {
        ...
        if (!notebookProjectId) {
            ...
            try {
                ...
                console.log('szdx-szdx-ln-jupyter-extra extension activated successfully!');
            }
            catch (error) {
...
//# sourceMappingURL=lib_index_js.90ab2f6ffa0724f774e0.js.map