...
class IqlExtension:
    ...
    cache: SqCache = field(default_factory=NoopSqCache, init=True)  # default is a NoopCache
    ...
    def execute_batch(self, queries: Iterable[subquery.SubQuery]) -> Iterable[IqlResultData]:
