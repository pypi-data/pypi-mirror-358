...
from xxy.agents.analysis_agent import (
    AgentState,
    create_document_agent,
    run_document_analysis,
)
from xxy.agents.search_agent import (
    SearchAgentState,
    create_search_agent,
    run_search_agent,
)
...
async def process_document_question(
    ...
    try:
        ...
        if not selected_doc_id:
            selected_doc_id = await run_search_agent(
                user_question, company_code, messages
            )
        ...
        return await run_document_analysis(selected_doc_id, user_question, messages)
