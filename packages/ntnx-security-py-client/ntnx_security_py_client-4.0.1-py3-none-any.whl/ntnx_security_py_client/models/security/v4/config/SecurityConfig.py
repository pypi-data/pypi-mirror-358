...
class SecurityConfig(ExternalizableAbstractModel):
    ...
    :param is_high_strength_password_enabled: (:attr:`is_high_strength_password_enabled`) Indicates whether the high strength password is enabled on a cluster. (**Default** False)
    :type is_high_strength_password_enabled: 
    
    
    :param is_aide_enabled: (:attr:`is_aide_enabled`) Indicates whether the aide service is enabled on a cluster. (**Default** False)
    :type is_aide_enabled: 
    
    
    :param is_secure_boot_enabled: (:attr:`is_secure_boot_enabled`) Indicates whether the host secure start is enabled on a cluster. (**Default** False)
    :type is_secure_boot_enabled: 
    
    
    :param is_cluster_lockdown_enabled: (:attr:`is_cluster_lockdown_enabled`) Indicates whether the cluster lockdown mode is enabled on a cluster. (**Default** False)
    :type is_cluster_lockdown_enabled: 
    
    
    :param is_log_forwarding_enabled: (:attr:`is_log_forwarding_enabled`) Indicates whether the log forwarding is enabled on a cluster. (**Default** False)
    ...
    :param is_ahv_defense_consent_banner_enabled: (:attr:`is_ahv_defense_consent_banner_enabled`) Indicates whether the AHV defence knowledge consent banner is enabled on the hypervisor. (**Default** False)
    :type is_ahv_defense_consent_banner_enabled: 
    
    
    :param is_cluster_defense_consent_banner_enabled: (:attr:`is_cluster_defense_consent_banner_enabled`) Indicates whether the Nutanix CVM defence knowledge consent banner is enabled. (**Default** False)
    ...
    def __init__(self, cluster_ext_id=None, is_high_strength_password_enabled=False, is_aide_enabled=False, is_secure_boot_enabled=False, is_cluster_lockdown_enabled=False, is_log_forwarding_enabled=False, cluster_scma_schedule=None, ahv_scma_schedule=None, is_ahv_defense_consent_banner_enabled=False, is_cluster_defense_consent_banner_enabled=False, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
