...
class SummaryProjection(Summary):
    ...
    def __init__(self, cluster_projection=None, cluster_ext_id=None, security_config_summary=None, stig_summary=None, vulnerabilities_summary=None, password_summary=None, trend_type=None, last_refresh_time=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        Summary.__init__(self, cluster_ext_id, security_config_summary, stig_summary, vulnerabilities_summary, password_summary, trend_type, last_refresh_time, ext_id, links, tenant_id, *args, **kwargs)
