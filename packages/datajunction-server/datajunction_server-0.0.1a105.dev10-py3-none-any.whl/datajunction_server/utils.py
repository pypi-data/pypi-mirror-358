...
class DatabaseSessionManager:
    ...
    def create_engine_and_session(
        ...
        engine = create_async_engine(
            ...
            connect_args={
                ...
                # "idle_session_timeout": database_config.idle_session_timeout,
                # "idle_in_transaction_session_timeout": database_config.idle_in_transaction_session_timeout
            },
        )
    ...
    async def close(self):
        ...
        """
        if self.reader_engine is None and self.writer_engine is None:  # pragma: no cover
