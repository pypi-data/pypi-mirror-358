...
) -> tuple[TextBlock | ImageBlock | ToolCall | ToolResult | URLContextBlock, ...]:
...
class Message(Generic[_CONTENT]):
    ...
    def normalize(
        ...
        tuple[ImageBlock | TextBlock | ToolCall | ToolResult | URLContextBlock, ...]
    ]:
    ...
    def exclude_image_blocks(
        self,
    ) -> Message[tuple[TextBlock | ToolCall | ToolResult | URLContextBlock, ...]]:
