...
"""
    ...
    def _format_message_content(
        cls,
        contents: Sequence[
            ImageBlock | TextBlock | ToolCall | ToolResult | URLContextBlock
        ],
        allow_tool: bool = True,
    ) -> list[dict[str, Any]]:
        # Filter out URLContextBlock since Anthropic doesn't support URL context
        filtered_contents = [
            content for content in contents if not isinstance(content, URLContextBlock)
        ]
