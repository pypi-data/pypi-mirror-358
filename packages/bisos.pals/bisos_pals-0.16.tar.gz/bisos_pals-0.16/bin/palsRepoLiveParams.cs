...
** This File: /bisos/core/bpip/bin/palsRepoLiveParams.py
...
#+end_org """
import typing
csInfo: typing.Dict[str, typing.Any] = { 'moduleName': ['palsRepoLiveParams'], }
csInfo['version'] = '202502142829'
csInfo['status']  = 'inUse'
csInfo['panel'] = 'palsRepoLiveParams-Panel.org'
...
#+END_SRC
#+RESULTS:
| bisos.b.cs.ro | bisos.csPlayer.bleep | bisos.bpo.bpo | bisos.bpo.bpoFpBases | bisos.pals.repoLiveParams | bisos.b.fpCls |
#+end_org """
...
csuList = [ 'bisos.b.cs.ro', 'bisos.csPlayer.bleep', 'bisos.bpo.bpo', 'bisos.bpo.bpoFpBases', 'bisos.pals.repoLiveParams', 'bisos.b.fpCls', ]
...
####+END:
        ...
        repoLiveParams.examples_repoLiveParams().pyCmnd(bpoId=oneBpo,)
