...
class ApiGatewayToLambda(
    ...
    def __init__(
        ...
        *,
        ...
        existingcertificate: typing.Optional[_aws_cdk_aws_certificatemanager_ceddda9d.ICertificate] = None,
        ...
        :param existingcertificate: Optional ACM certificate to use instead of creating a new one.
...
class ApiGatewayToLambdaProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            ...
            check_type(argname="argument existingcertificate", value=existingcertificate, expected_type=type_hints["existingcertificate"])
        ...
        if existingcertificate is not None:
            self._values["existingcertificate"] = existingcertificate
    ...
    @builtins.property
    def existingcertificate(
        self,
    ) -> typing.Optional[_aws_cdk_aws_certificatemanager_ceddda9d.ICertificate]:
        '''Optional ACM certificate to use instead of creating a new one.'''
        result = self._values.get("existingcertificate")
