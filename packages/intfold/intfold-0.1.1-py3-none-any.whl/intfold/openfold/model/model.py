...
class IntFold(nn.Module):
    ...
    def noise_schedule(self,device):
        ...
        # t is distributed uniformly between [0, 1] with a step size of 1/T
        # suppose T = 200, t = [0,1/200,2/200,3/200,...,199/200,1]
...
class CentreRandomAugmentation(nn.Module):
    ...
    def forward(
        ...
        # t = einops.rearrange(t, 'b c -> b 1 c')
        t = t.unsqueeze(-2)

        # Apply rotation and translation
        # x = einops.einsum(x, R, 'b n i, b j i -> b n j') + t
