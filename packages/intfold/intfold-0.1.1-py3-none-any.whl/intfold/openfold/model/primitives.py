    ...
    def __init__(
        ...
        Args:
            ...
            init:
                ...
                "linear": LeCun fan-in truncated normal initialization
                "relu": He initialization w/ truncated normal distribution
                "zeros": Weights=0, Bias=0
...
class Attention(nn.Module):
    ...
    def __init__(
        ...
        self.linear_q = Linear(
            self.c_q, self.c_hidden * self.no_heads, bias=False, init="linear"
        )
        ...
        self.linear_o = Linear(
            self.c_hidden * self.no_heads, self.c_q, init="zeros", bias=False
        )

        self.linear_g = None
        if self.gating:
            self.linear_g = Linear(
                self.c_q, self.c_hidden * self.no_heads, init="zeros", bias=False
            )
