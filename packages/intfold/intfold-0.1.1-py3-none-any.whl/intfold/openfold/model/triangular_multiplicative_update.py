...
from intfold.openfold.utils.tensor_utils import add, permute_final_dims
...
class BaseTriangleMultiplicativeUpdate(nn.Module, ABC):
    ...
    def __init__(self, c_z, c_hidden, _outgoing):
        ...
        self.linear_g = Linear(self.c_z, self.c_z, init="zeros", bias=False)
        self.linear_z = Linear(self.c_hidden, self.c_z, init="zeros", bias=False)
...
class FusedTriangleMultiplicativeUpdate(BaseTriangleMultiplicativeUpdate):
    ...
    def __init__(self, c_z, c_hidden, _outgoing=True):
        ...
        self.linear_ab_p = Linear(self.c_z, self.c_hidden * 2,bias=False, init="linear")
        self.linear_ab_g = Linear(self.c_z, self.c_hidden * 2,bias=False, init="zeros")
    ...
    def forward(self,
        ...
        ab = permute_final_dims(ab, (2, 0, 1)) # shape: [C_hidden, N_res, N_res]
