...
from .langgraph_handler import LangGraphCallbackHandler
...
# Import LangGraphCallbackHandler if available
try:
    from .langgraph_handler import LangGraphCallbackHandler
except ImportError:
    # LangGraphCallbackHandler requires langchain_core to be installed
    pass
