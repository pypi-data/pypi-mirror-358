...
class YunhuMessageModel:
    def __init__(
            ...
            message: typing.Union[YunhuTextReqModel, YunhuButtonClickModel, YunhuImageModel, YunhuActionModel]
        ):
...
class YunhuListener(Yunhu, FastAPI):
    def __init__(
        ...
        """
        YunhuListener is an subclass of yunhulink.orm.Yunhu, also is a subclass of fastapi.FastAPI.
        """
    ...
    def msghook(
        ...
        etype = set(eventType)
        def _constructor(fn: typing.Callable[[YunhuMessageModel], typing.Coroutine]):
            if len(etype) == 0:
