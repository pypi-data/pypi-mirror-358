...
PADDLE_API Tensor index_elementwise_get(const Tensor& x, const std::vector<Tensor>& index, const std::vector<int64_t>& input_dims, const std::vector<int64_t>& input_strides, const std::vector<int64_t>& index_dims, const std::vector<int64_t>& index_stride);

PADDLE_API Tensor index_elementwise_put(const Tensor& x, const std::vector<Tensor>& index, const Tensor& value, const std::vector<int64_t>& input_dims, const std::vector<int64_t>& input_strides, const std::vector<int64_t>& index_dims, const std::vector<int64_t>& index_strides, int64_t slice_offset);

PADDLE_API Tensor& index_elementwise_put_(Tensor& x, const std::vector<Tensor>& index, const Tensor& value, const std::vector<int64_t>& input_dims, const std::vector<int64_t>& input_strides, const std::vector<int64_t>& index_dims, const std::vector<int64_t>& index_strides, int64_t slice_offset);
...
PADDLE_API std::tuple<Tensor, Tensor, Tensor, Tensor> fp8_quant_blockwise(const Tensor& x, float epsilon, bool using_1x128_vec_quant, bool input_transpose, bool output_scale_transpose, bool using_e5m2, bool using_pow2_scale);
