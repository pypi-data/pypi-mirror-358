...
op_info = {
    ...
    "index_elementwise_get": {
        "args": "Tensor x, Tensor[] index, int64_t[] input_dims, int64_t[] input_strides, int64_t[] index_dims, int64_t[] index_stride",
        "output": "Tensor (out)"
    },
    ...
    "fp8_quant_blockwise": {
        "args": "Tensor x, float epsilon, bool using_1x128_vec_quant, bool input_transpose, bool output_scale_transpose, bool using_e5m2, bool using_pow2_scale",
