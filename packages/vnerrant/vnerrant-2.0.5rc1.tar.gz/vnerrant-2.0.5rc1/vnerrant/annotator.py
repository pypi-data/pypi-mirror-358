...
from vnerrant.constants import MergeType, TokenizeTypes, StyleGuide
...
class Annotator:
    ...
    def classify(self, edit: Edit, style_guide: str) -> Edit:
        """
    ...
    def annotate_raw(
        ...
        style_guide: str = StyleGuide.WRITING,
    ) -> list[Edit]:
        """
        ...
        for edit in edits:
            self.classify(edit, style_guide=style_guide)
            self.explain(edit)
