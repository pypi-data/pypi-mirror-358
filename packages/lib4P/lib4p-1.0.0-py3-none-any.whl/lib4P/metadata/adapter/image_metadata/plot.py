from .interface.image_linker_interface import IImageLinker
from ... import Plot as BasePlot
...
class Plot(BasePlot, IImageLinker):
    def link_images(self, images):
        ...
        :type images: Image or list[Image]
        """
        super().link_data(images)
