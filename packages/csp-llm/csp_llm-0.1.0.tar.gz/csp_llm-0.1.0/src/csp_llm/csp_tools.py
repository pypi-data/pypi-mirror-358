...
class CSPExtractor:
    """Extract PyCSP3 code from text using regex patterns"""

    @staticmethod
    def extract_pycsp3_code(text: str) -> str:
        """Extract PyCSP3 code from LLM's response"""
...
class MCPCSPRunner:
    """MCP function runner for CSP problems"""
    ...
    async def run_csp_code(self, code: str) -> Dict[str, Any]:
        """Run PyCSP3 code through MCP function"""
        try:
...
class CSPGenerator:
    """Generate CSP problems using LLM"""
