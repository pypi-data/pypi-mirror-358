from make87_messages.detection.box import box_2d_pb2 as _box_2d_pb2
...
class Boxes2DAxisAligned(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., boxes: _Optional[_Iterable[_Union[_box_2d_pb2.Box2DAxisAligned, _Mapping]]] = ...) -> None: ...
