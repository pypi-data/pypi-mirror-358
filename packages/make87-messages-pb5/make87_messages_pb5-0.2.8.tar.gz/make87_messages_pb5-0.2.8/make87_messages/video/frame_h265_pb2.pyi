...
class FrameH265(_message.Message):
    ...
    dts: int
    duration: int
    time_base: FrameH265.Fraction
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., data: _Optional[bytes] = ..., width: _Optional[int] = ..., height: _Optional[int] = ..., is_keyframe: bool = ..., pts: _Optional[int] = ..., dts: _Optional[int] = ..., duration: _Optional[int] = ..., time_base: _Optional[_Union[FrameH265.Fraction, _Mapping]] = ...) -> None: ...
