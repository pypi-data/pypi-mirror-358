...
class FrameAV1(_message.Message):
    ...
    dts: int
    duration: int
    time_base: FrameAV1.Fraction
    def __init__(self, header: _Optional[_Union[_header_pb2.Header, _Mapping]] = ..., data: _Optional[bytes] = ..., width: _Optional[int] = ..., height: _Optional[int] = ..., is_keyframe: bool = ..., pts: _Optional[int] = ..., dts: _Optional[int] = ..., duration: _Optional[int] = ..., time_base: _Optional[_Union[FrameAV1.Fraction, _Mapping]] = ...) -> None: ...
