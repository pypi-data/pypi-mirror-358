...
class Client:
    ...
    def make_request (self, method, uri, data, headers, auth = None, meta = {}, version = "1.1", json = None):
        method = method.upper ()
    ...
    def post (self, uri, data = None, headers = [], auth = None, meta = {}, version = "1.1", json = None):
        return self.make_request ("POST", uri, data, headers, auth, meta, version, json)
    ...
    def patch (self, uri, data = None, headers = [], auth = None, meta = {}, version = "1.1", json = None):
        return self.make_request ("PATCH", uri, data, headers, auth, meta, version, json)

    def put (self, uri, data = None, headers = [], auth = None, meta = {}, version = "1.1", json = None):
        return self.make_request ("PUT", uri, data, headers, auth, meta, version, json)
