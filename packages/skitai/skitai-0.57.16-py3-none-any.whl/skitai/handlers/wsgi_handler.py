...
class Handler:
    ...
    def make_collector (self, collector_class, request, max_cl, *args, **kargs):
        try:
            ...
            self.handle_error_before_collecting (request, 400) # protocol error
            return
...
class Job:
    ...
    def exec_app (self):
        ...
        try:
            ...
            if isinstance (content, (list, tuple)) and inspect.isasyncgen (content [0]):
                return tasks.add_async_generator (was, content [0])
