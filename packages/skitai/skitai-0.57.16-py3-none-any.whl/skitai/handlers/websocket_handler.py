...
class Handler (wsgi_handler.Handler):
    ...
    def build_response_header (self, request, protocol, secret_key, host, path):
        headers = [
            ("Sec-WebSocket-Accept", self.calculate_response_key (secret_key)),
            ("Upgrade", "Websocket"),
            ("Connection", "Upgrade"),
    ...
    def handle_request (self, request):
        ...
        secret_key = request.get_header ("sec-websocket-key")
        ...
        try:
            ...
            if collector_class:
                ...
                self.build_response_header (request, protocol, secret_key, host, path)
