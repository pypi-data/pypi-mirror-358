...
def check_existing_installation(bin_dir):
    """Check if wincontd is already installed"""
...
def install_dependencies(force=False):
    ...
    if not force and check_existing_installation(BIN_DIR):
        click.echo("✅ wincontd is already installed. Use --force to reinstall.")
        return True
...
'''
        ...
        click.echo("💡 Run 'wincontd start' to start the containerd service")
