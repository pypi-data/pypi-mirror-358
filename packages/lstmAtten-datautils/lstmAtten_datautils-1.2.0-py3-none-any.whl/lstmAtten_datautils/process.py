...
def word2id():
    word2id_dict = {word.strip(): idx for idx, word in enumerate(open(conf.vocab_data_path, encoding='utf-8'))}
    return word2id_dict
...
def pos_padding(pos_ids, baseconfig):
    ...
    pos_padding_value = min(baseconfig.pos_padding_value, baseconfig.pos_size - 1)
