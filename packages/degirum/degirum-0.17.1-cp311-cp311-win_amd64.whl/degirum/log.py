...
from typing import Callable, TypeVar, Optional, Union, overload
...
@overload
def log_wrap(f: Callable[P, R]) -> Callable[P, R]: ...  # noqa: E704
...
def log_wrap(
    f: Optional[Callable[P, R]] = None, *, log_level: int = logging.DEBUG
