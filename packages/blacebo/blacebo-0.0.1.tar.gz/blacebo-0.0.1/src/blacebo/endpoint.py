...
class Endpoint:
    ...
    @staticmethod
    def _render_template(type, name, params):
        package_root = os.path.dirname(os.path.dirname(os.path.dirname(__file__)))
        env = Environment(loader=FileSystemLoader(f"{package_root}/templates/{type}"))
        template_source = env.loader.get_source(env, name + ".json.j2")[0]
        ...
        template = env.get_template(name + ".json.j2")
