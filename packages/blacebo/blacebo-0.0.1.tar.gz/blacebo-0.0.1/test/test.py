...
# blacebo.generics.prefix = PREFIX
# blacebo.generics.identifier = IDENTIFIER
...
try:
    ...
    obs.kibana_settings.set(SPACE_ID, {"notifications:banner": None})
...
except blacebo.CurcumaException as e:
    print(f"Error: {e}")
