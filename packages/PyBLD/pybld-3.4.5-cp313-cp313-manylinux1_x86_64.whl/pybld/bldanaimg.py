...
#$Id: bldanaimg.py,v 7d67ae31cfcc 2025/06/28 00:53:23 watabe $
import numpy
...
class HDR:
    ...
    def read(self,fname):
        ...
        self.data_type = str(self.data_type.tobytes(),'utf8')
        self.db_name = numpyio.fread(fd,18,'c',self.swap)
        self.db_name = str(self.db_name.tobytes(),'utf8')
        ...
        self.vox_units = str(self.vox_units.tobytes(),'utf8')
        self.cal_units = numpyio.fread(fd,8,'c',self.swap)
        self.cal_units = str(self.cal_units.tobytes(),'utf8')
