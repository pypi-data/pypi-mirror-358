...
import time
from .utils import resource_path, get_voice_by_index, create_subtitle_image, split_timings, auto_split_timing_by_duration, to_seconds
...
ffmpeg_dir = resource_path("assets/ffmpeg/bin")
os.environ["PATH"] = ffmpeg_dir + os.pathsep + os.environ.get("PATH", "")

# ffmpeg 路径
ffmpeg_path = resource_path("assets/ffmpeg/bin/ffmpeg.exe")
ffprobe_path = resource_path("assets/ffmpeg/bin/ffprobe.exe")
...
ffplay_path = resource_path("assets/ffmpeg/bin/ffplay.exe")
...
def generate_video(config, timing):
    ...
    font_path = style.get('fontPath', resource_path('assets/simhei.ttf'))
