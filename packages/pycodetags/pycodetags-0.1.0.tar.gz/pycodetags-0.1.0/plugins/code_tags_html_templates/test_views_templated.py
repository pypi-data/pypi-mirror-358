...
from code_tags.views_templated import print_html
...
@patch("code_tags.views_templated.pkg_resources.files")
@patch("code_tags.views_templated.jinja2.Template")
@patch("code_tags.views_templated.webbrowser.open")
