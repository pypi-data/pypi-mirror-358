# Contents of code_tags source tree
...
from code_tags.user import get_current_user
from code_tags.users_from_authors import parse_authors_file_simple
...
class CodeTagsConfig:
    ...
    def _load(self) -> None:
        ...
        self._config = data.get("tool", {}).get("code_tags", {})
...
```python
from code_tags.data_tags import DataTagSchema
...
def generate_config(level: str = "DEBUG", enable_bug_trail: bool = False) -> dict[str, Any]:
    ...
    if enable_bug_trail:
        ...
        config["loggers"]["code_tags"]["handlers"].append("bugtrail")
...
from typing import Any
from code_tags.main_types import TODO
"""
        )
...
def plugin_currently_loaded(pm: pluggy.PluginManager) -> None:
    print("--- Loaded code_tags Plugins ---")
...
from code_tags.data_tags import DataTag
from code_tags.folk_code_tags import FolkTag
from code_tags.todo_object_schema import TODO_KEYWORDS
from code_tags.todo_tag_types import TODO
...
from code_tags.config import get_code_tags_config
from code_tags.todo_tag_types import TODO, TodoException
from code_tags.view_tools import group_and_sort
...
from code_tags.data_tag_types import DATA
from code_tags.specific_schemas import PEP350Schema
...
hookspec = pluggy.HookspecMarker("code_tags")


class CodeTagsSpec:
    """A hook specification namespace for code_tags."""
    ...
    def code_tags_add_cli_subcommands(self, subparsers: argparse._SubParsersAction) -> None:  # type: ignore[type-arg]
        """
        Allows plugins to add new subcommands to the code_tags CLI.
...
from code_tags.todo_tag_types import TodoException
