...
echo "JS plugin"
code_tags report --src demo/demo.js
echo "Report plugin"
code_tags report  --module demo.__main__ --src demo --format markdown_simple
echo "Mock integration plugin"
code_tags jira-sync --project foo --dry-run
echo "Mock integration plugin"
code_tags jira-sync --project foo