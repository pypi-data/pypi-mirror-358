...
from code_tags.data_tags import parse_codetags, parse_fields, promote_fields
from code_tags.specific_schemas import PEP350Schema
from code_tags.standard_code_tags import collect_pep350_code_tags
from code_tags.standard_code_tags import extract_comment_blocks_fallback as extract_comment_blocks
...
def test_parse_codetags_multiple_tags_in_same_block():
    ...
    # BUG: Critical issue <t:jira s:open>
    """
    results = parse_codetags(text_block, PEP350Schema, strict=False)
    ...
    assert results[2]["fields"]["data_fields"]["tracker"] == "jira"
