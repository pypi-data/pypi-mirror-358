...
@patch("code_tags.converters.TODO")
@patch("code_tags.converters.TODO_KEYWORDS", ["priority", "status"])
...
@patch("code_tags.converters.logger")
@patch("code_tags.converters.TODO")
@patch("code_tags.converters.TODO_KEYWORDS", ["priority"])
...
@patch("code_tags.converters.TODO")
@patch("code_tags.converters.TODO_KEYWORDS", ["category", "status"])
