...
class InnQuestionRecord:
    ...
    """
    _byte_size: int = 0
    _question_length: int = None # type: ignore [assignment]
    _question: str = None # type: ignore [assignment]
    _answer_length: int = None # type: ignore [assignment]
    _answer: str = None # type: ignore [assignment]
    ...
    def deserialize(reader: EoReader) -> "InnQuestionRecord":
        ...
        """
        data: InnQuestionRecord = InnQuestionRecord()
        old_chunked_reading_mode: bool = reader.chunked_reading_mode
        try:
            reader_start_position: int = reader.position
            data._question_length = reader.get_char()
            data._question = reader.get_fixed_string(data._question_length, False)
            data._answer_length = reader.get_char()
            data._answer = reader.get_fixed_string(data._answer_length, False)
