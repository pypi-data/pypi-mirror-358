...
class SkillMasterFile:
    ...
    """
    _byte_size: int = 0
    _skill_masters: list[SkillMasterRecord] = None # type: ignore [assignment]
    ...
    @property
    def skill_masters(self) -> list[SkillMasterRecord]:
        return self._skill_masters

    @skill_masters.setter
    def skill_masters(self, skill_masters: list[SkillMasterRecord]) -> None:
        self._skill_masters = skill_masters
    ...
    def deserialize(reader: EoReader) -> "SkillMasterFile":
        ...
        """
        data: SkillMasterFile = SkillMasterFile()
        ...
        try:
            ...
            while reader.remaining > 0:
                data._skill_masters.append(SkillMasterRecord.deserialize(reader))
