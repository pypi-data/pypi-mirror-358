import wave
from novus_pytils.files import get_files_by_extension, path_exists, file_exists
from bioamla.exceptions import PAthNotFoundException
...
def get_wav_files(directory : str) -> list:
    if not path_exists(directory):
        raise PAthNotFoundException(f"File not found: {directory}")
