...
`accdist() -> float`
    ...
    return _lib.Incr_fn_accdist_d0b7b3(ctx).collect()
...
`accdist() -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_accdist_d0b7b3(ctx)
...
`cum(series<float> src) -> float`
    ...
    return _lib.Incr_fn_cum_5677a1(ctx).collect(_25577_src=src)
...
`cum(series<float> src) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_cum_5677a1(ctx)
        self.locals = CumLocals(self.inner)

    def next(self, src: float) -> Optional[float]:
        return self.inner.next(_25577_src=src)
...
`change(series<float> src) -> series<float>`
    ...
    return _lib.Incr_fn_change_c62a7d(ctx).collect(_25579_src=src)
...
`change(series<float> src) -> series<float>`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_change_c62a7d(ctx)
        self.locals = ChangeLocals(self.inner)

    def next(self, src: float) -> Optional[float]:
        return self.inner.next(_25579_src=src)
...
`barssince(series<bool> condition) -> int`
    ...
    return _lib.Incr_fn_barssince_1b2a9a(ctx).collect(_25581_condition=condition)
...
`barssince(series<bool> condition) -> int`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_barssince_1b2a9a(ctx)
        self.locals = BarssinceLocals(self.inner)

    def next(self, condition: bool) -> Optional[int]:
        return self.inner.next(_25581_condition=condition)
...
`roc(series<float> src, int length = 14) -> series<float>`
    ...
    return _lib.Incr_fn_roc_3d2038(ctx).collect(_25583_src=src, _25584_length=length)
...
`roc(series<float> src, int length = 14) -> series<float>`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_roc_3d2038(ctx)
        self.locals = RocLocals(self.inner)

    def next(self, src: float, length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25583_src=src, _25584_length=length)
...
`crossover(series<float> source1, series<float> source2) -> bool`
    ...
    return _lib.Incr_fn_crossover_637e55(ctx).collect(_25586_source1=source1, _25587_source2=source2)
...
`crossover(series<float> source1, series<float> source2) -> bool`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_crossover_637e55(ctx)
        self.locals = CrossoverLocals(self.inner)

    def next(self, source1: float, source2: float) -> Optional[bool]:
        return self.inner.next(_25586_source1=source1, _25587_source2=source2)
...
`crossunder(series<float> source1, series<float> source2) -> bool`
    ...
    return _lib.Incr_fn_crossunder_636918(ctx).collect(_25589_source1=source1, _25590_source2=source2)
...
`crossunder(series<float> source1, series<float> source2) -> bool`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_crossunder_636918(ctx)
        self.locals = CrossunderLocals(self.inner)

    def next(self, source1: float, source2: float) -> Optional[bool]:
        return self.inner.next(_25589_source1=source1, _25590_source2=source2)
...
`cross(series<float> source1, series<float> source2) -> bool`
    ...
    return _lib.Incr_fn_cross_4edfa0(ctx).collect(_25592_source1=source1, _25593_source2=source2)
...
`cross(series<float> source1, series<float> source2) -> bool`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_cross_4edfa0(ctx)
        self.locals = CrossLocals(self.inner)

    def next(self, source1: float, source2: float) -> Optional[bool]:
        return self.inner.next(_25592_source1=source1, _25593_source2=source2)
...
`highestbars(series<float> src, int length = 14) -> int`
    ...
    return _lib.Incr_fn_highestbars_d660d5(ctx).collect(_25595_src=src, _25596_length=length)
...
`highestbars(series<float> src, int length = 14) -> int`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_highestbars_d660d5(ctx)
        self.locals = HighestbarsLocals(self.inner)

    def next(self, src: float, length: Optional[int]) -> Optional[int]:
        return self.inner.next(_25595_src=src, _25596_length=length)
...
`lowestbars(series<float> src, int length = 14) -> int`
    ...
    return _lib.Incr_fn_lowestbars_84f625(ctx).collect(_25598_src=src, _25599_length=length)
...
`lowestbars(series<float> src, int length = 14) -> int`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_lowestbars_84f625(ctx)
        self.locals = LowestbarsLocals(self.inner)

    def next(self, src: float, length: Optional[int]) -> Optional[int]:
        return self.inner.next(_25598_src=src, _25599_length=length)
...
`highest(series<float> src, int length = 14) -> float`
    ...
    return _lib.Incr_fn_highest_953656(ctx).collect(_25601_src=src, _25602_length=length)
...
`highest(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_highest_953656(ctx)
        self.locals = HighestLocals(self.inner)

    def next(self, src: float, length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25601_src=src, _25602_length=length)
...
`lowest(series<float> src, int length = 14) -> float`
    ...
    return _lib.Incr_fn_lowest_9785f8(ctx).collect(_25604_src=src, _25605_length=length)
...
`lowest(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_lowest_9785f8(ctx)
        self.locals = LowestLocals(self.inner)

    def next(self, src: float, length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25604_src=src, _25605_length=length)
...
`swma(series<float> src) -> float`
    ...
    return _lib.Incr_fn_swma_fb6db9(ctx).collect(_25607_src=src)
...
`swma(series<float> src) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_swma_fb6db9(ctx)
        self.locals = SwmaLocals(self.inner)

    def next(self, src: float) -> Optional[float]:
        return self.inner.next(_25607_src=src)
...
`sma(series<float> src, int length = 14) -> float`
    ...
    return _lib.Incr_fn_sma_f78799(ctx).collect(_25609_src=src, _25610_length=length)
...
`sma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_sma_f78799(ctx)
        self.locals = SmaLocals(self.inner)

    def next(self, src: float, length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25609_src=src, _25610_length=length)
...
`ema(series<float> src, int length = 14) -> float`
    ...
    return _lib.Incr_fn_ema_feadf2(ctx).collect(_25612_src=src, _25613_length=length)
...
`ema(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_ema_feadf2(ctx)
        self.locals = EmaLocals(self.inner)

    def next(self, src: float, length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25612_src=src, _25613_length=length)
...
`rma(series<float> src, int length = 14) -> float`
    ...
    return _lib.Incr_fn_rma_146870(ctx).collect(_25615_src=src, _25616_length=length)
...
`rma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_rma_146870(ctx)
        self.locals = RmaLocals(self.inner)

    def next(self, src: float, length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25615_src=src, _25616_length=length)
...
`wma(series<float> src, int length = 14) -> float`
    ...
    return _lib.Incr_fn_wma_cbf637(ctx).collect(_25618_src=src, _25619_length=length)
...
`wma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_wma_cbf637(ctx)
        self.locals = WmaLocals(self.inner)

    def next(self, src: float, length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25618_src=src, _25619_length=length)
...
`lwma(series<float> src, int length = 14) -> float`
    ...
    return _lib.Incr_fn_lwma_eb0cde(ctx).collect(_25621_src=src, _25622_length=length)
...
`lwma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_lwma_eb0cde(ctx)
        self.locals = LwmaLocals(self.inner)

    def next(self, src: float, length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25621_src=src, _25622_length=length)
...
`hma(series<float> src, int length = 14) -> float`
    ...
    return _lib.Incr_fn_hma_e66cb4(ctx).collect(_25624_src=src, _25625_length=length)
...
`hma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_hma_e66cb4(ctx)
        self.locals = HmaLocals(self.inner)

    def next(self, src: float, length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25624_src=src, _25625_length=length)
...
`vwma(series<float> src, int length = 14) -> float`
    ...
    return _lib.Incr_fn_vwma_1b4ac4(ctx).collect(_25627_src=src, _25628_length=length)
...
`vwma(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_vwma_1b4ac4(ctx)
        self.locals = VwmaLocals(self.inner)

    def next(self, src: float, length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25627_src=src, _25628_length=length)
...
`dev(series<float> src, int length = 14) -> float`
    ...
    return _lib.Incr_fn_dev_1b117e(ctx).collect(_25630_src=src, _25631_length=length)
...
`dev(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_dev_1b117e(ctx)
        self.locals = DevLocals(self.inner)

    def next(self, src: float, length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25630_src=src, _25631_length=length)
...
`tr(bool handle_na = true) -> series<float>`
    ...
    return _lib.Incr_fn_tr_ae4a49(ctx).collect(_25633_handle_na=handle_na)
...
`tr(bool handle_na = true) -> series<float>`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_tr_ae4a49(ctx)
        self.locals = TrLocals(self.inner)

    def next(self, handle_na: Optional[bool]) -> Optional[float]:
        return self.inner.next(_25633_handle_na=handle_na)
...
`atr(int length = 14) -> float`
    ...
    return _lib.Incr_fn_atr_3f40d3(ctx).collect(_25635_length=length)
...
`atr(int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_atr_3f40d3(ctx)
        self.locals = AtrLocals(self.inner)

    def next(self, length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25635_length=length)
...
`rsi(series<float> src, int length = 14) -> float`
    ...
    return _lib.Incr_fn_rsi_f8ce43(ctx).collect(_25637_src=src, _25638_length=length)
...
`rsi(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_rsi_f8ce43(ctx)
        self.locals = RsiLocals(self.inner)

    def next(self, src: float, length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25637_src=src, _25638_length=length)
...
`cci(series<float> src, int length = 14) -> float`
    ...
    return _lib.Incr_fn_cci_b18c60(ctx).collect(_25640_src=src, _25641_length=length)
...
`cci(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_cci_b18c60(ctx)
        self.locals = CciLocals(self.inner)

    def next(self, src: float, length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25640_src=src, _25641_length=length)
...
`stdev(series<float> src, int length, bool biased = true) -> float`
    ...
    return _lib.Incr_fn_stdev_27d3f0(ctx).collect(_25643_src=src, _25644_length=length, _25645_biased=biased)
...
`stdev(series<float> src, int length, bool biased = true) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_stdev_27d3f0(ctx)
        self.locals = StdevLocals(self.inner)

    def next(self, src: float, length: int, biased: Optional[bool]) -> Optional[float]:
        return self.inner.next(_25643_src=src, _25644_length=length, _25645_biased=biased)
...
`aroon(int length = 14) -> [float, float]`
    ...
    return _lib.Incr_fn_aroon_21b94f(ctx).collect(_25647_length=length)
...
`supertrend(series<float> src, float factor, int atr_period) -> [float, int]`
    ...
    return _lib.Incr_fn_supertrend_71d3a4(ctx).collect(_25649_src=src, _25650_factor=factor, _25651_atr_period=atr_period)
...
`supertrend(series<float> src, float factor, int atr_period) -> [float, int]`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_supertrend_71d3a4(ctx)
        self.locals = SupertrendLocals(self.inner)

    def next(self, src: float, factor: float, atr_period: int) -> Optional[Tuple[float, int]]:
        return self.inner.next(_25649_src=src, _25650_factor=factor, _25651_atr_period=atr_period)
...
`awesome_oscillator(series<float> src, int slow_length = 5, int fast_length = 34) -> float`
    ...
    return _lib.Incr_fn_awesome_oscillator_b82f25(ctx).collect(_25653_src=src, _25654_slow_length=slow_length, _25655_fast_length=fast_length)
...
`awesome_oscillator(series<float> src, int slow_length = 5, int fast_length = 34) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_awesome_oscillator_b82f25(ctx)
    ...
    def next(self, src: float, slow_length: Optional[int], fast_length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25653_src=src, _25654_slow_length=slow_length, _25655_fast_length=fast_length)
...
`balance_of_power() -> series<float>`
    ...
    return _lib.Incr_fn_balance_of_power_a98252(ctx).collect()
...
`balance_of_power() -> series<float>`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_balance_of_power_a98252(ctx)
...
`bollinger_bands_pct_b(series<float> src, int length = 20, float mult = 2.0) -> series<float>`
    ...
    return _lib.Incr_fn_bollinger_bands_pct_b_3524c8(ctx).collect(_25660_src=src, _25661_length=length, _25662_mult=mult)
...
class BollingerBandsPctBLocals:
    ...
    @property
    def bbr(self) -> float:
        return self.__inner._25667_bbr()
...
`bollinger_bands_pct_b(series<float> src, int length = 20, float mult = 2.0) -> series<float>`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_bollinger_bands_pct_b_3524c8(ctx)
    ...
    def next(self, src: float, length: Optional[int], mult: Optional[float]) -> Optional[float]:
        return self.inner.next(_25660_src=src, _25661_length=length, _25662_mult=mult)
...
`bollinger_bands_width(series<float> src, int length = 20, float mult = 2.0) -> float`
    ...
    return _lib.Incr_fn_bollinger_bands_width_20abf5(ctx).collect(_25669_src=src, _25670_length=length, _25671_mult=mult)
...
`bollinger_bands_width(series<float> src, int length = 20, float mult = 2.0) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_bollinger_bands_width_20abf5(ctx)
        self.locals = BollingerBandsWidthLocals(self.inner)

    def next(self, src: float, length: Optional[int], mult: Optional[float]) -> Optional[float]:
        return self.inner.next(_25669_src=src, _25670_length=length, _25671_mult=mult)
...
`bollinger_bands(series<float> src, int length = 20, float mult = 2.0) -> [float, float]`
    ...
    return _lib.Incr_fn_bollinger_bands_aca737(ctx).collect(_25678_src=src, _25679_length=length, _25680_mult=mult)
...
`bollinger_bands(series<float> src, int length = 20, float mult = 2.0) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_bollinger_bands_aca737(ctx)
    ...
    def next(self, src: float, length: Optional[int], mult: Optional[float]) -> Optional[Tuple[float, float]]:
        return self.inner.next(_25678_src=src, _25679_length=length, _25680_mult=mult)
...
`chaikin_money_flow(int length = 20) -> float`
    ...
    return _lib.Incr_fn_chaikin_money_flow_b2a309(ctx).collect(_25686_length=length)
...
class ChaikinMoneyFlowLocals:
    ...
    def cumVol(self) -> float:
        return self.__inner._25687_cumVol()
  

    @property
    def ad(self) -> float:
        return self.__inner._25688_ad()
...
`chaikin_money_flow(int length = 20) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_chaikin_money_flow_b2a309(ctx)
        self.locals = ChaikinMoneyFlowLocals(self.inner)

    def next(self, length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25686_length=length)
...
`chande_kroll_stop(int atr_length = 10, float atr_coeff = 1.0, int stop_length = 9) -> [float, float]`
    ...
    return _lib.Incr_fn_chande_kroll_stop_078a9c(ctx).collect(_25691_atr_length=atr_length, _25692_atr_coeff=atr_coeff, _25693_stop_length=stop_length)
...
`chande_kroll_stop(int atr_length = 10, float atr_coeff = 1.0, int stop_length = 9) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_chande_kroll_stop_078a9c(ctx)
    ...
    def next(self, atr_length: Optional[int], atr_coeff: Optional[float], stop_length: Optional[int]) -> Optional[Tuple[float, float]]:
        return self.inner.next(_25691_atr_length=atr_length, _25692_atr_coeff=atr_coeff, _25693_stop_length=stop_length)
...
`choppiness_index(int length = 14) -> float`
    ...
    return _lib.Incr_fn_choppiness_index_1f07b6(ctx).collect(_25702_length=length)
...
`choppiness_index(int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_choppiness_index_1f07b6(ctx)
        self.locals = ChoppinessIndexLocals(self.inner)

    def next(self, length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25702_length=length)
...
`coppock_curve(series<float> src, int wma_length = 10, int long_roc_length = 14, int short_roc_length = 11) -> float`
    ...
    return _lib.Incr_fn_coppock_curve_91058b(ctx).collect(_25704_src=src, _25705_wma_length=wma_length, _25706_long_roc_length=long_roc_length, _25707_short_roc_length=short_roc_length)
...
`coppock_curve(series<float> src, int wma_length = 10, int long_roc_length = 14, int short_roc_length = 11) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_coppock_curve_91058b(ctx)
    ...
    def next(self, src: float, wma_length: Optional[int], long_roc_length: Optional[int], short_roc_length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25704_src=src, _25705_wma_length=wma_length, _25706_long_roc_length=long_roc_length, _25707_short_roc_length=short_roc_length)
...
`donchian_channel(series<float> src, int length = 20) -> [float, float, float]`
    ...
    return _lib.Incr_fn_donchian_channel_0ff796(ctx).collect(_25709_src=src, _25710_length=length)
...
`macd(series<float> src, int short_length = 12, int long_length = 26) -> float`
    ...
    return _lib.Incr_fn_macd_11279d(ctx).collect(_25715_src=src, _25716_short_length=short_length, _25717_long_length=long_length)
...
`macd(series<float> src, int short_length = 12, int long_length = 26) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_macd_11279d(ctx)
    ...
    def next(self, src: float, short_length: Optional[int], long_length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25715_src=src, _25716_short_length=short_length, _25717_long_length=long_length)
...
`price_oscillator(series<float> src, int short_length = 12, int long_length = 26) -> float`
    ...
    return _lib.Incr_fn_price_oscillator_a632fc(ctx).collect(_25720_src=src, _25721_short_length=short_length, _25722_long_length=long_length)
...
`price_oscillator(series<float> src, int short_length = 12, int long_length = 26) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_price_oscillator_a632fc(ctx)
        self.locals = PriceOscillatorLocals(self.inner)

    def next(self, src: float, short_length: Optional[int], long_length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25720_src=src, _25721_short_length=short_length, _25722_long_length=long_length)
...
`relative_vigor_index(int length = 14) -> float`
    ...
    return _lib.Incr_fn_relative_vigor_index_9af6c4(ctx).collect(_25727_length=length)
...
`relative_vigor_index(int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_relative_vigor_index_9af6c4(ctx)
        self.locals = RelativeVigorIndexLocals(self.inner)

    def next(self, length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25727_length=length)
...
`relative_volatility_index(series<float> src, int length = 14) -> float`
    ...
    return _lib.Incr_fn_relative_volatility_index_768041(ctx).collect(_25729_src=src, _25730_length=length)
...
`relative_volatility_index(series<float> src, int length = 14) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_relative_volatility_index_768041(ctx)
        self.locals = RelativeVolatilityIndexLocals(self.inner)

    def next(self, src: float, length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25729_src=src, _25730_length=length)
...
`ultimate_oscillator(int fast_length = 7, int medium_length = 14, int slow_length = 28) -> float`
    ...
    return _lib.Incr_fn_ultimate_oscillator_6be8db(ctx).collect(_25740_fast_length=fast_length, _25741_medium_length=medium_length, _25742_slow_length=slow_length)
...
`ultimate_oscillator(int fast_length = 7, int medium_length = 14, int slow_length = 28) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_ultimate_oscillator_6be8db(ctx)
    ...
    def next(self, fast_length: Optional[int], medium_length: Optional[int], slow_length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25740_fast_length=fast_length, _25741_medium_length=medium_length, _25742_slow_length=slow_length)
...
`volume_oscillator(int short_length = 5, int long_length = 10) -> float`
    ...
    return _lib.Incr_fn_volume_oscillator_a8d339(ctx).collect(_25752_short_length=short_length, _25753_long_length=long_length)
...
`volume_oscillator(int short_length = 5, int long_length = 10) -> float`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_volume_oscillator_a8d339(ctx)
    ...
    def next(self, short_length: Optional[int], long_length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25752_short_length=short_length, _25753_long_length=long_length)
...
`vortex_indicator(int length = 14) -> [float, float]`
    ...
    return _lib.Incr_fn_vortex_indicator_b16c68(ctx).collect(_25758_length=length)
...
`vortex_indicator(int length = 14) -> [float, float]`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_vortex_indicator_b16c68(ctx)
        self.locals = VortexIndicatorLocals(self.inner)

    def next(self, length: Optional[int]) -> Optional[Tuple[float, float]]:
        return self.inner.next(_25758_length=length)
...
`williams_pct_r(series<float> src, int length = 14) -> series<float>`
    ...
    return _lib.Incr_fn_williams_pct_r_87021a(ctx).collect(_25765_src=src, _25766_length=length)
...
class WilliamsPctRLocals:
    ...
    def wpctr(self) -> float:
        return self.__inner._25769_wpctr()
...
`williams_pct_r(series<float> src, int length = 14) -> series<float>`
    ...
    def __init__(self, ctx: Ctx):
        self.ctx = ctx
        self.inner = _lib.Incr_fn_williams_pct_r_87021a(ctx)
        self.locals = WilliamsPctRLocals(self.inner)

    def next(self, src: float, length: Optional[int]) -> Optional[float]:
        return self.inner.next(_25765_src=src, _25766_length=length)
