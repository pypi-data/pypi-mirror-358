...
__all__ = ["DocumentCreateMultipleSectionsParams"]


class DocumentCreateMultipleSectionsParams(TypedDict, total=False):
    sections: Required[Iterable[CreateDocumentSectionParam]]
