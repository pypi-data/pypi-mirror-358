...
__all__ = ["DocumentUpdateMultipleSectionsParams", "Section", "SectionDescription"]


class DocumentUpdateMultipleSectionsParams(TypedDict, total=False):
    sections: Required[Iterable[Section]]

    context: BaseRequestContextParam


SectionDescription: TypeAlias = Union[DraftjsParam, Optional[object]]
