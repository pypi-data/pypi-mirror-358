...
def start_event_engine(remote_json_url: str, slack_webhook: WebhookClient = None, custom_scrapers: dict[Publisher, list[CustomScraperJob]] = None,
                       test_mode: bool = False, cache_db: SQLiteDB = None):
    ...
    while True:
        ...
        cache_db: SQLiteDB = cache_db if cache_db is not None else SQLiteDB(test_mode)
