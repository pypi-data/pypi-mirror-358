...
def update_coverage():
    ...
    if os.path.exists(COVERAGE_FILE):
        with open(COVERAGE_FILE, "rb") as fh:
    ...
    with open(COVERAGE_FILE, "wb") as fh:
...
if __name__ == "__main__":
    with open("CMakeLists.txt", "rb") as fh:
        data = cPickle.load(COVERAGE_FILE)
    lines = data["lines"]
