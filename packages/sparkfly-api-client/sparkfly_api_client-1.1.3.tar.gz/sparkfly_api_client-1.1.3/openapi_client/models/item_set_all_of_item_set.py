...
class ItemSetAllOfItemSet(BaseModel):
    ...
    manufacturer_name: Optional[Any] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if manufacturer_name (nullable) is None
        # and model_fields_set contains the field
        if self.manufacturer_name is None and "manufacturer_name" in self.model_fields_set:
            _dict['manufacturer_name'] = None
