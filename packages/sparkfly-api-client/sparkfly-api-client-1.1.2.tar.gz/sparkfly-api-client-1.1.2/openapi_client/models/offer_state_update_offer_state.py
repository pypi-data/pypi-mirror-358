...
class OfferStateUpdateOfferState(BaseModel):
    ...
    offer_value_required: Optional[Any] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if offer_value_required (nullable) is None
        # and model_fields_set contains the field
        if self.offer_value_required is None and "offer_value_required" in self.model_fields_set:
            _dict['offer_value_required'] = None
