...
class OfferAllOfOffer(BaseModel):
    ...
    manufacturer_id: Optional[Any] = None
    name: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    description_template_id: Optional[Any] = None
    ...
    terms_and_conditions_template_id: Optional[Any] = None
    quest_only: Optional[Any] = None
    ...
    trigger_amount: Optional[Any] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if manufacturer_id (nullable) is None
        # and model_fields_set contains the field
        if self.manufacturer_id is None and "manufacturer_id" in self.model_fields_set:
            _dict['manufacturer_id'] = None

        # set to None if description_template_id (nullable) is None
        # and model_fields_set contains the field
        if self.description_template_id is None and "description_template_id" in self.model_fields_set:
            _dict['description_template_id'] = None

        # set to None if terms_and_conditions_template_id (nullable) is None
        # and model_fields_set contains the field
        if self.terms_and_conditions_template_id is None and "terms_and_conditions_template_id" in self.model_fields_set:
            _dict['terms_and_conditions_template_id'] = None

        # set to None if quest_only (nullable) is None
        # and model_fields_set contains the field
        if self.quest_only is None and "quest_only" in self.model_fields_set:
            _dict['quest_only'] = None
        ...
        # set to None if trigger_amount (nullable) is None
        # and model_fields_set contains the field
        if self.trigger_amount is None and "trigger_amount" in self.model_fields_set:
            _dict['trigger_amount'] = None
