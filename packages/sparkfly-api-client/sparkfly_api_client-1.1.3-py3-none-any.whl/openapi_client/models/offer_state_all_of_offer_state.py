...
class OfferStateAllOfOfferState(BaseModel):
    ...
    credential_custom_data: Optional[Any] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if credential_custom_data (nullable) is None
        # and model_fields_set contains the field
        if self.credential_custom_data is None and "credential_custom_data" in self.model_fields_set:
            _dict['credential_custom_data'] = None
