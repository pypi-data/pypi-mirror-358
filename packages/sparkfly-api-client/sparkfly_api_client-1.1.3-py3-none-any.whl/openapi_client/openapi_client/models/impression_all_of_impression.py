...
class ImpressionAllOfImpression(BaseModel):
    ...
    channel_name: Optional[Any] = None
    creative_name: Optional[Any] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if creative_name (nullable) is None
        # and model_fields_set contains the field
        if self.creative_name is None and "creative_name" in self.model_fields_set:
            _dict['creative_name'] = None
