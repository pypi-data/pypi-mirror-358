...
from ..exceptions._error_msg import ERROR_MSG_0018, ERROR_MSG_0014
...
class WeChatSend:
    ...
    def __upload_file(self, file):
        ...
        res = requests.post(url=self.notice_config.webhook, files=data, proxies={'http': None, 'https': None}).json()
        return res['media_id']
