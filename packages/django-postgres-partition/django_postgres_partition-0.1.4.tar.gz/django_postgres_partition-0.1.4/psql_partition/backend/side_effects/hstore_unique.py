from psql_partition.fields import HStoreField
...
class HStoreUniqueSchemaEditorSideEffect:
    ...
    sql_hstore_unique_rename = "ALTER INDEX {old_name} RENAME TO {new_name}"
    ...
    def alter_field(self, model, old_field, new_field, strict=False):
        ...
        for keys in old_uniqueness:
            if keys not in new_uniqueness:
                self._drop_hstore_unique(model, old_field, self._compose_keys(keys))
