...
class Group(BaseModel):
    ...
    @validator("icon")
    def icon_validator(cls, v) -> str:  # noqa: N805, ANN001
...
class MetadataConfig(BaseModel):
    """Represents default Luma metadata fields configuration.

    Attributes:
        fields (str): The fields to include.
        value (str): The value of the metadata configuration.
    """
...
class Config(BaseModel):
    ...
    def validate_unique(cls, values: dict) -> dict:  # noqa: N805
