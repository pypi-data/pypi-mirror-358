...
####+BEGIN: b:py3:cs:func/typing :funcName "platformBpoId" :funcType "extTyped" :deco "track"
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  F-T-extTyped [[elisp:(outline-show-subtree+toggle)][||]] /platformBpoId/  deco=track  [[elisp:(org-cycle)][| ]]
#+end_org """
...
** [[elisp:(org-cycle)][| *DocStr | ]
    ...
    fileParam = b.fp.FileParamReadFromPath(parRoot="/bisos/var/bpoId/sysChar.fp",)
    return str(fileParam.parValueGet())
