...
** This File: /bisos/git/bxRepos/bisos-pip/platform/py3/bisos/platform/bxPlatformThis.py
...
#+end_org """
import typing
csInfo: typing.Dict[str, typing.Any] = { 'moduleName': ['bxPlatformThis'], }
csInfo['version'] = '202502113746'
csInfo['status']  = 'inUse'
csInfo['panel'] = 'bxPlatformThis-Panel.org'
...
####+BEGIN: b:py3:cs:cmnd/classHead :cmndName "thisPkgPlatform_libOverview" :comment "" :parsMand "" :parsOpt "" :argsMin 0 :argsMax 3 :pyInv ""
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  CmndSvc-   [[elisp:(outline-show-subtree+toggle)][||]] <<thisPkgPlatform_libOverview>>  =verify= argsMax=3 ro=cli   [[elisp:(org-cycle)][| ]]
#+end_org """
class thisPkgPlatform_libOverview(cs.Cmnd):
    cmndParamsMandatory = [ ]
    cmndParamsOptional = [ ]
