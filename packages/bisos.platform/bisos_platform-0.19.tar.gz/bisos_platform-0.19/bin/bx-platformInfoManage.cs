...
** This File: /bisos/git/bxRepos/bisos-pip/platform/py3/bin/bx-platformInfoManage.py
...
#+end_org """
import typing
csInfo: typing.Dict[str, typing.Any] = { 'moduleName': ['bx-platformInfoManage'], }
csInfo['version'] = '202502112757'
csInfo['status']  = 'inUse'
csInfo['panel'] = 'bx-platformInfoManage-Panel.org'
...
#+END_SRC
#+RESULTS:
| bisos.b.cs.ro | bisos.csPlayer.bleep | bisos.platform.bxPlatformConfig |
#+end_org """
...
csuList = [ 'bisos.b.cs.ro', 'bisos.csPlayer.bleep', 'bisos.platform.bxPlatformConfig', ]
