...
** This File: /bisos/git/bxRepos/bisos-pip/platform/py3/bin/platformStub.cs
...
#+end_org """
import typing
csInfo: typing.Dict[str, typing.Any] = { 'moduleName': ['platformStub'], }
csInfo['version'] = '202502132208'
csInfo['status']  = 'inUse'
csInfo['panel'] = 'platformStub-Panel.org'
...
***** [[elisp:(org-cycle)][| *CmndDesc:* | ]]  Conventional top level example.
        ...
        cmnd('startingPoint', args="""'firstArg' 'SecondArg'""")
...
####+BEGIN: b:py3:cs:cmnd/classHead :cmndName "startingPoint" :comment "" :extent "verify" :ro "cli" :parsMand "" :parsOpt "" :argsMin 1 :argsMax 9999 :pyInv ""
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  CmndSvc-   [[elisp:(outline-show-subtree+toggle)][||]] <<startingPoint>>  =verify= argsMin=1 argsMax=9999 ro=cli   [[elisp:(org-cycle)][| ]]
#+end_org """
class startingPoint(cs.Cmnd):
    cmndParamsMandatory = [ ]
    cmndParamsOptional = [ ]
...
** [[elisp:(org-cycle)][| *CmndDesc:* | ]]  A starting point command.
        ...
        processedParamsAndArgs = f"""args={joinedRunArgs}"""

        if b.subProc.WOpW(invedBy=self, log=1).bash(
                f"""\
echo 'Provided Params and Args were: {processedParamsAndArgs} \
This is a place holder. It uses platform module to create what is needed \
in ~/bisos.\n \
It is to be tested with facter.cs first.'
                """,
