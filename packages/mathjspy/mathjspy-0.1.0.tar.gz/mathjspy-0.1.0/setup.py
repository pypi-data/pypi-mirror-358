...
try:
    with open(os.path.join(here, 'README.rst'),  "r", encoding="utf-8") as rstf:
        README = rstf.read()
...
__url__ = 'https://mathjspy.readthedocs.org'
__downloadUrl__ = "https://bitbucket.org/amorris/mathjspy/downloads"
