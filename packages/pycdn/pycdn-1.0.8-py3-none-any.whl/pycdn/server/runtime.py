...
def install_package(package_name: str) -> bool:
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            log_debug(f"Failed to install {package_name}: {result.stderr}")
            return False
            ...
            if self.auto_install:
                ...
                if install_package(self.package_name):
                    ...
                    try:
                        ...
                        raise ImportError(f"Failed to load package {self.package_name} even after installation: {import_error}")
                else:
