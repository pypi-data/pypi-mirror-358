...
public:
    ...
    virtual int PyContext_ClearFreeList() = 0;
    ...
    virtual int PyDict_ClearFreeList() = 0;
    ...
    virtual int PyFloat_ClearFreeList() = 0;
    ...
    virtual void PyImport_Cleanup() = 0;
    ...
    virtual int PyList_ClearFreeList() = 0;
    ...
    virtual PyObject* PyLong_FromUnicode(Py_UNICODE* p0, Py_ssize_t p1, int p2) = 0;
    ...
    virtual int PyMethod_ClearFreeList() = 0;
    ...
    virtual void PyOS_InitInterrupts() = 0;
    ...
    virtual int PySet_ClearFreeList() = 0;
    ...
    virtual int PyTuple_ClearFreeList() = 0;
    ...
    virtual PyObject* PyType_GenericAlloc(struct _typeobject* p0, Py_ssize_t p1) = 0;

    virtual PyObject* PyType_GenericNew(struct _typeobject* p0, PyObject* p1, PyObject* p2) = 0;

    virtual unsigned long PyType_GetFlags(struct _typeobject* p0) = 0;

    virtual void* PyType_GetSlot(struct _typeobject* p0, int p1) = 0;

    virtual int PyType_IsSubtype(struct _typeobject* p0, struct _typeobject* p1) = 0;

    virtual void PyType_Modified(struct _typeobject* p0) = 0;

    virtual int PyType_Ready(struct _typeobject* p0) = 0;
    ...
    virtual Py_UNICODE* Py_UNICODE_strcat(Py_UNICODE* s1, const Py_UNICODE* s2) = 0;

    virtual Py_UNICODE* Py_UNICODE_strchr(const Py_UNICODE* s, Py_UNICODE c) = 0;

    virtual int Py_UNICODE_strcmp(const Py_UNICODE* s1, const Py_UNICODE* s2) = 0;

    virtual Py_UNICODE* Py_UNICODE_strcpy(Py_UNICODE* s1, const Py_UNICODE* s2) = 0;

    virtual size_t Py_UNICODE_strlen(const Py_UNICODE* u) = 0;

    virtual int Py_UNICODE_strncmp(const Py_UNICODE* s1, const Py_UNICODE* s2, size_t n) = 0;

    virtual Py_UNICODE* Py_UNICODE_strncpy(Py_UNICODE* s1, const Py_UNICODE* s2, size_t n) = 0;

    virtual Py_UNICODE* Py_UNICODE_strrchr(const Py_UNICODE* s, Py_UNICODE c) = 0;
