...
virtual PyObject* PyType_GetModule(struct _typeobject* p0) override {
return ::PyType_GetModule(p0);
}

virtual void* PyType_GetModuleState(struct _typeobject* p0) override {
...
virtual void Py_UNICODE_COPY(Py_UNICODE* target, const Py_UNICODE* source, Py_ssize_t length) override {
return ::Py_UNICODE_COPY(target, source, length);
}

virtual void Py_UNICODE_FILL(Py_UNICODE* target, Py_UNICODE value, Py_ssize_t length) override {
return ::Py_UNICODE_FILL(target, value, length);
}
