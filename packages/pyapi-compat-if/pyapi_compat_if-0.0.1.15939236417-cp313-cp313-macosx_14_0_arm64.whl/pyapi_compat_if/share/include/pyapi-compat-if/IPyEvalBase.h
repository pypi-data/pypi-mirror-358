...
public:
    ...
    virtual int PyArg_VaParseTupleAndKeywords(PyObject* p0, PyObject* p1, const char* p2, char* const* p3, va_list p4) = 0;
    ...
    virtual int PyDict_ClearWatcher(int watcher_id) = 0;

    virtual int PyDict_Contains(PyObject* mp, PyObject* key) = 0;

    virtual int PyDict_ContainsString(PyObject* mp, const char* key) = 0;
    ...
    virtual int PyDict_GetItemRef(PyObject* mp, PyObject* key, PyObject** result) = 0;

    virtual PyObject* PyDict_GetItemString(PyObject* dp, const char* key) = 0;

    virtual int PyDict_GetItemStringRef(PyObject* mp, const char* key, PyObject** result) = 0;
    ...
    virtual int PyDict_Pop(PyObject* dict, PyObject* key, PyObject** result) = 0;

    virtual int PyDict_PopString(PyObject* dict, const char* key, PyObject** result) = 0;

    virtual PyObject* PyDict_SetDefault(PyObject* mp, PyObject* key, PyObject* defaultobj) = 0;

    virtual int PyDict_SetDefaultRef(PyObject* mp, PyObject* key, PyObject* default_value, PyObject** result) = 0;
    ...
    virtual int PyDict_Unwatch(int watcher_id, PyObject* dict) = 0;

    virtual int PyDict_Update(PyObject* mp, PyObject* other) = 0;

    virtual PyObject* PyDict_Values(PyObject* mp) = 0;

    virtual int PyDict_Watch(int watcher_id, PyObject* dict) = 0;
    ...
    virtual void PyErr_DisplayException(PyObject* p0) = 0;
    ...
    virtual PyObject* PyErr_GetHandledException() = 0;

    virtual PyObject* PyErr_GetRaisedException() = 0;
    ...
    virtual void PyErr_SetHandledException(PyObject* p0) = 0;
    ...
    virtual void PyErr_SetRaisedException(PyObject* p0) = 0;
    ...
    virtual PyObject* PyEval_GetFrameBuiltins() = 0;

    virtual PyObject* PyEval_GetFrameGlobals() = 0;

    virtual PyObject* PyEval_GetFrameLocals() = 0;
    ...
    virtual PyObject* PyException_GetArgs(PyObject* p0) = 0;
    ...
    virtual void PyException_SetArgs(PyObject* p0, PyObject* p1) = 0;
    ...
    virtual int PyFloat_Pack2(double x, char* p, int le) = 0;

    virtual int PyFloat_Pack4(double x, char* p, int le) = 0;

    virtual int PyFloat_Pack8(double x, char* p, int le) = 0;

    virtual double PyFloat_Unpack2(const char* p, int le) = 0;

    virtual double PyFloat_Unpack4(const char* p, int le) = 0;

    virtual double PyFloat_Unpack8(const char* p, int le) = 0;
    ...
    virtual PyObject* PyImport_AddModuleRef(const char* name) = 0;
    ...
    virtual int PyList_Clear(PyObject* self) = 0;

    virtual int PyList_Extend(PyObject* self, PyObject* iterable) = 0;

    virtual PyObject* PyList_GetItem(PyObject* p0, Py_ssize_t p1) = 0;

    virtual PyObject* PyList_GetItemRef(PyObject* p0, Py_ssize_t p1) = 0;
    ...
    virtual int PyLong_AsInt(PyObject* p0) = 0;
    ...
    virtual Py_ssize_t PyLong_AsNativeBytes(PyObject* v, void* buffer, Py_ssize_t n_bytes, int flags) = 0;
    ...
    virtual PyObject* PyLong_FromNativeBytes(const void* buffer, size_t n_bytes, int flags) = 0;
    ...
    virtual PyObject* PyLong_FromUnsignedNativeBytes(const void* buffer, size_t n_bytes, int flags) = 0;
    ...
    virtual int PyMapping_GetOptionalItem(PyObject* p0, PyObject* p1, PyObject** p2) = 0;

    virtual int PyMapping_GetOptionalItemString(PyObject* p0, const char* p1, PyObject** p2) = 0;

    virtual int PyMapping_HasKey(PyObject* o, PyObject* key) = 0;

    virtual int PyMapping_HasKeyString(PyObject* o, const char* key) = 0;

    virtual int PyMapping_HasKeyStringWithError(PyObject* o, const char* key) = 0;

    virtual int PyMapping_HasKeyWithError(PyObject* o, PyObject* key) = 0;
    ...
    virtual void PyObject_ClearManagedDict(PyObject* obj) = 0;

    virtual void PyObject_ClearWeakRefs(PyObject* p0) = 0;

    virtual int PyObject_CopyData(PyObject* dest, PyObject* src) = 0;

    virtual int PyObject_DelAttr(PyObject* v, PyObject* name) = 0;

    virtual int PyObject_DelAttrString(PyObject* v, const char* name) = 0;
    ...
    virtual void* PyObject_GetItemData(PyObject* obj) = 0;

    virtual PyObject* PyObject_GetIter(PyObject* p0) = 0;

    virtual int PyObject_GetOptionalAttr(PyObject* p0, PyObject* p1, PyObject** p2) = 0;

    virtual int PyObject_GetOptionalAttrString(PyObject* p0, const char* p1, PyObject** p2) = 0;

    virtual void* PyObject_GetTypeData(PyObject* obj, PyTypeObject* cls) = 0;

    virtual int PyObject_HasAttr(PyObject* p0, PyObject* p1) = 0;

    virtual int PyObject_HasAttrString(PyObject* p0, const char* p1) = 0;

    virtual int PyObject_HasAttrStringWithError(PyObject* p0, const char* p1) = 0;

    virtual int PyObject_HasAttrWithError(PyObject* p0, PyObject* p1) = 0;
    ...
    virtual int PyType_ClearWatcher(int watcher_id) = 0;
    ...
    virtual PyObject* PyType_GetDict(PyTypeObject* p0) = 0;

    virtual unsigned long PyType_GetFlags(PyTypeObject* p0) = 0;

    virtual PyObject* PyType_GetFullyQualifiedName(PyTypeObject* type) = 0;

    virtual PyObject* PyType_GetModule(PyTypeObject* p0) = 0;

    virtual PyObject* PyType_GetModuleName(PyTypeObject* type) = 0;

    virtual void* PyType_GetModuleState(PyTypeObject* p0) = 0;

    virtual PyObject* PyType_GetName(PyTypeObject* p0) = 0;

    virtual PyObject* PyType_GetQualName(PyTypeObject* p0) = 0;

    virtual void* PyType_GetSlot(PyTypeObject* p0, int p1) = 0;

    virtual Py_ssize_t PyType_GetTypeDataSize(PyTypeObject* cls) = 0;
    ...
    virtual int PyType_SUPPORTS_WEAKREFS(PyTypeObject* type) = 0;

    virtual int PyType_Unwatch(int watcher_id, PyObject* type) = 0;

    virtual int PyType_Watch(int watcher_id, PyObject* type) = 0;
    ...
    virtual char* Py_GETENV(const char* name) = 0;
    ...
    virtual PyObject* Py_GetConstant(unsigned int constant_id) = 0;

    virtual PyObject* Py_GetConstantBorrowed(unsigned int constant_id) = 0;
