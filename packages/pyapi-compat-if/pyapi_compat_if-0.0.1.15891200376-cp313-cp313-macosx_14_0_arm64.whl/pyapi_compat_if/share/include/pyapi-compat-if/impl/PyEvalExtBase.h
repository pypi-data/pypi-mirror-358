...
virtual int PyArg_VaParseTupleAndKeywords(PyObject* p0, PyObject* p1, const char* p2, char* const* p3, va_list p4) override {
...
virtual int PyDict_ContainsString(PyObject* mp, const char* key) override {
return ::PyDict_ContainsString(mp, key);
}
...
virtual int PyDict_GetItemRef(PyObject* mp, PyObject* key, PyObject** result) override {
...
virtual int PyDict_GetItemStringRef(PyObject* mp, const char* key, PyObject** result) override {
...
virtual int PyDict_Pop(PyObject* dict, PyObject* key, PyObject** result) override {
return ::PyDict_Pop(dict, key, result);
}

virtual int PyDict_PopString(PyObject* dict, const char* key, PyObject** result) override {
...
virtual int PyDict_SetDefaultRef(PyObject* mp, PyObject* key, PyObject* default_value, PyObject** result) override {
return ::PyDict_SetDefaultRef(mp, key, default_value, result);
}
...
virtual PyObject* PyEval_GetFrameBuiltins() override {
return ::PyEval_GetFrameBuiltins();
}

virtual PyObject* PyEval_GetFrameGlobals() override {
return ::PyEval_GetFrameGlobals();
}

virtual PyObject* PyEval_GetFrameLocals() override {
...
virtual PyObject* PyImport_AddModuleRef(const char* name) override {
...
virtual int PyList_Clear(PyObject* self) override {
return ::PyList_Clear(self);
}

virtual int PyList_Extend(PyObject* self, PyObject* iterable) override {
return ::PyList_Extend(self, iterable);
}
...
virtual PyObject* PyList_GetItemRef(PyObject* p0, Py_ssize_t p1) override {
return ::PyList_GetItemRef(p0, p1);
}
...
virtual int PyLong_AsInt(PyObject* p0) override {
return ::PyLong_AsInt(p0);
}
...
virtual Py_ssize_t PyLong_AsNativeBytes(PyObject* v, void* buffer, Py_ssize_t n_bytes, int flags) override {
return ::PyLong_AsNativeBytes(v, buffer, n_bytes, flags);
}
...
virtual PyObject* PyLong_FromNativeBytes(const void* buffer, size_t n_bytes, int flags) override {
return ::PyLong_FromNativeBytes(buffer, n_bytes, flags);
}
...
virtual PyObject* PyLong_FromUnsignedNativeBytes(const void* buffer, size_t n_bytes, int flags) override {
return ::PyLong_FromUnsignedNativeBytes(buffer, n_bytes, flags);
}
...
virtual int PyMapping_GetOptionalItem(PyObject* p0, PyObject* p1, PyObject** p2) override {
return ::PyMapping_GetOptionalItem(p0, p1, p2);
}

virtual int PyMapping_GetOptionalItemString(PyObject* p0, const char* p1, PyObject** p2) override {
return ::PyMapping_GetOptionalItemString(p0, p1, p2);
}
...
virtual int PyMapping_HasKeyStringWithError(PyObject* o, const char* key) override {
return ::PyMapping_HasKeyStringWithError(o, key);
}

virtual int PyMapping_HasKeyWithError(PyObject* o, PyObject* key) override {
return ::PyMapping_HasKeyWithError(o, key);
}
...
virtual void PyObject_ClearManagedDict(PyObject* obj) override {
return ::PyObject_ClearManagedDict(obj);
}
...
virtual int PyObject_DelAttr(PyObject* v, PyObject* name) override {
return ::PyObject_DelAttr(v, name);
}

virtual int PyObject_DelAttrString(PyObject* v, const char* name) override {
return ::PyObject_DelAttrString(v, name);
}
...
virtual int PyObject_GetOptionalAttr(PyObject* p0, PyObject* p1, PyObject** p2) override {
return ::PyObject_GetOptionalAttr(p0, p1, p2);
}

virtual int PyObject_GetOptionalAttrString(PyObject* p0, const char* p1, PyObject** p2) override {
return ::PyObject_GetOptionalAttrString(p0, p1, p2);
}
...
virtual int PyObject_HasAttrStringWithError(PyObject* p0, const char* p1) override {
return ::PyObject_HasAttrStringWithError(p0, p1);
}

virtual int PyObject_HasAttrWithError(PyObject* p0, PyObject* p1) override {
return ::PyObject_HasAttrWithError(p0, p1);
}
...
virtual PyObject* PyType_GetFullyQualifiedName(PyTypeObject* type) override {
...
virtual PyObject* PyType_GetModuleName(PyTypeObject* type) override {
...
virtual PyObject* Py_GetConstant(unsigned int constant_id) override {
return ::Py_GetConstant(constant_id);
}

virtual PyObject* Py_GetConstantBorrowed(unsigned int constant_id) override {
...
virtual int Py_IsFinalizing() override {
