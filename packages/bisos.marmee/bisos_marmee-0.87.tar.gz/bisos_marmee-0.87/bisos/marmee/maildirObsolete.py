...
** [[elisp:(org-cycle)][| *DocStr | ]
    ...
    envFullPathPars = od([('bpoId', bpoId ), ('envRelPath', f"{envRelPath}/alias"),])
    cmnd('envMaildirCreate', args="main", pars=envFullPathPars, comment=f" # ")

    envFullPathPars = od([('bpoId', bpoId ), ('envRelPath', f"{envRelPath}/bystar"),])
    cmnd('envMaildirCreate', args="main", pars=envFullPathPars, comment=f" # ")

    envFullPathPars = od([('bpoId', bpoId ), ('envRelPath', f"{envRelPath}/bisos"),])
    cmnd('envMaildirCreate', args="main", pars=envFullPathPars, comment=f" # ")
