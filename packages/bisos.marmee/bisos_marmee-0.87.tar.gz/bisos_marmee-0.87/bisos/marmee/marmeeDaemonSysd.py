...
** This File: /bisos/git/auth/bxRepos/bisos-pip/marmee/py3/bisos/marmee/marmeeDaemonSysd.py
...
####+BEGIN: b:py3:class/decl :className "ConfigFile_sysdMarmee" :superClass "configFile.ConfigFile" :comment "" :classType "basic"
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  Cls-basic  [[elisp:(outline-show-subtree+toggle)][||]] /ConfigFile_sysdMarmee/  superClass=configFile.ConfigFile  [[elisp:(org-cycle)][| ]]
#+end_org """
class ConfigFile_sysdMarmee(configFile.ConfigFile):
####+END:
    """ #+begin_org
...
*** [[elisp:(org-cycle)][| DocStr| ]]  Return path NOTYET
        #+end_org """
        serviceFilePath = sysdUnitMarmee.serviceFilePath()
...
*** [[elisp:(org-cycle)][| DocStr| ]]  Returns string NOTYET
        ...
        templateStr = """
[Unit]
Description=Marmee Service
Documentation=man:marmee(1)

[Service]
ExecStart=/bisos/venv/py3/dev-bisos3/bin/python3 /bisos/git/auth/bxRepos/bisos-pip/marmee/py3/bin/marmeeDaemonSysd.cs -i sysdCmndMarmee
Restart=always
RestartSec=60
...
sysdConfigMarmee = ConfigFile_sysdMarmee("NOTYET")
sysdUnitMarmee = bifSystemd.UserUnit("marmee")
...
** [[elisp:(org-cycle)][| *DocStr | ] Examples of Service Access Instance Commands.
    ...
    #
    configFile.examples_csu(concreteConfigFile='sysdConfigMarmee', sectionTitle="default")
    bifSystemd.examples_csuUserUnit(userUnitInstanceName='sysdUnitMarmee', sectionTitle="default")

    cs.examples.menuChapter('*Marmee Daemon Full Update*')

    cmndName = "marmeeDaemonFullUpdate" ;  cmndArgs = ""
    cps=cpsInit(); menuItem(verbosity='none') ; menuItem(verbosity='full')

    cmndName = "sysdCmndMarmee" ;  cmndArgs = ""
    cps=cpsInit(); menuItem(verbosity='none') ; menuItem(verbosity='full')


####+BEGIN: b:py3:cs:cmnd/classHead :cmndName "marmeeDaemonFullUpdate" :extent "verify" :parsMand "" :parsOpt "" :argsMin 0 :argsMax 0 :pyInv ""
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  CmndSvc-   [[elisp:(outline-show-subtree+toggle)][||]] <<marmeeDaemonFullUpdate>>  =verify= ro=cli   [[elisp:(org-cycle)][| ]]
#+end_org """
class marmeeDaemonFullUpdate(cs.Cmnd):
    cmndParamsMandatory = [ ]
    cmndParamsOptional = [ ]
...
** [[elisp:(org-cycle)][| *CmndDesc:* | ]] Return a dict of parName:parValue as results
        ...
        sysdConfigMarmee.configFileUpdate()

        path = sysdConfigMarmee.configFilePath()
        ...
        sysdUnitMarmee.reload()  # to have systemd aware of the unit files

        sysdUnitMarmee.start()
...
####+BEGIN: b:py3:cs:cmnd/classHead :cmndName "sysdCmndMarmee" :extent "verify" :parsMand "" :parsOpt "" :argsMin 0 :argsMax 0 :pyInv ""
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  CmndSvc-   [[elisp:(outline-show-subtree+toggle)][||]] <<sysdCmndMarmee>>  =verify= ro=cli   [[elisp:(org-cycle)][| ]]
#+end_org """
class sysdCmndMarmee(cs.Cmnd):
    cmndParamsMandatory = [ ]
    cmndParamsOptional = [ ]
    cmndArgsLen = {'Min': 0, 'Max': 0,}
...
** [[elisp:(org-cycle)][| *CmndDesc:* | ]] Return a dict of parName:parValue as results
        ...
        if b.subProc.Op(outcome=cmndOutcome, log=1).bash(
f"""/bisos/venv/py3/dev-bisos3/bin/python3 /bisos/git/auth/bxRepos/bisos-pip/marmee/py3/bin/marmeeOfflineimap.cs --bpoId="piu_mbFullUsage" --envRelPath="aas/marmee/gmail/mohsen.byname"  -i offlineimapRun""",
        ).isProblematic():  return(b_io.eh.badOutcome(cmndOutcome))
