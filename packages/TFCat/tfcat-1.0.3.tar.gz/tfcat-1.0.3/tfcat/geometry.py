...
"""
This file is adapted from: https://github.com/jazzband/geojson/blob/master/geojson/geometry.py
"""
...
class Polygon(Geometry):
    ...
    @classmethod
    def from_bbox(cls, time_range, spectral_range):
        return Polygon([
            [
                (time_range[0], spectral_range[0]),
                (time_range[1], spectral_range[0]),
                (time_range[1], spectral_range[1]),
                (time_range[0], spectral_range[1]),
                (time_range[0], spectral_range[0]),
            ]
        ])
