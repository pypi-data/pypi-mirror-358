...
def hive_reward_train(
        ...
        max_seq_length: int = typer.Option(128000, help="Maximum sequence length for the training."),
        alpaca_dataset_path: str = typer.Argument("", help="Path to the alpaca dataset for training."),
        logging_steps: int = typer.Option(10, help="Logging steps for the training."),
        save_steps: int = typer.Option(1000, help="Save steps for the training."),
        ...
        per_device_train_batch_size: int = typer.Option(1, help="Batch size per device for training."),
