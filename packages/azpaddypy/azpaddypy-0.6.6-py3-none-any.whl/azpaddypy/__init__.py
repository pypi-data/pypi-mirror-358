...
# Initialize default management configuration for direct imports
_default_management = AzureManagementDirector.build_default_management()
_default_config = AzureResourceDirector.build_default_config()

# Export commonly used services for direct import convenience
logger = _default_management.logger
identity = _default_management.identity
local_env_manager = _default_management.local_env_manager
keyvault = _default_management.keyvault
storage_account = _default_config.resources.storage_account

__all__ = [
    # Direct service exports
    "logger", "identity", "local_env_manager", "keyvault", "storage_account",
