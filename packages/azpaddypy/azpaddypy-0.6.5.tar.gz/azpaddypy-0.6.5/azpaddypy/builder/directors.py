...
class ConfigurationSetupDirector:
    ...
    def build_default_setup():
        ...
        return (ConfigurationSetupBuilder()
                ...
                }, in_docker=True, in_machine=True)  # Development storage only for local machine
...
class AzureConfigurationDirector:
...
AzureResourceDirector = AzureConfigurationDirector

__all__ = [
    "ConfigurationSetupDirector",
    "AzureManagementDirector", 
    "AzureConfigurationDirector",
