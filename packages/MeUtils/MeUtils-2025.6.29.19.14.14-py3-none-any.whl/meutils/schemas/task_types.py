...
class FluxTaskResponse(BaseModel):
    ...
    def __init__(self, /, **data: Any):
        ...
        if self.status is None and "queue.fal.run" not in str(self.result):  # 会误判其他渠道
            self.status = "Ready"
...
if __name__ == '__main__':
    ...
    data = {
        "model": "cogvideox",
        "request_id": "20250629150043d607940a649747a5",
        "task_status": "SUCCESS",
        "video_result": [
            {
                "cover_image_url": "https://aigc-files.bigmodel.cn/api/cogvideo/c68536f8-54b6-11f0-b1ba-f6ffae442cf3_cover_0.jpeg",
                "url": "https://aigc-files.bigmodel.cn/api/cogvideo/c68536f8-54b6-11f0-b1ba-f6ffae442cf3_0.mp4"
            }
        ]
    }
