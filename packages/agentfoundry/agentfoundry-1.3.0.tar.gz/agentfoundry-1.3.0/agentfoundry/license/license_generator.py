...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Generate a signed license file for AIgent.")
    ...
    parser.add_argument("--private-key", default="private.pem", help="Path to private RSA key")
