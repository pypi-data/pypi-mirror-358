        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.AccountingCategoriesAllResponse(
                get_categories_response=utils.unmarshal_json(
                    http_res.text, Optional[models.GetCategoriesResponse]
                ),
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.AccountingCategoriesOneResponse(
                get_category_response=utils.unmarshal_json(
                    http_res.text, Optional[models.GetCategoryResponse]
                ),
                http_meta=models.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, "400", "application/json"):
