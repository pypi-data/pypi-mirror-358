...
def get_ksa_details(skill: str, description: str, model_id, use_gpu, tokenizer=None, model=None, num_key_kr: int = 3, num_key_tas: int = 3):    
    """
    ...
    try:
        raw_text = llm_router(prompt, model_id, use_gpu, tokenizer, model)        # Attempt to locate JSON object within the text
