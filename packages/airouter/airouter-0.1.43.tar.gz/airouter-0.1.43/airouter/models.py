...
provider_strings = [provider.value for provider in ProviderName]
...
class LLM(str, Enum):
  ...
  ANTHROPIC_CLAUDE_V4_SONNET = "arn:aws:bedrock:us-east-1:740126131356:inference-profile/us.anthropic.claude-sonnet-4-20250514-v1:0"
  ANTHROPIC_CLAUDE_V4_OPUS = "arn:aws:bedrock:us-east-1:740126131356:inference-profile/us.anthropic.claude-opus-4-20250514-v1:0"
...
def process_llm(llm: t.Union[str, LLM]) -> t.Tuple[ProviderName, LLM]:
  ...
  if isinstance(llm, str):
    str_llm = llm
    if "/" in str_llm and any(x in str_llm for x in provider_strings):
      tokens = str_llm.split("/")
      str_provider_name = tokens[0]
      str_llm = '/'.join(tokens[1:])
...
if True:
  ...
  map_provider_to_llms = {
    ...
    ProviderName.AWS_BEDROCK_CHAT: [
      ...
      LLM.ANTHROPIC_CLAUDE_V4_SONNET,
      LLM.ANTHROPIC_CLAUDE_V4_OPUS,
    ],
  ...
  map_context_size = {
    ...
    LLM.ANTHROPIC_CLAUDE_V4_OPUS: 200_000,
    LLM.ANTHROPIC_CLAUDE_V4_SONNET: 200_000,
  ...
  map_output_size = {
    ...
    LLM.ANTHROPIC_CLAUDE_V4_SONNET: 32_000,  # 64_000
    LLM.ANTHROPIC_CLAUDE_V4_OPUS: 16_000,  # 16_000
  }
