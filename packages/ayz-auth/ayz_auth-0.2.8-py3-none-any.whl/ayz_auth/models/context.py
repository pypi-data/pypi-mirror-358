...
class StytchContext(BaseModel):
    ...
    member_id: str = Field(description="Unique Stytch member identifier")
    session_id: str = Field(description="Unique Stytch session identifier")
    organization_id: str = Field(description="Stytch organization identifier")

    # Session timing information
    session_started_at: datetime = Field(
        description="When the session was initially created"
    )
    session_expires_at: datetime = Field(description="When the session will expire")
    session_last_accessed_at: datetime = Field(
    ...
    def __str__(self) -> str:
        ...
        return (
            ...
            f"expires_at={self.session_expires_at.isoformat()})"
        )
