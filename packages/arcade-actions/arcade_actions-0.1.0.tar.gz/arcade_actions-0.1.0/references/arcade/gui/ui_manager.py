...
class UIManager(EventDispatcher):
    ...
    def walk_widgets(self, *, root: UIWidget | None = None, layer=DEFAULT_LAYER) -> Iterable[UIWidget]:
    ...
    def get_widgets_at(self, pos: Point2, cls: type[W] | type[UIWidget] = UIWidget, layer=DEFAULT_LAYER) -> Iterable[W]:
    ...
    def debug(self):
        ...
        for index, layer in self.children.items():
            ...
            print(f"{'Widget':<60}|{'Rect (LBWH)':<30}|{'Size Hint':<12}|{'Size Hint Min':<12}|{'Size Hint Max':<12}")
