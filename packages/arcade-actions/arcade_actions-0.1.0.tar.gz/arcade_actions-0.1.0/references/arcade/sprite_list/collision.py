...
def get_closest_sprite(sprite: BasicSprite, sprite_list: SpriteSequence[SpriteType]) -> tuple[SpriteType, float] | None:
    """
...
def _get_nearby_sprites(sprite: BasicSprite, sprite_list: SpriteSequence[SpriteType]) -> list[SpriteType]:
...
def get_sprites_at_exact_point(point: Point, sprite_list: SpriteSequence[SpriteType]) -> list[SpriteType]:
    """
