...
def _parse_python_friendly_version(raw_version: str, pattern: re.Pattern[str] = _VERSION_REGEX) -> str:
...
def _parse_py_version_from_file(version_path: str | Path = _HERE / "VERSION", write_errors_to=sys.stderr) -> str:
