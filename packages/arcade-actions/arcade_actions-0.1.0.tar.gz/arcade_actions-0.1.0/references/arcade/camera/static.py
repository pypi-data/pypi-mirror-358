...
class _StaticCamera:
    ...
    def unproject(self, screen_coordinate: Point) -> Vec3:
        ...
        return self._unproject_method(screen_coordinate, self._viewport, self._view, self._projection)
...
def static_from_raw_orthographic(
    ...
    *,
    ...
    proj = generate_orthographic_matrix(
        OrthographicProjectionData(projection[0], projection[1], projection[2], projection[3], near, far),
        zoom,
    )
    return _StaticCamera(
        view,
