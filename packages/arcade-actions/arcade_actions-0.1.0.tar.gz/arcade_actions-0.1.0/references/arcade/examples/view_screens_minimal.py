...
class MenuView(arcade.View):
    ...
    def on_draw(self):
        ...
        self.clear()
        arcade.draw_text(
            "Menu Screen - click to advance", WIDTH / 2, HEIGHT / 2, arcade.color.BLACK, font_size=30, anchor_x="center"
        )
...
class GameView(arcade.View):
    ...
    def on_draw(self):
        ...
        self.clear()
        arcade.draw_text(
            "Game - press SPACE to advance", WIDTH / 2, HEIGHT / 2, arcade.color.BLACK, font_size=30, anchor_x="center"
        )
...
class GameOverView(arcade.View):
    ...
    def on_draw(self):
        ...
        self.clear()
        arcade.draw_text(
            "Game Over - press ESCAPE to advance", WIDTH / 2, HEIGHT / 2, arcade.color.WHITE, 30, anchor_x="center"
        )
