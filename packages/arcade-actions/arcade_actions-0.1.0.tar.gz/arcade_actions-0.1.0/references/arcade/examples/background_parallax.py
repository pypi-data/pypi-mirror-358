...
class GameView(arcade.View):
    def __init__(self):
        ...
        self.car_texture_right = arcade.texture.load_texture(":resources:/images/miami_synth_parallax/car/car-idle.png")
        ...
        self.player_sprite = arcade.Sprite(
            self.car_texture_right, center_x=self.camera.viewport_width // 2, center_y=-200.0, scale=PIXEL_SCALE
        )
