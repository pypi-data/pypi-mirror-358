...
import arcade
from arcade import SpriteList, SpriteSolidColor, Text, View, Window, get_window
...
class DepthOfField:
    ...
    def __init__(self, size: tuple[int, int] | None = None, clear_color: RGBA255 = BACKGROUND_GRAY):
