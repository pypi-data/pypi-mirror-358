...
class MenuView(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.draw_text(
            "Click to advance.", WIDTH / 2, HEIGHT / 2 - 75, arcade.color.GRAY, font_size=20, anchor_x="center"
        )
...
class GameView(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.draw_text(
            "Press Esc. to pause", WIDTH // 2, HEIGHT - 100, arcade.color.BLACK, font_size=20, anchor_x="center"
        )
...
class PauseView(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.draw_text("PAUSED", WIDTH / 2, HEIGHT / 2 + 50, arcade.color.BLACK, font_size=50, anchor_x="center")

        # Show tip to return or reset
        arcade.draw_text(
            "Press Esc. to return", WIDTH / 2, HEIGHT / 2, arcade.color.BLACK, font_size=20, anchor_x="center"
        )
        arcade.draw_text(
            "Press Enter to reset", WIDTH / 2, HEIGHT / 2 - 30, arcade.color.BLACK, font_size=20, anchor_x="center"
        )
