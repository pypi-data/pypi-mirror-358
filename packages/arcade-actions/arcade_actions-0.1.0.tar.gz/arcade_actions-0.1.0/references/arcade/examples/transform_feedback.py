...
class GameView(arcade.View):
    def __init__(self):
        ...
        self.gravity_1 = context.geometry([BufferDescription(self.buffer_1, "2f 2f", ["in_pos", "in_vel"])])
        self.gravity_2 = context.geometry([BufferDescription(self.buffer_2, "2f 2f", ["in_pos", "in_vel"])])
