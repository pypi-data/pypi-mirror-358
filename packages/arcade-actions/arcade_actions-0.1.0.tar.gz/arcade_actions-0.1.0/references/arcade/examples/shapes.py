...
class Rectangle(Shape):
    def draw(self):
        arcade.draw_rect_filled(arcade.rect.XYWH(self.x, self.y, self.width, self.height), self.color, self.angle)
    ...
    def __init__(self):
        ...
        for i in range(NUMBER_OF_SHAPES):
            ...
            if shape_type == 0:
                ...
                shape = Line(x, y, width, height, angle, d_x, d_y, d_angle, (red, green, blue, alpha))
