...
class GameView(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.draw_rect_outline(
            arcade.XYWH(camera_x, camera_y, CAMERA_BOUNDARY.width, CAMERA_BOUNDARY.height), arcade.color.RED, 2
        )
        ...
        # Draw the GUI
        arcade.draw_rect_filled(arcade.rect.XYWH(self.width // 2, 20, self.width, 40), color=arcade.color.ALMOND)
        text = (f"Scroll value: ({self.camera_sprites.position[0]:5.1f}", f"{self.camera_sprites.position[1]:5.1f})")
