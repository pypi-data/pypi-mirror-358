...
class GameView(arcade.View):
    ...
    def setup(self):
        ...
        self.player_sprite = arcade.Sprite(
            ":resources:images/animated_characters/female_person/femalePerson_idle.png", scale=PLAYER_SPRITE_SCALING
        )
        ...
        self.processing_time_text = arcade.Text(output, 20, self.height - 60, arcade.color.WHITE, 16)
