...
class GameView(arcade.View):
    ...
    def on_draw(self):
        ...
        if self.media_player:
            ...
            arcade.draw_text(f"Time: {minutes}:{seconds:02}", x=10, y=10, color=arcade.color.BLACK, font_size=24)
            volume = self.media_player.volume
            arcade.draw_text(f"Volume: {volume:3.1f}", x=10, y=50, color=arcade.color.BLACK, font_size=24)
