...
class GameView(arcade.View):
    ...
    def __init__(self):
        ...
        minimap_projection = arcade.XYWH(0.0, 0.0, MAP_PROJECTION_WIDTH, MAP_PROJECTION_HEIGHT)
        self.camera_minimap = arcade.Camera2D(viewport=minimap_viewport, projection=minimap_projection)
