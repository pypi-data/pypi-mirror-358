...
class InstructionView(arcade.View):
    ...
    def on_draw(self):
        self.clear()
        arcade.draw_text(
            "Instructions Screen", WIDTH / 2, HEIGHT / 2, arcade.color.BLACK, font_size=50, anchor_x="center"
        )
        arcade.draw_text(
            "Click to advance", WIDTH / 2, HEIGHT / 2 - 75, arcade.color.GRAY, font_size=20, anchor_x="center"
        )
...
class GameOverView(arcade.View):
    ...
    def on_draw(self):
        ...
        """
        arcade.draw_text("Game Over", x=WIDTH / 2, y=400, color=arcade.color.WHITE, font_size=54, anchor_x="center")
        arcade.draw_text(
            "Click to restart",
            x=WIDTH / 2,
            y=300,
        ...
        arcade.draw_text(
            f"Time taken: {time_taken_formatted}", WIDTH / 2, 200, arcade.color.GRAY, font_size=15, anchor_x="center"
        )
