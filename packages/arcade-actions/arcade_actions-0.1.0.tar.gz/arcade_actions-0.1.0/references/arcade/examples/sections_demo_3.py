...
class ModalSection(Section):
    ...
    def on_draw(self):
        ...
        arcade.draw_lrbt_rectangle_filled(self.left, self.right, self.bottom, self.top, arcade.color.GRAY)
        arcade.draw_lrbt_rectangle_outline(self.left, self.right, self.bottom, self.top, arcade.color.WHITE)
        self.draw_button()
...
class InfoBar(Section):
    ...
    def on_draw(self):
        ...
        arcade.draw_lrbt_rectangle_outline(self.left, self.right, self.bottom, self.top, COLOR_LIGHT)
        arcade.draw_text(
