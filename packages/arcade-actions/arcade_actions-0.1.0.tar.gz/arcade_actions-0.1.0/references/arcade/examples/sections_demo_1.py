...
class GameView(arcade.View):
    def __init__(self):
        ...
        self.section_manager.add_section(ScreenPart(0, 0, self.window.width / 2, self.window.height, name="Left"))

        # 2) Second section holds the other half of the screen
        self.section_manager.add_section(
            ScreenPart(self.window.width / 2, 0, self.window.width / 2, self.window.height, name="Right")
        )
