...
import arcade
from arcade.color import BLUE, GREEN, RED, WHITE
...
class LevelRenderer:
    ...
    def __init__(self, level: str, level_loader: LevelLoader, location: arcade.types.Point2, size: tuple[int, int]):
        ...
        self.size = size
        x, y = location
        self.camera: arcade.Camera2D = arcade.Camera2D(arcade.XYWH(x, y, size[0], size[1]))
        camera_x, camera_y = self.camera.position
        self.level: arcade.TileMap | None = None
        self.level_text: arcade.Text = arcade.Text(level, camera_x, camera_y, anchor_x="center", anchor_y="center")
