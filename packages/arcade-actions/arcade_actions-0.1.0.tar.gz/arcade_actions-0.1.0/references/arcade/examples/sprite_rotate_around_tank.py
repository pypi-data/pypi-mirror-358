...
class GameView(arcade.View):
    def __init__(self):
        ...
        self.barrel.position = (self.tank.center_x, self.tank.center_y - TANK_BARREL_LENGTH_HALF)
        ...
        self.control_text = arcade.Text("WASD to move tank, Mouse to aim", self.window.center_x, 15, anchor_x="center")
    ...
    def move_tank(self, delta_time):
        ...
        mouse_angle = get_angle_degrees(self.tank.center_x, self.tank.center_y, self.mouse_pos[0], self.mouse_pos[1])
    ...
    def correct(self, correct: bool):
        ...
        if correct:
            angle = get_angle_radians(self.tank.center_y, self.tank.center_x, self.mouse_pos[1], self.mouse_pos[0])
