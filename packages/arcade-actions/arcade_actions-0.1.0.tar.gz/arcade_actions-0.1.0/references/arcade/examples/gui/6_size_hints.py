...
class MyView(UIView):
    def __init__(self):
        ...
        center_box = content_anchor.add(UIBoxLayout(size_hint=(0.8, 0.5), align="left", space_between=20))
        ...
        width_slider = width_slider_box.add(
            arcade.gui.UISlider(min_value=0, max_value=1, value=0, size_hint=None, height=30, step=0.1)
        )
