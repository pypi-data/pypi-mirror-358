...
class MyView(UIView):
    def __init__(self):
        ...
        self.username_input = grid.add(UIInputText(width=150, font_name="Kenney Future"), column=1, row=1)

        grid.add(UILabel(text="Password:", width=80, font_name="Kenney Future"), column=0, row=2)
        self.password_input = grid.add(UIPasswordInput(width=150, font_name="Kenney Future"), column=1, row=2)
