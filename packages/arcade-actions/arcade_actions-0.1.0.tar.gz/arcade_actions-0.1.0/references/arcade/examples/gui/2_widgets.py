...
class ScrollableTextArea(UITextArea, UIAnchorLayout):
    ...
    def __init__(self, **kwargs):
        ...
        self._up_indicator = UIImage(texture=TEX_SCROLL_UP, size_hint=None, width=indicator_size, height=indicator_size)
    ...
    def on_update(self, dt):
        ...
        self._down_indicator.visible = abs(self.layout.view_y) < self.layout.content_height - self.layout.height
...
class GalleryView(UIView):
    ...
    def _show_start_widgets(self):
        ...
        open_sourcecode = self._body.add(
            UIFlatButton(text="Open Source Code", style=UIFlatButton.STYLE_RED, size_hint=(0.3, 0.1)),
            anchor_y="bottom",
            align_y=20,
        )
        ...
        def on_click(_):
            ...
            webbrowser.open("https://github.com/pythonarcade/arcade/tree/development/arcade/examples/gui")
    ...
    def _show_text_widgets(self):
        ...
        welcome_label = box.add(UILabel("Nice to meet you ''", font_name=DEFAULT_FONT, font_size=24))
    ...
    def _show_interactive_widgets(self):
        ...
        flat_row.add(UIFlatButton(text="UIFlatButton blue", style=UIFlatButton.STYLE_BLUE, size_hint=(0.3, 1)))
        flat_row.add(UIFlatButton(text="UIFlatButton red", style=UIFlatButton.STYLE_RED, size_hint=(0.3, 1)))
        flat_row.add(UIFlatButton(text="disabled", style=UIFlatButton.STYLE_BLUE, size_hint=(0.3, 1))).disabled = True
        ...
        box.add(toggle_row)
        toggle_row.add(UILabel("UITextureToggle", font_name=DETAILS_FONT, font_size=16, size_hint=(0.3, 0)))
        toggle_row.add(
            UITextureToggle(
        ...
        dropdown_row.add(UILabel("UIDropdown", font_name=DETAILS_FONT, font_size=16, size_hint=(0.3, 0)))
        dropdown_row.add(
            UIDropdown(
                default="Option 1",
    ...
    def _show_other_widgets(self):
        ...
        sprite_row.add(UILabel("UISpriteWidget", font_name=DETAILS_FONT, font_size=16, size_hint=(0.3, 0)))
