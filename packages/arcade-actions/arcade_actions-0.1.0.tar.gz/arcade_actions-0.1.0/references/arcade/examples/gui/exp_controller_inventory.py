...
class MyView(UIView, ControllerView):
    def __init__(self):
        ...
        text = self.root.add(
            UILabel(text="Open Inventory with 'Select' button on a controller or 'I' key", font_size=24)
        )
        text.fit_content()
...
if __name__ == "__main__":
    ...
    ControllerWindow(title="Minimal example", width=1280, height=720, resizable=True).show_view(MyView())
    arcade.run()
