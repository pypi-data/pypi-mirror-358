...
class GameView(arcade.View):
    ...
    def on_draw(self):
        ...
        if self.game_over:
            arcade.draw_text(
                "GAME OVER, Press R to reset", self.center_x, self.center_y, font_size=30, anchor_x="center"
            )
    ...
    def on_update(self, delta_time):
        ...
        if not self.game_over:
            ...
            for enemy in self.enemy_list:
                ...
                if (
                    len(arcade.check_for_collision_with_list(enemy, self.wall_list)) > 0
                    or enemy.boundary_left is not None
                    and enemy.left < enemy.boundary_left
                    or enemy.boundary_right is not None
