...
class Info(ABC):
    ...
    def __init__(self, ctx):
        ...
        self.MAX_COMBINED_VERTEX_UNIFORM_COMPONENTS = self.get(enums.MAX_COMBINED_VERTEX_UNIFORM_COMPONENTS)
        """Number of words for vertex shader uniform variables in all uniform blocks"""

        self.MAX_COMBINED_FRAGMENT_UNIFORM_COMPONENTS = self.get(enums.MAX_COMBINED_FRAGMENT_UNIFORM_COMPONENTS)
        ...
        self.MAX_TRANSFORM_FEEDBACK_SEPARATE_ATTRIBS = self.get(enums.MAX_TRANSFORM_FEEDBACK_SEPARATE_ATTRIBS)
        """
