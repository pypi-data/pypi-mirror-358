            ...
            while volume_remaining > 0:
                ...
                for d in dest:
                    ...
                    if isinstance(d._get_parent(), TrashBin):
                        self.dispense(volume_chunk+extra_volume, d._get_parent(), flow_rate=dispense_flow_rate)
                    else:
                        self.dispense(volume_chunk+extra_volume, d, position=dispense_position, offset=dispense_offset, flow_rate=dispense_flow_rate)
