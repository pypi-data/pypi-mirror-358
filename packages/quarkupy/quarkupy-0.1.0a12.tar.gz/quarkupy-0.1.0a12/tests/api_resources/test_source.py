...
from quakupy import Quark, AsyncQuark
...
class TestSource:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_add_all_items(self, client: Quark) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_add_all_items_with_all_params(self, client: Quark) -> None:
        source = client.source.add_all_items(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            path="path",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_add_all_items(self, client: Quark) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_add_all_items(self, client: Quark) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_path_params_add_all_items(self, client: Quark) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_list_items(self, client: Quark) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_list_items_with_all_params(self, client: Quark) -> None:
        source = client.source.list_items(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            path="path",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_list_items(self, client: Quark) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_list_items(self, client: Quark) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_path_params_list_items(self, client: Quark) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
...
class TestAsyncSource:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_add_all_items(self, async_client: AsyncQuark) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_add_all_items_with_all_params(self, async_client: AsyncQuark) -> None:
        source = await async_client.source.add_all_items(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            path="path",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_add_all_items(self, async_client: AsyncQuark) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_add_all_items(self, async_client: AsyncQuark) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_path_params_add_all_items(self, async_client: AsyncQuark) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_list_items(self, async_client: AsyncQuark) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_list_items_with_all_params(self, async_client: AsyncQuark) -> None:
        source = await async_client.source.list_items(
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            path="path",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_list_items(self, async_client: AsyncQuark) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_list_items(self, async_client: AsyncQuark) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_path_params_list_items(self, async_client: AsyncQuark) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
