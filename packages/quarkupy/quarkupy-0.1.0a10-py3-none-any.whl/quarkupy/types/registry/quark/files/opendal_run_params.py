...
class ConfigOpendalConfigInputOpendalS3Config(TypedDict, total=False):
    ...
    disable_config_load: Required[bool]
    ...
    disable_ec2_metadata: Required[bool]
    ...
    disable_list_objects_v2: Required[bool]
    """
    ...
    disable_stat_with_override: Required[bool]
    """
    ...
    disable_write_with_if_match: Required[bool]
    """
    ...
    enable_request_payer: Required[bool]
    """
    Indicates whether the client agrees to pay for the requests made to the S3
    bucket.
    """

    enable_versioning: Required[bool]
    """is bucket versioning enabled for this bucket"""

    enable_virtual_host_style: Required[bool]
    """
    ...
    enable_write_with_append: Required[bool]
    """
