...
class TestOpendal:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_create_schema(self, client: Quarkupy) -> None:
        opendal = client.registry.quark.files.opendal.create_schema()
        assert_matches_type(object, opendal, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_create_schema(self, client: Quarkupy) -> None:
        response = client.registry.quark.files.opendal.with_raw_response.create_schema()
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_create_schema(self, client: Quarkupy) -> None:
        with client.registry.quark.files.opendal.with_streaming_response.create_schema() as response:
...
class TestAsyncOpendal:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_create_schema(self, async_client: AsyncQuarkupy) -> None:
        opendal = await async_client.registry.quark.files.opendal.create_schema()
        assert_matches_type(object, opendal, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_create_schema(self, async_client: AsyncQuarkupy) -> None:
        response = await async_client.registry.quark.files.opendal.with_raw_response.create_schema()
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_create_schema(self, async_client: AsyncQuarkupy) -> None:
        async with async_client.registry.quark.files.opendal.with_streaming_response.create_schema() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
