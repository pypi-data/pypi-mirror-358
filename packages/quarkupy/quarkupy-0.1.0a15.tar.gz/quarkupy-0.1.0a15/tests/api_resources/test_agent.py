...
class TestAgent:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_chat_rag_demo(self, client: Quarkupy) -> None:
        agent = client.agent.chat_rag_demo(
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_chat_rag_demo_with_all_params(self, client: Quarkupy) -> None:
        agent = client.agent.chat_rag_demo(
            openai_api_key="openai_api_key",
            query="query",
            table_name="table_name",
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_chat_rag_demo(self, client: Quarkupy) -> None:
        response = client.agent.with_raw_response.chat_rag_demo(
            openai_api_key="openai_api_key",
            query="query",
            table_name="table_name",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_chat_rag_demo(self, client: Quarkupy) -> None:
        with client.agent.with_streaming_response.chat_rag_demo(
            openai_api_key="openai_api_key",
            query="query",
            table_name="table_name",
        ) as response:
...
class TestAsyncAgent:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_chat_rag_demo(self, async_client: AsyncQuarkupy) -> None:
        agent = await async_client.agent.chat_rag_demo(
            openai_api_key="openai_api_key",
            query="query",
            table_name="table_name",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_chat_rag_demo_with_all_params(self, async_client: AsyncQuarkupy) -> None:
        agent = await async_client.agent.chat_rag_demo(
            openai_api_key="openai_api_key",
            query="query",
            table_name="table_name",
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_chat_rag_demo(self, async_client: AsyncQuarkupy) -> None:
        response = await async_client.agent.with_raw_response.chat_rag_demo(
            openai_api_key="openai_api_key",
            query="query",
            table_name="table_name",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_chat_rag_demo(self, async_client: AsyncQuarkupy) -> None:
        async with async_client.agent.with_streaming_response.chat_rag_demo(
            openai_api_key="openai_api_key",
            query="query",
            table_name="table_name",
        ) as response:
