...
def main():
    parser = argparse.ArgumentParser(
        description="Create a starter JavaScript (.js) file."
    )
    parser.add_argument("--output", required=True, help="Output .js file path")
    parser.add_argument("--name", default="MainScript", help="Module or function name")
...
"""
    ...
    try:
        ...
        if args.json:
            ...
            print(f"✅ Created JavaScript file at {out_path}")
        sys.exit(0)
