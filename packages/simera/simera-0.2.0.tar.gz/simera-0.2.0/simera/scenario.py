...
shipments = [Shipment({'lane': {'dest_ctry': ctry, 'dest_zip': zm.zipcode_clean_first[ctry]}, 'unit': {'m3': kg / 150, 'shipment': 1, 'kg': kg}}) for ctry in countries for kg in [0.1, 1, 10, 30, 40, 50]]
