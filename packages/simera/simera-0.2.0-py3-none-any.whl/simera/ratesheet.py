...
class Ratesheet:
    ...
    def __repr__(self):
        ...
        countries = "-".join(self.shortcuts.dest_countries)
...
if __name__ == '__main__':
    # rs = Ratesheet(Path(sc.path.resources /'ratesheets/DC_PL_Pila_1.xlsb'), 'pil_dac_de')
    rs = Ratesheet(Path(sc.path.resources /'ratesheets/DC_GB_Northampton.xlsb'), 'nor_yus_gb')
    ...
    df = pd.read_csv(Path(r'C:\Users\plr03474\Downloads\ifc_output_20250625.csv'), sep=";", header=1)