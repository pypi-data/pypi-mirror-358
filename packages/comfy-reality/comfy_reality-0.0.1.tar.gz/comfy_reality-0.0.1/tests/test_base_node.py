...
from comfy_reality.exceptions import ARValidationError, ARFormatError
...
class TestBaseARNode:
    ...
    def test_tensor_to_numpy_conversion(self):
        ...
        assert numpy_array.shape == (512, 512, 3)  # Batch dim removed
    ...
    def test_numpy_to_tensor_conversion(self):
        ...
        assert tensor.shape == (1, 512, 512, 3)  # Batch dim added
