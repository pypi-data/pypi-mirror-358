...
def test_node_mappings():
    ...
    expected_nodes = [
        "USDZExporter", "AROptimizer", "SpatialPositioner", 
        "MaterialComposer", "RealityComposer", "CrossPlatformExporter",
        "AnimationBuilder", "PhysicsIntegrator"
    ]
...
def test_node_instantiation():
    ...
    from comfy_reality.nodes import (
        USDZExporter, AROptimizer, SpatialPositioner, MaterialComposer
    )
