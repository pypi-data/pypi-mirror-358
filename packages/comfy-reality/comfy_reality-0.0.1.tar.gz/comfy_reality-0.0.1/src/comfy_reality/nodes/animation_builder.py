...
class AnimationBuilder:
    ...
    def build_animation(
        ...
        if animation_type == "transform":
            animation = self._build_transform_animation(
                start_transform, end_transform, duration, easing_function
            )
        elif animation_type == "material":
            animation = self._build_material_animation(
                start_material, end_material, duration, easing_function
            )
        elif animation_type == "visibility":
            animation = self._build_visibility_animation(
                visibility_pattern, duration, easing_function
            )
            ...
            animation = self._build_custom_animation(
                keyframes, duration, easing_function
            )
        ...
        properties = {
            "total_duration": self._calculate_total_duration(
                duration, repeat_count, auto_reverse, delay
            ),
    ...
    def _build_transform_animation(
        self, start_transform, end_transform, duration, easing
    ):
    ...
    def _calculate_total_duration(
        self, base_duration, repeat_count, auto_reverse, delay
    ):
