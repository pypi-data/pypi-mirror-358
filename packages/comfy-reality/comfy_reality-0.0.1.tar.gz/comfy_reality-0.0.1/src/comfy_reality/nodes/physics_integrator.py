...
class PhysicsIntegrator:
    ...
    def integrate_physics(
        ...
        collision_shape_data = self._build_collision_shape(
            collision_shape, geometry, mass
        )
        ...
        properties = {
            ...
            "collision_complexity": self._calculate_collision_complexity(
    ...
    def _apply_material_physics(self, physics_body, material):
        ...
        if "physics_properties" in material:
            ...
            physics_body["restitution"] = props.get(
    ...
    def _check_mobile_optimization(self, physics_body):
        ...
        return (
            shape_type in mobile_friendly_shapes
            and not physics_body["continuous_collision_detection"]
            and physics_body["mass"] < 100.0
        )
    ...
    def _estimate_performance_cost(self, physics_body):
        ...
        shape_complexity = self._calculate_collision_complexity(
            physics_body["collision_shape"]
        )
