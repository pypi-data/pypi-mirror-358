    ...
    def create_spatial_transform(
        ...
        try:
            ...
            self.validate_numeric_parameter(
                position_x, "position_x", min_val=-1000.0, max_val=1000.0
            )
            self.validate_numeric_parameter(
                position_y, "position_y", min_val=-1000.0, max_val=1000.0
            )
            self.validate_numeric_parameter(
                position_z, "position_z", min_val=-1000.0, max_val=1000.0
            )
            self.validate_numeric_parameter(
                scale, "scale", min_val=0.001, max_val=100.0
            )
            self.validate_numeric_parameter(
                rotation_x, "rotation_x", min_val=-3600.0, max_val=3600.0
            )
            self.validate_numeric_parameter(
                rotation_y, "rotation_y", min_val=-3600.0, max_val=3600.0
            )
            self.validate_numeric_parameter(
                rotation_z, "rotation_z", min_val=-3600.0, max_val=3600.0
            )
            ...
            if relative_positioning and reference_object is not None:
                transform_matrix = self._apply_relative_transform(
                    transform_matrix, reference_object
                )
