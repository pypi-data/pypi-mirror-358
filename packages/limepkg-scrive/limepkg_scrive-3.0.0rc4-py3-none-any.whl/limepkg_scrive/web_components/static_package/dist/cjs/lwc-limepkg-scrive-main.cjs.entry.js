...
const Main = class {
  ...
  render() {
    ...
    return (index.h("section", null, index.h("limel-button", { id: "scrive_esign_button", label: esignLabel, outlined: true, icon: "signature", onClick: () => { var _a; return this.goToScrive(this.context.id, (_a = this.document) === null || _a === void 0 ? void 0 : _a.scrive_document_id); } }), index.h("p", null, index.h("limel-flex-container", { justify: "start" }, index.h("limel-checkbox", { label: cloneLabel, checked: this.cloneDocument && ((_b = (_a = this.config) === null || _a === void 0 ? void 0 : _a.limepkg_scrive) === null || _b === void 0 ? void 0 : _b.cloneDocument), onChange: this.setCloneDocument }), index.h("limel-icon-button", { icon: "question_mark", label: cloneHintLabel, onClick: this.openDialog }))), index.h("limel-dialog", { open: this.isOpen, onClose: this.closeDialog }, index.h("p", null, cloneInfoLabel), index.h("limel-button", { label: okLabel, onClick: this.closeDialog, slot: "button" }))));
  }
};
__decorate([
