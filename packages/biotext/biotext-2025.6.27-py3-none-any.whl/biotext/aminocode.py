...
class aminocode:
    ...
    def encode_string(input_string, detail='dp'):
        ...
        This method encodes a given string by translating its characters into
        AMINOcode using predefined encoding tables for letters, digits, and
        punctuation. The method also handles unaccented characters and spaces.
        ...
        c_dict = aminocode.aminocode_table.copy()
        
        # Add detailed digit encoding if 'd' is specified in the detail parameter
        if 'd' in detail:
            c_dict.update(aminocode.aminocode_table_d)
        else:
        ...
        # parameter
        if 'p' in detail:
            c_dict.update(aminocode.aminocode_table_p)
        else:
    ...
    def decode_string(input_string, detail='dp'):
        ...
        This method decodes a given AMINOcode-encoded string back to its
    ...
    def encode_list(string_list, detail='dp', verbose=False):
        ...
        This method encodes each string in a given list of strings using
        AMINOcode encoding.
        ...
        selectedEncoder = lambda x: aminocode.encode_string(x, detail=detail)
    ...
    def decode_list(input_list, detail='dp', verbose=False):
        ...
        This method decodes each AMINOcode-encoded string in a given list of
        ...
        selectedEncoder = lambda x: aminocode.decode_string(x, detail=detail)
