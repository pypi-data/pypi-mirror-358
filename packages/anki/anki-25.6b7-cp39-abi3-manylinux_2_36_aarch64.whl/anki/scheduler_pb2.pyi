...
class SimulateFsrsReviewRequest(google.protobuf.message.Message):
    ...
    @typing.final
    class CMRRTarget(google.protobuf.message.Message):
        """For CMRR"""

        DESCRIPTOR: google.protobuf.descriptor.Descriptor

        @typing.final
        class Memorized(google.protobuf.message.Message):
            DESCRIPTOR: google.protobuf.descriptor.Descriptor
            ...
            def ClearField(self, field_name: typing.Literal["loss_aversion", b"loss_aversion"]) -> None: ...

        @typing.final
        class Stability(google.protobuf.message.Message):
            DESCRIPTOR: google.protobuf.descriptor.Descriptor
        ...
        @typing.final
        class FutureMemorized(google.protobuf.message.Message):
            DESCRIPTOR: google.protobuf.descriptor.Descriptor
        ...
        @typing.final
        class AverageFutureMemorized(google.protobuf.message.Message):
            DESCRIPTOR: google.protobuf.descriptor.Descriptor
        ...
        FUTURE_MEMORIZED_FIELD_NUMBER: builtins.int
        AVERAGE_FUTURE_MEMORIZED_FIELD_NUMBER: builtins.int
        @property
        def memorized(self) -> global___SimulateFsrsReviewRequest.CMRRTarget.Memorized: ...
        @property
        def stability(self) -> global___SimulateFsrsReviewRequest.CMRRTarget.Stability: ...
        @property
        def future_memorized(self) -> global___SimulateFsrsReviewRequest.CMRRTarget.FutureMemorized: ...
        @property
        def average_future_memorized(self) -> global___SimulateFsrsReviewRequest.CMRRTarget.AverageFutureMemorized: ...
        def __init__(
            self,
            *,
            memorized: global___SimulateFsrsReviewRequest.CMRRTarget.Memorized | None = ...,
            stability: global___SimulateFsrsReviewRequest.CMRRTarget.Stability | None = ...,
            future_memorized: global___SimulateFsrsReviewRequest.CMRRTarget.FutureMemorized | None = ...,
            average_future_memorized: global___SimulateFsrsReviewRequest.CMRRTarget.AverageFutureMemorized | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing.Literal["average_future_memorized", b"average_future_memorized", "future_memorized", b"future_memorized", "kind", b"kind", "memorized", b"memorized", "stability", b"stability"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["average_future_memorized", b"average_future_memorized", "future_memorized", b"future_memorized", "kind", b"kind", "memorized", b"memorized", "stability", b"stability"]) -> None: ...
        def WhichOneof(self, oneof_group: typing.Literal["kind", b"kind"]) -> typing.Literal["memorized", "stability", "future_memorized", "average_future_memorized"] | None: ...
    ...
    @property
    def target(self) -> global___SimulateFsrsReviewRequest.CMRRTarget: ...
    def __init__(
        self,
        *,
        params: collections.abc.Iterable[builtins.float] | None = ...,
        ...
        target: global___SimulateFsrsReviewRequest.CMRRTarget | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["_suspend_after_lapse_count", b"_suspend_after_lapse_count", "_target", b"_target", "suspend_after_lapse_count", b"suspend_after_lapse_count", "target", b"target"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_suspend_after_lapse_count", b"_suspend_after_lapse_count", "_target", b"_target", "days_to_simulate", b"days_to_simulate", "deck_size", b"deck_size", "desired_retention", b"desired_retention", "easy_days_percentages", b"easy_days_percentages", "max_interval", b"max_interval", "new_cards_ignore_review_limit", b"new_cards_ignore_review_limit", "new_limit", b"new_limit", "params", b"params", "review_limit", b"review_limit", "review_order", b"review_order", "search", b"search", "suspend_after_lapse_count", b"suspend_after_lapse_count", "target", b"target"]) -> None: ...
    @typing.overload
