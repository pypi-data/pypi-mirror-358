...
import os , time , json ,logging , urllib3 , ccxt , pandas , pandas,mplfinance , aiohttp , asyncio
...
class CryptoManager:
    ...
    def GenerateCryptoChart(
        ...
        if ChartTemplate in ["Professional", "professional"]:
            ...
            Chart.update_traces(increasing_line_color='lime', decreasing_line_color='red')
