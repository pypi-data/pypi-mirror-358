#!/usr/bin/env python3
"""
Cross-Platform MCP Diagnostic Script for weather-monitor
...
class CrossPlatformDiagnostics:
    def __init__(self):
        self.server_path = Path(__file__).parent.parent / "weather-monitor" / "server.py"
        self.requirements_path = Path(__file__).parent.parent / "weather-monitor" / "requirements.txt"
        self.results = []
        self.errors = []
        self.warnings = []
    ...
    def run_diagnostics(self):
        ...
        print("🔍 Cross-Platform MCP Diagnostics for weather-monitor")
        print("=" * 70)
    ...
    def _generate_platform_specific_steps(self):
        ...
        if self.os_type == "windows":
            print(f"   claude mcp add weather-monitor -s user \"{python_cmd} {project_path}\\run_server.py\"")
            print("   # Alternative methods:")
            print(f"   claude mcp add weather-monitor -s user \"{project_path}\\run_server.bat\"")
            print("   # Local (only works from current directory):")
            print(f"   # claude mcp add weather-monitor \"{python_cmd} {project_path}\\run_server.py\"")
        else:
            print(f"   claude mcp add weather-monitor -s user \"{project_path}/run_server.py\"")
            print("   # Alternative methods:")
            print(f"   claude mcp add weather-monitor -s user \"{python_cmd} {project_path}/run_server.py\"")
            print("   # Local (only works from current directory):")
            print(f"   # claude mcp add weather-monitor \"{project_path}/run_server.py\"")
