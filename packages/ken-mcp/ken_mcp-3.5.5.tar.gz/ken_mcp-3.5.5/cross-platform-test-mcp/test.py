#!/usr/bin/env python3
"""
Automated test suite for cross-platform-test-mcp MCP server
...
async def test_server_initialization():
    ...
    try:
        assert mcp.name == "cross-platform-test-mcp"
...
async def run_all_tests():
    """Run all test cases"""
    print("=" * 50)
    print(f"🧪 Running MCP Server Tests for cross-platform-test-mcp")
    print("=" * 50)
