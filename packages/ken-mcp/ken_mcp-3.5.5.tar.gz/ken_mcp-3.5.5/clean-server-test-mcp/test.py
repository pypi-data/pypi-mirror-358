#!/usr/bin/env python3
"""
Automated test suite for clean-server-test-mcp MCP server
...
async def test_server_initialization():
    ...
    try:
        assert mcp.name == "clean-server-test-mcp"
...
async def run_all_tests():
    """Run all test cases"""
    print("=" * 50)
    print(f"🧪 Running MCP Server Tests for clean-server-test-mcp")
    print("=" * 50)
