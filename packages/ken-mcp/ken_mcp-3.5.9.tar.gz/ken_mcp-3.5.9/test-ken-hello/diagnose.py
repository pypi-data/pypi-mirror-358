#!/usr/bin/env python3
"""
MCP Diagnostic Script for test-ken-hello
...
class MCPDiagnostics:
    ...
    def run_diagnostics(self):
        ...
        print("🔍 MCP Diagnostics for test-ken-hello")
        print("=" * 60)
    ...
    def generate_report(self):
        ...
        if self.errors:
            ...
            print("4. Add to Claude: claude mcp add test-ken-hello \"python3 $(pwd)/server.py\"")
        else:
            print("1. Install if needed: pip install -r requirements.txt")
            print("2. Add to Claude: claude mcp add test-ken-hello \"python3 $(pwd)/server.py\"")
