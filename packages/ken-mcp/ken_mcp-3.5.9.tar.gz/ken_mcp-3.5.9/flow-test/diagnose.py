#!/usr/bin/env python3
"""
MCP Diagnostic Script for flow-test
...
class MCPDiagnostics:
    ...
    def run_diagnostics(self):
        ...
        print("🔍 MCP Diagnostics for flow-test")
        print("=" * 60)
    ...
    def generate_report(self):
        ...
        if self.errors:
            ...
            print("4. Add to Claude: claude mcp add flow-test \"python3 $(pwd)/server.py\"")
        else:
            print("1. Install if needed: pip install -r requirements.txt")
            print("2. Add to Claude: claude mcp add flow-test \"python3 $(pwd)/server.py\"")
