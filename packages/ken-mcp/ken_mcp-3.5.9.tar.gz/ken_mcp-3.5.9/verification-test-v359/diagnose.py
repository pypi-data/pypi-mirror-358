#!/usr/bin/env python3
"""
Cross-Platform MCP Diagnostic Script for verification-test-v359
...
class CrossPlatformDiagnostics:
    ...
    def run_diagnostics(self):
        ...
        print("🔍 Cross-Platform MCP Diagnostics for verification-test-v359")
        print("=" * 70)
    ...
    def _generate_platform_specific_steps(self):
        ...
        if self.os_type == "windows":
            ...
            print(f"   {python_cmd} -m pip install --user -r requirements.txt")
            print("   # Note: --user flag prevents 'externally-managed-environment' errors")
        else:  # macOS
            print(f"   {python_cmd} -m pip install -r requirements.txt")
        print()
        ...
        print("6. Add to Claude Code:")
        project_path = Path(__file__).parent.absolute()
        
        if self.os_type == "windows":
            print(f"   claude mcp add verification-test-v359 \"{python_cmd} {project_path}\\run_server.py\"")
            print("   # Alternative if above fails:")
            print(f"   claude mcp add verification-test-v359 \"{project_path}\\run_server.bat\"")
        else:
            print(f"   claude mcp add verification-test-v359 \"{project_path}/run_server.py\"")
            print("   # Alternative if above fails:")
            print(f"   claude mcp add verification-test-v359 \"{python_cmd} {project_path}/run_server.py\"")
        print()
