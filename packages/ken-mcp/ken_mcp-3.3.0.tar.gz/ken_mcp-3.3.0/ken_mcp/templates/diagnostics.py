...
class MCPDiagnostics:
    def __init__(self):
        ...
        self.pyproject_path = Path(__file__).parent / "pyproject.toml"
        self.results = []
        self.errors = []
        self.warnings = []
    ...
    def check_dependencies(self):
        ...
        # Check other dependencies from pyproject.toml
        if self.pyproject_path.exists():
            try:
                ...
                try:
                    ...
                    self.add_warning("tomllib not available, skipping dependency check")
                    return
    ...
    def generate_report(self):
        ...
        if self.errors:
            ...
            print("4. Add to Claude: claude mcp add {project_name} \\"python3 $(pwd)/server.py\\"")
        else:
            print("1. Install if needed: pip install -e .")
            print("2. Add to Claude: claude mcp add {project_name} \\"python3 $(pwd)/server.py\\"")
