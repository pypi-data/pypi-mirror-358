#!/usr/bin/env python3
"""
Cross-Platform MCP Diagnostic Script for test-v357-mcp
...
class CrossPlatformDiagnostics:
    ...
    def run_diagnostics(self):
        ...
        print("🔍 Cross-Platform MCP Diagnostics for test-v357-mcp")
        print("=" * 70)
    ...
    def _generate_platform_specific_steps(self):
        ...
        if self.os_type == "windows":
            print(f"   claude mcp add test-v357-mcp \"{python_cmd} {project_path}\\run_server.py\"")
            print("   # Alternative if above fails:")
            print(f"   claude mcp add test-v357-mcp \"{project_path}\\run_server.bat\"")
        else:
            print(f"   claude mcp add test-v357-mcp \"{project_path}/run_server.py\"")
            print("   # Alternative if above fails:")
            print(f"   claude mcp add test-v357-mcp \"{python_cmd} {project_path}/run_server.py\"")
        print()
