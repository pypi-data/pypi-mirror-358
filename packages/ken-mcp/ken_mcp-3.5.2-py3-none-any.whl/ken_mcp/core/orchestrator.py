...
def generate_next_steps(project_path: Path) -> List[str]:
    """Generate list of next steps for user
    ...
    return [
        ...
        f"5. Add to Claude using: claude mcp add <name> \"{project_path}/run_server.py\"",
        f"6. Exit and restart Claude Code for MCP to become active",
        f"7. Verify connection with: /mcp (should show connected ✔)"
    ]