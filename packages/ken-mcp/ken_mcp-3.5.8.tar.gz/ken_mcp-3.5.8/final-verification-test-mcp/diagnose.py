#!/usr/bin/env python3
"""
Cross-Platform MCP Diagnostic Script for final-verification-test-mcp
...
class CrossPlatformDiagnostics:
    ...
    def run_diagnostics(self):
        ...
        print("🔍 Cross-Platform MCP Diagnostics for final-verification-test-mcp")
        print("=" * 70)
    ...
    def _generate_platform_specific_steps(self):
        ...
        if self.os_type == "windows":
            print(f"   claude mcp add final-verification-test-mcp \"{python_cmd} {project_path}\\run_server.py\"")
            print("   # Alternative if above fails:")
            print(f"   claude mcp add final-verification-test-mcp \"{project_path}\\run_server.bat\"")
        else:
            print(f"   claude mcp add final-verification-test-mcp \"{project_path}/run_server.py\"")
            print("   # Alternative if above fails:")
            print(f"   claude mcp add final-verification-test-mcp \"{python_cmd} {project_path}/run_server.py\"")
        print()
