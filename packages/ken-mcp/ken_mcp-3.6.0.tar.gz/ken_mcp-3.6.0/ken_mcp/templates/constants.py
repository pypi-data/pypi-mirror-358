...
**📋 CLAUDE.md Rules File:** This project includes a comprehensive CLAUDE.md file with:
...
The CLAUDE.md file helps Claude Code understand exactly how to work with your MCP!
