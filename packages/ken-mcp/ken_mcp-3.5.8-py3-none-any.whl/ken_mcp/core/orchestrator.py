...
def generate_next_steps(project_path: Path) -> List[str]:
    ...
    steps.extend([
        "6. claude mcp list  # Confirm MCP was added to config",
        "7. Exit and restart Claude Code for MCP to become active",
        "8. claude mcp list  # Verify MCP shows as Active ✓ (not Failed ✗)",
        "9. Verify connection with: /mcp (should show connected ✔)",
        "",
