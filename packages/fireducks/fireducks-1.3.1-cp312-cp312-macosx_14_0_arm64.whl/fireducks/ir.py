...
Op_make_scalar_timedelta_ns = fire.Opcode("fireducks.make_scalar.timedelta_ns")
...
def make_scalar_timedelta_ns(src: int):
    return _build_op(Op_make_scalar_timedelta_ns, [Ty_scalar], [src]).outs[0]
