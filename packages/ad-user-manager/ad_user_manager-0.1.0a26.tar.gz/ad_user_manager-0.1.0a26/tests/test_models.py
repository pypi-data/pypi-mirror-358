...
from ad_user_manager.models import (
...
class TestADConfigIntegration:
    ...
    def test_dc_config_empty_base_dn_with_auto_detect_false_should_fail(self):
        ...
        assert "Base DN is required for DC configuration when auto_detect_base_dn is False" in str(exc_info.value)
