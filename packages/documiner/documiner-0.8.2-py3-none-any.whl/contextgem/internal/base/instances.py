...
various instance types in the Documiner framework. It includes the _InstanceBase class
...
from documiner.internal.utils import _is_text_content_empty
...
class _InstanceBase(_PostInitCollectorMixin, _InstanceSerializer, ABC):
    ...
    for various instance types in the Documiner framework.
