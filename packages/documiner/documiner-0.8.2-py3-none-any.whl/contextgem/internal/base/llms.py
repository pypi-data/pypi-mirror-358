...
in the Documiner framework. It includes abstract base classes and utility functions
...
from documiner.internal.base.serialization import _InstanceSerializer
...
if TYPE_CHECKING:
    ...
    from documiner.internal.items import _ExtractedItem

from documiner.internal.base.concepts import _Concept
from documiner.internal.base.mixins import _PostInitCollectorMixin
from documiner.internal.data_models import (
    _LLMCall,
    _LLMCostOutputContainer,
    _LLMUsage,
    _LLMUsageOutputContainer,
)
from documiner.internal.decorators import _timer_decorator
from documiner.internal.items import _StringItem
from documiner.internal.loggers import logger
from documiner.internal.typings.aliases import (
    ExtractedInstanceType,
    JustificationDepth,
    LLMRoleAny,
    ReferenceDepth,
)
from documiner.internal.utils import (
...
class _GenericLLMProcessor(_PostInitCollectorMixin, _InstanceSerializer, ABC):
    ...
    operations within the Documiner framework. It defines the core interface and shared
