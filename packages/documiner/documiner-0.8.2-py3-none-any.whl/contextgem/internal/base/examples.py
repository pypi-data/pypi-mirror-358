...
in the Documiner framework. Examples serve as user-provided samples for extraction tasks,
...
class _Example(_InstanceBase):
    """
    Base class that represents an example for extraction tasks in the Documiner framework.
