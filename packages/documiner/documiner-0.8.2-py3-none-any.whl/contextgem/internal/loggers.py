...
"""
Module providing a customized logging configuration for the Documiner framework.
...
DISABLE_LOGGER_ENV_VAR_NAME = "DOCUMINER_DISABLE_LOGGER"
LOGGER_LEVEL_ENV_VAR_NAME = "DOCUMINER_LOGGER_LEVEL"
...
class _DedicatedStream:
    ...
    def write(self, message):
        ...
        self.base.write(f"[documiner] {message}")
