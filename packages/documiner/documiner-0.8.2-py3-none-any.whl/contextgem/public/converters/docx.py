...
"""
DOCX document conversion module for Documiner.

Provides functionality for converting Microsoft Word DOCX files into Documiner document objects,
...
from documiner.internal.converters.docx.base import _DocxConverterBase
from documiner.internal.converters.docx.exceptions import DocxConverterError
from documiner.internal.converters.docx.package import _DocxPackage
from documiner.internal.loggers import logger
from documiner.internal.typings.aliases import TextMode
from documiner.public.documents import Document


class DocxConverter(_DocxConverterBase):
    """
    Converter for DOCX files into Documiner documents.
    ...
    in any way. It only extracts content for conversion to Documiner document object
    or text formats.

    The resulting Documiner document is populated with the following:
    ...
    def convert_to_text_format(
        ...
        """
        Converts a DOCX file directly to text without creating a Documiner Document.
    ...
    def convert(
        ...
        """
        Converts a DOCX file into a Documiner Document object.
