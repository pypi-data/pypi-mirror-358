...
The module supports common image formats (JPEG, PNG, WebP) and integrates with the broader Documiner
...
class Image(_InstanceBase):
    ...
    :ivar base64_data: The base64-encoded data of the image. The util function
        `image_to_base64()` from documiner.public.utils can be used to encode images to base64.
