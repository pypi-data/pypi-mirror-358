...
Documents serve as the primary container for content analysis within the Documiner framework,
...
from documiner.internal.decorators import _post_init_method, _timer_decorator
from documiner.internal.loggers import logger
from documiner.internal.typings.aliases import NonEmptyStr, SaTModelId, Self
...
class Document(_AssignedInstancesProcessor, _MarkdownTextAttributesProcessor):
    ...
    A document serves as the primary container for content analysis within the Documiner framework,
    enabling complex document understanding and information extraction workflows.
