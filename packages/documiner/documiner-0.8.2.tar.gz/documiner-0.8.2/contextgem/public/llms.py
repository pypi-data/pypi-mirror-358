...
from documiner.internal.base.llms import _GenericLLMProcessor
from documiner.internal.data_models import _LLMCall, _LLMCost, _LLMUsage
from documiner.internal.decorators import _post_init_method
...
from documiner.internal.utils import _get_template, _run_sync, _setup_jinja2_template
from documiner.public.data_models import LLMPricing
...
class DocumentLLM(_GenericLLMProcessor):
    ...
    def _post_init(self, __context):
        ...
        if any(self.model.startswith(provider) for provider in local_providers):
            logger.info(
                ...
                "https://documiner.ai/optimizations/optimization_small_llm_troubleshooting.html"
            )
    ...
    def _update_default_prompt(
        ...
        Default prompts are located under ``documiner/internal/prompts/``
