...
from aspects or documents in the Documiner framework. Items serve as the basic units of information
...
from documiner.internal.base.attrs import _RefParasAndSentsAttrituteProcessor
from documiner.internal.decorators import _post_init_method
from documiner.internal.typings.aliases import NonEmptyStr
...
class _ExtractedItem(_RefParasAndSentsAttrituteProcessor):
    """
    Base class for items extracted from aspects or documents in the Documiner framework.
