...
from documiner.internal.base.attrs import _ExtractedItemsAttributeProcessor
from documiner.internal.base.items import _ExtractedItem
from documiner.internal.typings.aliases import LLMRoleAny, NonEmptyStr, ReferenceDepth


class _Concept(_ExtractedItemsAttributeProcessor):
    """
    Base class for all concept types in the Documiner framework.
