...
from documiner.internal.loggers import logger
from documiner.internal.typings.strings_to_types import _deserialize_type_hint
from documiner.internal.typings.types_normalization import _normalize_type_annotation
from documiner.internal.typings.types_to_strings import _serialize_type_hint

if TYPE_CHECKING:
    from documiner.internal.base.concepts import _Concept
    from documiner.internal.base.items import _ExtractedItem
    from documiner.internal.base.examples import _Example
    from documiner.internal.data_models import _LLMCost

from documiner.internal.typings.aliases import Self
...
class _InstanceSerializer(BaseModel):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        from documiner.internal.data_models import _LLMCost, _LLMUsage
    ...
    def from_dict(cls, obj_dict: dict[str, Any]) -> Self:
        ...
        import documiner.internal.items as cg_items
        import documiner.public.concepts as cg_concepts
        import documiner.public.examples as cg_examples
        from documiner import Image
        from documiner.internal.data_models import _LLMUsage
        from documiner.public.aspects import Aspect
        from documiner.public.data_models import LLMPricing, RatingScale
        from documiner.public.llms import DocumentLLM
    ...
    def _validate_custom_data_serializable(cls, value: dict) -> dict:
        ...
        """
        from documiner.internal.utils import _is_json_serializable
