...
class HandleReadFileFromEphemeralDevServer200ResponseContentOneOf(BaseModel):
    """
    HandleReadFileFromEphemeralDevServer200ResponseContentOneOf
    """ # noqa: E501
    content: StrictStr
    encoding: StrictStr
    kind: StrictStr
    __properties: ClassVar[List[str]] = ["content", "encoding", "kind"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HandleReadFileFromEphemeralDevServer200ResponseContentOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HandleReadFileFromEphemeralDevServer200ResponseContentOneOf from a dict"""
        if obj is None:
            return None
