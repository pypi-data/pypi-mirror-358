...
DEPLOYMENTBUILDOPTIONS_ONE_OF_SCHEMAS = ["Custom", "bool"]
...
class DeploymentBuildOptions(BaseModel):
    ...
    """
    # data type: Custom
    oneof_schema_1_validator: Optional[Custom] = None
    # data type: bool
    oneof_schema_2_validator: Optional[StrictBool] = None
    actual_instance: Optional[Union[Custom, bool]] = None
    one_of_schemas: Set[str] = { "Custom", "bool" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in DeploymentBuildOptions with oneOf schemas: Custom, bool. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in DeploymentBuildOptions with oneOf schemas: Custom, bool. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into DeploymentBuildOptions with oneOf schemas: Custom, bool. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into DeploymentBuildOptions with oneOf schemas: Custom, bool. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], Custom, bool]]:
