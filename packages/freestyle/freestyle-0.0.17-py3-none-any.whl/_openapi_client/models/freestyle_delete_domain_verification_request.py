...
class FreestyleDeleteDomainVerificationRequest(BaseModel):
    """
    FreestyleDeleteDomainVerificationRequest
    """ # noqa: E501
    domain: StrictStr = Field(description="The domain to create a verification code for")
    verification_code: StrictStr = Field(description="The verification code", alias="verificationCode")
    __properties: ClassVar[List[str]] = ["domain", "verificationCode"]
