...
class ReadFileRequest(BaseModel):
    ...
    ReadFileRequest
    """ # noqa: E501
    dev_server: DevServer = Field(alias="devServer")
    encoding: Optional[StrictStr] = 'utf-8'
    __properties: ClassVar[List[str]] = ["devServer", "encoding"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReadFileRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReadFileRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "devServer": DevServer.from_dict(obj["devServer"]) if obj.get("devServer") is not None else None,
