...
class HandleReadFileFromEphemeralDevServer200Response(BaseModel):
    """
    HandleReadFileFromEphemeralDevServer200Response
    """ # noqa: E501
    id: StrictStr
    is_new: StrictBool = Field(alias="isNew")
    content: HandleReadFileFromEphemeralDevServer200ResponseContent
    __properties: ClassVar[List[str]] = ["id", "isNew", "content"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HandleReadFileFromEphemeralDevServer200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HandleReadFileFromEphemeralDevServer200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "isNew": obj.get("isNew"),
            "content": HandleReadFileFromEphemeralDevServer200ResponseContent.from_dict(obj["content"]) if obj.get("content") is not None else None
        })
        return _obj
