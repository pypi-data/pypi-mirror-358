...
class ConfigureGithubSyncRequest(BaseModel):
    """
    ConfigureGithubSyncRequest
    """ # noqa: E501
    github_repo_name: StrictStr = Field(description="The GitHub repository name in \"owner/repo\" format", alias="githubRepoName")
    __properties: ClassVar[List[str]] = ["githubRepoName"]
