...
class HandleWriteFileFromEphemeralDevServer200Response(BaseModel):
    """
    HandleWriteFileFromEphemeralDevServer200Response
    """ # noqa: E501
    id: StrictStr
    is_new: StrictBool = Field(alias="isNew")
    __properties: ClassVar[List[str]] = ["id", "isNew"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HandleWriteFileFromEphemeralDevServer200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HandleWriteFileFromEphemeralDevServer200Response from a dict"""
        if obj is None:
            return None
