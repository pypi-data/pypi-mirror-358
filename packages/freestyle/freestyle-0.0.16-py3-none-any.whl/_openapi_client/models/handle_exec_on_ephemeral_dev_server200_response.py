...
class HandleExecOnEphemeralDevServer200Response(BaseModel):
    """
    HandleExecOnEphemeralDevServer200Response
    """ # noqa: E501
    id: StrictStr
    is_new: StrictBool = Field(alias="isNew")
    stdout: Optional[List[StrictStr]] = None
    stderr: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["id", "isNew", "stdout", "stderr"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HandleExecOnEphemeralDevServer200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HandleExecOnEphemeralDevServer200Response from a dict"""
        if obj is None:
            return None
