...
class HandleCreateGitTriggerRequestActionOneOf(BaseModel):
    """
    HandleCreateGitTriggerRequestActionOneOf
    """ # noqa: E501
    endpoint: StrictStr
    action: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HandleCreateGitTriggerRequestActionOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HandleCreateGitTriggerRequestActionOneOf from a dict"""
        if obj is None:
            return None
