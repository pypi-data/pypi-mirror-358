...
class HandleListIdentities200Response(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HandleListIdentities200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HandleListIdentities200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "identities": [GitIdentity.from_dict(_item) for _item in obj["identities"]] if obj.get("identities") is not None else None,
