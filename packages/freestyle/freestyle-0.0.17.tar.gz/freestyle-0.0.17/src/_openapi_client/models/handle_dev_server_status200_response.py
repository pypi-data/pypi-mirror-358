...
class HandleDevServerStatus200Response(BaseModel):
    """
    HandleDevServerStatus200Response
    """ # noqa: E501
    installing: StrictBool
    dev_running: StrictBool = Field(alias="devRunning")
    __properties: ClassVar[List[str]] = ["installing", "devRunning"]
