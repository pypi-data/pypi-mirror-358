...
class GitReference(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the ref (e.g., \"refs/heads/main\" or \"refs/tags/v1.0.0\")")
    sha: StrictStr = Field(description="The SHA-1 hash of the Git object this reference points to")
