...
setup(
    ...
    entry_points={
        "console_scripts": [
            "mybashbuddy=bashbuddy.main:app",
        ],
    },
    keywords="ai, shell, cli, gemini, assistant, automation",
    project_urls={
        "Bug Reports": "https://github.com/yourusername/bashbuddy/issues",
        "Source": "https://github.com/yourusername/bashbuddy",
        "Documentation": "https://github.com/yourusername/bashbuddy#readme",
    },
) 