...
class LicenseKeyProjection(LicenseKey):
    ...
    def __init__(self, cluster_license_key_mapping_projection=None, key=None, validation_detail=None, type=None, category=None, sub_category=None, entitlement_expiry_date=None, meter=None, quantity=None, group_id=None, assignment_details=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        LicenseKey.__init__(self, key, validation_detail, type, category, sub_category, entitlement_expiry_date, meter, quantity, group_id, assignment_details, ext_id, links, tenant_id, *args, **kwargs)
