...
class FaithfulnessScorer(Scorer):
    ...
    def __init__(self, model: InferenceModel, language: SupportedLanguages):
        self.model = model
    ...
    async def score(self, thread: StringThread) -> ScoreWithMetadata:
        ...
        # Generate response
        _, parsed_response = await self.model.generate_and_validate(judge_thread, FaithfulnessScorerOutput)
