TOOL_PARAM_MAP = {
    ...
    "mcp_cldkctl_cldkctl_status": {
        "endpoint": "/core/cldkctl/status",
        "method": "GET",
        "required_params": [],
        "optional_params": [],
    },
    ...
    "mcp_cldkctl_cldkctl_switch_environment": {
        "endpoint": "/core/cldkctl/environment",
        "method": "POST",
        "required_params": [
            {"name": "environment", "type": "string", "desc": "Environment to use: 'production' or 'staging'"},
        ],
        "optional_params": [],
    },
    ...
    "mcp_cldkctl_cldkctl_registry_artifact_list": {
        "endpoint": "/core/registry/artifact/list",
        "method": "GET",
        "required_params": [],
        "optional_params": [],
    },
    ...
    "mcp_cldkctl_cldkctl_voucher_list": {
        "endpoint": "/core/voucher/list",
        "method": "GET",
        "required_params": [],
        "optional_params": [],
    },
    "mcp_cldkctl_cldkctl_voucher_apply": {
        "endpoint": "/core/voucher/apply",
        "method": "POST",
        "required_params": [],
        "optional_params": [],
    },
    "mcp_cldkctl_cldkctl_token_list": {
        "endpoint": "/core/token/list",
        "method": "GET",
        "required_params": [],
        "optional_params": [],
    },
    ...
    "mcp_cldkctl_cldkctl_token_delete": {
        "endpoint": "/core/token/:token_id",
        "method": "DELETE",
        "required_params": [],
        "optional_params": [],
    },
    "mcp_cldkctl_cldkctl_audit_logs": {
        "endpoint": "/core/audit/logs",
        "method": "GET",
        "required_params": [],
        "optional_params": [],
    },
