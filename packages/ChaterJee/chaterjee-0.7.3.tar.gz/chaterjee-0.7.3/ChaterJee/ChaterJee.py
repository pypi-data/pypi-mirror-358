...
jobs_file = _data / "CHATERJEE_JOB_status.json"
...
class ChatLogs:
    ...
    def cmdTRIGGER(self, read_timeout=7, get_updates_read_timeout=42):
        ...
        send_job_complete_notification = job_queue.run_repeating(callback_minute, interval=60, first=10)

        application.run_polling()

    async def send_jobs_status(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        TXT = get_jobs_status()
        self.txt = TXT
