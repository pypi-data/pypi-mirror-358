...
# ------------------------------------------------------------------
# File Name:        nmr_c13_fibroin_spectrum.py
# Author:           Jiwei Huang
# Version:          0.0.1
# Created:          2012/01/01
# Description:      定义“表征`丝素 NMR C13 谱数据`的类”。
# History:
...
__doc__ = """
Define a class that represents `NMR C13 spectrum of fibroin`.
"""
...
# 定义 ==============================================================
class NmrC13FibroinSpectrum(NmrC13Spectrum):
    """
    类`NmrC13FibroinSpectrum`表征“丝素 NMR C13 谱数据”。
    """
    ...
    def __init__(self, ppm: npt.NDArray[np.number],
        ...
        """
        super(NmrC13FibroinSpectrum, self).__init__(ppm, intensity, **kwargs)
    ...
    def slice(self, xi: Union[int, float], xj: Union[int, float]):
        ...
        return NmrC13FibroinSpectrum(slice_ppm, slice_intensity, **self.rebuild_kwargs())
    ...
    def horizontal_shift(self, shift_amount: Union[int, float]):
        ...
        return NmrC13FibroinSpectrum(new_ppm, self.intensity, **self.rebuild_kwargs())
    ...
    def vertical_shift(self, shift_amount: Union[int, float]):
        ...
        return NmrC13FibroinSpectrum(self.ppm, new_intensity, **self.rebuild_kwargs())
    ...
    def alignment_point(self):
        ...
        """
        return self.find_alignment_point(x_start=110, x_end=120)
