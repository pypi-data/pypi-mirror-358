...
class PaymentSettings(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["automatic_checkout", b"automatic_checkout", "cc_fixed", b"cc_fixed", "cc_percent", b"cc_percent", "fee_fixed", b"fee_fixed", "fee_monthly", b"fee_monthly", "fee_percent", b"fee_percent"]) -> None: ...
