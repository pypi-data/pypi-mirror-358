...
from voidgrapi.extractors import extract_guide_v1, extract_location, extract_media_v1
from voidgrapi.types import Guide, Location, Media
...
class LocationMixin:
    ...
    def location_info(self, location_pk: int) -> Location:
        ...
        try:
            ...
            # such this - https://github.com/subzeroid/voidgrapi/issues/364
