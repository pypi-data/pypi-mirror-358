...
from voidgrapi import config
from voidgrapi.exceptions import ClientNotFoundError, StoryNotFound, UserNotFound
from voidgrapi.extractors import (
    extract_story_gql,
    extract_story_v1,
    extract_user_short,
)
from voidgrapi.types import Story, UserShort
...
class StoryMixin:
    ...
    def story_download_by_url(
        ...
        assert fname, (
            ...
            """Read the documentation https://subzeroid.github.io/voidgrapi/usage-guide/story.html"""
        )
