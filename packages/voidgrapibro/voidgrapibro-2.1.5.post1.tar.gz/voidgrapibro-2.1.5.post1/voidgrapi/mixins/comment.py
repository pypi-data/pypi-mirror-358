...
from voidgrapi.exceptions import ClientError, ClientNotFoundError, MediaNotFound
from voidgrapi.extractors import extract_comment
from voidgrapi.types import Comment
