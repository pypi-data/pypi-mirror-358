...
class DataStore:
    ...
    def save_object(self, objectname: str, objectinstance: Any, isencrypted: bool, attributes: Optional[List[str]] = None, path: str = "objects") -> None:
        """
        ...
        Args:
            ...
            path (str): The path for saving data; defaults to "objects".
    ...
    def save_offline_object(self, objectname: str, objectinstance: Any, attributes: Optional[List[str]] = None) -> None:
        """
