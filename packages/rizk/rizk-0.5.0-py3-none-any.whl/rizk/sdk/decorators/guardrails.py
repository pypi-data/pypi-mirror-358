...
logger = logging.getLogger("rizk.decorators.guardrails")
...
def guardrails(
    ...
    **adapter_kwargs: Any,
    ...
    """Decorator to apply Rizk guardrails using framework adapters.

    This decorator detects the framework (or uses the one provided by other Rizk decorators)
    ...
    Args:
        ...
        on_output_violation: Action on output violation: 'exception' (raise RizkPolicyViolation),
    ...
    def decorator_guardrails(func: Callable[..., Any]) -> Callable[..., Any]:
        ...
        if not adapter_instance:
            ...
            from rizk.sdk.adapters.openai_agents_adapter import OpenAIAgentsAdapter
                ...
                try:
                    ...
                    if blocked:
                        if on_input_violation == "exception":
                            ...
                            from rizk.sdk.decorators.policies import RizkPolicyViolation

                            raise RizkPolicyViolation(
...
# Alias for backward compatibility with previous Rizk SDK versions
