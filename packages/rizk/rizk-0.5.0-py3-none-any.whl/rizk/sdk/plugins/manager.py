...
class PluginLoadResult:
    ...
    plugin_name: str
    success: bool
    plugin_instance: Optional[RizkPlugin] = None
...
class PluginManager:
    ...
    def __init__(
        ...
        # Plugin state
        self.loaded_plugins: Dict[str, RizkPlugin] = {}
        ...
        # Event hooks
        self._load_hooks: List[Callable[[str, RizkPlugin], None]] = []
    ...
    def add_load_hook(self, hook: Callable[[str, RizkPlugin], None]) -> None:
    ...
    def _create_plugin_instance(
        self, plugin_class: Type[RizkPlugin], plugin_name: str, config: Dict[str, Any]
    ) -> RizkPlugin:
    ...
    def _register_plugin_with_di(
        self, plugin_name: str, plugin_instance: RizkPlugin
    ) -> None:
