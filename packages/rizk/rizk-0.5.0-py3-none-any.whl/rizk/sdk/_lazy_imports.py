"""
Lazy import system for Rizk SDK to prevent circular imports and reduce initialization overhead.
...
LAZY_FRAMEWORK_ADAPTERS: Dict[str, LazyImporter] = {
    "openai_agents": LazyImporter(
        "rizk.sdk.adapters.openai_agents_adapter", "OpenAIAgentsAdapter", DummyClass
    ),
    "agents_sdk": LazyImporter(
        "rizk.sdk.adapters.openai_agents_adapter", "OpenAIAgentsAdapter", DummyClass
    ),
    "langchain": LazyImporter(
        "rizk.sdk.adapters.langchain", "LangChainAdapter", DummyClass
    ),
    "langgraph": LazyImporter(
        "rizk.sdk.adapters.langgraph_adapter", "LangGraphAdapter", DummyClass
    ),
    "crewai": LazyImporter("rizk.sdk.adapters.crew_ai", "CrewAIAdapter", DummyClass),
    "llama_index": LazyImporter(
        "rizk.sdk.adapters.llama_index", "LlamaIndexAdapter", DummyClass
    ),
}
...
LAZY_LLM_ADAPTERS: Dict[str, LazyImporter] = {
    "openai": LazyImporter(
        "rizk.sdk.adapters.openai_completion_adapter",
        "OpenAICompletionAdapter",
        DummyClass,
    ),
    "anthropic": LazyImporter(
        "rizk.sdk.adapters.anthropic_adapter", "AnthropicAdapter", DummyClass
    ),
    "gemini": LazyImporter(
        "rizk.sdk.adapters.gemini_adapter", "GeminiAdapter", DummyClass
    ),
    "ollama": LazyImporter(
        "rizk.sdk.adapters.ollama_adapter", "OllamaAdapter", DummyClass
    ),
}

# Registry of lazy-loaded functions
LAZY_FUNCTIONS: Dict[str, LazyImporter] = {
    "add_rizk_guardrails": LazyImporter(
        "rizk.sdk.adapters.agents_adapter", "add_rizk_guardrails", DummyClass
    ),
}
