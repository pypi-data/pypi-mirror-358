"""Provides the Rizk Client class for API interaction and Traceloop integration."""
...
logger = logging.getLogger("rizk.client")


class Client:
    """Rizk Client for Rizk API interaction and Traceloop features.

    Wraps the Traceloop client, offering a unified interface for Rizk-specific
    ...
    Attributes:
        ...
        api_key: The Rizk API key for authentication (optional).
