"""
Base class for all framework adapters in Rizk SDK.
"""
...
logger = logging.getLogger("rizk.adapters.base")

F = TypeVar("F", bound=Callable[..., Any])


class RizkFrameworkAdapter(BaseAdapter):
    """
    Base class for all framework adapters.

    Framework adapters provide a common interface for adapting Rizk decorators
...
def detect_framework(func_or_obj: Any, **kwargs: Any) -> str:
    ...
    from rizk.sdk.utils.framework_detection import detect_framework_cached as detect
