"""
Base class for all guardrail adapters in Rizk SDK.
"""
...
from rizk.sdk.guardrails.types import Decision, PolicySet
from rizk.sdk.tracing import get_current_span, set_span_attribute

logger = logging.getLogger("rizk.adapters.guardrail")


class RizkGuardrailAdapter:
    """Base adapter for Rizk guardrails to work with different frameworks"""
    ...
    async def evaluate(
        ...
        """
        Run guardrail evaluation using the Rizk engine.
