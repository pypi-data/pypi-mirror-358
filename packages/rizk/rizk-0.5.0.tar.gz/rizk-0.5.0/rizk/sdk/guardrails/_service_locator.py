...
from rizk.sdk._di_container import DIContainer, get_container
from rizk.sdk.guardrails.llm_service import LLMServiceProtocol, DefaultLLMService
...
class GuardrailsServiceLocator:
    ...
    def _register_llm_service(self, config: Dict[str, Any]) -> None:
        ...
        if hasattr(llm_service, "evaluate"):
            self._container.register_singleton(LLMServiceProtocol, llm_service)  # type: ignore[type-abstract]
    ...
    def _register_tracer(self) -> None:
        ...
        tracer = trace.get_tracer("rizk.guardrails")
