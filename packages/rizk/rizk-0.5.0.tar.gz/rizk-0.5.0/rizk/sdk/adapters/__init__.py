...
ADAPTERS: Dict[str, Type[RizkFrameworkAdapter]] = {}


def register_adapter(
    framework_name: str, adapter_class: Type[RizkFrameworkAdapter]
) -> None:
...
def get_adapter(framework_name: str) -> Optional[Type[RizkFrameworkAdapter]]:
