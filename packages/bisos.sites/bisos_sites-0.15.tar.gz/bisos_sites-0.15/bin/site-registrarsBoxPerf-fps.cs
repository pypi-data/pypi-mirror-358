...
#+END_SRC
#+RESULTS:
| bisos.b.cs.ro | bisos.csPlayer.bleep | bisos.b.fp_csu | bisos.bpo.bpo | bisos.bpo.bpoFps_csu | bisos.b.fpCls | bisos.b.clsMethod_csu | bisos.sites.site_registrarsBoxPerf_fps |
#+end_org """
...
csuList = [ 'bisos.b.cs.ro', 'bisos.csPlayer.bleep', 'bisos.b.fp_csu', 'bisos.bpo.bpo', 'bisos.bpo.bpoFps_csu', 'bisos.b.fpCls', 'bisos.b.clsMethod_csu', 'bisos.sites.site_registrarsBoxPerf_fps', ]
...
####+BEGIN: b:py3:cs:main/exposedSymbols :classes ("site_registrarsBoxPerf_fps.site_RegistrarsBoxPerf_FPs")
""" #+begin_org
...
** [[elisp:(org-cycle)][| *CmndDesc:* | ]]  Conventional top level example.
        ...
        site_registrarsBoxPerf_fps.examples_csu()

        bpoFps_csu.examples_csu().pyCmnd(bpoId=siteBpoId, cls='site_RegistrarsBoxPerf_FPs')
