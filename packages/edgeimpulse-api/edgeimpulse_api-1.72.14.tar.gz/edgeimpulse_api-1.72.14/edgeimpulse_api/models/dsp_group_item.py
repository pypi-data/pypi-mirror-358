...
class DSPGroupItem(BaseModel):
    ...
    __properties = ["name", "value", "defaultValue", "type", "help", "param", "selectOptions", "readonly", "shouldShow", "showIf", "invalidText", "section", "multiline", "required", "hint", "placeholder", "showClickToSet"]
