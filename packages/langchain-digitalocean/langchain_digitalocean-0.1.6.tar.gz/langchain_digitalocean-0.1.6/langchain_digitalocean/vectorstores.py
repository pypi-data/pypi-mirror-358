"""LangchainDigitalocean vector stores."""
...
class LangchainDigitaloceanVectorStore(VectorStore):
    # TODO: Replace all TODOs in docstring.
    """LangchainDigitalocean vector store integration.
    ...
    Instantiate:
        .. code-block:: python
            ...
            vector_store = LangchainDigitaloceanVectorStore(
                collection_name="foo",
    ...
    @classmethod
    def from_texts(
        cls: Type[LangchainDigitaloceanVectorStore],
        texts: List[str],
