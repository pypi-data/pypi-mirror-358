...
def box_group(data: pd.DataFrame, x: str, y: str, pal: list = None, legend: bool = False) -> None:
    '''
...
def bar_freq(data: pd.DataFrame, x: str, color: str = None, pal: list = None, legend: bool = False) -> None:
    '''
