...
class StreamsetsFlowApiClient(BaseAPIClient):
    ...
    def get_streamsets_flow_by_id(self, params: dict, flow_id: str) -> requests.Response:
        ...
        Returns:
           A HTTP response.
        """
        url = f"{self.base_url}/{self.url_path}/streamsets_flows/{flow_id}"
        response = self.get(url=url, params=params)
        return response
    ...
    def duplicate_streamsets_flow(self, params: dict, flow_id: str, data: str) -> requests.Response:
        ...
        Returns:
            A HTTP response.
        """
        url = f"{self.base_url}/{self.url_path}/streamsets_flows/{flow_id}/duplicate"
        response = self.post(url=url, data=data, params=params)
        return response

    def get_streamsets_connection(self, id: str, params: dict[str, Any]) -> requests.Response:
