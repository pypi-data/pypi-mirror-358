...
class UserAPIClient(BaseAPIClient):
    ...
    def get_users(self, account_id: str, params: dict = None) -> requests.Response:
        ...
        Returns:
            A HTTP response.
        """
        url = f"{self.base_url}/{self.url_path}/{account_id}/users"
    ...
    def get_user_profile(self, account_id: str, iam_id: str) -> requests.Response:
        ...
        Returns:
            A HTTP response.
        """
        url = f"{self.base_url}/{self.url_path}/{account_id}/users/{iam_id}"
    ...
    def get_user_settings(self, account_id: str, iam_id: str) -> requests.Response:
        ...
        Returns:
            A HTTP response.
        """
        url = f"{self.base_url}/{self.url_path}/{account_id}/users/{iam_id}/settings"
        response = self.get(url=url)
        return response
