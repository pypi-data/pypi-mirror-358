...
class RoleAPIClient(BaseAPIClient):
    ...
    def get_roles(
        ...
        Args:
            params: Params to filter by. This can contain: account_id, service_name,
            source_service_name, policy_type, service_group_id
    ...
    def retrieve_role(self, role_id: str) -> requests.Response:
        ...
        Returns:
            A HTTP response.
        """
        url = f"{self.base_url}/{self.url_path}/{role_id}"
    ...
    def create_role(self, data: str) -> requests.Response:
        ...
        Args:
            data: data to create a role. this should contain:
            name, display_name, description, account_id, service_name, actions
        Returns:
            A HTTP response.
        """
        url = f"{self.base_url}/{self.url_path}"
    ...
    def update_role(self, role_id: str, etag: str, data: str) -> requests.Response:
        ...
        Args:
            ...
            data: data to update a role. Possible fields are:
            display_name, description, actions.
