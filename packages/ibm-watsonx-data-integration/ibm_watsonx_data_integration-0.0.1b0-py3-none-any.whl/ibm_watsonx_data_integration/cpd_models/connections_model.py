...
class Connection(BaseModel):
    ...
    def _delete(self) -> requests.Response:
        ...
        return self._platform._connections_api.delete_connection(id=self.metadata.asset_id, params=params)
...
class DatasourceTypeAction(BaseModel):
    ...
    def execute(
        ...
        response = self._platform._connections_api.perform_connection_action(
            id=connection.metadata.asset_id if connection else self._connection.metadata.asset_id,
