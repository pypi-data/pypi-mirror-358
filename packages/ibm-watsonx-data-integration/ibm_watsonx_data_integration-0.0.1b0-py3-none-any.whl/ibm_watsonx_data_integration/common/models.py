...
class BaseModel(PydanticBaseModel):
    ...
    Attributes:
        EXPOSED_DATA_PATH: Dictionary of key paths used to expose data as attributes
    """
    ...
    def serialize_model(self, handler: Any, info: SerializationInfo) -> dict:  # noqa: ANN401
        """Serializes the data, back into it's originnal formatting.
        ...
        for key_path in data[HIDDEN_DICTIONARY]:
            ...
            # Wrap back the data in its appropiate field
...
class CollectionModel:
    ...
    def _paginate(self, **kwargs: dict) -> BaseModel:
        ...
        # Iterate over pages
        while not last_page and len(current_results) > 0:
            ...
            if response_bookmark in response:
