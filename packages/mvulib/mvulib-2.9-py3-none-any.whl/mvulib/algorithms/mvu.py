...
def summarize(inst):
    ...
    print(f"\nSolver Summary:\n\nn_constraints={inst.n_constraints}"+\
          f"\niter={inst.iter}\nfeasratio={inst.feasratio}"+\
          f"\npinf={inst.pinf}\ndinf={inst.dinf}\nnumerr={inst.numerr}\n")
    print(f"Mvu Summary:\n\ncost={inst.cost}\nn_components={inst.n_components}"+\
          f"\nreconstruction_error={inst.reconstruction_error}"+\
          f"\nreconstruction_error_rel={inst.reconstruction_error_rel}\n")
    print(sep)
