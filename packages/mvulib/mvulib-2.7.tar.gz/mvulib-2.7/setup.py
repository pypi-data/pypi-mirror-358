...
if __name__ == '__main__':
    setup_dict = {
        'name': 'mvulib',
        'version': '2.7',
        'description': 'A Python Interface to MATLAB implementation of Maximum Variance '+\
          ' Unfolding (MVU) dimensionality reduction algorithm.\n'+\
          ' Installation of MATLAB Runtime 24.1 is required.',
