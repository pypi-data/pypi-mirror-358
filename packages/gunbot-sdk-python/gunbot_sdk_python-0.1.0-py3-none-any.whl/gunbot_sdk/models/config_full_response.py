...
class ConfigFullResponse(object):
    ...
    def __init__(self, status=None, config=None):  # noqa: E501
        """ConfigFullResponse - a model defined in Swagger"""  # noqa: E501
        self._status = None
        self._config = None
    ...
    @property
    def status(self):
        """Gets the status of this ConfigFullResponse.  # noqa: E501


        :return: The status of this ConfigFullResponse.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this ConfigFullResponse.


        :param status: The status of this ConfigFullResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def config(self):
        """Gets the config of this ConfigFullResponse.  # noqa: E501


        :return: The config of this ConfigFullResponse.  # noqa: E501
        :rtype: GunbotConfig
        """
        return self._config
    ...
    def config(self, config):
        """Sets the config of this ConfigFullResponse.


        :param config: The config of this ConfigFullResponse.  # noqa: E501
        :type: GunbotConfig
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConfigFullResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfigFullResponse):
            return False
