...
class CoreMemSingleRequest(object):
    ...
    def __init__(self, exchange=None, pair=None):  # noqa: E501
        """CoreMemSingleRequest - a model defined in Swagger"""  # noqa: E501
        self._exchange = None
        self._pair = None
    ...
    @property
    def exchange(self):
        """Gets the exchange of this CoreMemSingleRequest.  # noqa: E501


        :return: The exchange of this CoreMemSingleRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def exchange(self, exchange):
        """Sets the exchange of this CoreMemSingleRequest.


        :param exchange: The exchange of this CoreMemSingleRequest.  # noqa: E501
        :type: str
        """
        if exchange is None:
    ...
    @property
    def pair(self):
        """Gets the pair of this CoreMemSingleRequest.  # noqa: E501


        :return: The pair of this CoreMemSingleRequest.  # noqa: E501
        :rtype: str
        """
        return self._pair
    ...
    @pair.setter
    def pair(self, pair):
        """Sets the pair of this CoreMemSingleRequest.


        :param pair: The pair of this CoreMemSingleRequest.  # noqa: E501
        :type: str
        """
        if pair is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CoreMemSingleRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CoreMemSingleRequest):
            return False
