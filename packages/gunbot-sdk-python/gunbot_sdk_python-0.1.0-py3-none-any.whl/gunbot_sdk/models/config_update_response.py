...
class ConfigUpdateResponse(object):
    ...
    def __init__(self, status=None, config=None):  # noqa: E501
        """ConfigUpdateResponse - a model defined in Swagger"""  # noqa: E501
        self._status = None
        self._config = None
    ...
    @property
    def status(self):
        """Gets the status of this ConfigUpdateResponse.  # noqa: E501


        :return: The status of this ConfigUpdateResponse.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this ConfigUpdateResponse.


        :param status: The status of this ConfigUpdateResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def config(self):
        """Gets the config of this ConfigUpdateResponse.  # noqa: E501


        :return: The config of this ConfigUpdateResponse.  # noqa: E501
        :rtype: GunbotConfig
        """
        return self._config
    ...
    def config(self, config):
        """Sets the config of this ConfigUpdateResponse.


        :param config: The config of this ConfigUpdateResponse.  # noqa: E501
        :type: GunbotConfig
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConfigUpdateResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfigUpdateResponse):
            return False
