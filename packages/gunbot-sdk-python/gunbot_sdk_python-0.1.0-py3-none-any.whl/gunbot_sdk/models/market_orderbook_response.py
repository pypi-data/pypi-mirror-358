...
class MarketOrderbookResponse(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """MarketOrderbookResponse - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this MarketOrderbookResponse.  # noqa: E501


        :return: The data of this MarketOrderbookResponse.  # noqa: E501
        :rtype: MarketOrderbookData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this MarketOrderbookResponse.


        :param data: The data of this MarketOrderbookResponse.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MarketOrderbookResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MarketOrderbookResponse):
            return False
