...
class FileGetRequest(object):
    ...
    def __init__(self, filename=None):  # noqa: E501
        """FileGetRequest - a model defined in Swagger"""  # noqa: E501
        self._filename = None
    ...
    @property
    def filename(self):
        """Gets the filename of this FileGetRequest.  # noqa: E501

        The name of the file to retrieve.  # noqa: E501

        :return: The filename of this FileGetRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def filename(self, filename):
        """Sets the filename of this FileGetRequest.

        The name of the file to retrieve.  # noqa: E501

        :param filename: The filename of this FileGetRequest.  # noqa: E501
        :type: str
        """
        if filename is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FileGetRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FileGetRequest):
            return False
