...
class ConfigPairAddRequest(object):
    ...
    def __init__(self, pair=None, exchange=None, settings=None):  # noqa: E501
        """ConfigPairAddRequest - a model defined in Swagger"""  # noqa: E501
        self._pair = None
        self._exchange = None
        self._settings = None
    ...
    @property
    def pair(self):
        """Gets the pair of this ConfigPairAddRequest.  # noqa: E501

        The trading pair to add (e.g., `USDT-PEPE`).  # noqa: E501

        :return: The pair of this ConfigPairAddRequest.  # noqa: E501
        :rtype: str
        """
        return self._pair
    ...
    @pair.setter
    def pair(self, pair):
        """Sets the pair of this ConfigPairAddRequest.

        The trading pair to add (e.g., `USDT-PEPE`).  # noqa: E501

        :param pair: The pair of this ConfigPairAddRequest.  # noqa: E501
        :type: str
        """
        if pair is None:
    ...
    @property
    def exchange(self):
        """Gets the exchange of this ConfigPairAddRequest.  # noqa: E501

        The exchange name (e.g., `binance`).  # noqa: E501

        :return: The exchange of this ConfigPairAddRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def exchange(self, exchange):
        """Sets the exchange of this ConfigPairAddRequest.

        The exchange name (e.g., `binance`).  # noqa: E501

        :param exchange: The exchange of this ConfigPairAddRequest.  # noqa: E501
        :type: str
        """
        if exchange is None:
    ...
    @property
    def settings(self):
        """Gets the settings of this ConfigPairAddRequest.  # noqa: E501

        (Optional) Specific settings for the trading pair.  # noqa: E501

        :return: The settings of this ConfigPairAddRequest.  # noqa: E501
    ...
    def settings(self, settings):
        """Sets the settings of this ConfigPairAddRequest.

        (Optional) Specific settings for the trading pair.  # noqa: E501

        :param settings: The settings of this ConfigPairAddRequest.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConfigPairAddRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfigPairAddRequest):
            return False
