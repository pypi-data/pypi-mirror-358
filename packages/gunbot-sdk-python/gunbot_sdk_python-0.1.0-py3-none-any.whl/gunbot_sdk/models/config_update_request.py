...
class ConfigUpdateRequest(object):
    ...
    def __init__(self, config=None):  # noqa: E501
        """ConfigUpdateRequest - a model defined in Swagger"""  # noqa: E501
        self._config = None
    ...
    @property
    def config(self):
        """Gets the config of this ConfigUpdateRequest.  # noqa: E501


        :return: The config of this ConfigUpdateRequest.  # noqa: E501
        :rtype: GunbotConfig
        """
        return self._config
    ...
    def config(self, config):
        """Sets the config of this ConfigUpdateRequest.


        :param config: The config of this ConfigUpdateRequest.  # noqa: E501
        :type: GunbotConfig
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConfigUpdateRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfigUpdateRequest):
            return False
