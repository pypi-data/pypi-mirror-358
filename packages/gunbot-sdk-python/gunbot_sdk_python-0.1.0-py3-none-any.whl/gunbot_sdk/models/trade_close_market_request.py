...
class TradeCloseMarketRequest(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """TradeCloseMarketRequest - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this TradeCloseMarketRequest.  # noqa: E501


        :return: The data of this TradeCloseMarketRequest.  # noqa: E501
        :rtype: TradeCloseMarketData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this TradeCloseMarketRequest.


        :param data: The data of this TradeCloseMarketRequest.  # noqa: E501
        :type: TradeCloseMarketData
        """
        if data is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TradeCloseMarketRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TradeCloseMarketRequest):
            return False
