...
class TradeOcoData(object):
    ...
    def __init__(self, exch=None, pair=None, amt=None, price=None, stop_price=None, limit=None):  # noqa: E501
        """TradeOcoData - a model defined in Swagger"""  # noqa: E501
        self._exch = None
        self._pair = None
        self._amt = None
        self._price = None
    ...
    @property
    def exch(self):
        """Gets the exch of this TradeOcoData.  # noqa: E501


        :return: The exch of this TradeOcoData.  # noqa: E501
        :rtype: str
        """
        return self._exch
    ...
    @exch.setter
    def exch(self, exch):
        """Sets the exch of this TradeOcoData.


        :param exch: The exch of this TradeOcoData.  # noqa: E501
        :type: str
        """
        if exch is None:
    ...
    @property
    def pair(self):
        """Gets the pair of this TradeOcoData.  # noqa: E501


        :return: The pair of this TradeOcoData.  # noqa: E501
        :rtype: str
        """
        return self._pair
    ...
    @pair.setter
    def pair(self, pair):
        """Sets the pair of this TradeOcoData.


        :param pair: The pair of this TradeOcoData.  # noqa: E501
        :type: str
        """
        if pair is None:
    ...
    @property
    def amt(self):
        """Gets the amt of this TradeOcoData.  # noqa: E501


        :return: The amt of this TradeOcoData.  # noqa: E501
        :rtype: float
        """
        return self._amt
    ...
    @amt.setter
    def amt(self, amt):
        """Sets the amt of this TradeOcoData.


        :param amt: The amt of this TradeOcoData.  # noqa: E501
        :type: float
        """
        if amt is None:
    ...
    @property
    def price(self):
        """Gets the price of this TradeOcoData.  # noqa: E501

        Limit price for the OCO order part.  # noqa: E501

        :return: The price of this TradeOcoData.  # noqa: E501
        :rtype: float
        """
        return self._price
    ...
    def price(self, price):
        """Sets the price of this TradeOcoData.

        Limit price for the OCO order part.  # noqa: E501

        :param price: The price of this TradeOcoData.  # noqa: E501
        :type: float
        """
        if price is None:
    ...
    @property
    def stop_price(self):
        """Gets the stop_price of this TradeOcoData.  # noqa: E501

        Stop price for the stop-limit part.  # noqa: E501

        :return: The stop_price of this TradeOcoData.  # noqa: E501
        :rtype: float
        """
    ...
    def stop_price(self, stop_price):
        """Sets the stop_price of this TradeOcoData.

        Stop price for the stop-limit part.  # noqa: E501

        :param stop_price: The stop_price of this TradeOcoData.  # noqa: E501
        :type: float
        """
    ...
    @property
    def limit(self):
        """Gets the limit of this TradeOcoData.  # noqa: E501

        Limit price used after stopPrice is triggered for the stop-limit part.  # noqa: E501

        :return: The limit of this TradeOcoData.  # noqa: E501
        :rtype: float
        """
        return self._limit
    ...
    def limit(self, limit):
        """Sets the limit of this TradeOcoData.

        Limit price used after stopPrice is triggered for the stop-limit part.  # noqa: E501

        :param limit: The limit of this TradeOcoData.  # noqa: E501
        :type: float
        """
        if limit is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TradeOcoData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TradeOcoData):
            return False
