...
class OrdersDayResponse(object):
    ...
    swagger_types = {
        'days': 'list[str]',
        'orders': 'list[int]',
        'close_orders': 'list[int]'
    }

    attribute_map = {
        'days': 'days',
        'orders': 'orders',
        'close_orders': 'closeOrders'
    }

    def __init__(self, days=None, orders=None, close_orders=None):  # noqa: E501
        """OrdersDayResponse - a model defined in Swagger"""  # noqa: E501
        self._days = None
        self._orders = None
        self._close_orders = None
        self.discriminator = None
        if days is not None:
            self.days = days
        if orders is not None:
            self.orders = orders
        if close_orders is not None:
            self.close_orders = close_orders

    @property
    def days(self):
        """Gets the days of this OrdersDayResponse.  # noqa: E501

        ISO-8601 dates.  # noqa: E501

        :return: The days of this OrdersDayResponse.  # noqa: E501
        :rtype: list[str]
        """
        return self._days
    ...
    @days.setter
    def days(self, days):
        """Sets the days of this OrdersDayResponse.

        ISO-8601 dates.  # noqa: E501

        :param days: The days of this OrdersDayResponse.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def orders(self):
        """Gets the orders of this OrdersDayResponse.  # noqa: E501

        Order count per day.  # noqa: E501

        :return: The orders of this OrdersDayResponse.  # noqa: E501
        :rtype: list[int]
        """
        return self._orders
    ...
    def orders(self, orders):
        """Sets the orders of this OrdersDayResponse.

        Order count per day.  # noqa: E501

        :param orders: The orders of this OrdersDayResponse.  # noqa: E501
        :type: list[int]
        """
    ...
    def close_orders(self):
        """Gets the close_orders of this OrdersDayResponse.  # noqa: E501

        Close order count per day.  # noqa: E501

        :return: The close_orders of this OrdersDayResponse.  # noqa: E501
        :rtype: list[int]
        """
        return self._close_orders

    @close_orders.setter
    def close_orders(self, close_orders):
        """Sets the close_orders of this OrdersDayResponse.

        Close order count per day.  # noqa: E501

        :param close_orders: The close_orders of this OrdersDayResponse.  # noqa: E501
        :type: list[int]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OrdersDayResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrdersDayResponse):
            return False
