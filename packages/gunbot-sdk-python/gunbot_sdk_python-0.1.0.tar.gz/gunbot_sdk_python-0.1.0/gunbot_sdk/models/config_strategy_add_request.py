...
class ConfigStrategyAddRequest(object):
    ...
    def __init__(self, name=None, settings=None):  # noqa: E501
        """ConfigStrategyAddRequest - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._settings = None
    ...
    @property
    def name(self):
        """Gets the name of this ConfigStrategyAddRequest.  # noqa: E501

        The name of the strategy to add (e.g., `myStrategy`).  # noqa: E501

        :return: The name of this ConfigStrategyAddRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ConfigStrategyAddRequest.

        The name of the strategy to add (e.g., `myStrategy`).  # noqa: E501

        :param name: The name of this ConfigStrategyAddRequest.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def settings(self):
        """Gets the settings of this ConfigStrategyAddRequest.  # noqa: E501

        (Optional) Specific settings for the strategy.  # noqa: E501

        :return: The settings of this ConfigStrategyAddRequest.  # noqa: E501
    ...
    def settings(self, settings):
        """Sets the settings of this ConfigStrategyAddRequest.

        (Optional) Specific settings for the strategy.  # noqa: E501

        :param settings: The settings of this ConfigStrategyAddRequest.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConfigStrategyAddRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfigStrategyAddRequest):
            return False
