...
class TradeLimitOrderRequest(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """TradeLimitOrderRequest - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    @property
    def data(self):
        """Gets the data of this TradeLimitOrderRequest.  # noqa: E501


        :return: The data of this TradeLimitOrderRequest.  # noqa: E501
        :rtype: TradeLimitOrderData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this TradeLimitOrderRequest.


        :param data: The data of this TradeLimitOrderRequest.  # noqa: E501
        :type: TradeLimitOrderData
        """
        if data is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TradeLimitOrderRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TradeLimitOrderRequest):
            return False
