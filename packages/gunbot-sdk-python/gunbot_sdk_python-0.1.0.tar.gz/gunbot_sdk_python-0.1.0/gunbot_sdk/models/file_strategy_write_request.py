...
class FileStrategyWriteRequest(object):
    ...
    def __init__(self, filename=None, document=None):  # noqa: E501
        """FileStrategyWriteRequest - a model defined in Swagger"""  # noqa: E501
        self._filename = None
        self._document = None
    ...
    @property
    def filename(self):
        """Gets the filename of this FileStrategyWriteRequest.  # noqa: E501


        :return: The filename of this FileStrategyWriteRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def filename(self, filename):
        """Sets the filename of this FileStrategyWriteRequest.


        :param filename: The filename of this FileStrategyWriteRequest.  # noqa: E501
        :type: str
        """
        if filename is None:
    ...
    @property
    def document(self):
        """Gets the document of this FileStrategyWriteRequest.  # noqa: E501

        The content to write into the strategy file.  # noqa: E501

        :return: The document of this FileStrategyWriteRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def document(self, document):
        """Sets the document of this FileStrategyWriteRequest.

        The content to write into the strategy file.  # noqa: E501

        :param document: The document of this FileStrategyWriteRequest.  # noqa: E501
        :type: str
        """
        if document is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FileStrategyWriteRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FileStrategyWriteRequest):
            return False
