...
class ConfigPairRemoveRequest(object):
    ...
    def __init__(self, pair=None, exchange=None):  # noqa: E501
        """ConfigPairRemoveRequest - a model defined in Swagger"""  # noqa: E501
        self._pair = None
        self._exchange = None
    ...
    @property
    def pair(self):
        """Gets the pair of this ConfigPairRemoveRequest.  # noqa: E501

        The trading pair to remove (e.g., `USDT-PEPE`).  # noqa: E501

        :return: The pair of this ConfigPairRemoveRequest.  # noqa: E501
        :rtype: str
        """
        return self._pair
    ...
    @pair.setter
    def pair(self, pair):
        """Sets the pair of this ConfigPairRemoveRequest.

        The trading pair to remove (e.g., `USDT-PEPE`).  # noqa: E501

        :param pair: The pair of this ConfigPairRemoveRequest.  # noqa: E501
        :type: str
        """
        if pair is None:
    ...
    @property
    def exchange(self):
        """Gets the exchange of this ConfigPairRemoveRequest.  # noqa: E501

        The exchange name (e.g., `binance`).  # noqa: E501

        :return: The exchange of this ConfigPairRemoveRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def exchange(self, exchange):
        """Sets the exchange of this ConfigPairRemoveRequest.

        The exchange name (e.g., `binance`).  # noqa: E501

        :param exchange: The exchange of this ConfigPairRemoveRequest.  # noqa: E501
        :type: str
        """
        if exchange is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConfigPairRemoveRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfigPairRemoveRequest):
            return False
