...
class PairsDetailedResponse(object):
    ...
    swagger_types = {
        'status': 'str',
        'pair_list': 'dict(str, list[PairDetailItem])'
    }
    ...
    def __init__(self, status=None, pair_list=None):  # noqa: E501
        """PairsDetailedResponse - a model defined in Swagger"""  # noqa: E501
        self._status = None
    ...
    @property
    def status(self):
        """Gets the status of this PairsDetailedResponse.  # noqa: E501


        :return: The status of this PairsDetailedResponse.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this PairsDetailedResponse.


        :param status: The status of this PairsDetailedResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def pair_list(self):
        """Gets the pair_list of this PairsDetailedResponse.  # noqa: E501

        An object where keys are base currencies (e.g., \"BTC\") and values are arrays of pair details.  # noqa: E501

        :return: The pair_list of this PairsDetailedResponse.  # noqa: E501
        :rtype: dict(str, list[PairDetailItem])
        """
        return self._pair_list

    @pair_list.setter
    def pair_list(self, pair_list):
        """Sets the pair_list of this PairsDetailedResponse.

        An object where keys are base currencies (e.g., \"BTC\") and values are arrays of pair details.  # noqa: E501

        :param pair_list: The pair_list of this PairsDetailedResponse.  # noqa: E501
        :type: dict(str, list[PairDetailItem])
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PairsDetailedResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PairsDetailedResponse):
            return False
