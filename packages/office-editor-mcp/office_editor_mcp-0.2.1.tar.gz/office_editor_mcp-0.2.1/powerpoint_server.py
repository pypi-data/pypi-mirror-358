...
@mcp.tool()
def presentation_to_base64(prs_id: str) -> str:
    """
    将PowerPoint文件保存为base64格式
...
@mcp.tool()
def base64_to_presentation(base64_str: str, filename: str) -> str:
    """
    将base64格式的PowerPoint文件保存为Presentation对象，并返回prs_id

    Args:
        base64_str: base64字符串格式的PowerPoint文件
        filename: PowerPoint文件的文件名

    Returns:
        prs_id
    """
    pptx_data = base64.b64decode(base64_str)
    buffer = io.BytesIO(pptx_data)
