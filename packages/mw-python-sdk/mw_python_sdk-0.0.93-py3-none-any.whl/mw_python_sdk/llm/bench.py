...
def get_tokenizer(
    ...
    if pretrained_model_name_or_path.endswith(
        ...
        return PreTrainedTokenizerFast(tokenizer_file=pretrained_model_name_or_path)
...
def get_dataset(dataset_name, dataset_path, num_prompts, context_len, output_len, tokenizer):
