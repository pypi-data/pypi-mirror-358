...
import time, os
from .generation import generate_flask_api, generate_flask_full
...
def main():
    ...
    print(ANSI_BLUE + "2. Flask Full Stack Application" + ANSI_RESET)
    ...
    if choice == '1' or choice == "":
        ...
        print("What is the name of your Flask Full Stack project?")
        project_name = input("Enter project name: ")
        if not project_name:
            print(ANSI_RED + "Project name cannot be empty." + ANSI_RESET)
            return main()
        print(ANSI_BLUE + f"Generating Flask Full Stack project: {project_name}..." + ANSI_RESET)
        generate_flask_full.generate(os.getcwd(), project_name)
        time.sleep(1)
        print(ANSI_GREEN + "Project generated successfully!" + ANSI_RESET)
        time.sleep(1)
    else:
