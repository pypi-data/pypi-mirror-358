...
```python
# Initialize the API
entity_sync_policies_api_instance = EntitySyncPoliciesApi(api_client=client) # client configured in previous step
extId = 'extId_example' # UUID.

# List entity sync policies
try:
    api_response = entity_sync_policies_api_instance.list_entity_sync_policies(
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=datapolicies&version=v4.1&language=python). This documentation is auto-generated, and the location may change.
