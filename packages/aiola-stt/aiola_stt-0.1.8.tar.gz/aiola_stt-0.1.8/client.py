...
SILENCE_DURATION_MS = 2000  # Silence duration in milliseconds
...
class AiolaSttClient:
    ...
    def _silence_padding(
        ...
        silence_duration_ms = SILENCE_DURATION_MS + (getattr(self.config.vad_config, 'min_silence_duration_ms', 0) if self.config.vad_config else 0)
