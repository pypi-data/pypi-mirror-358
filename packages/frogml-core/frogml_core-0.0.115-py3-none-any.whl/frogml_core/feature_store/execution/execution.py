...
from frogml_proto.qwak.administration.authenticated_user.v1.authenticated_user_service_pb2 import (
    GetCloudCredentialsResponse,
)
from frogml_core.clients.administration import AuthenticatedUserClient
