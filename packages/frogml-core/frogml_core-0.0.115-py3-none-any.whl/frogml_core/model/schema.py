...
from frogml_proto.qwak.build.v1.build_pb2 import ModelSchema as ProtoModelSchema
from frogml_core.model._entity_extraction import enrich_schema
from frogml_core.model.schema_entities import (
    BaseFeature,
    Entity,
    ExplicitFeature,
    FeatureStoreInput,
