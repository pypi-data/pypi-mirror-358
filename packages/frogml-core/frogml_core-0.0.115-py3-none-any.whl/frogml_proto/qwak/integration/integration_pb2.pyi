...
import frogml_proto.qwak.integration.hugging_face_integration_pb2
import frogml_proto.qwak.integration.open_a_i_integration_pb2
import frogml_proto.qwak.integration.opsgenie_integration_pb2
import frogml_proto.qwak.integration.pagerduty_integration_pb2
import frogml_proto.qwak.integration.slack_app_integration_pb2
import sys
import typing
...
class Integration(google.protobuf.message.Message):
    ...
    @property
    def opsgenie_integration(self) -> frogml_proto.qwak.integration.opsgenie_integration_pb2.OpsgenieIntegration: ...
    @property
    def pagerduty_integration(self) -> frogml_proto.qwak.integration.pagerduty_integration_pb2.PagerdutyIntegration: ...
    @property
    def qwak_slack_app_integration(self) -> frogml_proto.qwak.integration.slack_app_integration_pb2.SlackAppIntegration: ...
    @property
    def openai_integration(self) -> frogml_proto.qwak.integration.open_a_i_integration_pb2.OpenAIIntegration: ...
    @property
    def hugging_face_integration(self) -> frogml_proto.qwak.integration.hugging_face_integration_pb2.HuggingFaceIntegration: ...
    name: builtins.str
    """Integration Name"""
    def __init__(
        self,
        *,
        ...
        opsgenie_integration: frogml_proto.qwak.integration.opsgenie_integration_pb2.OpsgenieIntegration | None = ...,
        pagerduty_integration: frogml_proto.qwak.integration.pagerduty_integration_pb2.PagerdutyIntegration | None = ...,
        qwak_slack_app_integration: frogml_proto.qwak.integration.slack_app_integration_pb2.SlackAppIntegration | None = ...,
        openai_integration: frogml_proto.qwak.integration.open_a_i_integration_pb2.OpenAIIntegration | None = ...,
        hugging_face_integration: frogml_proto.qwak.integration.hugging_face_integration_pb2.HuggingFaceIntegration | None = ...,
        name: builtins.str = ...,
    ) -> None: ...
...
class IntegrationSpec(google.protobuf.message.Message):
    ...
    @property
    def opsgenie_integration_spec(self) -> frogml_proto.qwak.integration.opsgenie_integration_pb2.OpsgenieIntegrationSpec: ...
    @property
    def pagerduty_integration_spec(self) -> frogml_proto.qwak.integration.pagerduty_integration_pb2.PagerdutyIntegrationSpec: ...
    @property
    def qwak_slack_app_integration_spec(self) -> frogml_proto.qwak.integration.slack_app_integration_pb2.SlackAppIntegrationSpec: ...
    @property
    def openai_integration_spec(self) -> frogml_proto.qwak.integration.open_a_i_integration_pb2.OpenAIIntegrationSpec: ...
    @property
    def hugging_face_integration_spec(self) -> frogml_proto.qwak.integration.hugging_face_integration_pb2.HuggingFaceIntegrationSpec: ...
    name: builtins.str
    """Integration Name"""
    def __init__(
        self,
        *,
        ...
        opsgenie_integration_spec: frogml_proto.qwak.integration.opsgenie_integration_pb2.OpsgenieIntegrationSpec | None = ...,
        pagerduty_integration_spec: frogml_proto.qwak.integration.pagerduty_integration_pb2.PagerdutyIntegrationSpec | None = ...,
        qwak_slack_app_integration_spec: frogml_proto.qwak.integration.slack_app_integration_pb2.SlackAppIntegrationSpec | None = ...,
        openai_integration_spec: frogml_proto.qwak.integration.open_a_i_integration_pb2.OpenAIIntegrationSpec | None = ...,
        hugging_face_integration_spec: frogml_proto.qwak.integration.hugging_face_integration_pb2.HuggingFaceIntegrationSpec | None = ...,
        name: builtins.str = ...,
    ) -> None: ...
...
class IntegrationValidationSpec(google.protobuf.message.Message):
    ...
    @property
    def opsgenie_validation_spec(self) -> frogml_proto.qwak.integration.opsgenie_integration_pb2.OpsgenieValidationSpec: ...
    @property
    def pagerduty_validation_spec(self) -> frogml_proto.qwak.integration.pagerduty_integration_pb2.PagerdutyValidationSpec: ...
    @property
    def qwak_slack_app_validation_spec(self) -> frogml_proto.qwak.integration.slack_app_integration_pb2.SlackAppValidationSpec: ...
    @property
    def openai_validation_spec(self) -> frogml_proto.qwak.integration.open_a_i_integration_pb2.OpenAIValidationSpec: ...
    @property
    def hugging_face_validation_spec(self) -> frogml_proto.qwak.integration.hugging_face_integration_pb2.HuggingFaceValidationSpec: ...
    def __init__(
        self,
        *,
        jfrog_validation_spec: global___JFrogValidationSpec | None = ...,
        opsgenie_validation_spec: frogml_proto.qwak.integration.opsgenie_integration_pb2.OpsgenieValidationSpec | None = ...,
        pagerduty_validation_spec: frogml_proto.qwak.integration.pagerduty_integration_pb2.PagerdutyValidationSpec | None = ...,
        qwak_slack_app_validation_spec: frogml_proto.qwak.integration.slack_app_integration_pb2.SlackAppValidationSpec | None = ...,
        openai_validation_spec: frogml_proto.qwak.integration.open_a_i_integration_pb2.OpenAIValidationSpec | None = ...,
        hugging_face_validation_spec: frogml_proto.qwak.integration.hugging_face_integration_pb2.HuggingFaceValidationSpec | None = ...,
    ) -> None: ...
...
class IntegrationOptions(google.protobuf.message.Message):
    ...
    @property
    def opsgenie_integration_options(self) -> frogml_proto.qwak.integration.opsgenie_integration_pb2.OpsgenieIntegrationOptions: ...
    @property
    def pagerduty_integration_options(self) -> frogml_proto.qwak.integration.pagerduty_integration_pb2.PagerdutyIntegrationOptions: ...
    @property
    def qwak_slack_app_integration_options(self) -> frogml_proto.qwak.integration.slack_app_integration_pb2.SlackAppIntegrationOptions: ...
    @property
    def openai_integration_options(self) -> frogml_proto.qwak.integration.open_a_i_integration_pb2.OpenAIIntegrationOptions: ...
    @property
    def hugging_face_integration_options(self) -> frogml_proto.qwak.integration.hugging_face_integration_pb2.HuggingFaceIntegrationOptions: ...
    def __init__(
        self,
        *,
        jfrog_integration_options: global___JFrogIntegrationOptions | None = ...,
        opsgenie_integration_options: frogml_proto.qwak.integration.opsgenie_integration_pb2.OpsgenieIntegrationOptions | None = ...,
        pagerduty_integration_options: frogml_proto.qwak.integration.pagerduty_integration_pb2.PagerdutyIntegrationOptions | None = ...,
        qwak_slack_app_integration_options: frogml_proto.qwak.integration.slack_app_integration_pb2.SlackAppIntegrationOptions | None = ...,
        openai_integration_options: frogml_proto.qwak.integration.open_a_i_integration_pb2.OpenAIIntegrationOptions | None = ...,
        hugging_face_integration_options: frogml_proto.qwak.integration.hugging_face_integration_pb2.HuggingFaceIntegrationOptions | None = ...,
    ) -> None: ...
