...
class SetEnvironmentSecretRequest(google.protobuf.message.Message):
    ...
    @property
    def options(self) -> frogml_proto.qwak.admiral.secret.v0.secret_pb2.SetUserEnvironmentSecretOptions: ...
    def __init__(
        self,
        *,
        options: frogml_proto.qwak.admiral.secret.v0.secret_pb2.SetUserEnvironmentSecretOptions | None = ...,
    ) -> None: ...
...
class ListAccountSecretsResponse(google.protobuf.message.Message):
    ...
    @property
    def account_secrets(self) -> frogml_proto.qwak.admiral.secret.v0.secret_pb2.AccountSecrets:
        """Secrets of account"""
    def __init__(
        self,
        *,
        account_secrets: frogml_proto.qwak.admiral.secret.v0.secret_pb2.AccountSecrets | None = ...,
    ) -> None: ...
