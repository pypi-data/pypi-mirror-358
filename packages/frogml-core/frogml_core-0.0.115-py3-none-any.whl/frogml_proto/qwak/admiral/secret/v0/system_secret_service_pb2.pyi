...
import frogml_proto.qwak.admiral.secret.v0.secret_pb2
import sys
...
class SetSystemSecretRequest(google.protobuf.message.Message):
    ...
    @property
    def options(self) -> frogml_proto.qwak.admiral.secret.v0.secret_pb2.SetSystemEnvironmentSecretOptions: ...
    def __init__(
        self,
        *,
        options: frogml_proto.qwak.admiral.secret.v0.secret_pb2.SetSystemEnvironmentSecretOptions | None = ...,
    ) -> None: ...
...
class DeleteSystemSecretRequest(google.protobuf.message.Message):
    ...
    @property
    def identifier(self) -> frogml_proto.qwak.admiral.secret.v0.secret_pb2.EnvironmentSecretIdentifier:
        """Secret identifier"""
    def __init__(
        self,
        *,
        identifier: frogml_proto.qwak.admiral.secret.v0.secret_pb2.EnvironmentSecretIdentifier | None = ...,
    ) -> None: ...
...
class GetSystemSecretResponse(google.protobuf.message.Message):
    ...
    @property
    def secret_definition(self) -> frogml_proto.qwak.admiral.secret.v0.secret_pb2.SystemSecretDefinition:
        """Secret definition"""
    def __init__(
        self,
        *,
        secret_definition: frogml_proto.qwak.admiral.secret.v0.secret_pb2.SystemSecretDefinition | None = ...,
    ) -> None: ...
