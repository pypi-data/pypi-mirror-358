...
import frogml_proto.qwak.feature_store.jobs.v1.job_pb2
import sys
...
class ApplyJobRequest(google.protobuf.message.Message):
    ...
    @property
    def job_record(self) -> frogml_proto.qwak.feature_store.jobs.v1.job_pb2.JobRecord:
        """The job record to register"""
    def __init__(
        self,
        *,
        job_record: frogml_proto.qwak.feature_store.jobs.v1.job_pb2.JobRecord | None = ...,
    ) -> None: ...
...
class GetLatestJobResponse(google.protobuf.message.Message):
    ...
    @property
    def job(self) -> frogml_proto.qwak.feature_store.jobs.v1.job_pb2.JobRecord:
        """the requested job"""
    def __init__(
        self,
        *,
        job: frogml_proto.qwak.feature_store.jobs.v1.job_pb2.JobRecord | None = ...,
    ) -> None: ...
