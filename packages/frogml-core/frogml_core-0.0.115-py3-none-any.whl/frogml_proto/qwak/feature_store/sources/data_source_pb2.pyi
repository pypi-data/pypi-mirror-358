...
import frogml_proto.qwak.feature_store.sources.data_source_attribute_pb2
...
class DataSourceSpec(google.protobuf.message.Message):
    ...
    @property
    def batch_source(self) -> frogml_proto.qwak.feature_store.sources.batch_pb2.BatchSource: ...
    @property
    def stream_source(self) -> frogml_proto.qwak.feature_store.sources.streaming_pb2.StreamingSource: ...
    @property
    def source_code_spec(self) -> frogml_proto.qwak.feature_store.v1.common.source_code.source_code_pb2.SourceCodeSpec: ...
    @property
    def data_source_attributes(self) -> frogml_proto.qwak.feature_store.sources.data_source_attribute_pb2.DataSourceAttributes:
    ...
    def __init__(
        self,
        *,
        batch_source: frogml_proto.qwak.feature_store.sources.batch_pb2.BatchSource | None = ...,
        stream_source: frogml_proto.qwak.feature_store.sources.streaming_pb2.StreamingSource | None = ...,
        source_code_spec: frogml_proto.qwak.feature_store.v1.common.source_code.source_code_pb2.SourceCodeSpec | None = ...,
        data_source_attributes: frogml_proto.qwak.feature_store.sources.data_source_attribute_pb2.DataSourceAttributes | None = ...,
        featureset_repository_name: builtins.str = ...,
        data_source_repository_name: builtins.str = ...,
    ) -> None: ...
