...
import frogml_proto.qwak.administration.account.v1.personalization_pb2
import sys
...
class AccountPreferences(google.protobuf.message.Message):
    ...
    @property
    def personalization(self) -> frogml_proto.qwak.administration.account.v1.personalization_pb2.AccountPersonalization:
        """Account personalization"""
    def __init__(
        self,
        *,
        personalization: frogml_proto.qwak.administration.account.v1.personalization_pb2.AccountPersonalization | None = ...,
    ) -> None: ...
