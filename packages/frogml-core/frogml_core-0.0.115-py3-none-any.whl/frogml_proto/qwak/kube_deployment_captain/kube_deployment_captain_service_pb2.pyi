...
import frogml_proto.qwak.kube_deployment_captain.alert_pb2
import frogml_proto.qwak.kube_deployment_captain.alerting_pb2
import frogml_proto.qwak.kube_deployment_captain.deployment_pb2
import frogml_proto.qwak.kube_deployment_captain.feature_set_deployment_pb2
import frogml_proto.qwak.kube_deployment_captain.traffic_mapping_pb2
import sys
import typing
...
class ApplyModelsAlertsRequest(google.protobuf.message.Message):
    ...
    kube_deployment_type: frogml_proto.qwak.kube_deployment_captain.deployment_pb2.KubeDeploymentType.ValueType
...
class CreateOrReplaceFeatureSetAlertRequest(google.protobuf.message.Message):
    ...
    @property
    def options(self) -> frogml_proto.qwak.kube_deployment_captain.alerting_pb2.FeatureSetAlertOptions:
        """Parameters for creating or replacing an alert"""
    def __init__(
        self,
        *,
        options: frogml_proto.qwak.kube_deployment_captain.alerting_pb2.FeatureSetAlertOptions | None = ...,
    ) -> None: ...
...
class KubeDeployModelRequest(google.protobuf.message.Message):
    ...
    """
    @property
    def deployment_size(self) -> frogml_proto.qwak.kube_deployment_captain.deployment_pb2.KubeDeploymentSize:
        """Deployment size"""
    @property
    def advanced_deployment_options(self) -> frogml_proto.qwak.kube_deployment_captain.deployment_pb2.KubeAdvancedDeploymentOptions:
        """Advanced Deployment Options"""
    deployment_id: builtins.str
    """Deployment Id"""
    @property
    def serving_strategy(self) -> frogml_proto.qwak.kube_deployment_captain.deployment_pb2.KubeServingStrategy:
    ...
    @property
    def auto_scaling_spec(self) -> frogml_proto.qwak.kube_deployment_captain.deployment_pb2.AutoScalingSpec:
    ...
    def __init__(
        ...
        *,
        ...
        docker_image: builtins.str = ...,
        number_of_pods: builtins.int = ...,
        deployment_size: frogml_proto.qwak.kube_deployment_captain.deployment_pb2.KubeDeploymentSize | None = ...,
        advanced_deployment_options: frogml_proto.qwak.kube_deployment_captain.deployment_pb2.KubeAdvancedDeploymentOptions | None = ...,
        deployment_id: builtins.str = ...,
        serving_strategy: frogml_proto.qwak.kube_deployment_captain.deployment_pb2.KubeServingStrategy | None = ...,
        environment_variables: collections.abc.Mapping[builtins.str, builtins.str] | None = ...,
        auto_scaling_spec: frogml_proto.qwak.kube_deployment_captain.deployment_pb2.AutoScalingSpec | None = ...,
        model_uuid: builtins.str = ...,
        project_id: builtins.str = ...,
        image_pull_secret: builtins.str = ...,
    ) -> None: ...
...
class UpdateKubeDeploymentRuntimeSettingsRequest(google.protobuf.message.Message):
    ...
    """Branch ID which the model was deployed under"""
    @property
    def deployment_settings(self) -> frogml_proto.qwak.kube_deployment_captain.deployment_pb2.KubeRuntimeDeploymentSettings: ...
    kube_deployment_type: frogml_proto.qwak.kube_deployment_captain.deployment_pb2.KubeDeploymentType.ValueType
    ...
    def __init__(
        ...
        *,
        model_id: builtins.str = ...,
        branch_id: builtins.str = ...,
        deployment_settings: frogml_proto.qwak.kube_deployment_captain.deployment_pb2.KubeRuntimeDeploymentSettings | None = ...,
        kube_deployment_type: frogml_proto.qwak.kube_deployment_captain.deployment_pb2.KubeDeploymentType.ValueType = ...,
        variation_name: builtins.str = ...,
    ) -> None: ...
...
class ApplyNotificationsChannelRequest(google.protobuf.message.Message):
    ...
    @property
    def notification_channel(self) -> frogml_proto.qwak.kube_deployment_captain.alert_pb2.KubeNotificationChannel:
        """The notifications channels to apply"""
    def __init__(
        self,
        *,
        notification_channel: frogml_proto.qwak.kube_deployment_captain.alert_pb2.KubeNotificationChannel | None = ...,
    ) -> None: ...
...
class DeployFeatureSetRequest(google.protobuf.message.Message):
    ...
    @property
    def feature_set_spec(self) -> frogml_proto.qwak.kube_deployment_captain.feature_set_deployment_pb2.FeatureSetDeploymentSpec:
        """Feature set spec for deployment feature set"""
    def __init__(
        self,
        *,
        feature_set_spec: frogml_proto.qwak.kube_deployment_captain.feature_set_deployment_pb2.FeatureSetDeploymentSpec | None = ...,
    ) -> None: ...
...
class DeployStreamingAggregationBackfillRequest(google.protobuf.message.Message):
    ...
    @property
    def feature_set_deployment(self) -> frogml_proto.qwak.kube_deployment_captain.feature_set_deployment_pb2.FeatureSetDeployment: ...
    environment_id: builtins.str
    def __init__(
        self,
        *,
        feature_set_deployment: frogml_proto.qwak.kube_deployment_captain.feature_set_deployment_pb2.FeatureSetDeployment | None = ...,
        environment_id: builtins.str = ...,
    ) -> None: ...
...
class BatchFeatureSetV1DeploymentRequest(google.protobuf.message.Message):
    ...
    @property
    def batch_details(self) -> frogml_proto.qwak.kube_deployment_captain.feature_set_deployment_pb2.BatchDetails:
        """Batch details"""
    environment_id: builtins.str
    """Environment id"""
    @property
    def execution_identifier(self) -> frogml_proto.qwak.kube_deployment_captain.feature_set_deployment_pb2.ExecutionIdentifier: ...
    def __init__(
        self,
        *,
        feature_set_deployment: frogml_proto.qwak.kube_deployment_captain.feature_set_deployment_pb2.FeatureSetDeployment | None = ...,
        batch_details: frogml_proto.qwak.kube_deployment_captain.feature_set_deployment_pb2.BatchDetails | None = ...,
        environment_id: builtins.str = ...,
        execution_identifier: frogml_proto.qwak.kube_deployment_captain.feature_set_deployment_pb2.ExecutionIdentifier | None = ...,
    ) -> None: ...
