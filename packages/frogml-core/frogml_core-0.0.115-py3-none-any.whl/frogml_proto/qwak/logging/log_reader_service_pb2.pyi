...
import frogml_proto.qwak.logging.log_filter_pb2
import frogml_proto.qwak.logging.log_line_pb2
import frogml_proto.qwak.logging.log_source_pb2
import sys
...
class ReadLogsRequest(google.protobuf.message.Message):
    ...
    @property
    def source(self) -> frogml_proto.qwak.logging.log_source_pb2.LogSource:
        """Source of the logs"""
    ...
    @property
    def search_filter(self) -> frogml_proto.qwak.logging.log_filter_pb2.SearchFilter:
        """Search filter"""
    ...
    def __init__(
        self,
        *,
        source: frogml_proto.qwak.logging.log_source_pb2.LogSource | None = ...,
        before_offset: builtins.str = ...,
        after_offset: builtins.str = ...,
        search_filter: frogml_proto.qwak.logging.log_filter_pb2.SearchFilter | None = ...,
        max_number_of_results: builtins.int = ...,
    ) -> None: ...
