...
import frogml_proto.qwak.instance_template.instance_template_pb2
import sys
...
class ListInstanceTemplatesRequest(google.protobuf.message.Message):
    ...
    @property
    def optional_instance_filter(self) -> frogml_proto.qwak.instance_template.instance_template_pb2.InstanceFilter: ...
    def __init__(
        self,
        *,
        optional_instance_filter: frogml_proto.qwak.instance_template.instance_template_pb2.InstanceFilter | None = ...,
    ) -> None: ...
...
class GetInstanceTemplateResponse(google.protobuf.message.Message):
    ...
    @property
    def instance_template(self) -> frogml_proto.qwak.instance_template.instance_template_pb2.InstanceTemplateSpec: ...
    def __init__(
        self,
        *,
        instance_template: frogml_proto.qwak.instance_template.instance_template_pb2.InstanceTemplateSpec | None = ...,
    ) -> None: ...
