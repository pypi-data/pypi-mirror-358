...
import frogml_proto.qwak.administration.runtime_configuration.v0.external.victoriametrics_config_pb2
import sys
...
class MonitoringConfiguration(google.protobuf.message.Message):
    ...
    @property
    def prometheus(self) -> frogml_proto.qwak.administration.runtime_configuration.v0.external.prometheus_config_pb2.PrometheusConfiguration: ...
    @property
    def victoria_metrics(self) -> frogml_proto.qwak.administration.runtime_configuration.v0.external.victoriametrics_config_pb2.VictoriaMetricsConfiguration: ...
    def __init__(
        self,
        *,
        prometheus: frogml_proto.qwak.administration.runtime_configuration.v0.external.prometheus_config_pb2.PrometheusConfiguration | None = ...,
        victoria_metrics: frogml_proto.qwak.administration.runtime_configuration.v0.external.victoriametrics_config_pb2.VictoriaMetricsConfiguration | None = ...,
    ) -> None: ...
