...
import frogml_proto.qwak.administration.runtime_configuration.v0.external.elasticsearch_config_pb2
import sys
...
class LogsStorageConfiguration(google.protobuf.message.Message):
    ...
    @property
    def elasticsearch(self) -> frogml_proto.qwak.administration.runtime_configuration.v0.external.elasticsearch_config_pb2.ElasticsearchConfiguration: ...
    def __init__(
        self,
        *,
        elasticsearch: frogml_proto.qwak.administration.runtime_configuration.v0.external.elasticsearch_config_pb2.ElasticsearchConfiguration | None = ...,
    ) -> None: ...
