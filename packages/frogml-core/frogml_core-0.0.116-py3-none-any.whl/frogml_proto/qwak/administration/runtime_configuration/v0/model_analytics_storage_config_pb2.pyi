...
import frogml_proto.qwak.administration.runtime_configuration.v0.external.kafka_config_pb2
import sys
...
class ModelAnalyticsStorageConfiguration(google.protobuf.message.Message):
    ...
    @property
    def kafka(self) -> frogml_proto.qwak.administration.runtime_configuration.v0.external.kafka_config_pb2.KafkaConfiguration: ...
    def __init__(
        self,
        *,
        kafka: frogml_proto.qwak.administration.runtime_configuration.v0.external.kafka_config_pb2.KafkaConfiguration | None = ...,
    ) -> None: ...
