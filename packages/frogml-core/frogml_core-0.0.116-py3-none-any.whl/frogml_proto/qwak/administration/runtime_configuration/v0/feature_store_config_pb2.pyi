...
import frogml_proto.qwak.administration.runtime_configuration.v0.external.redis_config_pb2
import sys
...
class OnlineFeatureStore(google.protobuf.message.Message):
    ...
    @property
    def redis_configuration(self) -> frogml_proto.qwak.administration.runtime_configuration.v0.external.redis_config_pb2.RedisConfiguration: ...
    def __init__(
        self,
        *,
        redis_configuration: frogml_proto.qwak.administration.runtime_configuration.v0.external.redis_config_pb2.RedisConfiguration | None = ...,
    ) -> None: ...
