...
import frogml_proto.qwak.fitness_service.status_pb2
import sys
import typing
...
class Build(google.protobuf.message.Message):
    ...
    """Last modified by"""
    deployment_build_status: frogml_proto.qwak.deployment.deployment_pb2.ModelDeploymentStatus.ValueType
    ...
    @property
    def podStatus(self) -> frogml_proto.qwak.fitness_service.status_pb2.PodStatus:
        """Pod status"""
    image_name_tag: builtins.str
    """The build image name and tag"""
    @property
    def build_initiator(self) -> frogml_proto.qwak.builds.build_pb2.BuildInitiator:
    ...
    def __init__(
        ...
        *,
        ...
        podStatus: frogml_proto.qwak.fitness_service.status_pb2.PodStatus | None = ...,
        image_name_tag: builtins.str = ...,
        build_initiator: frogml_proto.qwak.builds.build_pb2.BuildInitiator | None = ...,
    ) -> None: ...
