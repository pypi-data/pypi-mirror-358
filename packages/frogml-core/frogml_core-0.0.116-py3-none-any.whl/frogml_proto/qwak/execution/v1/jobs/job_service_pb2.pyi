...
import frogml_proto.qwak.execution.v1.jobs.job_pb2
import sys
import typing
...
class ApplyJobRecordRequest(google.protobuf.message.Message):
    ...
    @property
    def job_record(self) -> frogml_proto.qwak.execution.v1.jobs.job_pb2.JobRecord:
        """a Job Record to create or replace"""
    def __init__(
        self,
        *,
        job_record: frogml_proto.qwak.execution.v1.jobs.job_pb2.JobRecord | None = ...,
    ) -> None: ...
...
class GetJobsSummaryByExecutionIdResponse(google.protobuf.message.Message):
    ...
    total_affected_rows: builtins.int
    @property
    def first_job_record(self) -> frogml_proto.qwak.execution.v1.jobs.job_pb2.JobRecord: ...
    @property
    def last_job_record(self) -> frogml_proto.qwak.execution.v1.jobs.job_pb2.JobRecord: ...
    def __init__(
        self,
        *,
        execution_id: builtins.str = ...,
        job_count: builtins.int = ...,
        total_affected_rows: builtins.int = ...,
        first_job_record: frogml_proto.qwak.execution.v1.jobs.job_pb2.JobRecord | None = ...,
        last_job_record: frogml_proto.qwak.execution.v1.jobs.job_pb2.JobRecord | None = ...,
    ) -> None: ...
