...
import frogml_proto.qwak.feature_store.v1.common.jfrog_artifact.jfrog_artifact_pb2
import sys
...
class ZipArtifact(google.protobuf.message.Message):
    ...
    @property
    def jfrog_artifact_path(self) -> frogml_proto.qwak.feature_store.v1.common.jfrog_artifact.jfrog_artifact_pb2.JfrogArtifact:
    ...
    def __init__(
        ...
        *,
        path: builtins.str = ...,
        jfrog_artifact_path: frogml_proto.qwak.feature_store.v1.common.jfrog_artifact.jfrog_artifact_pb2.JfrogArtifact | None = ...,
        main_file: builtins.str = ...,
    ) -> None: ...
