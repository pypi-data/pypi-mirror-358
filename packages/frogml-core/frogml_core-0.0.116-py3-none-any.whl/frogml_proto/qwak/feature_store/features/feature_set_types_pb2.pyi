...
import frogml_proto.qwak.feature_store.features.aggregation_pb2
import frogml_proto.qwak.feature_store.features.execution_pb2
import frogml_proto.qwak.feature_store.features.monitoring_pb2
import frogml_proto.qwak.feature_store.features.real_time_feature_extractor_pb2
import frogml_proto.qwak.feature_store.sinks.sink_pb2
import frogml_proto.qwak.feature_store.sources.batch_pb2
import frogml_proto.qwak.feature_store.sources.streaming_pb2
import sys
import typing
...
class BatchFeatureSet(google.protobuf.message.Message):
    ...
    @property
    def monitoring_configurations(self) -> frogml_proto.qwak.feature_store.features.monitoring_pb2.MonitoringConfigurations:
    ...
    def __init__(
        ...
        *,
        ...
        monitoring_configurations: frogml_proto.qwak.feature_store.features.monitoring_pb2.MonitoringConfigurations | None = ...,
    ) -> None: ...
...
class BatchFeatureSetV1(google.protobuf.message.Message):
    ...
    def feature_set_batch_sources(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___FeatureSetBatchSource]:
        """Data sources and their properties which are used by the feature set"""
    @property
    def execution_spec(self) -> frogml_proto.qwak.feature_store.features.execution_pb2.ExecutionSpec:
    ...
    @property
    def real_time_feature_extractor(self) -> frogml_proto.qwak.feature_store.features.real_time_feature_extractor_pb2.RealTimeFeatureExtractor: ...
    def __init__(
        self,
        *,
        scheduling_policy: builtins.str = ...,
        ...
        function: global___Function | None = ...,
        feature_set_batch_sources: collections.abc.Iterable[global___FeatureSetBatchSource] | None = ...,
        execution_spec: frogml_proto.qwak.feature_store.features.execution_pb2.ExecutionSpec | None = ...,
        offline_sink: builtins.bool = ...,
        online_sink: builtins.bool = ...,
        monitoring_configurations: frogml_proto.qwak.feature_store.features.monitoring_pb2.MonitoringConfigurations | None = ...,
        timestamp_column_name: builtins.str = ...,
        ...
        qwak_internal_protocol_version: builtins.int = ...,
        real_time_feature_extractor: frogml_proto.qwak.feature_store.features.real_time_feature_extractor_pb2.RealTimeFeatureExtractor | None = ...,
    ) -> None: ...
...
class FeatureSetBatchSource(google.protobuf.message.Message):
    ...
    @property
    def data_source(self) -> frogml_proto.qwak.feature_store.sources.batch_pb2.BatchSource:
    ...
    def __init__(
        self,
        *,
        data_source: frogml_proto.qwak.feature_store.sources.batch_pb2.BatchSource | None = ...,
...
class StreamingFeatureSetV1(google.protobuf.message.Message):
    ...
    @property
    def execution_spec(self) -> frogml_proto.qwak.feature_store.features.execution_pb2.StreamingExecutionSpec:
        """Execution Spec of the FeatureSet"""
    timestamp_column_name: builtins.str
    ...
    def __init__(
        ...
        *,
        data_sources: collections.abc.Iterable[qwak.feature_store.sources.streaming_pb2.StreamingSource] | None = ...,
        transformation: global___Transformation | None = ...,
        execution_spec: frogml_proto.qwak.feature_store.features.execution_pb2.StreamingExecutionSpec | None = ...,
        timestamp_column_name: builtins.str = ...,
        online_trigger_interval: builtins.int = ...,
        offline_scheduling_policy: builtins.str = ...,
        qwak_internal_protocol_version: builtins.int = ...,
...
class BackfillSpec(google.protobuf.message.Message):
    ...
    @property
    def execution_spec(self) -> frogml_proto.qwak.feature_store.features.execution_pb2.BackfillExecutionSpec:
    ...
    def __init__(
        self,
        *,
        execution_spec: frogml_proto.qwak.feature_store.features.execution_pb2.BackfillExecutionSpec | None = ...,
        start_timestamp: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        end_timestamp: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        transformation: global___Transformation | None = ...,
