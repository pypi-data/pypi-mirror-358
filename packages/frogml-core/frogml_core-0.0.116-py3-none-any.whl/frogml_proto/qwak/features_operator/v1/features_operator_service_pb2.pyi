...
import frogml_proto.qwak.features_operator.v1.features_operator_pb2
import sys
...
class ValidationResponse(google.protobuf.message.Message):
    ...
    @property
    def success_response(self) -> frogml_proto.qwak.features_operator.v1.features_operator_pb2.ValidationSuccessResponse: ...
    @property
    def failure_response(self) -> frogml_proto.qwak.features_operator.v1.features_operator_pb2.ValidationFailureResponse: ...
    def __init__(
        self,
        *,
        success_response: frogml_proto.qwak.features_operator.v1.features_operator_pb2.ValidationSuccessResponse | None = ...,
        failure_response: frogml_proto.qwak.features_operator.v1.features_operator_pb2.ValidationFailureResponse | None = ...,
    ) -> None: ...
