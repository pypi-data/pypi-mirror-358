...
import frogml_proto.qwak.fitness_service.constructs_pb2
import sys
import typing
...
class BuildSpec(google.protobuf.message.Message):
    ...
    @property
    def build_properties(self) -> frogml_proto.qwak.fitness_service.constructs_pb2.BuildProperties: ...
    @property
    def build_env(self) -> frogml_proto.qwak.fitness_service.constructs_pb2.BuildEnv: ...
    @property
    def cpu_resources(self) -> frogml_proto.qwak.fitness_service.constructs_pb2.CpuResources:
        """CPU Properties"""
    @property
    def gpu_resources(self) -> frogml_proto.qwak.fitness_service.constructs_pb2.GpuResources:
        """GPU Properties"""
    ...
    def __init__(
        self,
        *,
        build_properties: frogml_proto.qwak.fitness_service.constructs_pb2.BuildProperties | None = ...,
        build_env: frogml_proto.qwak.fitness_service.constructs_pb2.BuildEnv | None = ...,
        cpu_resources: frogml_proto.qwak.fitness_service.constructs_pb2.CpuResources | None = ...,
        gpu_resources: frogml_proto.qwak.fitness_service.constructs_pb2.GpuResources | None = ...,
        verbose: builtins.int = ...,
        build_config: builtins.str = ...,
        build_v1_flag: builtins.bool = ...,
