...
class CreateProjectRequest(google.protobuf.message.Message):
    ...
    """Project description"""
    @property
    def jfrog_spec(self) -> frogml_proto.qwak.projects.jfrog_project_spec_pb2.ModelRepositoryJFrogSpec:
        """jfrog spec"""
    def __init__(
        self,
        *,
        project_name: builtins.str = ...,
        project_description: builtins.str = ...,
        jfrog_spec: frogml_proto.qwak.projects.jfrog_project_spec_pb2.ModelRepositoryJFrogSpec | None = ...,
    ) -> None: ...
