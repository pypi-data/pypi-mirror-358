...
from frogml_proto.qwak.build.v1.build_pb2 import BatchFeature as ProtoBatchFeature
...
from frogml_core.model.schema_entities import BaseFeature, Entity, FeatureStoreInput
