...
from frogml_proto.qwak.feature_store.jobs.v1.job_service_pb2 import (
    GetLatestJobRequest,
    GetLatestJobResponse,
    GetLatestSuccessfulJobRequest,
    GetLatestSuccessfulJobResponse,
)
from frogml_proto.qwak.feature_store.jobs.v1.job_service_pb2_grpc import JobServiceStub
