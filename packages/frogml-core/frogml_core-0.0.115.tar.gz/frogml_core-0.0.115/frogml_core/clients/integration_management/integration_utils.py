...
from frogml_proto.qwak.integration.integration_pb2 import Integration
from frogml_core.clients.integration_management.integration_manager_client import (
