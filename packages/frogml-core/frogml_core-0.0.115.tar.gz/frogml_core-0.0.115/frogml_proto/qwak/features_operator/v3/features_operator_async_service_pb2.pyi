...
import frogml_proto.qwak.feature_store.sources.data_source_pb2
import frogml_proto.qwak.features_operator.v3.features_operator_pb2
import sys
import typing
...
class ValidateDataSourceRequest(google.protobuf.message.Message):
    ...
    @property
    def data_source_spec(self) -> frogml_proto.qwak.feature_store.sources.data_source_pb2.DataSourceSpec:
    ...
    def __init__(
        self,
        *,
        data_source_spec: frogml_proto.qwak.feature_store.sources.data_source_pb2.DataSourceSpec | None = ...,
        num_samples: builtins.int = ...,
...
class GetValidationResultResponse(google.protobuf.message.Message):
    ...
    @property
    def success_response(self) -> frogml_proto.qwak.features_operator.v3.features_operator_pb2.ValidationSuccessResponse: ...
    @property
    def failure_response(self) -> frogml_proto.qwak.features_operator.v3.features_operator_pb2.ValidationFailureResponse: ...
    @property
    def not_ready_response(self) -> frogml_proto.qwak.features_operator.v3.features_operator_pb2.ValidationNotReadyResponse: ...
    def __init__(
        self,
        *,
        success_response: frogml_proto.qwak.features_operator.v3.features_operator_pb2.ValidationSuccessResponse | None = ...,
        failure_response: frogml_proto.qwak.features_operator.v3.features_operator_pb2.ValidationFailureResponse | None = ...,
        not_ready_response: frogml_proto.qwak.features_operator.v3.features_operator_pb2.ValidationNotReadyResponse | None = ...,
    ) -> None: ...
