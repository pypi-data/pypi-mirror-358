...
class CreateEntityRequest(google.protobuf.message.Message):
    ...
    @property
    def entity_spec(self) -> frogml_proto.qwak.feature_store.entities.entity_pb2.EntitySpec:
        """Entity specifications to create"""
    def __init__(
        self,
        *,
        entity_spec: frogml_proto.qwak.feature_store.entities.entity_pb2.EntitySpec | None = ...,
    ) -> None: ...
...
class UpdateEntityResponse(google.protobuf.message.Message):
    ...
    @property
    def entity(self) -> frogml_proto.qwak.feature_store.entities.entity_pb2.Entity:
        """The updated entity"""
    def __init__(
        self,
        *,
        entity: frogml_proto.qwak.feature_store.entities.entity_pb2.Entity | None = ...,
    ) -> None: ...
