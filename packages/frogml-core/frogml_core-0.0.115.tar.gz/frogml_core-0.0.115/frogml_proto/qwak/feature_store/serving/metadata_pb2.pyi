...
class StreamingAggregationFeaturesetMetadata(google.protobuf.message.Message):
    ...
    """Featureset id"""
    @property
    def streaming_aggregation_featureset(self) -> frogml_proto.qwak.feature_store.features.feature_set_types_pb2.StreamingAggregationFeatureSet:
    ...
    def __init__(
        ...
        *,
        ...
        featureset_name: builtins.str = ...,
        featureset_id: builtins.str = ...,
        streaming_aggregation_featureset: frogml_proto.qwak.feature_store.features.feature_set_types_pb2.StreamingAggregationFeatureSet | None = ...,
...
class BatchFeaturesetV1Metadata(google.protobuf.message.Message):
    ...
    @property
    def batch_featureset_v1(self) -> frogml_proto.qwak.feature_store.features.feature_set_types_pb2.BatchFeatureSetV1:
        """batch v1 featureset"""
    @property
    def entity(self) -> frogml_proto.qwak.feature_store.entities.entity_pb2.EntityDefinition:
        """Entity definition of the FeatureSet"""
    def __init__(
        ...
        *,
        ...
        featureset_id: builtins.str = ...,
        qwak_protocol_version: builtins.int = ...,
        batch_featureset_v1: frogml_proto.qwak.feature_store.features.feature_set_types_pb2.BatchFeatureSetV1 | None = ...,
        entity: frogml_proto.qwak.feature_store.entities.entity_pb2.EntityDefinition | None = ...,
    ) -> None: ...
...
class StreamingFeaturesetV1Metadata(google.protobuf.message.Message):
    ...
    """qwak protocol version"""
    @property
    def streaming_featureset_v1(self) -> frogml_proto.qwak.feature_store.features.feature_set_types_pb2.StreamingFeatureSetV1:
    ...
    def __init__(
        ...
        *,
        ...
        featureset_id: builtins.str = ...,
        qwak_protocol_version: builtins.int = ...,
        streaming_featureset_v1: frogml_proto.qwak.feature_store.features.feature_set_types_pb2.StreamingFeatureSetV1 | None = ...,
        entity: frogml_proto.qwak.feature_store.entities.entity_pb2.EntityDefinition | None = ...,
    ) -> None: ...
