...
import frogml_proto.qwak.execution.v1.state.spark_execution_state_pb2
import sys
...
class ExecutionState(google.protobuf.message.Message):
    ...
    @property
    def spark_app_state(self) -> frogml_proto.qwak.execution.v1.state.spark_execution_state_pb2.SparkExecutionState: ...
    def __init__(
        self,
        *,
        execution_id: builtins.str = ...,
        featureset_id: builtins.str = ...,
        environment_id: builtins.str = ...,
        spark_app_state: frogml_proto.qwak.execution.v1.state.spark_execution_state_pb2.SparkExecutionState | None = ...,
    ) -> None: ...
