...
from frogml_proto.qwak.offline.serving.v1.options_pb2 import OfflineServingQueryOptions
...
from frogml_core.clients.feature_store.offline_serving_client import (
    FsOfflineServingClient,
)
from frogml_core.exceptions import FrogmlException
from frogml_core.feature_store._common.packaging import upload_to_s3
from frogml_core.feature_store._common.value import (
    UPDATE_FROGML_SDK_WITH_FEATURE_STORE_EXTRA_MSG,
)
from frogml_core.feature_store.offline._offline_serving_validations import (
    validate_features,
    validate_point_in_time_column_in_population,
)
from frogml_core.feature_store.offline.feature_set_features import FeatureSetFeatures
...
class OfflineClientV2:
    ...
    def get_feature_range_values(
        ...
        Examples:
        >>> from datetime import datetime
        >>> from frogml_core.feature_store.offline import OfflineClientV2
        >>> from frogml_core.feature_store.offline.feature_set_features import FeatureSetFeatures
        >>>
