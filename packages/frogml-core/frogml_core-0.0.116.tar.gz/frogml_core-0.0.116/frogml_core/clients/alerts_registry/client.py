...
from frogml_proto.qwak.monitoring.v0.alerting_channel_management_service_pb2 import (
...
from frogml_proto.qwak.monitoring.v0.alerting_channel_pb2 import (
    AlertingChannelCreateOptions,
    AlertingChannelSpec,
    AlertingChannelUpdateOptions,
)
from frogml_core.clients.alerts_registry.channel import Channel
