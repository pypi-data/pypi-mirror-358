...
from frogml_proto.qwak.file_versioning.file_versioning_pb2 import FileTagSpec
from frogml_proto.qwak.file_versioning.file_versioning_service_pb2 import (
