...
import frogml_proto.qwak.feature_store.jobs.job_pb2
import sys
...
class ApplyJobRequest(google.protobuf.message.Message):
    ...
    @property
    def job_record(self) -> frogml_proto.qwak.feature_store.jobs.job_pb2.JobRecord:
    ...
    def __init__(
        self,
        *,
        job_record: frogml_proto.qwak.feature_store.jobs.job_pb2.JobRecord | None = ...,
        logs_path: builtins.str = ...,
        partner_id: builtins.str = ...,
        error_technical_details: builtins.str = ...,
    ) -> None: ...
...
class GetLatestSuccessfulJobResponse(google.protobuf.message.Message):
    ...
    @property
    def job(self) -> frogml_proto.qwak.feature_store.jobs.job_pb2.ElaborateJobRecord:
        """the requested job"""
    found: builtins.bool
    ...
    def __init__(
        self,
        *,
        job: frogml_proto.qwak.feature_store.jobs.job_pb2.ElaborateJobRecord | None = ...,
        found: builtins.bool = ...,
    ) -> None: ...
