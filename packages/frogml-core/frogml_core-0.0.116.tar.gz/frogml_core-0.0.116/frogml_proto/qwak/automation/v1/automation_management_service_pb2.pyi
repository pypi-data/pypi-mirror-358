...
import frogml_proto.qwak.automation.v1.automation_execution_pb2
import frogml_proto.qwak.automation.v1.automation_pb2
import sys
...
class CreateAutomationRequest(google.protobuf.message.Message):
    ...
    @property
    def automation_spec(self) -> frogml_proto.qwak.automation.v1.automation_pb2.AutomationSpec: ...
    def __init__(
        self,
        *,
        automation_spec: frogml_proto.qwak.automation.v1.automation_pb2.AutomationSpec | None = ...,
    ) -> None: ...
...
class GetAutomationResponse(google.protobuf.message.Message):
    ...
    @property
    def automation(self) -> frogml_proto.qwak.automation.v1.automation_pb2.Automation: ...
    def __init__(
        self,
        *,
        automation: frogml_proto.qwak.automation.v1.automation_pb2.Automation | None = ...,
    ) -> None: ...
...
class ListAutomationExecutionsRequest(google.protobuf.message.Message):
    ...
    @property
    def date_range(self) -> frogml_proto.qwak.automation.v1.automation_execution_pb2.DateRange:
        """Date range to fetch executions for"""
    def __init__(
        self,
        *,
        automation_id: builtins.str = ...,
        date_range: frogml_proto.qwak.automation.v1.automation_execution_pb2.DateRange | None = ...,
    ) -> None: ...
...
class ListLastAutomationExecutionsResponse(google.protobuf.message.Message):
    ...
    class LastAutomationExecutionByAutomationIdEntry(google.protobuf.message.Message):
        ...
        key: builtins.str
        @property
        def value(self) -> frogml_proto.qwak.automation.v1.automation_execution_pb2.AutomationExecutionMessage: ...
        def __init__(
            self,
            *,
            key: builtins.str = ...,
            value: frogml_proto.qwak.automation.v1.automation_execution_pb2.AutomationExecutionMessage | None = ...,
        ) -> None: ...
...
class UpdateAutomationExecutionRequest(google.protobuf.message.Message):
    ...
    @property
    def run_details(self) -> frogml_proto.qwak.automation.v1.automation_execution_pb2.ExecutionRunDetailsMessage: ...
    def __init__(
        self,
        *,
        execution_id: builtins.str = ...,
        run_details: frogml_proto.qwak.automation.v1.automation_execution_pb2.ExecutionRunDetailsMessage | None = ...,
    ) -> None: ...
