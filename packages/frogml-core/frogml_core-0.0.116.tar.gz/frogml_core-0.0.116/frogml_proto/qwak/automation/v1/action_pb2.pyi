...
import frogml_proto.qwak.automation.v1.auto_scaling_pb2
import frogml_proto.qwak.automation.v1.common_pb2
import frogml_proto.qwak.batch_job.v1.batch_job_service_pb2
...
class BatchExecutionAction(google.protobuf.message.Message):
    ...
    @property
    def execute_batch_job(self) -> frogml_proto.qwak.batch_job.v1.batch_job_service_pb2.BatchJobRequest: ...
    def __init__(
        self,
        *,
        execute_batch_job: frogml_proto.qwak.batch_job.v1.batch_job_service_pb2.BatchJobRequest | None = ...,
    ) -> None: ...
...
class BuildMetricCondition(google.protobuf.message.Message):
    ...
    threshold_direction: frogml_proto.qwak.automation.v1.common_pb2.MetricThresholdDirection.ValueType
...
class AdvancedDeploymentOptions(google.protobuf.message.Message):
    ...
    """Custom IAM Role ARN"""
    @property
    def auto_scaling_config(self) -> frogml_proto.qwak.automation.v1.auto_scaling_pb2.AutoScalingConfig:
        """Auto scaling config"""
    ...
    def __init__(
        ...
        *,
        ...
        daemon_mode: builtins.bool = ...,
        custom_iam_role_arn: builtins.str = ...,
        auto_scaling_config: frogml_proto.qwak.automation.v1.auto_scaling_pb2.AutoScalingConfig | None = ...,
        max_batch_size: builtins.int = ...,
        deployment_process_timeout_limit: builtins.int = ...,
        service_account_key_secret_name: builtins.str = ...,
    ) -> None: ...
