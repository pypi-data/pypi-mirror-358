...
class FeatureSetDeployment(google.protobuf.message.Message):
    ...
    """FeatureSet name"""
    @property
    def streaming_feature_set(self) -> frogml_proto.qwak.feature_store.features.feature_set_types_pb2.StreamingFeatureSetV1: ...
    @property
    def batch_feature_set(self) -> frogml_proto.qwak.feature_store.features.feature_set_types_pb2.BatchFeatureSetV1: ...
    @property
    def streaming_aggregation_feature_set(self) -> frogml_proto.qwak.feature_store.features.feature_set_types_pb2.StreamingAggregationFeatureSet: ...
    @property
    ...
    def __init__(
        ...
        *,
        featureset_name: builtins.str = ...,
        streaming_feature_set: frogml_proto.qwak.feature_store.features.feature_set_types_pb2.StreamingFeatureSetV1 | None = ...,
        batch_feature_set: frogml_proto.qwak.feature_store.features.feature_set_types_pb2.BatchFeatureSetV1 | None = ...,
        streaming_aggregation_feature_set: frogml_proto.qwak.feature_store.features.feature_set_types_pb2.StreamingAggregationFeatureSet | None = ...,
