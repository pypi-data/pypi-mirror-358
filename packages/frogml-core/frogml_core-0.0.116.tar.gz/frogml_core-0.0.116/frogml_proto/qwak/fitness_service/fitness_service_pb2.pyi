...
class BuildModelRequest(google.protobuf.message.Message):
    ...
    @property
    def build_spec(self) -> frogml_proto.qwak.fitness_service.fitness_pb2.BuildSpec:
        """Requested build model spec"""
    def __init__(
        self,
        *,
        build_spec: frogml_proto.qwak.fitness_service.fitness_pb2.BuildSpec | None = ...,
    ) -> None: ...
...
class GetRemoteBuildingStatusResponse(google.protobuf.message.Message):
    ...
    @property
    def status(self) -> frogml_proto.qwak.fitness_service.status_pb2.RemoteBuildingStatus: ...
    def __init__(
        self,
        *,
        status: frogml_proto.qwak.fitness_service.status_pb2.RemoteBuildingStatus | None = ...,
    ) -> None: ...
