...
import frogml_proto.qwak.admiral.user_application_instance.v0.user_application_instance_pb2
import sys
...
class CreateUserApplicationInstanceRequest(google.protobuf.message.Message):
    ...
    @property
    def create_options(self) -> frogml_proto.qwak.admiral.user_application_instance.v0.user_application_instance_pb2.CreateOptions:
        """Options for creation a user application instance"""
    def __init__(
        self,
        *,
        create_options: frogml_proto.qwak.admiral.user_application_instance.v0.user_application_instance_pb2.CreateOptions | None = ...,
    ) -> None: ...
...
class UpdateUserApplicationInstanceSpecRequest(google.protobuf.message.Message):
    ...
    @property
    def update_options(self) -> frogml_proto.qwak.admiral.user_application_instance.v0.user_application_instance_pb2.UpdateSpecOptions:
        """Options for updating a user application instance"""
    def __init__(
        self,
        *,
        update_options: frogml_proto.qwak.admiral.user_application_instance.v0.user_application_instance_pb2.UpdateSpecOptions | None = ...,
    ) -> None: ...
...
class GetUserApplicationInstanceRequest(google.protobuf.message.Message):
    ...
    @property
    def identifier(self) -> frogml_proto.qwak.admiral.user_application_instance.v0.user_application_instance_pb2.Identifier:
        """The identifier of the user application instance to get"""
    def __init__(
        self,
        *,
        identifier: frogml_proto.qwak.admiral.user_application_instance.v0.user_application_instance_pb2.Identifier | None = ...,
    ) -> None: ...
...
class GetUserApplicationInstanceResponse(google.protobuf.message.Message):
    ...
    @property
    def description(self) -> frogml_proto.qwak.admiral.user_application_instance.v0.user_application_instance_pb2.Description:
        """Full details of a user application instance"""
    def __init__(
        self,
        *,
        description: frogml_proto.qwak.admiral.user_application_instance.v0.user_application_instance_pb2.Description | None = ...,
    ) -> None: ...
