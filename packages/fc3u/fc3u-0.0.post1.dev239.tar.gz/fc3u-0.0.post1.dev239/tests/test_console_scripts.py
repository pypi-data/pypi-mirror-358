...
import os
from fc3u.compute_fractionalcover import fractional_cover_surface_reflectance as cfc
from fc3u.qv_fractionalcover_sentinel2 import unmix_sentinel as qvs2
