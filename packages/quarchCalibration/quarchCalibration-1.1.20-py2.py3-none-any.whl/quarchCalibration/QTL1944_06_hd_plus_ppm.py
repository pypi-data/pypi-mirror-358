...
class QTL1944_06 (PowerModule):
    ...
    def specific_requirements(self):
        ...
        self.switchbox.resetDevice() # Reset just in-case?
    ...
    def getSwitchbox(self):
        # CheckSwitchbox
        while True:
            if calibrationResources["switchboxStr"] is None:
                ...
                switchboxAddress = calibrationResources["switchboxStr"]
            try:
                self.switchbox = quarchDevice(switchboxAddress)
                self.switchbox.resetDevice()
                break
            except:
