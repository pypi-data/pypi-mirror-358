...
\fbox{%
  ...
  \begin{minipage}[t][3.5cm][t]{4.86cm}
    ...
    \centering
    {\relscale{1.0416666666666665}
      Centerlock ring
    }

    {\relscale{1.3467219944952737} Centerlock lockring}

    \vspace*{1pt}
    \includegraphics[height=1.75cm,keepaspectratio,width=4.86cm]{../../../../../Hobby/fahrrad/things-data/things/centerlock_ring/image.jpg}
    \vspace*{-.5cm}
