...
from ._hurnet_torch import HurNetTorch as _HurNetTorch
from ._hurnet_transformer import HurNetTransformer as _HurNetTransformer
from ._transformer_hurnet import TransformerHurNet as _TransformerHurNet

class HurNetTorch(_HurNetTorch): pass
class HurNetTransformer(_HurNetTransformer): pass
class TransformerHurNet(_TransformerHurNet): pass
# THIS IS A HURNET TYPE ARTIFICIAL NEURAL NETWORK
"""
# HurNetTorch: A New Era in Neural Networks
HurNetTorch represents a significant evolution of the original HurNet architecture, maintaining its core computations while leveraging the flexibility of PyTorch’s dynamic tensors.
