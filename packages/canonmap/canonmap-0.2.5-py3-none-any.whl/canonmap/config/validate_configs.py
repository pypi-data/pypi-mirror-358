...
class CanonMapEmbeddingConfig:
    ...
    • HF name + local path
    • a CustomGCSConfig for where to pull/push model files
    ...
    def __init__(
        ...
        gcs_config: CanonMapCustomGCSConfig = None,
        troubleshooting: bool = False,
    ):
...
class CanonMapArtifactsConfig:
    ...
    Artifacts config:
    • local path
    • a CustomGCSConfig for bucket details
    • optional troubleshooting override
    """
    def __init__(
        self,
        artifacts_local_path: str,
        gcs_config: CanonMapCustomGCSConfig,
        troubleshooting: bool = False,
    ):
