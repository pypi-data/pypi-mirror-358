...
class BrassCLI:
    ...
    def init(self, mode: str = "claude-companion", integration_mode: Optional[str] = None):
        ...
        if not self.config["user_preferences"].get("claude_api_key"):
            print("\033[31m🔴 For Brass AI analysis, your Claude API key required.\033[0m")
            
            while True:
                api_key = input("\n\033[32m🎯 Enter your Claude API key (or press Enter for instructions):\033[0m ").strip()
                ...
                if api_key:
                    ...
                    if api_key.startswith('sk-ant-api'):
                        ...
                        print("❌ Invalid API key format. Claude API keys start with 'sk-ant-api'")
                        continue
                else:
                    # User pressed Enter - show instructions
                    print("\n\033[32m🎯 To get your Claude API key:\033[0m")
    ...
    def _handle_claude_code_integration(self, integration_mode: Optional[str] = None):
        ...
        if integration_mode == 'claude-code':
            ...
            while True:
                response = input("**Are you using Claude Code in this project?** (\033[32mY\033[0m/\033[31mN\033[0m): ").strip().lower()
