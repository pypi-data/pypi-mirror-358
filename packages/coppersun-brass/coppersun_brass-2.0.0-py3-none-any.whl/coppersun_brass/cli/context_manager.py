"""
Context Manager for Copper Alloy Brass Pro - Handles generation and updates of context files.
...
class ContextManager:
    """Manages Copper Alloy Brass context files for persistent memory."""
    ...
    def _load_config(self) -> Dict[str, Any]:
        """Load Copper Alloy Brass configuration."""
    ...
    def update_status(self, force: bool = False):
        ...
        content = ["# Copper Alloy Brass Status", ""]
        
        # Active status
        content.append("## 🧠 Copper Alloy Brass Active")
    ...
    def update_context(self, current_work: Optional[str] = None):
        ...
        content.append("## ⚙️ Copper Alloy Brass Configuration")
    ...
    def generate_insights(self):
        ...
        content = ["# Copper Alloy Brass Insights", ""]
    ...
    def add_to_history(self, event: str, details: Optional[Dict[str, Any]] = None):
        ...
        content.append("*Copper Alloy Brass tracks important events and decisions*")
        content.append("")
    ...
    def _identify_key_directories(self) -> Dict[str, str]:
        ...
        patterns = {
            ...
            'coppersun_brass': 'Copper Alloy Brass core system',
