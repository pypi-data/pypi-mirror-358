            ...
            for workspace in workspaces:
                if workspace.get("_refObjectName") == WORKSPACE_NAME:
                    ...
                    # if description:
                        ...
                        async_description_response = await async_description_instance.create(user_description)
            ...
            for workspace in workspaces:
                if workspace.get("_refObjectName") == WORKSPACE_NAME:
                    ...
                    # if description:
                        ...
                        sync_description_response = sync_description_instance.create(user_description)
