...
@overload
def ParamProbabilistic(distribution: Sequence[float], gate_list: Sequence[Union[scaluq.scaluq_core.default.f64.Gate, scaluq.scaluq_core.default.f64.ParamGate]]) -> scaluq.scaluq_core.default.f64.ParamGate:
    """
...
@overload
def ParamProbabilistic(prob_gate_list: Sequence[tuple[float, Union[scaluq.scaluq_core.default.f64.Gate, scaluq.scaluq_core.default.f64.ParamGate]]]) -> scaluq.scaluq_core.default.f64.ParamGate:
    """
    Generate general :class:`~scaluq.f64.ParamGate` class instance of :class:`~scaluq.f64.ParamProbabilisticGate`.
