...
@overload
def ParamProbabilistic(distribution: Sequence[float], gate_list: Sequence[scaluq.scaluq_core.default.f32.Gate | scaluq.scaluq_core.default.f32.ParamGate]) -> scaluq.scaluq_core.default.f32.ParamGate:
    """
...
@overload
def ParamProbabilistic(prob_gate_list: Sequence[tuple[float, scaluq.scaluq_core.default.f32.Gate | scaluq.scaluq_core.default.f32.ParamGate]]) -> scaluq.scaluq_core.default.f32.ParamGate:
    """
    Generate general :class:`~scaluq.f64.ParamGate` class instance of :class:`~scaluq.f64.ParamProbabilisticGate`.
