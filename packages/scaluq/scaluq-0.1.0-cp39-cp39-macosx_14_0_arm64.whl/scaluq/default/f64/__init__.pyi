...
class StateVector:
    ...
    @staticmethod
    def Haar_random_state(n_qubits: int, seed: Optional[int] = None) -> StateVector:
        """
...
class StateVectorBatched:
    ...
    def set_Haar_random_state(self, set_same_state: bool, seed: Optional[int] = None) -> None:
        """
    ...
    @staticmethod
    def Haar_random_state(batch_size: int, n_qubits: int, set_same_state: bool, seed: Optional[int] = None) -> StateVectorBatched:
        """
    ...
    def sampling(self, sampling_count: int, seed: Optional[int] = None) -> list[list[int]]:
        """
...
class ParamProbabilisticGate:
    ...
    def gate_list(self) -> list[Union[Gate, ParamGate]]: ...
...
class Circuit:
    ...
    def gate_list(self) -> list[Union[Gate, tuple[ParamGate, str]]]:
    ...
    def get_gate_at(self, index: int) -> Union[Gate, tuple[ParamGate, str]]:
        """Get reference of i-th gate."""

    def get_param_key_at(self, index: int) -> Optional[str]:
...
class Operator:
    ...
    def add_random_operator(self, operator_count: int, seed: Optional[int] = None) -> None:
        """
