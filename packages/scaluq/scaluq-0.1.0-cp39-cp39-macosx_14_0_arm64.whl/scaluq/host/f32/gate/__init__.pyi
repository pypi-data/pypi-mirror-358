...
import scaluq.scaluq_core.default.f32


def I() -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def GlobalPhase(gamma: float, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def X(target: int, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def Y(target: int, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def Z(target: int, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def H(target: int, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def S(target: int, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def Sdag(target: int, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def T(target: int, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def Tdag(target: int, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def SqrtX(target: int, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    r"""
...
def SqrtXdag(target: int, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    r"""
...
def SqrtY(target: int, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    r"""
...
def SqrtYdag(target: int, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    r"""
...
def P0(target: int, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def P1(target: int, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def RX(target: int, theta: float, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def RY(target: int, theta: float, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def RZ(target: int, theta: float, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def U1(target: int, lambda_: float, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def U2(target: int, phi: float, lambda_: float, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def U3(target: int, theta: float, phi: float, lambda_: float, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def Swap(target1: int, target2: int, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def CX(control: int, target: int) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def CNot(control: int, target: int) -> scaluq.scaluq_core.default.f32.Gate:
    """
    Generate general :class:`~scaluq.f64.Gate` class instance of :class:`~scaluq.f64.XGate` with one control qubit. Performs controlled-X operation.
...
def CZ(control: int, target: int) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def CCX(control1: int, control2: int, target: int) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def CCNot(control1: int, control2: int, target: int) -> scaluq.scaluq_core.default.f32.Gate:
    """
    Generate general :class:`~scaluq.f64.Gate` class instance of :class:`~scaluq.f64.XGate` with two control qubits. Performs controlled-controlled-X operation.
...
def Toffoli(control1: int, control2: int, target: int) -> scaluq.scaluq_core.default.f32.Gate:
    """
    Generate general :class:`~scaluq.f64.Gate` class instance of :class:`~scaluq.f64.XGate` with two control qubits. Performs controlled-controlled-X operation.
...
def DenseMatrix(targets: Sequence[int], matrix: Annotated[ArrayLike, dict(dtype='complex128', shape=(None, None), order='C')], controls: Sequence[int] = [], control_values: Sequence[int] = [], is_unitary: bool = False) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def SparseMatrix(targets: Sequence[int], matrix: scipy.sparse.csr_matrix[complex], controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def Pauli(pauli: scaluq.scaluq_core.default.f32.PauliOperator, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def PauliRotation(pauli: scaluq.scaluq_core.default.f32.PauliOperator, theta: float, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def Probabilistic(distribution: Sequence[float], gate_list: Sequence[scaluq.scaluq_core.default.f32.Gate]) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def BitFlipNoise(target: int, error_rate: float) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def DephasingNoise(target: int, error_rate: float) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def BitFlipAndDephasingNoise(target: int, error_rate: float) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def DepolarizingNoise(target: int, error_rate: float) -> scaluq.scaluq_core.default.f32.Gate:
    """
...
def ParamRX(target: int, coef: float = 1.0, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.ParamGate:
    """
...
def ParamRY(target: int, coef: float = 1.0, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.ParamGate:
    """
...
def ParamRZ(target: int, coef: float = 1.0, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.ParamGate:
    """
...
def ParamPauliRotation(pauli: scaluq.scaluq_core.default.f32.PauliOperator, coef: float = 1.0, controls: Sequence[int] = [], control_values: Sequence[int] = []) -> scaluq.scaluq_core.default.f32.ParamGate:
    """
...
@overload
def ParamProbabilistic(distribution: Sequence[float], gate_list: Sequence[Union[scaluq.scaluq_core.default.f32.Gate, scaluq.scaluq_core.default.f32.ParamGate]]) -> scaluq.scaluq_core.default.f32.ParamGate:
    """
...
@overload
def ParamProbabilistic(prob_gate_list: Sequence[tuple[float, Union[scaluq.scaluq_core.default.f32.Gate, scaluq.scaluq_core.default.f32.ParamGate]]]) -> scaluq.scaluq_core.default.f32.ParamGate:
    """
    Generate general :class:`~scaluq.f64.ParamGate` class instance of :class:`~scaluq.f64.ParamProbabilisticGate`.
