    ...
    def curses_main(stdscr):
        ...
        while True:
            ...
            # ------------------------------------------------------------
                ...
                while True:
                    res = maninf.show_measurement_newest_sample(name, dbase, silent=True, prepend=dt.datetime.now().strftime(f"measurement from {time1}  ==>>>  %H:%M:%S"), time_restrict=time_restrict)
