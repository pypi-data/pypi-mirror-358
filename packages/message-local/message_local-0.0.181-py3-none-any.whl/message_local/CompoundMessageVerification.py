...
class CompoundMessageVerification:
    ...
    def __init__(self, limit=100):
        self.message_crud = GenericCRUD(
            default_schema_name="message", default_entity_name="message", default_table_name="message_table")
        self.question_crud = GenericCRUD(
            default_schema_name="question", default_table_name="question_ml_table", default_entity_name="question"
        )
        self.profile_ml_crud = GenericCRUD(
            default_schema_name="profile", default_table_name="profile_ml_table", default_entity_name="profile_ml"
        )
        self.profile_crud = GenericCRUD(
            default_schema_name="profile", default_entity_name="profile", default_table_name="profile_table")
        self.user_crud = GenericCRUD(
            default_schema_name="user", default_entity_name="user", default_table_name="user_table")
        self.limit = limit
        self.message_template_text_block_ml_table = GenericCRUD(
            ...
            default_entity_name="message_template",
        )
