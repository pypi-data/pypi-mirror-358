...
def get_order_management_tools():
    ...
    return [
        Tool(
            name="place_order",
            description="Place a futures order of any type with optional take-profit and stop-loss orders",
            inputSchema={
                "type": "object",
                "properties": {
                    "symbol": {"type": "string", "description": "Trading pair symbol"},
                    ...
                    "take_profit_price": {"type": "number", "description": "Optional take-profit price to create a TP order"},
                    "stop_loss_price": {"type": "number", "description": "Optional stop-loss price to create an SL order"},
                    "tp_type": {"type": "string", "description": "Take-profit order type ('LIMIT' or 'MARKET'), default is 'LIMIT'"},
                    "sl_type": {"type": "string", "description": "Stop-loss order type ('LIMIT' or 'MARKET'), default is 'LIMIT'"},
...
def get_position_tools():
    ...
    return [
        ...
        Tool(
            ...
            description="[DEPRECATED] Place a position with automatic Take Profit and Stop Loss orders. Use place_order with take_profit_price and stop_loss_price parameters instead.",
            inputSchema={
                "type": "object",
                "properties": {
                    "symbol": {"type": "string", "description": "Trading pair symbol"},
                    "side": {"type": "string", "description": "Order side ('BUY' or 'SELL')"},
                    "quantity": {"type": "number", "description": "Order quantity"},
                    "entry_type": {"type": "string", "description": "Entry order type ('LIMIT', 'MARKET', 'STOP', 'STOP_MARKET', 'TAKE_PROFIT', 'TAKE_PROFIT_MARKET', 'TRAILING_STOP_MARKET')"},
                    "entry_price": {"type": "number", "description": "Entry price (for LIMIT/STOP/TAKE_PROFIT orders)"},
                    "stop_price": {"type": "number", "description": "Trigger price for STOP/STOP_MARKET/TAKE_PROFIT/TAKE_PROFIT_MARKET orders"},
                    "callback_rate": {"type": "number", "description": "Required for TRAILING_STOP_MARKET orders"},
                    "activation_price": {"type": "number", "description": "Optional for TRAILING_STOP_MARKET orders"},
                    ...
                    "time_in_force": {"type": "string", "description": "Time in force for LIMIT orders (GTC, IOC, FOK). Default 'GTC'"},
                    "tp_type": {"type": "string", "description": "Take-profit order type ('LIMIT' or 'MARKET'), default is 'LIMIT'"},
                    "sl_type": {"type": "string", "description": "Stop-loss order type ('LIMIT' or 'MARKET'), default is 'LIMIT'"},
                    "leverage": {"type": "number", "description": "Optional leverage to set before placing orders"}
                },
