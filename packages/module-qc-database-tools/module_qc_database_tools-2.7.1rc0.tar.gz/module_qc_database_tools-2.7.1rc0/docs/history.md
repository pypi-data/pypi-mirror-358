...
## [2.7.1](https://gitlab.cern.ch/atlas-itk/pixel/module/module-qc-database-tools/-/tags/v2.7.1) - 2025-06-28 ## {: #mqdbt-v2.7.1 }

**_Fixed:_**

- fix `rx` and `EnChipId` when generating data merging config (!121)
