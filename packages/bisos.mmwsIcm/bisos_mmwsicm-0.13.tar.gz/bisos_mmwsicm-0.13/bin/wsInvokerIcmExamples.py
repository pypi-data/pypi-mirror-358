...
""" #+begin_org
*  This file:/bisos/git/bxRepos/bisos-pip/mmwsIcm/py3/bin/wsInvokerIcmExamples.py :: [[elisp:(org-cycle)][| ]]
...
####+END:
        ...
        cs.examples.menuSection('* -i rinvoke getAllPackages svcSpecFile*')
