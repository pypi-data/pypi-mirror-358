...
####+BEGIN: bx:cs:python:top-of-file :partof "cible" :copyleft "none"
""" #+begin_org
*  This file:/bisos/git/bxRepos/bisos-pip/mmwsIcm/py3/bin/opScnPetstore.py :: [[elisp:(org-cycle)][| ]]
...
from bisos.common import icmsPkgLib
from bisos.mmwsIcm import mmwsIcmPkgThis
...
####+END:
    ...
    #bearerToken.commonParamsSpecify(csParams)
...
####+END:
        ...
        cs.examples.menuChapter('*Scenarios Selection*')

        # ../bisos/mmwsIcm-base/opScn-1.py
