...
class InteliaLLMClient:
    ...
    def call_llm(self, prompt: str, model: str, account_id: int | None = None, key: str | None = None, tags: list | None = None, no_cache: bool = False, metadata: dict | None = None) -> Tuple[str, int, int]:
        """
