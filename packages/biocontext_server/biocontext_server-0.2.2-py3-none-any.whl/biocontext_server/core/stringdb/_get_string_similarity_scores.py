...
def get_string_similarity_scores(
    protein_symbol: Annotated[str, Field(description="The name of the first protein (e.g., 'DRD1_HUMAN')")],
    protein_symbol_comparison: Annotated[str, Field(description="The name of the second protein (e.g., 'DRD2_HUMAN')")],
    ...
    Args:
        protein_symbol (str): The name of the first protein (e.g., "DRD1_HUMAN").
        protein_symbol_comparison (str): The name of the second protein (e.g., "DRD2_HUMAN").
    ...
    """
    # Resolve both protein names to STRING IDs
    try:
