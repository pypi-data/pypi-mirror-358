...
** This File: /bisos/git/auth/bxRepos/bisos-pip/lcnt/py3/bisos/lcnt/lcntProcConfig.py
...
#+end_org """
import typing
csInfo: typing.Dict[str, typing.Any] = { 'moduleName': ['lcntProcConfig'], }
csInfo['version'] = '202212185256'
csInfo['status']  = 'inUse'
csInfo['panel'] = 'lcntProcConfig-Panel.org'
...
####+BEGIN: b:py3:cs:func/typing :funcName "baseDirInfo" :comment "~SeedForBaseDirInfo~" :funcType "eType" :retType "" :deco "default" :argsList ""
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  F-T-eType  [[elisp:(outline-show-subtree+toggle)][||]] /baseDirInfo/  ~SeedForBaseDirInfo~ deco=default  [[elisp:(org-cycle)][| ]]
#+end_org """
