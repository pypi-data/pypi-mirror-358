...
####+BEGIN: bx:cs:python:func :funcName "withSlideNumberGetFrameName" :funcType "anyOrNone" :retType "bool" :deco "" :argsList "slideNu dispositionBase=None"
"""
