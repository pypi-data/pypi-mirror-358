...
if openai:
    ...
    class MockCompletions:
        def create(self, **kwargs):
            ...
            if kwargs.get('model') in ['gpt-4', 'gpt-4.1'] and kwargs.get('temperature', 0) > 0.9:
                print(f"  ✗ Arc Runtime did NOT intercept - temperature is still {kwargs.get('temperature')}")
                print(f"    (This is expected for mock client, Arc patches real OpenAI client)")
