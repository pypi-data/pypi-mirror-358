...
class IWebhookDeliveryRead(IModelData):
    ...
    webhook_id: %%%make_type_annotation!!!int%%% # noqa: E501
    """
    [optional]
    """

    event: %%%make_type_annotation!!!str%%% # noqa: E501
    """
    [optional]
    """

    status_code: %%%make_type_annotation!!!int, none_type%%% # noqa: E501
    """
    [optional]
    """

    redelivery: %%%make_type_annotation!!!bool%%% # noqa: E501
    """
    [optional]
    """
    ...
    changed_fields: %%%make_type_annotation!!!str%%% # noqa: E501
    """
    [optional]
    """

    request: %%%make_type_annotation!!!{str: (bool, date, datetime, dict, float, int, list, str, none_type)}%%% # noqa: E501
    """
    [optional]
    """

    response: %%%make_type_annotation!!!{str: (bool, date, datetime, dict, float, int, list, str, none_type)}%%% # noqa: E501
    """
    [optional]
    """
