...
class SchemaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.%%%make_operation_id!!!schema_retrieve%%%_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': '%%%make_operation_id!!!schema_retrieve%%%',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def %%%make_operation_id!!!schema_retrieve%%%(
        self,
        *,
        ...
        **kwargs,
        ...
        """%%%make_operation_id!!!schema_retrieve%%%  # noqa: E501
        ...
        >>> thread = api.%%%make_operation_id!!!schema_retrieve%%%(_async_call=True)
        >>> result = thread.get()
        ...
        return self.%%%make_operation_id!!!schema_retrieve%%%_endpoint.call_with_http_info(**kwargs)
