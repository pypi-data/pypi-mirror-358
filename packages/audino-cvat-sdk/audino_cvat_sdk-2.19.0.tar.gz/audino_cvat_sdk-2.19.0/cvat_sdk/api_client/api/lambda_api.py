...
class LambdaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.%%%make_operation_id!!!lambda_create_functions%%%_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': '%%%make_operation_id!!!lambda_create_functions%%%',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.%%%make_operation_id!!!lambda_create_requests%%%_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': '%%%make_operation_id!!!lambda_create_requests%%%',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.%%%make_operation_id!!!lambda_delete_requests%%%_endpoint = _Endpoint(
            settings={
                'response_schema': None,
                'auth': [
                    'basicAuth',
                ...
                'operation_id': '%%%make_operation_id!!!lambda_delete_requests%%%',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.%%%make_operation_id!!!lambda_list_functions%%%_endpoint = _Endpoint(
            settings={
                'response_schema': None,
                'auth': [
                    'basicAuth',
                ...
                'operation_id': '%%%make_operation_id!!!lambda_list_functions%%%',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.%%%make_operation_id!!!lambda_list_requests%%%_endpoint = _Endpoint(
            settings={
                'response_schema': ([FunctionCall],),
                'auth': [
                    'basicAuth',
                ...
                'endpoint_path': '/api/lambda/requests',
                'operation_id': '%%%make_operation_id!!!lambda_list_requests%%%',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.%%%make_operation_id!!!lambda_retrieve_functions%%%_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/lambda/functions/{func_id}',
                'operation_id': '%%%make_operation_id!!!lambda_retrieve_functions%%%',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.%%%make_operation_id!!!lambda_retrieve_requests%%%_endpoint = _Endpoint(
            settings={
                'response_schema': (FunctionCall,),
                'auth': [
                    'basicAuth',
                ...
                'endpoint_path': '/api/lambda/requests/{id}',
                'operation_id': '%%%make_operation_id!!!lambda_retrieve_requests%%%',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def %%%make_operation_id!!!lambda_create_functions%%%(
        self,
        func_id: %%%make_type_annotation!!!str%%%,
        *,
        ...
        **kwargs,
        ...
        """%%%make_operation_id!!!lambda_create_functions%%%  # noqa: E501
        ...
        >>> thread = api.%%%make_operation_id!!!lambda_create_functions%%%(func_id, _async_call=True)
        >>> result = thread.get()
        ...
        return self.%%%make_operation_id!!!lambda_create_functions%%%_endpoint.call_with_http_info(**kwargs)

    def %%%make_operation_id!!!lambda_create_requests%%%(
        self,
        function_call_request: %%%make_type_annotation!!!FunctionCallRequest%%%,
        *,
        _parse_response: bool = True,
        _request_timeout: typing.Union[int, float, tuple] = None,
        _validate_inputs: bool = True,
        ...
        _async_call: bool = False,
        **kwargs,
    ) -> typing.Tuple[typing.Optional[%%%make_type_annotation!!!FunctionCall%%%], urllib3.HTTPResponse]:
        """Method calls the function  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass _async_call=True

        >>> thread = api.%%%make_operation_id!!!lambda_create_requests%%%(function_call_request, _async_call=True)
        >>> result = thread.get()
        ...
        return self.%%%make_operation_id!!!lambda_create_requests%%%_endpoint.call_with_http_info(**kwargs)

    def %%%make_operation_id!!!lambda_delete_requests%%%(
        self,
        id: %%%make_type_annotation!!!str%%%,
        *,
        _parse_response: bool = True,
        _request_timeout: typing.Union[int, float, tuple] = None,
        _validate_inputs: bool = True,
        ...
        **kwargs,
        ...
        >>> thread = api.%%%make_operation_id!!!lambda_delete_requests%%%(id, _async_call=True)
        >>> result = thread.get()
        ...
        kwargs['_request_auths'] = _request_auths
        kwargs['id'] = id
        return self.%%%make_operation_id!!!lambda_delete_requests%%%_endpoint.call_with_http_info(**kwargs)

    def %%%make_operation_id!!!lambda_list_functions%%%(
        self,
        *,
        _parse_response: bool = True,
        _request_timeout: typing.Union[int, float, tuple] = None,
        ...
        **kwargs,
        ...
        >>> thread = api.%%%make_operation_id!!!lambda_list_functions%%%(_async_call=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = _host_index
        kwargs['_request_auths'] = _request_auths
        return self.%%%make_operation_id!!!lambda_list_functions%%%_endpoint.call_with_http_info(**kwargs)

    def %%%make_operation_id!!!lambda_list_requests%%%(
        self,
        *,
        _parse_response: bool = True,
        _request_timeout: typing.Union[int, float, tuple] = None,
        ...
        **kwargs,
        ...
        >>> thread = api.%%%make_operation_id!!!lambda_list_requests%%%(_async_call=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = _host_index
        kwargs['_request_auths'] = _request_auths
        return self.%%%make_operation_id!!!lambda_list_requests%%%_endpoint.call_with_http_info(**kwargs)

    def %%%make_operation_id!!!lambda_retrieve_functions%%%(
        self,
        func_id: %%%make_type_annotation!!!str%%%,
        *,
        _parse_response: bool = True,
        ...
        **kwargs,
        ...
        >>> thread = api.%%%make_operation_id!!!lambda_retrieve_functions%%%(func_id, _async_call=True)
        >>> result = thread.get()
        ...
        kwargs['_request_auths'] = _request_auths
        kwargs['func_id'] = func_id
        return self.%%%make_operation_id!!!lambda_retrieve_functions%%%_endpoint.call_with_http_info(**kwargs)

    def %%%make_operation_id!!!lambda_retrieve_requests%%%(
        self,
        id: %%%make_type_annotation!!!str%%%,
        *,
        _parse_response: bool = True,
        ...
        **kwargs,
        ...
        >>> thread = api.%%%make_operation_id!!!lambda_retrieve_requests%%%(id, _async_call=True)
        >>> result = thread.get()
        ...
        kwargs['_request_auths'] = _request_auths
        kwargs['id'] = id
        return self.%%%make_operation_id!!!lambda_retrieve_requests%%%_endpoint.call_with_http_info(**kwargs)
