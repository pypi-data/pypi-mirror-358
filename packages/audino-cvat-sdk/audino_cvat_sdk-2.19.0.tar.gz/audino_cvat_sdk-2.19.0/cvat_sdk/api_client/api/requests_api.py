...
class RequestsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.%%%make_operation_id!!!requests_create_cancel%%%_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': '%%%make_operation_id!!!requests_create_cancel%%%',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.%%%make_operation_id!!!requests_list%%%_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': '%%%make_operation_id!!!requests_list%%%',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.%%%make_operation_id!!!requests_retrieve%%%_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': '%%%make_operation_id!!!requests_retrieve%%%',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def %%%make_operation_id!!!requests_create_cancel%%%(
        self,
        ...
        **kwargs,
        ...
        >>> thread = api.%%%make_operation_id!!!requests_create_cancel%%%(id, _async_call=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = id
        return self.%%%make_operation_id!!!requests_create_cancel%%%_endpoint.call_with_http_info(**kwargs)

    def %%%make_operation_id!!!requests_list%%%(
        self,
        *,
        _parse_response: bool = True,
        _request_timeout: typing.Union[int, float, tuple] = None,
        ...
        _async_call: bool = False,
        **kwargs,
    ) -> typing.Tuple[typing.Optional[%%%make_type_annotation!!!PaginatedRequestList%%%], urllib3.HTTPResponse]:
        """List requests  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass _async_call=True

        >>> thread = api.%%%make_operation_id!!!requests_list%%%(_async_call=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = _host_index
        kwargs['_request_auths'] = _request_auths
        return self.%%%make_operation_id!!!requests_list%%%_endpoint.call_with_http_info(**kwargs)

    def %%%make_operation_id!!!requests_retrieve%%%(
        self,
        id: %%%make_type_annotation!!!str%%%,
        *,
        _parse_response: bool = True,
        ...
        _async_call: bool = False,
        **kwargs,
    ) -> typing.Tuple[typing.Optional[%%%make_type_annotation!!!Request%%%], urllib3.HTTPResponse]:
        """Get request details  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass _async_call=True

        >>> thread = api.%%%make_operation_id!!!requests_retrieve%%%(id, _async_call=True)
        >>> result = thread.get()
        ...
        kwargs['_request_auths'] = _request_auths
        kwargs['id'] = id
        return self.%%%make_operation_id!!!requests_retrieve%%%_endpoint.call_with_http_info(**kwargs)
