...
class AssetsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.%%%make_operation_id!!!assets_create%%%_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': '%%%make_operation_id!!!assets_create%%%',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.%%%make_operation_id!!!assets_destroy%%%_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': '%%%make_operation_id!!!assets_destroy%%%',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.%%%make_operation_id!!!assets_retrieve%%%_endpoint = _Endpoint(
            settings={
                'response_schema': None,
                'auth': [
                    'basicAuth',
                ...
                'endpoint_path': '/api/assets/{uuid}',
                'operation_id': '%%%make_operation_id!!!assets_retrieve%%%',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def %%%make_operation_id!!!assets_create%%%(
        self,
        *,
        ...
        **kwargs,
    ) -> typing.Tuple[typing.Optional[%%%make_type_annotation!!!AssetRead%%%], urllib3.HTTPResponse]:
        """Create an asset  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass _async_call=True

        >>> thread = api.%%%make_operation_id!!!assets_create%%%(_async_call=True)
        >>> result = thread.get()
        ...
        return self.%%%make_operation_id!!!assets_create%%%_endpoint.call_with_http_info(**kwargs)

    def %%%make_operation_id!!!assets_destroy%%%(
        self,
        uuid: %%%make_type_annotation!!!str%%%,
        *,
        _parse_response: bool = True,
        _request_timeout: typing.Union[int, float, tuple] = None,
        _validate_inputs: bool = True,
        ...
        **kwargs,
        ...
        >>> thread = api.%%%make_operation_id!!!assets_destroy%%%(uuid, _async_call=True)
        >>> result = thread.get()
        ...
        kwargs['_request_auths'] = _request_auths
        kwargs['uuid'] = uuid
        return self.%%%make_operation_id!!!assets_destroy%%%_endpoint.call_with_http_info(**kwargs)

    def %%%make_operation_id!!!assets_retrieve%%%(
        self,
        uuid: %%%make_type_annotation!!!str%%%,
        *,
        _parse_response: bool = True,
        ...
        **kwargs,
        ...
        >>> thread = api.%%%make_operation_id!!!assets_retrieve%%%(uuid, _async_call=True)
        >>> result = thread.get()
        ...
        kwargs['_request_auths'] = _request_auths
        kwargs['uuid'] = uuid
        return self.%%%make_operation_id!!!assets_retrieve%%%_endpoint.call_with_http_info(**kwargs)
