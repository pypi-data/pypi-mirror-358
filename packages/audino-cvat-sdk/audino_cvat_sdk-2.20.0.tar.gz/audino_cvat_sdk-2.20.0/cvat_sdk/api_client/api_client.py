...
class ApiClient(object):
    ...
    %%%make_api_name!!!AiAudioAnnotationApi%%%: AiAudioAnnotationApi
    %%%make_api_name!!!AnalyticsApi%%%: AnalyticsApi
    %%%make_api_name!!!AssetsApi%%%: AssetsApi
    %%%make_api_name!!!AuthApi%%%: AuthApi
    %%%make_api_name!!!CloudstoragesApi%%%: CloudstoragesApi
    %%%make_api_name!!!CommentsApi%%%: CommentsApi
    %%%make_api_name!!!EventsApi%%%: EventsApi
    %%%make_api_name!!!GuidesApi%%%: GuidesApi
    %%%make_api_name!!!InvitationsApi%%%: InvitationsApi
    %%%make_api_name!!!IssuesApi%%%: IssuesApi
    %%%make_api_name!!!JobsApi%%%: JobsApi
    %%%make_api_name!!!LabelsApi%%%: LabelsApi
    %%%make_api_name!!!LambdaApi%%%: LambdaApi
    %%%make_api_name!!!MembershipsApi%%%: MembershipsApi
    %%%make_api_name!!!NotificationsApi%%%: NotificationsApi
    %%%make_api_name!!!OrganizationsApi%%%: OrganizationsApi
    %%%make_api_name!!!ProjectsApi%%%: ProjectsApi
    %%%make_api_name!!!QualityApi%%%: QualityApi
    %%%make_api_name!!!RequestsApi%%%: RequestsApi
    %%%make_api_name!!!SchemaApi%%%: SchemaApi
    %%%make_api_name!!!ServerApi%%%: ServerApi
    %%%make_api_name!!!TasksApi%%%: TasksApi
    %%%make_api_name!!!UsersApi%%%: UsersApi
    %%%make_api_name!!!WebhooksApi%%%: WebhooksApi
    """
    ...
    _apis: typing.Dict[str, object] = { 
        '%%%make_api_name!!!AiAudioAnnotationApi%%%': [None, 'AiAudioAnnotationApi'],
        '%%%make_api_name!!!AnalyticsApi%%%': [None, 'AnalyticsApi'],
        '%%%make_api_name!!!AssetsApi%%%': [None, 'AssetsApi'],
        '%%%make_api_name!!!AuthApi%%%': [None, 'AuthApi'],
        '%%%make_api_name!!!CloudstoragesApi%%%': [None, 'CloudstoragesApi'],
        '%%%make_api_name!!!CommentsApi%%%': [None, 'CommentsApi'],
        '%%%make_api_name!!!EventsApi%%%': [None, 'EventsApi'],
        '%%%make_api_name!!!GuidesApi%%%': [None, 'GuidesApi'],
        '%%%make_api_name!!!InvitationsApi%%%': [None, 'InvitationsApi'],
        '%%%make_api_name!!!IssuesApi%%%': [None, 'IssuesApi'],
        '%%%make_api_name!!!JobsApi%%%': [None, 'JobsApi'],
        '%%%make_api_name!!!LabelsApi%%%': [None, 'LabelsApi'],
        '%%%make_api_name!!!LambdaApi%%%': [None, 'LambdaApi'],
        '%%%make_api_name!!!MembershipsApi%%%': [None, 'MembershipsApi'],
        '%%%make_api_name!!!NotificationsApi%%%': [None, 'NotificationsApi'],
        '%%%make_api_name!!!OrganizationsApi%%%': [None, 'OrganizationsApi'],
        '%%%make_api_name!!!ProjectsApi%%%': [None, 'ProjectsApi'],
        '%%%make_api_name!!!QualityApi%%%': [None, 'QualityApi'],
        '%%%make_api_name!!!RequestsApi%%%': [None, 'RequestsApi'],
        '%%%make_api_name!!!SchemaApi%%%': [None, 'SchemaApi'],
        '%%%make_api_name!!!ServerApi%%%': [None, 'ServerApi'],
        '%%%make_api_name!!!TasksApi%%%': [None, 'TasksApi'],
        '%%%make_api_name!!!UsersApi%%%': [None, 'UsersApi'],
        '%%%make_api_name!!!WebhooksApi%%%': [None, 'WebhooksApi'],
    }
