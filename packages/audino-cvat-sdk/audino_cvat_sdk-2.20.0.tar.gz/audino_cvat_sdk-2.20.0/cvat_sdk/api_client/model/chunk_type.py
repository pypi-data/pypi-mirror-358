...
class IChunkType(IModelData):
    ...
    One of: "audio", "video", "imageset", "list"  # noqa: E501
    """
...
class ChunkType(ModelSimple, IChunkType):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): * `audio` - AUDIO * `video` - VIDEO * `imageset` - IMAGESET * `list` - LIST., must be one of ["audio", "video", "imageset", "list", ]  # noqa: E501

        Keyword Args:
            value (str): * `audio` - AUDIO * `video` - VIDEO * `imageset` - IMAGESET * `list` - LIST., must be one of ["audio", "video", "imageset", "list", ]  # noqa: E501
