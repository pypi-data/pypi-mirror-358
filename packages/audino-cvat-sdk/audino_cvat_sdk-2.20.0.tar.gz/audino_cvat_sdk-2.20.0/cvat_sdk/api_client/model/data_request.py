...
class IDataRequest(IModelData):
    ...
    chunk_size: %%%make_type_annotation!!!int, none_type%%% # noqa: E501
    """
    [optional]
    ...
    frame_filter: %%%make_type_annotation!!!str%%% # noqa: E501
    """
    [optional]
    Frame filter. The only supported syntax is: 'step=N'.
    """

    client_files: %%%make_type_annotation!!![file_type]%%% # noqa: E501
    """
    [optional, default: []]
    [file_type]
    ...
    server_files: %%%make_type_annotation!!![str]%%% # noqa: E501
    """
    [optional, default: []]
    [str]
    ...
    remote_files: %%%make_type_annotation!!![str]%%% # noqa: E501
    """
    [optional, default: []]
    [str]
    ...
    use_zip_chunks: %%%make_type_annotation!!!bool%%% # noqa: E501
    """
    ...
    server_files_exclude: %%%make_type_annotation!!![str]%%% # noqa: E501
    """
    [optional, default: []]
    [str]
    ...
    cloud_storage_id: %%%make_type_annotation!!!int, none_type%%% # noqa: E501
    """
    [optional]
    ...
    storage_method: %%%make_type_annotation!!!StorageMethod%%% # noqa: E501
    """
    [optional]
    """

    storage: %%%make_type_annotation!!!StorageType%%% # noqa: E501
    """
    [optional]
    """

    sorting_method: %%%make_type_annotation!!!SortingMethod%%% # noqa: E501
    """
    [optional]
    """

    filename_pattern: %%%make_type_annotation!!!str, none_type%%% # noqa: E501
    """
    [optional]
    ...
    job_file_mapping: %%%make_type_annotation!!![[str]]%%% # noqa: E501
    """
    [optional]
    [[str]]
    ...
    upload_file_order: %%%make_type_annotation!!![str]%%% # noqa: E501
    """
    [optional]
    [str]
