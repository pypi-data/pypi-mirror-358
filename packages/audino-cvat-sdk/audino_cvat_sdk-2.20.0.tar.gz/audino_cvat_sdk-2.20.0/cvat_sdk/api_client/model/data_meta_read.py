...
class IDataMetaRead(IModelData):
    ...
    frames: %%%make_type_annotation!!![FrameMeta], none_type%%% # noqa: E501
    """
    [FrameMeta], none_type
    """

    deleted_frames: %%%make_type_annotation!!![int]%%% # noqa: E501
    """
    [int]
    """

    included_frames: %%%make_type_annotation!!![int], none_type%%% # noqa: E501
    """
    [optional]
    [int], none_type
    ...
    time_stamps: %%%make_type_annotation!!![float]%%% # noqa: E501
    """
    [float]
    """
...
class DataMetaRead(ModelNormal, IDataMetaRead):
    ...
    attribute_map = {
        ...
        'time_stamps': 'time_stamps',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, image_quality, frames, deleted_frames, time_stamps, *args, **kwargs):  # noqa: E501
...
"""
    ...
    @convert_js_args_to_python_args
    def __init__(self, image_quality, frames, deleted_frames, time_stamps, *args, **kwargs):  # noqa: E501
        """DataMetaRead - a model defined in OpenAPI
