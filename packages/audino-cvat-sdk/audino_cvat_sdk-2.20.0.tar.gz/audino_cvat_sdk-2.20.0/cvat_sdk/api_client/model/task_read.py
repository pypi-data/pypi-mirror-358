...
class ITaskRead(IModelData):
    ...
    name: %%%make_type_annotation!!!str%%% # noqa: E501
    """
    [optional]
    """
    ...
    owner: %%%make_type_annotation!!!CloudStorageReadOwner%%% # noqa: E501
    """
    [optional]
    """

    assignee: %%%make_type_annotation!!!CloudStorageReadOwner%%% # noqa: E501
    """
    [optional]
    """

    bug_tracker: %%%make_type_annotation!!!str%%% # noqa: E501
    """
    [optional]
    """
    ...
    segment_size: %%%make_type_annotation!!!int%%% # noqa: E501
    """
    [optional]
    """
    ...
    data_original_chunk_type: %%%make_type_annotation!!!bool, date, datetime, dict, float, int, list, str, none_type%%% # noqa: E501
    """
    [optional]
    """

    size: %%%make_type_annotation!!!int%%% # noqa: E501
    """
    [optional]
    """

    image_quality: %%%make_type_annotation!!!int%%% # noqa: E501
    """
    [optional]
    """

    data: %%%make_type_annotation!!!int%%% # noqa: E501
    """
    [optional]
    """
    ...
    subset: %%%make_type_annotation!!!str%%% # noqa: E501
    """
    [optional]
    """
    ...
    jobs: %%%make_type_annotation!!!JobsSummary%%% # noqa: E501
    """
    """
    ...
    segment_duration: %%%make_type_annotation!!!int, none_type%%% # noqa: E501
    """
    """

    flags: %%%make_type_annotation!!!JobReadTaskFlags%%% # noqa: E501
    """
    [optional]
    """

    audio_total_duration: %%%make_type_annotation!!![bool, date, datetime, dict, float, int, list, str, none_type], none_type%%% # noqa: E501
    """
    [optional]
    [bool, date, datetime, dict, float, int, list, str, none_type], none_type
    """

    total_frames_count: %%%make_type_annotation!!![bool, date, datetime, dict, float, int, list, str, none_type], none_type%%% # noqa: E501
    """
    [optional]
    [bool, date, datetime, dict, float, int, list, str, none_type], none_type
    """

    total_jobs_count: %%%make_type_annotation!!![bool, date, datetime, dict, float, int, list, str, none_type], none_type%%% # noqa: E501
    """
    [optional]
    [bool, date, datetime, dict, float, int, list, str, none_type], none_type
    """
...
class TaskRead(ModelNormal, ITaskRead):
    ...
    Attributes:
      ...
      segment_duration (int, none_type):
      ...
      flags (JobReadTaskFlags): [optional]  # noqa: E501

      audio_total_duration ([bool, date, datetime, dict, float, int, list, str, none_type], none_type): [optional]  # noqa: E501

      total_frames_count ([bool, date, datetime, dict, float, int, list, str, none_type], none_type): [optional]  # noqa: E501

      total_jobs_count ([bool, date, datetime, dict, float, int, list, str, none_type], none_type): [optional]  # noqa: E501
    ...
    def openapi_types():
        ...
        return {
            ...
            'segment_duration': (int, none_type,),  # noqa: E501
            'url': (str,),  # noqa: E501
            'id': (int,),  # noqa: E501
            'name': (str,),  # noqa: E501
            ...
            'flags': (JobReadTaskFlags,),  # noqa: E501
            'audio_total_duration': ([bool, date, datetime, dict, float, int, list, str, none_type], none_type,),  # noqa: E501
            'total_frames_count': ([bool, date, datetime, dict, float, int, list, str, none_type], none_type,),  # noqa: E501
            'total_jobs_count': ([bool, date, datetime, dict, float, int, list, str, none_type], none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'segment_duration': 'segment_duration',  # noqa: E501
        'url': 'url',  # noqa: E501
        'id': 'id',  # noqa: E501
        'name': 'name',  # noqa: E501
        ...
        'audio_total_duration': 'audio_total_duration',  # noqa: E501
        'total_frames_count': 'total_frames_count',  # noqa: E501
        'total_jobs_count': 'total_jobs_count',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, jobs, labels, segment_duration, *args, **kwargs):  # noqa: E501
...
"""
    ...
    @convert_js_args_to_python_args
    def __init__(self, jobs, labels, segment_duration, *args, **kwargs):  # noqa: E501
        """TaskRead - a model defined in OpenAPI
