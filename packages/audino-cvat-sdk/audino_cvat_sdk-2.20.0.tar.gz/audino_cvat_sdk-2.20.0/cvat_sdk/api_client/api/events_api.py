...
class EventsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.%%%make_operation_id!!!events_create%%%_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': '%%%make_operation_id!!!events_create%%%',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.%%%make_operation_id!!!events_list%%%_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/events',
                'operation_id': '%%%make_operation_id!!!events_list%%%',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def %%%make_operation_id!!!events_create%%%(
        self,
        client_events_request: %%%make_type_annotation!!!ClientEventsRequest%%%,
        *,
        ...
        **kwargs,
    ) -> typing.Tuple[typing.Optional[%%%make_type_annotation!!!ClientEvents%%%], urllib3.HTTPResponse]:
        ...
        >>> thread = api.%%%make_operation_id!!!events_create%%%(client_events_request, _async_call=True)
        >>> result = thread.get()
        ...
        return self.%%%make_operation_id!!!events_create%%%_endpoint.call_with_http_info(**kwargs)

    def %%%make_operation_id!!!events_list%%%(
        self,
        *,
        _parse_response: bool = True,
        _request_timeout: typing.Union[int, float, tuple] = None,
        ...
        **kwargs,
        ...
        >>> thread = api.%%%make_operation_id!!!events_list%%%(_async_call=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = _host_index
        kwargs['_request_auths'] = _request_auths
        return self.%%%make_operation_id!!!events_list%%%_endpoint.call_with_http_info(**kwargs)
