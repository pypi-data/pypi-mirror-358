...
class IssuesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.%%%make_operation_id!!!issues_create%%%_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': '%%%make_operation_id!!!issues_create%%%',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.%%%make_operation_id!!!issues_destroy%%%_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': '%%%make_operation_id!!!issues_destroy%%%',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.%%%make_operation_id!!!issues_list%%%_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/issues',
                'operation_id': '%%%make_operation_id!!!issues_list%%%',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.%%%make_operation_id!!!issues_partial_update%%%_endpoint = _Endpoint(
            settings={
                'response_schema': (IssueRead,),
                'auth': [
                    'basicAuth',
                ...
                'endpoint_path': '/api/issues/{id}',
                'operation_id': '%%%make_operation_id!!!issues_partial_update%%%',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.%%%make_operation_id!!!issues_retrieve%%%_endpoint = _Endpoint(
            settings={
                'response_schema': (IssueRead,),
                'auth': [
                    'basicAuth',
                ...
                'endpoint_path': '/api/issues/{id}',
                'operation_id': '%%%make_operation_id!!!issues_retrieve%%%',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def %%%make_operation_id!!!issues_create%%%(
        self,
        issue_write_request: %%%make_type_annotation!!!IssueWriteRequest%%%,
        *,
        ...
        **kwargs,
    ) -> typing.Tuple[typing.Optional[%%%make_type_annotation!!!IssueRead%%%], urllib3.HTTPResponse]:
        """Create an issue  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass _async_call=True

        >>> thread = api.%%%make_operation_id!!!issues_create%%%(issue_write_request, _async_call=True)
        >>> result = thread.get()
        ...
        return self.%%%make_operation_id!!!issues_create%%%_endpoint.call_with_http_info(**kwargs)

    def %%%make_operation_id!!!issues_destroy%%%(
        self,
        ...
        **kwargs,
        ...
        >>> thread = api.%%%make_operation_id!!!issues_destroy%%%(id, _async_call=True)
        >>> result = thread.get()
        ...
        kwargs['_request_auths'] = _request_auths
        kwargs['id'] = id
        return self.%%%make_operation_id!!!issues_destroy%%%_endpoint.call_with_http_info(**kwargs)

    def %%%make_operation_id!!!issues_list%%%(
        self,
        *,
        _parse_response: bool = True,
        _request_timeout: typing.Union[int, float, tuple] = None,
        ...
        _async_call: bool = False,
        **kwargs,
    ) -> typing.Tuple[typing.Optional[%%%make_type_annotation!!!PaginatedIssueReadList%%%], urllib3.HTTPResponse]:
        """List issues  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass _async_call=True

        >>> thread = api.%%%make_operation_id!!!issues_list%%%(_async_call=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = _host_index
        kwargs['_request_auths'] = _request_auths
        return self.%%%make_operation_id!!!issues_list%%%_endpoint.call_with_http_info(**kwargs)

    def %%%make_operation_id!!!issues_partial_update%%%(
        self,
        id: %%%make_type_annotation!!!int%%%,
        *,
        _parse_response: bool = True,
        ...
        **kwargs,
        ...
        >>> thread = api.%%%make_operation_id!!!issues_partial_update%%%(id, _async_call=True)
        >>> result = thread.get()
        ...
        kwargs['_request_auths'] = _request_auths
        kwargs['id'] = id
        return self.%%%make_operation_id!!!issues_partial_update%%%_endpoint.call_with_http_info(**kwargs)

    def %%%make_operation_id!!!issues_retrieve%%%(
        self,
        id: %%%make_type_annotation!!!int%%%,
        *,
        _parse_response: bool = True,
        ...
        **kwargs,
        ...
        >>> thread = api.%%%make_operation_id!!!issues_retrieve%%%(id, _async_call=True)
        >>> result = thread.get()
        ...
        kwargs['_request_auths'] = _request_auths
        kwargs['id'] = id
        return self.%%%make_operation_id!!!issues_retrieve%%%_endpoint.call_with_http_info(**kwargs)
