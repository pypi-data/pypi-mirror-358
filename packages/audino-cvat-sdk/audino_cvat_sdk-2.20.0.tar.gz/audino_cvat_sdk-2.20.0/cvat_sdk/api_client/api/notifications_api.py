...
class NotificationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.%%%make_operation_id!!!notifications_create_fetch%%%_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': '%%%make_operation_id!!!notifications_create_fetch%%%',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.%%%make_operation_id!!!notifications_create_markallread%%%_endpoint = _Endpoint(
            settings={
                'response_schema': None,
                'auth': [
                    'basicAuth',
                ...
                'operation_id': '%%%make_operation_id!!!notifications_create_markallread%%%',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.%%%make_operation_id!!!notifications_create_send%%%_endpoint = _Endpoint(
            settings={
                'response_schema': None,
                'auth': [
                    'basicAuth',
                ...
                'operation_id': '%%%make_operation_id!!!notifications_create_send%%%',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def %%%make_operation_id!!!notifications_create_fetch%%%(
        self,
        *,
        ...
        **kwargs,
        ...
        """%%%make_operation_id!!!notifications_create_fetch%%%  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass _async_call=True

        >>> thread = api.%%%make_operation_id!!!notifications_create_fetch%%%(_async_call=True)
        >>> result = thread.get()
        ...
        return self.%%%make_operation_id!!!notifications_create_fetch%%%_endpoint.call_with_http_info(**kwargs)

    def %%%make_operation_id!!!notifications_create_markallread%%%(
        self,
        *,
        _parse_response: bool = True,
        _request_timeout: typing.Union[int, float, tuple] = None,
        ...
        **kwargs,
        ...
        """%%%make_operation_id!!!notifications_create_markallread%%%  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass _async_call=True

        >>> thread = api.%%%make_operation_id!!!notifications_create_markallread%%%(_async_call=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = _host_index
        kwargs['_request_auths'] = _request_auths
        return self.%%%make_operation_id!!!notifications_create_markallread%%%_endpoint.call_with_http_info(**kwargs)

    def %%%make_operation_id!!!notifications_create_send%%%(
        self,
        *,
        _parse_response: bool = True,
        _request_timeout: typing.Union[int, float, tuple] = None,
        ...
        **kwargs,
        ...
        """%%%make_operation_id!!!notifications_create_send%%%  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass _async_call=True

        >>> thread = api.%%%make_operation_id!!!notifications_create_send%%%(_async_call=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = _host_index
        kwargs['_request_auths'] = _request_auths
        return self.%%%make_operation_id!!!notifications_create_send%%%_endpoint.call_with_http_info(**kwargs)
