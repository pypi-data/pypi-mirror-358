...
class TasksApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.retrieve_gt_status_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'retrieve_gt_status',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def retrieve_gt_status(
        ...
        **kwargs,
        ...
        >>> thread = api.retrieve_gt_status(id, _async_call=True)
        >>> result = thread.get()
        ...
        kwargs['_request_auths'] = _request_auths
        kwargs['id'] = id
        return self.retrieve_gt_status_endpoint.call_with_http_info(**kwargs)
