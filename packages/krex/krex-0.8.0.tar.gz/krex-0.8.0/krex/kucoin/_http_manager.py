    ...
    def _request(
        ...
        try:
            ...
            if method.upper() == "GET":
                ...
                response = self.session.post(url, headers=headers, json=query, timeout=self.timeout)
            elif method.upper() == "PUT":
                response = self.session.put(url, headers=headers, json=query, timeout=self.timeout)
