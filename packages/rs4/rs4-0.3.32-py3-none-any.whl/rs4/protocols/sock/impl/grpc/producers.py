...
def serialize (msg, use_compress = True, compressor = None):
	compressed = 0
	serialized = msg.SerializeToString ()
	if use_compress and len (serialized) > 2048:
		serialized = compressor.compress (serialized) + compressor.flush ()
		compressed = 1
...
class grpc_producer:
	...
	def serialize (self, msg):
		s = serialize (msg, self.use_compress, self.compressor)
