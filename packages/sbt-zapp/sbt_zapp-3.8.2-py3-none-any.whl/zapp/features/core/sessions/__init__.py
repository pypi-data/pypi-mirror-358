...
ENABLE_LOG_METHOD = env.bool("ENABLE_LOG_METHOD", default=True)
...
def info() -> Callable[P, T]:
    return log_call(log.info)


def debug() -> Callable[P, T]:
    return log_call(log.debug)
