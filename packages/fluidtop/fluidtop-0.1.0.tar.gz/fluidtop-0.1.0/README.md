...
[![PyPI Publishing](https://img.shields.io/badge/PyPI-Coming%20Soon-yellow.svg)](https://pypi.org/project/fluidtop/)
...
```bash
# Clone and run directly (current method)
...
```bash
# After PyPI publication, you'll be able to run:
sudo uvx fluidtop                    # One-time usage
# or
uv add fluidtop && sudo fluidtop     # Install permanently
```
