...
class IRecv:
    def __init__(self, ecid=None, timeout=3, is_recovery=None):
        if 'arm' in platform.machine().lower():
            self.libusb_path = pkg_resources.resource_filename('pyappleinternal', 'lib/arm/libusb-1.0.dylib')
        else:
            self.libusb_path=pkg_resources.resource_filename('pyappleinternal', 'lib/x86/libusb-1.0.dylib')
