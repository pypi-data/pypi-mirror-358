...
class DataArguments:
    ...
    train_dataset_type: List[str] = field(
        default='file', metadata={"help": "List contains type of training datasets."}
    )
    train_dataset_path: List[str] = field(
        default=None,
        metadata={"help": "List contains path of training data sources."},
    )
    train_dataset_prob: List[float] = field(
        default=None,
        metadata={"help": "List contains probabilities of training data sources."},
    )
    eval_dataset_type: List[str] = field(default='file', metadata={"help": "List contains type of eval datasets."})
    eval_dataset_path: List[str] = field(
        default=None,
        metadata={"help": "List contains path of eval data sources."},
    )
    eval_dataset_prob: List[float] = field(
        default=None,
