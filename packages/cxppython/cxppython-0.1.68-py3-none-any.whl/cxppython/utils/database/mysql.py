...
class MysqlDB:
    def __init__(self, mysql_config):
        ...
        :param mysql_config: 数据库配置字典或连接字符串，包含 user, password, host, port, database 等字段
        """
    ...
    def _reconnect(self):
        ...
        try:
            ...
            self.session_factory = sessionmaker(bind=self.engine)  # 更新会话工厂
