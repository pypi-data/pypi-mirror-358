...
class AIIA:
    ...
    def __init__(self, api_key: Optional[str] = None, client_secret: Optional[str] = None, 
        ...
        Args:
            ...
            company_email: Email of the company using this AI (for log association)
        """
        ...
        # Store company email for log association
        self.company_email = company_email or os.getenv("AIIA_COMPANY_EMAIL")
    ...
    def log_action(self, *args, **kwargs) -> bool:
        ...
        try:
            ...
            if self.company_email:
                log_payload["user_email"] = self.company_email
