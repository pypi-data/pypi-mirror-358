...
class ContextBuilder:
    ...
    def build_context_for_follow_up(agent: ChattyAIAgent, mode_in_chat: ChattyAIMode, company_info:EmpresaModel) -> str:
        ##TODO: Add the follow up context here
        ##Basically we should remove some of the context that is not relevant for the follow up and add a specific prompt for the follow up based on the follow up strategy of the agent
        return ContextBuilder.build_context(agent=agent, mode_in_chat=mode_in_chat, company_info=company_info)