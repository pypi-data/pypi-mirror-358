...
class ChatService:
    ...
    @staticmethod
    def add_workflow_link(chat : Chat, link : LinkItem, flow:FlowPreview, execution_context: ExecutionContext, description: str) -> FlowStateAssignedToChat:
        """
        Add a tag to the chat.
        """
        state = FlowStateAssignedToChat.from_link(link, execution_context, description)
