...
class FlowStateAssignedToChat(AssignedAssetToChat):
    ...
    last_incoming_message_id: Optional[StrObjectId] = Field(default=None)
    ...
    @staticmethod
    def from_link(link: LinkItem, execution_context: ExecutionContext, description: str, last_incoming_message_id: Optional[StrObjectId] = None) -> FlowStateAssignedToChat:
