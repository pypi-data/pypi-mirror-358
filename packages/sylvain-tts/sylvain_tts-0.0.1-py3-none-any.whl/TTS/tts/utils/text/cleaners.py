...
from TTS.tts.utils.text.chinese_cantonese.numbers import replace_numbers_to_characters_in_text as replace_numbers_to_characters_in_text_cantonese
...
def chinese_cantonese_cleaners(text: str) -> str:
    """Basic pipeline for chinese cantonese"""
    text = normalize_unicode(text)
    text = replace_numbers_to_characters_in_text_cantonese(text)
    return text
