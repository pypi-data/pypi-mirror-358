...
class RobutlerApi:
    ...
    async def validate_payment_token(self, token: str) -> Dict[str, Any]:
        ...
        Raises:
            RobutlerApiError: On API error
        """
        return await self._request("GET", "/api/tokens/validate", params={"token": token})
    ...
    async def redeem_payment_token(
        ...
        return await self._request("PUT", "/api/tokens/redeem", data=data)
    ...
    async def issue_payment_token(
        ...
        response = await self._request("POST", "/api/tokens", data=data)
    ...
    async def cancel_payment_token(self, token_id: str) -> Dict[str, Any]:
        ...
        Raises:
            RobutlerApiError: On API error
        """
        return await self._request("PUT", "/api/tokens/cancel", data={"tokenId": token_id})
