...
struct TfMakePyPtr {
    ...
    typedef pxr::boost::python::objects::pointer_holder<Ptr, Pointee> Holder;
    ...
    static Result Execute(Ptr const& p)
    {
        ...
        if (!p.GetUniqueIdentifier())
            return Result(pxr::boost::python::detail::none(), false);
        ...
        PyObject *res = pxr::boost::python::objects::make_ptr_instance
