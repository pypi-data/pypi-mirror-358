...
struct Tf_PySequenceToListConverter {
    ...
    PyObject *operator()(T seq) const {
        return pxr::boost::python::incref(TfPyCopySequenceToList(seq).ptr());
    }
...
struct Tf_PySequenceToSetConverter {
    ...
    PyObject *operator()(T seq) const {
        return pxr::boost::python::incref(TfPyCopySequenceToSet(seq).ptr());
    }
    PyTypeObject *get_pytype() {
        return &PySet_Type;
    }
...
struct Tf_PyMapToDictionaryConverter {
    ...
    PyObject *operator()(T seq) const {
        return pxr::boost::python::incref(TfPyCopyMapToDictionary(seq).ptr());
    }
    PyTypeObject *get_pytype() {
        return &PyDict_Type;
    }
...
struct Tf_PySequenceToTupleConverter {
    ...
    PyObject *operator()(T seq) const {
        return pxr::boost::python::incref(TfPyCopySequenceToTuple(seq).ptr());
    }
    PyTypeObject *get_pytype() {
        return &PyTuple_Type;
    }
