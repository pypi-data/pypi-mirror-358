...
// Convert any type to pxr::boost::python::object.
template <typename T>
pxr::boost::python::object Tf_ArgToPy(const T &value)
{
    return pxr::boost::python::object(value);
}

// Convert nullptr to None.
TF_API pxr::boost::python::object Tf_ArgToPy(const std::nullptr_t &value);
...
struct TfPyKwArg
{
    ...
    TfPyKwArg(const std::string &nameIn, const T &valueIn)
        : name(nameIn)
    {
        // Constructing pxr::boost::python::object requires the GIL.
        TfPyLock lock;
...
bool TfPyInvokeAndReturn(
    const std::string &moduleName,
    const std::string &callableExpr,
    pxr::boost::python::object *resultOut,
    Args... args);
    ...
    Args... args)
{
    ...
    pxr::boost::python::object resultObj;
    ...
    pxr::boost::python::extract<Result> extractor(resultObj);
    if (!extractor.check()) {
...
/// value as a \c pxr::boost::python::object, rather than extracting a particular C++
/// type from it.
///
template <typename... Args>
bool TfPyInvokeAndReturn(
    ...
    Args... args)
{
    ...
    try {
        ...
        pxr::boost::python::list posArgs;
        pxr::boost::python::dict kwArgs;
    ...
    Args... args)
{
    ...
    pxr::boost::python::object ignoredResult;
