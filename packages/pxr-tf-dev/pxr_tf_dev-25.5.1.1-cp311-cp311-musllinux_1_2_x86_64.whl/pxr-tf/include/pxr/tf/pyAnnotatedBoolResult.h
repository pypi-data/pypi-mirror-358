...
struct TfPyAnnotatedBoolResult
{
    ...
    static pxr::boost::python::class_<Derived>
...
private:
    ...
    template <class Derived>
    static pxr::boost::python::object _GetItem(const Derived& x, int i)
    {
        if (i == 0) {
            return pxr::boost::python::object(x._val);
        }
        if (i == 1) {
            return pxr::boost::python::object(x._annotation);
        }
