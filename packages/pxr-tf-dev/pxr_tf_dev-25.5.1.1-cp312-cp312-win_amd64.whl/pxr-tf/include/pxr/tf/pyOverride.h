...
///
/// A reimplementation of pxr::boost::python::detail::method_result.
///
...
/// pxr::boost::python::override, which we also reimplement below.
///
/// \see TfPyOverride
class TfPyMethodResult
{
...
public:
    ...
    {
        TfPyLock lock;
        pxr::boost::python::converter::return_from_python<T> converter;
    ...
    operator T&() const
    {
        ...
        pxr::boost::python::converter::return_from_python<T&> converter;
        return converter(
            const_cast<pxr::boost::python::handle<>&>(m_obj).release());
    }

    template <class T>
    T as(pxr::boost::python::type<T>* = 0)
    {
        TfPyLock lock;
        pxr::boost::python::converter::return_from_python<T> converter;
        return converter(m_obj.release());
    ...
    template <class T>
    T unchecked(pxr::boost::python::type<T>* = 0)
    {
        TfPyLock lock;
        return pxr::boost::python::extract<T>(m_obj)();
    }

private:
    mutable pxr::boost::python::handle<> m_obj;
};

/// \class TfPyOverride
///
/// A reimplementation of pxr::boost::python::override.
///
/// This class is reimplemented from the boost class simply because the
/// provided class only allows construction from, ultimately,
/// pxr::boost::python::wrapper::get_override(). Unfortunately, that method
...
public:
    ...
    TfPyOverride(pxr::boost::python::handle<> callable)
        : TfPyObjWrapper(pxr::boost::python::object(callable))
    {}
    ...
    operator()(Args const&... args) const
    {
        ...
        TfPyMethodResult x(
            PyEval_CallFunction(
                ...
                pxr::boost::python::converter::arg_to_python<Args>(args).get()...));
        return x;
    }
};
