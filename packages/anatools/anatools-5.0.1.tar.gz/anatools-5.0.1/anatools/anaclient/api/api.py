...
class api:
    ...
    def errorhandler(self, response, call):
        ...
        try: 
            ...
            if 'data' not in responsedata or call not in responsedata['data']: raise Exception()
    ...
    from .volumes       import getVolumes, getVolumes, createVolume, deleteVolume, editVolume, getVolumeData, uploadVolumeData, uploadVolumeDataFinalizer, deleteVolumeData, mountVolumes
