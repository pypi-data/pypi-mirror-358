...
class SubnetProjection(Subnet):
    ...
    def __init__(self, virtual_switch_projection=None, vpc_projection=None, name=None, description=None, subnet_type=None, network_id=None, dhcp_options=None, ip_config=None, cluster_reference=None, cluster_reference_list=None, cluster_name_list=None, virtual_switch_reference=None, vpc_reference=None, is_nat_enabled=None, is_external=None, reserved_ip_addresses=None, dynamic_ip_addresses=None, network_function_chain_reference=None, bridge_name=None, is_advanced_networking=None, cluster_name=None, hypervisor_type=None, virtual_switch=None, vpc=None, ip_prefix=None, ip_usage=None, migration_state=None, external_dhcp_servers=None, metadata=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        Subnet.__init__(self, name, description, subnet_type, network_id, dhcp_options, ip_config, cluster_reference, cluster_reference_list, cluster_name_list, virtual_switch_reference, vpc_reference, is_nat_enabled, is_external, reserved_ip_addresses, dynamic_ip_addresses, network_function_chain_reference, bridge_name, is_advanced_networking, cluster_name, hypervisor_type, virtual_switch, vpc, ip_prefix, ip_usage, migration_state, external_dhcp_servers, metadata, ext_id, links, tenant_id, *args, **kwargs)
