...
class xG:
    ...
    def from_dict(cls, response: dict) -> 'xG':
        ...
        return cls(
            ...
            ht_xg=data['home']['statistics']['xg'] if 'xg' in data['home']['statistics'] else None,
            at_xg=data['away']['statistics']['xg'] if 'xg' in data['away']['statistics'] else None,
            ht_goals=data['home']['statistics']['goals'] if 'goals' in data['home']['statistics'] else None,
            at_goals=data['away']['statistics']['goals'] if 'goals' in data['away']['statistics'] else None
        )
