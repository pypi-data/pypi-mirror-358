...
class SamlIdentityProvider(ExternalizableAbstractModel):
    ...
    def redirect_url(self, redirect_url):
        ...
        if redirect_url is not None and not re.search('^((http[s]?):\/)?\/?([^:\/\\s]*)((:[0-9]+)*?)$', redirect_url):  # noqa: E501
            raise ValueError(r"Invalid value for `redirect_url`, must be a follow pattern or equal to `/^((http[s]?):\/)?\/?([^:\/\\s]*)((:[0-9]+)*?)$/`")  # noqa: E501
