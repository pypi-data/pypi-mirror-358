...
class TestWaveguideModule:
    ...
    def test_calculate_group_index(self):
        ...
        # Verify metadata
        assert ng_result.get_metadata("Measurement") == "Group Index Calculation"
    ...
    def test_calculate_waveguide_losses(self):
        ...
        # Verify metadata
        assert loss_result.get_metadata("Measurement") == "Propagation Loss, dB"
    ...
    def test_find_peaks_plot(self):
        """Test plotting function (check it doesn't crash)."""
        # This test mainly checks that the function runs without error
        # In a real test environment, you might want to mock matplotlib
        try:
            # Temporarily redirect plotting to avoid actual display
            import matplotlib

            matplotlib.use("Agg")  # Use non-interactive backend

            find_peaks_plot(self.basic_data)
