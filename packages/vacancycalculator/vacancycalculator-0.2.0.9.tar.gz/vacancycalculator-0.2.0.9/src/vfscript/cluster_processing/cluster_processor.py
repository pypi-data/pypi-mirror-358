...
class ClusterProcessor:
    def __init__(self, defect: str, json_params_path: str = None):
        ...
        # 1) Si no me pasan la ruta, intento cargar input_params.json desde el directorio de trabajo actual
        ...
        # 3) Extraer la configuración principal
        ...
        # 4) Extraer los parámetros relevantes
