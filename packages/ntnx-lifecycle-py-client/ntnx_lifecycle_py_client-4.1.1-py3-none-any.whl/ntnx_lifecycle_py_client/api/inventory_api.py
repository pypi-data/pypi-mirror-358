...
class InventoryApi(object):
    ...
    def perform_inventory(self, body=None, X_Cluster_Id=None, _dryrun=None, **kwargs):  # noqa: E501
        """Perform an inventory operation to identify/scan entities on the cluster that can be updated through LCM.

        >>> response = api.perform_inventory((optional) body, (optional) X_Cluster_Id, (optional) _dryrun)
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/lifecycle/v4.1/operations/$actions/inventory', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
