...
class LcmSummary(ExternalizableAbstractModel):
    ...
    def __init__(self, current_version=None, available_version=None, hardware_vendor=None, capabilities=None, in_progress_operation=None, cluster_ext_id=None, is_url_accessible=True, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
