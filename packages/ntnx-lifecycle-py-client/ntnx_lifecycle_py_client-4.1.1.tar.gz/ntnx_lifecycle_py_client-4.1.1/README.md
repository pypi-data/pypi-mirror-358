...
# Queries a Service MSP Cluster by its external Id.
try:
    api_response = cluster_api_instance.get_cluster_by_id(extId)
...
# Update Service MSP cluster by Id.
try:
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=lifecycle&version=v4.1&language=python). This documentation is auto-generated, and the location may change.
