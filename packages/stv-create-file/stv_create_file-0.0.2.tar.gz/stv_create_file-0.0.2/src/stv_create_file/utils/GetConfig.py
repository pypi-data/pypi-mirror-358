...
class ConfigProcessor:
    ...
    def parse(self, args: str) -> bool or None or str:
        if self.config:
            try:
    ...
    def initialize(self):
        ...
        with open(self.path, "r+", encoding="utf-8") as f:
            if not f.read():
                ...
                content = {"lang": "zh-cn","verbose": False,} if is_ch() else {"lang": "en-uk","verbose": False,}
                self.save(content, f)
    ...
    def change(self, key: str = "", value: bool = False):
