...
#获取单个股票市值
def mark_c_data(ca_code,start_date,token=get_token(),end_date=str(datetime.date.today().strftime('%Y-%m-%d'))):
    ...
    li = hg(ca_code=ca_code, start_date=start_date, end_date=end_date, token=token,)
