...
from PySide6.QtWidgets import (
    ...
    QFormLayout, QProgressBar, QMessageBox, QSizePolicy
)
...
from telegram_download_chat.paths import get_downloads_dir, get_app_dir
...
class ConvertTab(QWidget):
    ...
    def _browse_dir(self):
        ...
        start_dir = self.dir_edit.text() or self._config.value("last_output_dir", str(Path.home()))
